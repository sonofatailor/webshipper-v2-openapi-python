...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://.api.webshipper.io/v2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("webshipperv2")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://{tenant}.api.webshipper.io/v2",
                'description': "No description provided",
                'variables': {
                    'tenant': {
                        'description': "Your webshipper account name",
                        'default_value': "",
                        }
                    }
            }
