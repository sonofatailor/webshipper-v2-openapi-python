...
class AttachmentApi:
    ...
    def attachments_get(
        ...
        _param = self._attachments_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def attachments_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AttachmentsGet200Response]:
        """List all Attachments
    ...
    @validate_call
    def attachments_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _attachments_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def attachments_id_delete(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AttachmentsIdGet200Response"
    ...
    def attachments_id_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AttachmentsIdGet200Response]:
        """Delete a Attachment
    ...
    def attachments_id_get(
        ...
        _param = self._attachments_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def attachments_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def attachments_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _attachments_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def attachments_id_patch(
        self,
        id: StrictInt,
        attachments_id_patch_request: AttachmentsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param attachments_id_patch_request: (required)
        :type attachments_id_patch_request: AttachmentsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._attachments_id_patch_serialize(
            id=id,
            attachments_id_patch_request=attachments_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def attachments_id_patch_with_http_info(
        self,
        id: StrictInt,
        attachments_id_patch_request: AttachmentsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def attachments_id_patch_without_preload_content(
        self,
        id: StrictInt,
        attachments_id_patch_request: AttachmentsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _attachments_id_patch_serialize(
        self,
        id,
        attachments_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if attachments_id_patch_request is not None:
            _body_params = attachments_id_patch_request
    ...
    def attachments_post(
        self,
        attachments_post_request: AttachmentsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param attachments_post_request: (required)
        :type attachments_post_request: AttachmentsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._attachments_post_serialize(
            attachments_post_request=attachments_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "AttachmentsIdGet200Response"
    ...
    @validate_call
    def attachments_post_with_http_info(
        self,
        attachments_post_request: AttachmentsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def attachments_post_without_preload_content(
        self,
        attachments_post_request: AttachmentsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _attachments_post_serialize(
        self,
        attachments_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if attachments_post_request is not None:
            _body_params = attachments_post_request
