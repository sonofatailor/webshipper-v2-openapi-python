...
class ReturnPortalApi:
    ...
    def return_portals_get(
        ...
        _param = self._return_portals_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ReturnPortalsGet200Response"
    ...
    @validate_call
    def return_portals_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReturnPortalsGet200Response]:
        """List all Return Portals
    ...
    @validate_call
    def return_portals_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _return_portals_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def return_portals_id_delete(
        ...
        _param = self._return_portals_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ReturnPortalsIdGet200Response"
    ...
    @validate_call
    def return_portals_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReturnPortalsIdGet200Response]:
        """Delete a Return Portal
    ...
    @validate_call
    def return_portals_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _return_portals_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/return_portals/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def return_portals_id_get(
        ...
        _param = self._return_portals_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def return_portals_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def return_portals_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _return_portals_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def return_portals_id_patch(
        self,
        id: StrictInt,
        return_portals_id_patch_request: ReturnPortalsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param return_portals_id_patch_request: (required)
        :type return_portals_id_patch_request: ReturnPortalsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._return_portals_id_patch_serialize(
            id=id,
            return_portals_id_patch_request=return_portals_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def return_portals_id_patch_with_http_info(
        self,
        id: StrictInt,
        return_portals_id_patch_request: ReturnPortalsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def return_portals_id_patch_without_preload_content(
        self,
        id: StrictInt,
        return_portals_id_patch_request: ReturnPortalsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _return_portals_id_patch_serialize(
        self,
        id,
        return_portals_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if return_portals_id_patch_request is not None:
            _body_params = return_portals_id_patch_request
    ...
    @validate_call
    def return_portals_post(
        self,
        return_portals_post_request: ReturnPortalsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param return_portals_post_request: (required)
        :type return_portals_post_request: ReturnPortalsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._return_portals_post_serialize(
            return_portals_post_request=return_portals_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "ReturnPortalsIdGet200Response"
    ...
    @validate_call
    def return_portals_post_with_http_info(
        self,
        return_portals_post_request: ReturnPortalsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def return_portals_post_without_preload_content(
        self,
        return_portals_post_request: ReturnPortalsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _return_portals_post_serialize(
        self,
        return_portals_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if return_portals_post_request is not None:
            _body_params = return_portals_post_request
