...
class ReportApi:
    ...
    def reports_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportsGet200Response]:
        """List all Reports
    ...
    def reports_id_delete(
        ...
        _param = self._reports_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def reports_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportsIdGet200Response]:
        """Delete a Report
    ...
    @validate_call
    def reports_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _reports_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def reports_id_get(
        ...
        _param = self._reports_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def reports_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def reports_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def reports_id_patch(
        self,
        id: StrictInt,
        reports_id_patch_request: ReportsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param reports_id_patch_request: (required)
        :type reports_id_patch_request: ReportsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._reports_id_patch_serialize(
            id=id,
            reports_id_patch_request=reports_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def reports_id_patch_with_http_info(
        self,
        id: StrictInt,
        reports_id_patch_request: ReportsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def reports_id_patch_without_preload_content(
        self,
        id: StrictInt,
        reports_id_patch_request: ReportsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _reports_id_patch_serialize(
        self,
        id,
        reports_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if reports_id_patch_request is not None:
            _body_params = reports_id_patch_request
    ...
    def reports_post(
        self,
        reports_post_request: ReportsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param reports_post_request: (required)
        :type reports_post_request: ReportsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._reports_post_serialize(
            reports_post_request=reports_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _reports_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if reports_post_request is not None:
            _body_params = reports_post_request
