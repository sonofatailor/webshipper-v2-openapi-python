...
class TrackingEventApi:
    ...
    def tracking_events_get(
        ...
        _param = self._tracking_events_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TrackingEventsGet200Response"
    ...
    @validate_call
    def tracking_events_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_created_at: Annotated[Optional[StrictStr], Field(description="Filter by created_at")] = None,
        filter_shipment_id: Annotated[Optional[StrictStr], Field(description="Filter by shipment_id")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TrackingEventsGet200Response]:
        """List all Tracking Events
    ...
    @validate_call
    def tracking_events_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_created_at: Annotated[Optional[StrictStr], Field(description="Filter by created_at")] = None,
        filter_shipment_id: Annotated[Optional[StrictStr], Field(description="Filter by shipment_id")] = None,
    ...
    def _tracking_events_get_serialize(
        self,
        filter_id,
        filter_created_at,
        filter_shipment_id,
    ...
    def tracking_events_id_get(
        ...
        _param = self._tracking_events_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TrackingEventsIdGet200Response"
    ...
    @validate_call
    def tracking_events_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TrackingEventsIdGet200Response]:
        """Show a single Tracking Event
    ...
    @validate_call
    def tracking_events_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _tracking_events_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tracking_events/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
