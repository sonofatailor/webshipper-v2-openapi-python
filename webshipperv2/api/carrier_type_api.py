...
class CarrierTypeApi:
    ...
    @validate_call
    def carrier_types_get(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_carrier_code: Annotated[Optional[StrictStr], Field(description="Filter by carrier_code")] = None,
        ...
        :type filter_id: str
        :param filter_carrier_code: Filter by carrier_code
        :type filter_carrier_code: str
        ...
        _param = self._carrier_types_get_serialize(
            filter_id=filter_id,
            filter_carrier_code=filter_carrier_code,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CarrierTypesGet200Response"
    ...
    @validate_call
    def carrier_types_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_carrier_code: Annotated[Optional[StrictStr], Field(description="Filter by carrier_code")] = None,
        filter_carrier_group_id: Annotated[Optional[StrictStr], Field(description="Filter by carrier_group_id")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CarrierTypesGet200Response]:
        """List all Carrier Types
    ...
    @validate_call
    def carrier_types_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_carrier_code: Annotated[Optional[StrictStr], Field(description="Filter by carrier_code")] = None,
        filter_carrier_group_id: Annotated[Optional[StrictStr], Field(description="Filter by carrier_group_id")] = None,
    ...
    def _carrier_types_get_serialize(
        self,
        filter_id,
        filter_carrier_code,
        ...
        if filter_carrier_code is not None:
            
            _query_params.append(('filter[carrier_code]', filter_carrier_code))
    ...
    def carrier_types_id_get(
        ...
        _param = self._carrier_types_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CarrierTypesIdGet200Response"
    ...
    @validate_call
    def carrier_types_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CarrierTypesIdGet200Response]:
        """Show a single Carrier Type
    ...
    @validate_call
    def carrier_types_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _carrier_types_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/carrier_types/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
