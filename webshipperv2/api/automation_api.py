...
class AutomationApi:
    ...
    def automations_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AutomationsGet200Response]:
        """List all Automations
    ...
    def automations_id_delete(
        ...
        _param = self._automations_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AutomationsIdGet200Response"
    ...
    @validate_call
    def automations_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AutomationsIdGet200Response]:
        """Delete a Automation
    ...
    @validate_call
    def automations_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _automations_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def automations_id_get(
        ...
        _param = self._automations_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def automations_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def automations_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _automations_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def automations_id_patch(
        self,
        id: StrictInt,
        automations_id_patch_request: AutomationsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param automations_id_patch_request: (required)
        :type automations_id_patch_request: AutomationsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._automations_id_patch_serialize(
            id=id,
            automations_id_patch_request=automations_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def automations_id_patch_with_http_info(
        self,
        id: StrictInt,
        automations_id_patch_request: AutomationsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def automations_id_patch_without_preload_content(
        self,
        id: StrictInt,
        automations_id_patch_request: AutomationsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _automations_id_patch_serialize(
        self,
        id,
        automations_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if automations_id_patch_request is not None:
            _body_params = automations_id_patch_request
    ...
    @validate_call
    def automations_post(
        self,
        automations_post_request: AutomationsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param automations_post_request: (required)
        :type automations_post_request: AutomationsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._automations_post_serialize(
            automations_post_request=automations_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "AutomationsIdGet200Response"
    ...
    @validate_call
    def automations_post_with_http_info(
        self,
        automations_post_request: AutomationsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def automations_post_without_preload_content(
        self,
        automations_post_request: AutomationsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _automations_post_serialize(
        self,
        automations_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if automations_post_request is not None:
            _body_params = automations_post_request
