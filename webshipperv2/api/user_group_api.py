...
class UserGroupApi:
    ...
    def user_groups_get(
        ...
        _param = self._user_groups_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def user_groups_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserGroupsGet200Response]:
        """List all User Groups
    ...
    @validate_call
    def user_groups_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _user_groups_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def user_groups_id_delete(
        ...
        _param = self._user_groups_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UserGroupsIdGet200Response"
    ...
    @validate_call
    def user_groups_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserGroupsIdGet200Response]:
        """Delete a User Group
    ...
    @validate_call
    def user_groups_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _user_groups_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def user_groups_id_get(
        ...
        _param = self._user_groups_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def user_groups_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def user_groups_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _user_groups_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def user_groups_id_patch(
        self,
        id: StrictInt,
        user_groups_id_patch_request: UserGroupsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param user_groups_id_patch_request: (required)
        :type user_groups_id_patch_request: UserGroupsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._user_groups_id_patch_serialize(
            id=id,
            user_groups_id_patch_request=user_groups_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def user_groups_id_patch_with_http_info(
        self,
        id: StrictInt,
        user_groups_id_patch_request: UserGroupsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def user_groups_id_patch_without_preload_content(
        self,
        id: StrictInt,
        user_groups_id_patch_request: UserGroupsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _user_groups_id_patch_serialize(
        self,
        id,
        user_groups_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if user_groups_id_patch_request is not None:
            _body_params = user_groups_id_patch_request
    ...
    def user_groups_post(
        self,
        user_groups_post_request: UserGroupsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_groups_post_request: (required)
        :type user_groups_post_request: UserGroupsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._user_groups_post_serialize(
            user_groups_post_request=user_groups_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "UserGroupsIdGet200Response"
    ...
    def _user_groups_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if user_groups_post_request is not None:
            _body_params = user_groups_post_request
