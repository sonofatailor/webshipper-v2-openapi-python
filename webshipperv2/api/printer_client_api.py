...
class PrinterClientApi:
    ...
    def printer_clients_get(
        ...
        _param = self._printer_clients_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PrinterClientsGet200Response"
    ...
    @validate_call
    def printer_clients_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrinterClientsGet200Response]:
        """List all Printer Clients
    ...
    @validate_call
    def printer_clients_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _printer_clients_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def printer_clients_id_get(
        ...
        _param = self._printer_clients_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PrinterClientsIdGet200Response"
    ...
    @validate_call
    def printer_clients_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrinterClientsIdGet200Response]:
        """Show a single Printer Client
    ...
    @validate_call
    def printer_clients_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _printer_clients_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/printer_clients/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def printer_clients_id_patch(
        self,
        id: StrictInt,
        printer_clients_id_patch_request: PrinterClientsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param printer_clients_id_patch_request: (required)
        :type printer_clients_id_patch_request: PrinterClientsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._printer_clients_id_patch_serialize(
            id=id,
            printer_clients_id_patch_request=printer_clients_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def printer_clients_id_patch_with_http_info(
        self,
        id: StrictInt,
        printer_clients_id_patch_request: PrinterClientsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def printer_clients_id_patch_without_preload_content(
        self,
        id: StrictInt,
        printer_clients_id_patch_request: PrinterClientsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _printer_clients_id_patch_serialize(
        self,
        id,
        printer_clients_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if printer_clients_id_patch_request is not None:
            _body_params = printer_clients_id_patch_request
