...
class CSVUploadApi:
    ...
    @validate_call
    def csv_uploads_post(
        self,
        csv_uploads_post_request: CsvUploadsPostRequest,
        ...
        :param csv_uploads_post_request: (required)
        :type csv_uploads_post_request: CsvUploadsPostRequest
        ...
        _param = self._csv_uploads_post_serialize(
            csv_uploads_post_request=csv_uploads_post_request,
    ...
    @validate_call
    def csv_uploads_post_with_http_info(
        self,
        csv_uploads_post_request: CsvUploadsPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CsvUploadsPost204Response]:
        """Create a CSV Upload
    ...
    @validate_call
    def csv_uploads_post_without_preload_content(
        self,
        csv_uploads_post_request: CsvUploadsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _csv_uploads_post_serialize(
        self,
        csv_uploads_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if csv_uploads_post_request is not None:
            _body_params = csv_uploads_post_request
