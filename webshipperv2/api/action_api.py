...
class ActionApi:
    ...
    def actions_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActionsGet200Response]:
        """List all Actions
    ...
    def actions_id_delete(
        ...
        _param = self._actions_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def actions_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActionsIdGet200Response]:
        """Delete a Action
    ...
    @validate_call
    def actions_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _actions_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def actions_id_patch(
        self,
        id: StrictInt,
        actions_id_patch_request: ActionsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param actions_id_patch_request: (required)
        :type actions_id_patch_request: ActionsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._actions_id_patch_serialize(
            id=id,
            actions_id_patch_request=actions_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def actions_id_patch_with_http_info(
        self,
        id: StrictInt,
        actions_id_patch_request: ActionsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def actions_id_patch_without_preload_content(
        self,
        id: StrictInt,
        actions_id_patch_request: ActionsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _actions_id_patch_serialize(
        self,
        id,
        actions_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if actions_id_patch_request is not None:
            _body_params = actions_id_patch_request
    ...
    def actions_post(
        self,
        actions_post_request: ActionsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param actions_post_request: (required)
        :type actions_post_request: ActionsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._actions_post_serialize(
            actions_post_request=actions_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _actions_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if actions_post_request is not None:
            _body_params = actions_post_request
