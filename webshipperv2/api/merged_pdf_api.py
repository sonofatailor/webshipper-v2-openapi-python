...
class MergedPDFApi:
    ...
    def pdf_merges_id_get(
        ...
        _param = self._pdf_merges_id_get_serialize(
            id=id,
    ...
    @validate_call
    def pdf_merges_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PdfMergesIdGet200Response]:
        """Show a single Merged PDF
    ...
    @validate_call
    def pdf_merges_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _pdf_merges_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def pdf_merges_post(
        self,
        pdf_merges_post_request: PdfMergesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pdf_merges_post_request: (required)
        :type pdf_merges_post_request: PdfMergesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._pdf_merges_post_serialize(
            pdf_merges_post_request=pdf_merges_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def pdf_merges_post_with_http_info(
        self,
        pdf_merges_post_request: PdfMergesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def pdf_merges_post_without_preload_content(
        self,
        pdf_merges_post_request: PdfMergesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _pdf_merges_post_serialize(
        self,
        pdf_merges_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if pdf_merges_post_request is not None:
            _body_params = pdf_merges_post_request
