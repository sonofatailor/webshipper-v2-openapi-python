...
class AutomationsDryRunApi:
    ...
    def automations_dry_runs_get(
        ...
        _param = self._automations_dry_runs_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AutomationsDryRunsGet200Response"
    ...
    @validate_call
    def automations_dry_runs_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AutomationsDryRunsGet200Response]:
        """List all Automations Dry Runs
    ...
    @validate_call
    def automations_dry_runs_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _automations_dry_runs_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/automations_dry_runs',
    ...
    @validate_call
    def automations_dry_runs_id_delete(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._automations_dry_runs_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AutomationsDryRunsIdGet200Response"
    ...
    @validate_call
    def automations_dry_runs_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AutomationsDryRunsIdGet200Response]:
        """Delete a Automations Dry Run
    ...
    @validate_call
    def automations_dry_runs_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _automations_dry_runs_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/automations_dry_runs/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def automations_dry_runs_id_get(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._automations_dry_runs_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def automations_dry_runs_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def automations_dry_runs_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _automations_dry_runs_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def automations_dry_runs_id_patch(
        self,
        id: StrictInt,
        automations_dry_runs_id_patch_request: AutomationsDryRunsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param automations_dry_runs_id_patch_request: (required)
        :type automations_dry_runs_id_patch_request: AutomationsDryRunsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._automations_dry_runs_id_patch_serialize(
            id=id,
            automations_dry_runs_id_patch_request=automations_dry_runs_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def automations_dry_runs_id_patch_with_http_info(
        self,
        id: StrictInt,
        automations_dry_runs_id_patch_request: AutomationsDryRunsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def automations_dry_runs_id_patch_without_preload_content(
        self,
        id: StrictInt,
        automations_dry_runs_id_patch_request: AutomationsDryRunsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _automations_dry_runs_id_patch_serialize(
        self,
        id,
        automations_dry_runs_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if automations_dry_runs_id_patch_request is not None:
            _body_params = automations_dry_runs_id_patch_request
    ...
    @validate_call
    def automations_dry_runs_post(
        self,
        automations_dry_runs_post_request: AutomationsDryRunsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param automations_dry_runs_post_request: (required)
        :type automations_dry_runs_post_request: AutomationsDryRunsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._automations_dry_runs_post_serialize(
            automations_dry_runs_post_request=automations_dry_runs_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "AutomationsDryRunsIdGet200Response"
    ...
    @validate_call
    def automations_dry_runs_post_with_http_info(
        self,
        automations_dry_runs_post_request: AutomationsDryRunsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def automations_dry_runs_post_without_preload_content(
        self,
        automations_dry_runs_post_request: AutomationsDryRunsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _automations_dry_runs_post_serialize(
        self,
        automations_dry_runs_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if automations_dry_runs_post_request is not None:
            _body_params = automations_dry_runs_post_request
