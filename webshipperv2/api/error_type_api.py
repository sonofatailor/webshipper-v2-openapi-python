...
class ErrorTypeApi:
    ...
    def error_types_get(
        ...
        _param = self._error_types_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def error_types_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ErrorTypesGet200Response]:
        """List all Error Types
    ...
    @validate_call
    def error_types_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _error_types_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def error_types_id_delete(
        ...
        _param = self._error_types_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ErrorTypesIdGet200Response"
    ...
    @validate_call
    def error_types_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ErrorTypesIdGet200Response]:
        """Delete a Error Type
    ...
    @validate_call
    def error_types_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _error_types_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def error_types_id_get(
        ...
        _param = self._error_types_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def error_types_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def error_types_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _error_types_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def error_types_id_patch(
        self,
        id: StrictInt,
        error_types_id_patch_request: ErrorTypesIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param error_types_id_patch_request: (required)
        :type error_types_id_patch_request: ErrorTypesIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._error_types_id_patch_serialize(
            id=id,
            error_types_id_patch_request=error_types_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def error_types_id_patch_with_http_info(
        self,
        id: StrictInt,
        error_types_id_patch_request: ErrorTypesIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def error_types_id_patch_without_preload_content(
        self,
        id: StrictInt,
        error_types_id_patch_request: ErrorTypesIdPatchRequest,
        _request_timeout: Union[
    ...
    def _error_types_id_patch_serialize(
        self,
        id,
        error_types_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if error_types_id_patch_request is not None:
            _body_params = error_types_id_patch_request
    ...
    @validate_call
    def error_types_post(
        self,
        error_types_post_request: ErrorTypesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param error_types_post_request: (required)
        :type error_types_post_request: ErrorTypesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._error_types_post_serialize(
            error_types_post_request=error_types_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "ErrorTypesIdGet200Response"
    ...
    @validate_call
    def error_types_post_with_http_info(
        self,
        error_types_post_request: ErrorTypesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def error_types_post_without_preload_content(
        self,
        error_types_post_request: ErrorTypesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _error_types_post_serialize(
        self,
        error_types_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if error_types_post_request is not None:
            _body_params = error_types_post_request
