...
class OAuthApplicationApi:
    ...
    @validate_call
    def oauth_applications_get(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_uid: Annotated[Optional[StrictStr], Field(description="Filter by uid")] = None,
        filter_active: Annotated[Optional[StrictStr], Field(description="Filter by active")] = None,
        ...
        :type filter_id: str
        :param filter_uid: Filter by uid
        :type filter_uid: str
        :param filter_active: Filter by active
        :type filter_active: str
        ...
        _param = self._oauth_applications_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OauthApplicationsGet200Response"
    ...
    @validate_call
    def oauth_applications_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_uid: Annotated[Optional[StrictStr], Field(description="Filter by uid")] = None,
        filter_active: Annotated[Optional[StrictStr], Field(description="Filter by active")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OauthApplicationsGet200Response]:
        """List all OAuth Applications
    ...
    @validate_call
    def oauth_applications_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_uid: Annotated[Optional[StrictStr], Field(description="Filter by uid")] = None,
        filter_active: Annotated[Optional[StrictStr], Field(description="Filter by active")] = None,
    ...
    def _oauth_applications_get_serialize(
        self,
        filter_id,
        filter_uid,
        filter_active,
        ...
        if filter_uid is not None:
            ...
            _query_params.append(('filter[uid]', filter_uid))
            
        if filter_active is not None:
            
            _query_params.append(('filter[active]', filter_active))
    ...
    def oauth_applications_id_get(
        ...
        _param = self._oauth_applications_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OauthApplicationsIdGet200Response"
    ...
    @validate_call
    def oauth_applications_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OauthApplicationsIdGet200Response]:
        """Show a single OAuth Application
    ...
    @validate_call
    def oauth_applications_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _oauth_applications_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/oauth_applications/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
