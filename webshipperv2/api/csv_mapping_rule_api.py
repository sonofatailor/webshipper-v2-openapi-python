...
class CSVMappingRuleApi:
    ...
    def csv_rules_get(
        ...
        _param = self._csv_rules_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def csv_rules_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CsvRulesGet200Response]:
        """List all CSV Mapping Rules
    ...
    @validate_call
    def csv_rules_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def csv_rules_id_delete(
        ...
        _param = self._csv_rules_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def csv_rules_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CsvRulesIdGet200Response]:
        """Delete a CSV Mapping Rule
    ...
    @validate_call
    def csv_rules_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _csv_rules_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def csv_rules_id_get(
        ...
        _param = self._csv_rules_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def csv_rules_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def csv_rules_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _csv_rules_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def csv_rules_id_patch(
        self,
        id: StrictInt,
        csv_rules_id_patch_request: CsvRulesIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param csv_rules_id_patch_request: (required)
        :type csv_rules_id_patch_request: CsvRulesIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._csv_rules_id_patch_serialize(
            id=id,
            csv_rules_id_patch_request=csv_rules_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def csv_rules_id_patch_with_http_info(
        self,
        id: StrictInt,
        csv_rules_id_patch_request: CsvRulesIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def csv_rules_id_patch_without_preload_content(
        self,
        id: StrictInt,
        csv_rules_id_patch_request: CsvRulesIdPatchRequest,
        _request_timeout: Union[
    ...
    def _csv_rules_id_patch_serialize(
        self,
        id,
        csv_rules_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if csv_rules_id_patch_request is not None:
            _body_params = csv_rules_id_patch_request
    ...
    def csv_rules_post(
        self,
        csv_rules_post_request: CsvRulesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param csv_rules_post_request: (required)
        :type csv_rules_post_request: CsvRulesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._csv_rules_post_serialize(
            csv_rules_post_request=csv_rules_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def csv_rules_post_with_http_info(
        self,
        csv_rules_post_request: CsvRulesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def csv_rules_post_without_preload_content(
        self,
        csv_rules_post_request: CsvRulesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _csv_rules_post_serialize(
        self,
        csv_rules_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if csv_rules_post_request is not None:
            _body_params = csv_rules_post_request
