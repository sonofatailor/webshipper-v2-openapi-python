...
class LocalAttributeApi:
    ...
    def local_attrs_get(
        ...
        _param = self._local_attrs_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def local_attrs_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LocalAttrsGet200Response]:
        """List all Local Attributes
    ...
    @validate_call
    def local_attrs_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _local_attrs_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def local_attrs_id_get(
        ...
        _param = self._local_attrs_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LocalAttrsIdGet200Response"
    ...
    @validate_call
    def local_attrs_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LocalAttrsIdGet200Response]:
        """Show a single Local Attribute
    ...
    @validate_call
    def local_attrs_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _local_attrs_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
