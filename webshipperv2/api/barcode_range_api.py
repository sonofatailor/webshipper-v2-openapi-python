...
class BarcodeRangeApi:
    ...
    def barcode_ranges_get(
        ...
        _param = self._barcode_ranges_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BarcodeRangesGet200Response"
    ...
    @validate_call
    def barcode_ranges_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BarcodeRangesGet200Response]:
        """List all Barcode Ranges
    ...
    @validate_call
    def barcode_ranges_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _barcode_ranges_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def barcode_ranges_id_delete(
        ...
        _param = self._barcode_ranges_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BarcodeRangesIdGet200Response"
    ...
    @validate_call
    def barcode_ranges_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BarcodeRangesIdGet200Response]:
        """Delete a Barcode Range
    ...
    @validate_call
    def barcode_ranges_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _barcode_ranges_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/barcode_ranges/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def barcode_ranges_id_get(
        ...
        _param = self._barcode_ranges_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def barcode_ranges_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def barcode_ranges_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _barcode_ranges_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def barcode_ranges_id_patch(
        self,
        id: StrictInt,
        barcode_ranges_id_patch_request: BarcodeRangesIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param barcode_ranges_id_patch_request: (required)
        :type barcode_ranges_id_patch_request: BarcodeRangesIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._barcode_ranges_id_patch_serialize(
            id=id,
            barcode_ranges_id_patch_request=barcode_ranges_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def barcode_ranges_id_patch_with_http_info(
        self,
        id: StrictInt,
        barcode_ranges_id_patch_request: BarcodeRangesIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def barcode_ranges_id_patch_without_preload_content(
        self,
        id: StrictInt,
        barcode_ranges_id_patch_request: BarcodeRangesIdPatchRequest,
        _request_timeout: Union[
    ...
    def _barcode_ranges_id_patch_serialize(
        self,
        id,
        barcode_ranges_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if barcode_ranges_id_patch_request is not None:
            _body_params = barcode_ranges_id_patch_request
    ...
    @validate_call
    def barcode_ranges_post(
        self,
        barcode_ranges_post_request: BarcodeRangesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param barcode_ranges_post_request: (required)
        :type barcode_ranges_post_request: BarcodeRangesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._barcode_ranges_post_serialize(
            barcode_ranges_post_request=barcode_ranges_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "BarcodeRangesIdGet200Response"
    ...
    @validate_call
    def barcode_ranges_post_with_http_info(
        self,
        barcode_ranges_post_request: BarcodeRangesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def barcode_ranges_post_without_preload_content(
        self,
        barcode_ranges_post_request: BarcodeRangesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _barcode_ranges_post_serialize(
        self,
        barcode_ranges_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if barcode_ranges_post_request is not None:
            _body_params = barcode_ranges_post_request
