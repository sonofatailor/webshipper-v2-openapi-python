...
class OrderChannelApi:
    ...
    @validate_call
    def order_channels_get(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_attr: Annotated[Optional[StrictStr], Field(description="Filter by attr")] = None,
        ...
        :type filter_id: str
        :param filter_attr: Filter by attr
        :type filter_attr: str
        ...
        _param = self._order_channels_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrderChannelsGet200Response"
    ...
    @validate_call
    def order_channels_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_attr: Annotated[Optional[StrictStr], Field(description="Filter by attr")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderChannelsGet200Response]:
        """List all Order Channels
    ...
    @validate_call
    def order_channels_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_attr: Annotated[Optional[StrictStr], Field(description="Filter by attr")] = None,
        _request_timeout: Union[
    ...
    def _order_channels_get_serialize(
        self,
        filter_id,
        filter_attr,
        _request_auth,
        ...
        if filter_attr is not None:
            ...
            _query_params.append(('filter[attr]', filter_attr))
    ...
    def order_channels_id_delete(
        ...
        _param = self._order_channels_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OrderChannelsIdGet200Response"
    ...
    @validate_call
    def order_channels_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderChannelsIdGet200Response]:
        """Delete a Order Channel
    ...
    @validate_call
    def order_channels_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _order_channels_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/order_channels/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def order_channels_id_get(
        ...
        _param = self._order_channels_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def order_channels_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def order_channels_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _order_channels_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def order_channels_id_patch(
        self,
        id: StrictInt,
        order_channels_id_patch_request: OrderChannelsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param order_channels_id_patch_request: (required)
        :type order_channels_id_patch_request: OrderChannelsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._order_channels_id_patch_serialize(
            id=id,
            order_channels_id_patch_request=order_channels_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def order_channels_id_patch_with_http_info(
        self,
        id: StrictInt,
        order_channels_id_patch_request: OrderChannelsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def order_channels_id_patch_without_preload_content(
        self,
        id: StrictInt,
        order_channels_id_patch_request: OrderChannelsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _order_channels_id_patch_serialize(
        self,
        id,
        order_channels_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if order_channels_id_patch_request is not None:
            _body_params = order_channels_id_patch_request
    ...
    @validate_call
    def order_channels_post(
        self,
        order_channels_post_request: OrderChannelsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param order_channels_post_request: (required)
        :type order_channels_post_request: OrderChannelsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._order_channels_post_serialize(
            order_channels_post_request=order_channels_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "OrderChannelsIdGet200Response"
    ...
    @validate_call
    def order_channels_post_with_http_info(
        self,
        order_channels_post_request: OrderChannelsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def order_channels_post_without_preload_content(
        self,
        order_channels_post_request: OrderChannelsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _order_channels_post_serialize(
        self,
        order_channels_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if order_channels_post_request is not None:
            _body_params = order_channels_post_request
