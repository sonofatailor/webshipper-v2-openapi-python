...
class UserApi:
    ...
    def users_id_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UsersIdGet200Response]:
        """Delete a User
    ...
    def users_id_patch(
        self,
        id: StrictInt,
        users_id_patch_request: UsersIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param users_id_patch_request: (required)
        :type users_id_patch_request: UsersIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._users_id_patch_serialize(
            id=id,
            users_id_patch_request=users_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _users_id_patch_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if users_id_patch_request is not None:
            _body_params = users_id_patch_request
