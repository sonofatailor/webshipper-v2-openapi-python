...
class FavouritePagesIdGet200Response(BaseModel):
    """
    FavouritePagesIdGet200Response
    """ # noqa: E501
    data: Optional[FavouritePagesIdGet200ResponseData] = None
    relationships: Optional[FavouritePagesIdGet200ResponseRelationships] = None
    included: Optional[List[FavouritePagesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": FavouritePagesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": FavouritePagesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [FavouritePagesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
