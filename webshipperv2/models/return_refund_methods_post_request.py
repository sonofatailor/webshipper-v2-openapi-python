...
class ReturnRefundMethodsPostRequest(BaseModel):
    """
    ReturnRefundMethodsPostRequest
    """ # noqa: E501
    data: Optional[ReturnRefundMethodsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnRefundMethodsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
