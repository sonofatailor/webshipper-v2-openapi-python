...
class OrdersIdGet200Response(BaseModel):
    """
    OrdersIdGet200Response
    """ # noqa: E501
    data: Optional[OrdersIdGet200ResponseData] = None
    relationships: Optional[OrdersIdGet200ResponseRelationships] = None
    included: Optional[List[OrdersIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrdersIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": OrdersIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [OrdersIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
