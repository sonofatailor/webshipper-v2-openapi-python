...
class ActionsIdGet200ResponseRelationshipsAutomation(BaseModel):
    """
    ActionsIdGet200ResponseRelationshipsAutomation
    """ # noqa: E501
    data: Optional[ActionsIdGet200ResponseRelationshipsAutomationData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ActionsIdGet200ResponseRelationshipsAutomationData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
