...
class ShipmentsTrackingLinksInner(BaseModel):
    """
    ShipmentsTrackingLinksInner
    """ # noqa: E501
    url: Optional[StrictStr] = None
    number: Optional[StrictStr] = None
    latest_transit_event: Optional[StrictStr] = None
    tracking_events: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["url", "number", "latest_transit_event", "tracking_events"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "latest_transit_event": obj.get("latest_transit_event"),
            "tracking_events": obj.get("tracking_events")
        })
        return _obj
