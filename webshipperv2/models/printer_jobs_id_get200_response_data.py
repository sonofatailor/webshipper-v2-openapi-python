...
class PrinterJobsIdGet200ResponseData(BaseModel):
    """
    PrinterJobsIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[PrinterJobs] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('printer_jobs'):
            raise ValueError("must be one of enum values ('printer_jobs')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": PrinterJobs.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
