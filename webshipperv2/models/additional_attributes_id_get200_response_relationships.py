...
class AdditionalAttributesIdGet200ResponseRelationships(BaseModel):
    """
    ...
    order_line: Optional[AdditionalAttributesIdGet200ResponseRelationshipsOrderLine] = None
    __properties: ClassVar[List[str]] = ["order", "order_line"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.order_line:
            _dict['order_line'] = self.order_line.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "order_line": AdditionalAttributesIdGet200ResponseRelationshipsOrderLine.from_dict(obj.get("order_line")) if obj.get("order_line") is not None else None
        })
        return _obj
