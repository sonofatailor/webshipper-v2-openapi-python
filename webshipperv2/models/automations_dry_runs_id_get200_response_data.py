...
class AutomationsDryRunsIdGet200ResponseData(BaseModel):
    """
    AutomationsDryRunsIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[AutomationsDryRuns] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('automations_dry_runs'):
            raise ValueError("must be one of enum values ('automations_dry_runs')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": AutomationsDryRuns.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
