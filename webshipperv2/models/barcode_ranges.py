...
class BarcodeRanges(BaseModel):
    """
    BarcodeRanges
    """ # noqa: E501
    barcode_type: Optional[StrictStr] = Field(default=None, description="String like DPD or SSCC")
    serial_from: Optional[StrictInt] = Field(default=None, description="The first barcode in the range")
    serial_to: Optional[StrictInt] = Field(default=None, description="The last barcode in the range")
    current_serial: Optional[StrictInt] = Field(default=None, description="The last used (highest) barcode serial")
    usage_status: Optional[StrictInt] = None
    replaces_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["barcode_type", "serial_from", "serial_to", "current_serial", "usage_status", "replaces_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "serial_from": obj.get("serial_from"),
            "serial_to": obj.get("serial_to"),
            "current_serial": obj.get("current_serial"),
            "usage_status": obj.get("usage_status"),
            "replaces_id": obj.get("replaces_id")
        })
        return _obj
