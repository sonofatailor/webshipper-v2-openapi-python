...
class PrinterJobsIdGet200ResponseRelationshipsPrintable(BaseModel):
    """
    PrinterJobsIdGet200ResponseRelationshipsPrintable
    """ # noqa: E501
    data: Optional[PrinterJobsIdGet200ResponseRelationshipsPrintableData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrinterJobsIdGet200ResponseRelationshipsPrintableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
