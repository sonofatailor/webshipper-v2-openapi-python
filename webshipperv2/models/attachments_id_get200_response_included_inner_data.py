...
ATTACHMENTSIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["Documents", "object"]

class AttachmentsIdGet200ResponseIncludedInnerData(BaseModel):
    """
    AttachmentsIdGet200ResponseIncludedInnerData
    """
    # data type: Documents
    oneof_schema_1_validator: Optional[Documents] = None
    # data type: object
    oneof_schema_2_validator: Optional[Union[str, Any]] = None
    actual_instance: Optional[Union[Documents, object]] = None
    one_of_schemas: List[str] = Literal["Documents", "object"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = AttachmentsIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        # validate data type: Documents
        if not isinstance(v, Documents):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Documents`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in AttachmentsIdGet200ResponseIncludedInnerData with oneOf schemas: Documents, object. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in AttachmentsIdGet200ResponseIncludedInnerData with oneOf schemas: Documents, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into Documents
        try:
            instance.actual_instance = Documents.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into AttachmentsIdGet200ResponseIncludedInnerData with oneOf schemas: Documents, object. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AttachmentsIdGet200ResponseIncludedInnerData with oneOf schemas: Documents, object. Details: " + ", ".join(error_messages))
        else:
            return instance
