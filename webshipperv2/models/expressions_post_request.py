...
class ExpressionsPostRequest(BaseModel):
    """
    ExpressionsPostRequest
    """ # noqa: E501
    data: Optional[ExpressionsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ExpressionsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
