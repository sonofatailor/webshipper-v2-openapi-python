...
class ReportTypesPostRequest(BaseModel):
    """
    ReportTypesPostRequest
    """ # noqa: E501
    data: Optional[ReportTypesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReportTypesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
