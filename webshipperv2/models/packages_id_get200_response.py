...
class PackagesIdGet200Response(BaseModel):
    """
    PackagesIdGet200Response
    """ # noqa: E501
    data: Optional[PackagesIdGet200ResponseData] = None
    relationships: Optional[EdisIdGet200ResponseRelationships] = None
    included: Optional[List[EdisIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PackagesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": EdisIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [EdisIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
