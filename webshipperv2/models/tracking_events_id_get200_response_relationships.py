...
class TrackingEventsIdGet200ResponseRelationships(BaseModel):
    """
    TrackingEventsIdGet200ResponseRelationships
    """ # noqa: E501
    package: Optional[TrackingEventsIdGet200ResponseRelationshipsPackage] = None
    shipment: Optional[EdisIdGet200ResponseRelationshipsShipment] = None
    __properties: ClassVar[List[str]] = ["package", "shipment"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "package": TrackingEventsIdGet200ResponseRelationshipsPackage.from_dict(obj.get("package")) if obj.get("package") is not None else None,
