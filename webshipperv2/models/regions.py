...
class Regions(BaseModel):
    ...
    expressions: Optional[StrictStr] = Field(default=None, description="Flattened array of expressions. Please see section 8 for more details regarding expressions.")
    ...
    __properties: ClassVar[List[str]] = ["name", "expressions", "created_at", "updated_at", "countries"]
