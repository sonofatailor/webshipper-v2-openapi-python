...
class PrintersIdGet200Response(BaseModel):
    """
    PrintersIdGet200Response
    """ # noqa: E501
    data: Optional[PrintersIdGet200ResponseData] = None
    relationships: Optional[PrintersIdGet200ResponseRelationships] = None
    included: Optional[List[PrintersIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrintersIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": PrintersIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [PrintersIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
