...
class DropPointLocatorsPost204Response(BaseModel):
    """
    DropPointLocatorsPost204Response
    """ # noqa: E501
    data: Optional[DropPointLocatorsPost204ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": DropPointLocatorsPost204ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
