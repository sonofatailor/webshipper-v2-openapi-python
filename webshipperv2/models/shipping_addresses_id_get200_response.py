...
class ShippingAddressesIdGet200Response(BaseModel):
    """
    ShippingAddressesIdGet200Response
    """ # noqa: E501
    data: Optional[ShippingAddressesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShippingAddressesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
