...
class BrandsIdGet200Response(BaseModel):
    """
    BrandsIdGet200Response
    """ # noqa: E501
    data: Optional[BrandsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BrandsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
