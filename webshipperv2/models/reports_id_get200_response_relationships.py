...
class ReportsIdGet200ResponseRelationships(BaseModel):
    """
    ReportsIdGet200ResponseRelationships
    """ # noqa: E501
    report_type: Optional[ReportsIdGet200ResponseRelationshipsReportType] = None
    carrier: Optional[BarcodeRangesIdGet200ResponseRelationshipsCarrier] = None
    __properties: ClassVar[List[str]] = ["report_type", "carrier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of report_type
        if self.report_type:
            _dict['report_type'] = self.report_type.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "report_type": ReportsIdGet200ResponseRelationshipsReportType.from_dict(obj.get("report_type")) if obj.get("report_type") is not None else None,
