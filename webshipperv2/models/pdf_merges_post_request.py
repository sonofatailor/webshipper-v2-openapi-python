...
class PdfMergesPostRequest(BaseModel):
    """
    PdfMergesPostRequest
    """ # noqa: E501
    data: Optional[PdfMergesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PdfMergesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
