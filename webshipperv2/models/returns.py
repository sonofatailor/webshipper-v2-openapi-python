...
class Returns(BaseModel):
    ...
    Returns
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="One of pending, sent, arrived, processed, error or approved")
    error_message: Optional[StrictStr] = None
    return_lines: Optional[List[StrictStr]] = Field(default=None, description="Array of ReturnLine objects. Contains fields order_line_id, quantity, cause_id, cause_description and images. When creating, images should be an array of data uri containing the base64 encoding of the image, example: <em>data:image/jpeg;base64,AAQSkZJ......RgABAQEAlgCWAAD</em>")
    var_base64: Optional[StrictStr] = Field(default=None, description="Base 64 encoding of return slip", alias="base64")
    secret: Optional[StrictStr] = Field(default=None, description="Read only token for publicly accessing status of the return order")
    internal_comment: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["status", "error_message", "return_lines", "base64", "secret", "internal_comment", "latest_activity", "updated_at", "created_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "return_lines": obj.get("return_lines"),
