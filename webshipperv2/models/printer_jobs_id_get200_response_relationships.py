...
class PrinterJobsIdGet200ResponseRelationships(BaseModel):
    """
    PrinterJobsIdGet200ResponseRelationships
    """ # noqa: E501
    printer_client: Optional[OrdersIdGet200ResponseRelationshipsPrinterClient] = None
    printer: Optional[PrinterClientsIdGet200ResponseRelationshipsLabelPrinter] = None
    printable: Optional[PrinterJobsIdGet200ResponseRelationshipsPrintable] = None
    __properties: ClassVar[List[str]] = ["printer_client", "printer", "printable"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of printable
        if self.printable:
            _dict['printable'] = self.printable.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "printer": PrinterClientsIdGet200ResponseRelationshipsLabelPrinter.from_dict(obj.get("printer")) if obj.get("printer") is not None else None,
            "printable": PrinterJobsIdGet200ResponseRelationshipsPrintable.from_dict(obj.get("printable")) if obj.get("printable") is not None else None
        })
        return _obj
