...
class SlipTemplatesIdGet200ResponseData(BaseModel):
    """
    SlipTemplatesIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[SlipTemplates] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('slip_templates'):
            raise ValueError("must be one of enum values ('slip_templates')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": SlipTemplates.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
