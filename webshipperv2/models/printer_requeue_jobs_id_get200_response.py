...
class PrinterRequeueJobsIdGet200Response(BaseModel):
    """
    PrinterRequeueJobsIdGet200Response
    """ # noqa: E501
    data: Optional[PrinterRequeueJobsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrinterRequeueJobsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
