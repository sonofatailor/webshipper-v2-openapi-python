...
class AutomationsDryRunsIdGet200Response(BaseModel):
    """
    AutomationsDryRunsIdGet200Response
    """ # noqa: E501
    data: Optional[AutomationsDryRunsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AutomationsDryRunsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
