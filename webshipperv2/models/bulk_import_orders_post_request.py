...
class BulkImportOrdersPostRequest(BaseModel):
    """
    BulkImportOrdersPostRequest
    """ # noqa: E501
    data: Optional[BulkImportOrdersPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BulkImportOrdersPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
