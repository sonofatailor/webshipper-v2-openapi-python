...
class OrdersGet200ResponseDataInner(BaseModel):
    """
    OrdersGet200ResponseDataInner
    """ # noqa: E501
    attributes: Optional[Orders] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "attributes": Orders.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
