...
class CsvRulesIdGet200Response(BaseModel):
    """
    CsvRulesIdGet200Response
    """ # noqa: E501
    data: Optional[CsvRulesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvRulesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
