...
class ShippingMappingsPostRequest(BaseModel):
    """
    ShippingMappingsPostRequest
    """ # noqa: E501
    data: Optional[ShippingMappingsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShippingMappingsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
