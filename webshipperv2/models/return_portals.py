...
class ReturnPortals(BaseModel):
    """
    ReturnPortals
    """ # noqa: E501
    name: Optional[StrictStr] = None
    custom_style: Optional[StrictStr] = None
    shipping_methods: Optional[StrictStr] = None
    translations: Optional[StrictStr] = None
    locale: Optional[StrictStr] = None
    allowed_days_since_dispatch: Optional[StrictInt] = None
    send_immediately: Optional[StrictBool] = None
    static_notice_email: Optional[StrictStr] = None
    order_channel_logo: Optional[StrictStr] = None
    logo: Optional[StrictStr] = None
    force_single_page: Optional[StrictBool] = None
    order_channel_id: Optional[StrictInt] = None
    optional_return_cause: Optional[StrictBool] = None
    new_mail_template: Optional[StrictStr] = None
    new_confirmation_mail_template: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "custom_style", "shipping_methods", "translations", "locale", "allowed_days_since_dispatch", "send_immediately", "static_notice_email", "order_channel_logo", "logo", "force_single_page", "order_channel_id", "optional_return_cause", "new_mail_template", "new_confirmation_mail_template"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "custom_style": obj.get("custom_style"),
            "shipping_methods": obj.get("shipping_methods"),
            "translations": obj.get("translations"),
            "locale": obj.get("locale"),
            "allowed_days_since_dispatch": obj.get("allowed_days_since_dispatch"),
            "send_immediately": obj.get("send_immediately"),
            "static_notice_email": obj.get("static_notice_email"),
            "order_channel_logo": obj.get("order_channel_logo"),
            "logo": obj.get("logo"),
            "force_single_page": obj.get("force_single_page"),
            "order_channel_id": obj.get("order_channel_id"),
            "optional_return_cause": obj.get("optional_return_cause"),
            "new_mail_template": obj.get("new_mail_template"),
            "new_confirmation_mail_template": obj.get("new_confirmation_mail_template")
        })
        return _obj
