...
class CsvRulesIdGet200ResponseRelationshipsMapping(BaseModel):
    """
    CsvRulesIdGet200ResponseRelationshipsMapping
    """ # noqa: E501
    data: Optional[CsvRulesIdGet200ResponseRelationshipsMappingData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvRulesIdGet200ResponseRelationshipsMappingData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
