...
class ShippingMappingsIdGet200Response(BaseModel):
    """
    ShippingMappingsIdGet200Response
    """ # noqa: E501
    data: Optional[ShippingMappingsIdGet200ResponseData] = None
    relationships: Optional[ShippingMappingsIdGet200ResponseRelationships] = None
    included: Optional[List[ShippingMappingsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShippingMappingsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ShippingMappingsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ShippingMappingsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
