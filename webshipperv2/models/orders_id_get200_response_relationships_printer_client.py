...
class OrdersIdGet200ResponseRelationshipsPrinterClient(BaseModel):
    """
    OrdersIdGet200ResponseRelationshipsPrinterClient
    """ # noqa: E501
    data: Optional[OrdersIdGet200ResponseRelationshipsPrinterClientData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrdersIdGet200ResponseRelationshipsPrinterClientData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
