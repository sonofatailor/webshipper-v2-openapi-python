...
class CsvUploadsPost204Response(BaseModel):
    """
    CsvUploadsPost204Response
    """ # noqa: E501
    data: Optional[CsvUploadsPost204ResponseData] = None
    relationships: Optional[CsvRulesIdGet200ResponseRelationships] = None
    included: Optional[List[CsvRulesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvUploadsPost204ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": CsvRulesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [CsvRulesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
