...
class Printers(BaseModel):
    ...
    active: Optional[StrictBool] = Field(default=None, description="Determines if the printer is configured on the printer station")
    last_connected: Optional[StrictStr] = Field(default=None, description="Last connection time")
    paper_width: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Paper width")
    paper_height: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Paper height")
    rotate_print_180: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "active", "last_connected", "paper_width", "paper_height", "rotate_print_180"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "paper_width": obj.get("paper_width"),
            "paper_height": obj.get("paper_height"),
            "rotate_print_180": obj.get("rotate_print_180")
        })
        return _obj
