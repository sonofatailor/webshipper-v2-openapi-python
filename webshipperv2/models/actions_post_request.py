...
class ActionsPostRequest(BaseModel):
    """
    ActionsPostRequest
    """ # noqa: E501
    data: Optional[ActionsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ActionsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
