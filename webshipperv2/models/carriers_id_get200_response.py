...
class CarriersIdGet200Response(BaseModel):
    """
    CarriersIdGet200Response
    """ # noqa: E501
    data: Optional[CarriersIdGet200ResponseData] = None
    relationships: Optional[CarriersIdGet200ResponseRelationships] = None
    included: Optional[List[CarriersIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarriersIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": CarriersIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [CarriersIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
