...
class ShippingRatesPostRequest(BaseModel):
    """
    ShippingRatesPostRequest
    """ # noqa: E501
    data: Optional[ShippingRatesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShippingRatesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
