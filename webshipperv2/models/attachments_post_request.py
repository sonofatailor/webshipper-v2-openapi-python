...
class AttachmentsPostRequest(BaseModel):
    """
    AttachmentsPostRequest
    """ # noqa: E501
    data: Optional[AttachmentsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AttachmentsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
