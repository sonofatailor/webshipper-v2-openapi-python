...
class OauthApplicationsIdGet200ResponseData(BaseModel):
    """
    OauthApplicationsIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[OauthApplications] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('oauth_applications'):
            raise ValueError("must be one of enum values ('oauth_applications')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": OauthApplications.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
