...
class FavouritePagesPostRequest(BaseModel):
    """
    FavouritePagesPostRequest
    """ # noqa: E501
    data: Optional[FavouritePagesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": FavouritePagesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
