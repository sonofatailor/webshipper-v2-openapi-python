...
class ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('document_templates'):
            raise ValueError("must be one of enum values ('document_templates')")
        return value
