...
class EdisIdGet200ResponseRelationshipsShipment(BaseModel):
    """
    EdisIdGet200ResponseRelationshipsShipment
    """ # noqa: E501
    data: Optional[EdisIdGet200ResponseRelationshipsShipmentData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EdisIdGet200ResponseRelationshipsShipmentData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
