...
class LabelsIdGet200Response(BaseModel):
    """
    LabelsIdGet200Response
    """ # noqa: E501
    data: Optional[LabelsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": LabelsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
