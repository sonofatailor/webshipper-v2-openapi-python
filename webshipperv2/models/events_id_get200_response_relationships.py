...
class EventsIdGet200ResponseRelationships(BaseModel):
    """
    EventsIdGet200ResponseRelationships
    """ # noqa: E501
    model: Optional[EventsIdGet200ResponseRelationshipsModel] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "model": EventsIdGet200ResponseRelationshipsModel.from_dict(obj.get("model")) if obj.get("model") is not None else None
        })
        return _obj
