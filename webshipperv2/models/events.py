...
class Events(BaseModel):
    ...
    icon: Optional[StrictStr] = Field(default=None, description="FontAwesome 4 compatible icon like: exclamation, trash, truck, envelope, cog, anchor, map-marker, certificate")
    initiator: Optional[StrictStr] = Field(default=None, description="Will be set by the Webshipper API")
    source: Optional[StrictStr] = None
    created_at: Optional[StrictStr] = Field(default=None, description="The time when the resource was created")
    __properties: ClassVar[List[str]] = ["title", "details", "icon", "initiator", "source", "created_at"]
