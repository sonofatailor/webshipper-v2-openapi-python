...
class WebhookFailuresIdGet200Response(BaseModel):
    """
    WebhookFailuresIdGet200Response
    """ # noqa: E501
    data: Optional[WebhookFailuresIdGet200ResponseData] = None
    relationships: Optional[WebhookFailuresIdGet200ResponseRelationships] = None
    included: Optional[List[WebhookFailuresIdGet200ResponseIncludedInner]] = None
    __properties: ClassVar[List[str]] = ["data", "relationships", "included"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": WebhookFailuresIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": WebhookFailuresIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [WebhookFailuresIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
