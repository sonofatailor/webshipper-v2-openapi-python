...
class AttachmentsIdGet200Response(BaseModel):
    """
    AttachmentsIdGet200Response
    """ # noqa: E501
    data: Optional[AttachmentsIdGet200ResponseData] = None
    relationships: Optional[AttachmentsIdGet200ResponseRelationships] = None
    included: Optional[List[AttachmentsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AttachmentsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": AttachmentsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [AttachmentsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
