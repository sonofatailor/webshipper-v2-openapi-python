...
PRINTERJOBSIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["PrinterClients", "Printers", "object"]

class PrinterJobsIdGet200ResponseIncludedInnerData(BaseModel):
    """
    PrinterJobsIdGet200ResponseIncludedInnerData
    """
    # data type: PrinterClients
    oneof_schema_1_validator: Optional[PrinterClients] = None
    # data type: Printers
    oneof_schema_2_validator: Optional[Printers] = None
    # data type: object
    oneof_schema_3_validator: Optional[Union[str, Any]] = None
    actual_instance: Optional[Union[PrinterClients, Printers, object]] = None
    one_of_schemas: List[str] = Literal["PrinterClients", "Printers", "object"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PrinterJobsIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        ...
        if not isinstance(v, PrinterClients):
            ...
            match += 1
        # validate data type: Printers
        if not isinstance(v, Printers):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Printers`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PrinterJobsIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients, Printers, object. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in PrinterJobsIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients, Printers, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into Printers
        try:
            instance.actual_instance = Printers.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into PrinterJobsIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients, Printers, object. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PrinterJobsIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients, Printers, object. Details: " + ", ".join(error_messages))
        else:
            return instance
