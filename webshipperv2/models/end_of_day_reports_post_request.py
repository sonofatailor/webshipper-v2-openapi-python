...
class EndOfDayReportsPostRequest(BaseModel):
    """
    EndOfDayReportsPostRequest
    """ # noqa: E501
    data: Optional[EndOfDayReportsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EndOfDayReportsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
