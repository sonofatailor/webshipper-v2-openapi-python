...
class ShipmentsIdGet200Response(BaseModel):
    """
    ShipmentsIdGet200Response
    """ # noqa: E501
    data: Optional[ShipmentsIdGet200ResponseData] = None
    relationships: Optional[ShipmentsIdGet200ResponseRelationships] = None
    included: Optional[List[ShipmentsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShipmentsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ShipmentsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ShipmentsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
