...
class CustomsLinesPostRequest(BaseModel):
    """
    CustomsLinesPostRequest
    """ # noqa: E501
    data: Optional[CustomsLinesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CustomsLinesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
