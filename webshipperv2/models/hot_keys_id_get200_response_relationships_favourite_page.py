...
class HotKeysIdGet200ResponseRelationshipsFavouritePage(BaseModel):
    """
    HotKeysIdGet200ResponseRelationshipsFavouritePage
    """ # noqa: E501
    data: Optional[HotKeysIdGet200ResponseRelationshipsFavouritePageData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": HotKeysIdGet200ResponseRelationshipsFavouritePageData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
