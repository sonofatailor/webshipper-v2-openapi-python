...
class EdisIdGet200Response(BaseModel):
    """
    EdisIdGet200Response
    """ # noqa: E501
    data: Optional[EdisIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EdisIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
