...
class RegionsPostRequest(BaseModel):
    """
    RegionsPostRequest
    """ # noqa: E501
    data: Optional[RegionsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": RegionsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
