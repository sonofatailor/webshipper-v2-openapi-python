...
class OauthAccessTokensIdGet200ResponseRelationships(BaseModel):
    """
    OauthAccessTokensIdGet200ResponseRelationships
    """ # noqa: E501
    application: Optional[OauthAccessTokensIdGet200ResponseRelationshipsApplication] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "application": OauthAccessTokensIdGet200ResponseRelationshipsApplication.from_dict(obj.get("application")) if obj.get("application") is not None else None
        })
        return _obj
