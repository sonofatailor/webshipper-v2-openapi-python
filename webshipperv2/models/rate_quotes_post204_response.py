...
class RateQuotesPost204Response(BaseModel):
    """
    RateQuotesPost204Response
    """ # noqa: E501
    data: Optional[RateQuotesPost204ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": RateQuotesPost204ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
