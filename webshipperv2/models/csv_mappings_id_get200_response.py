...
class CsvMappingsIdGet200Response(BaseModel):
    """
    CsvMappingsIdGet200Response
    """ # noqa: E501
    data: Optional[CsvMappingsIdGet200ResponseData] = None
    relationships: Optional[CsvMappingsIdGet200ResponseRelationships] = None
    included: Optional[List[CsvMappingsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvMappingsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": CsvMappingsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [CsvMappingsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
