...
class OauthAccessTokensIdGet200ResponseIncludedInner(BaseModel):
    """
    OauthAccessTokensIdGet200ResponseIncludedInner
    """ # noqa: E501
    type: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    data: Optional[OauthAccessTokensIdGet200ResponseIncludedInnerData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "data": OauthAccessTokensIdGet200ResponseIncludedInnerData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
