...
class WebhookFailures(BaseModel):
    """
    WebhookFailures
    """ # noqa: E501
    record_id: Optional[StrictInt] = Field(default=None, description="The id of the record the webhook failed to send")
    message: Optional[StrictStr] = Field(default=None, description="Title of the failure")
    ...
    __properties: ClassVar[List[str]] = ["record_id", "message", "created_at", "updated_at"]
