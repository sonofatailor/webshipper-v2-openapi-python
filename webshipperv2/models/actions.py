...
class Actions(BaseModel):
    ...
    Actions
    """ # noqa: E501
    job_type: Optional[StrictStr] = Field(default=None, description="Name of a supported job: <ul> <li> CreateShipmentJob </li> </ul>")
    var_async: Optional[StrictBool] = Field(default=None, description="If true, this action runs as a background process, if not it runs immediately", alias="async")
    additional_attributes: Optional[List[StrictStr]] = Field(default=None, description="Array of objects containing keys <code>attr_values</code> and <code>attr_value</code>")
    priority: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["job_type", "async", "additional_attributes", "priority"]
