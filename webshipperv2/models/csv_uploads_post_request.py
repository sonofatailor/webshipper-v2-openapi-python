...
class CsvUploadsPostRequest(BaseModel):
    """
    CsvUploadsPostRequest
    """ # noqa: E501
    data: Optional[CsvUploadsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvUploadsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
