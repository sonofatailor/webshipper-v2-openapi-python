...
class PrinterClientsIdGet200ResponseRelationships(BaseModel):
    """
    PrinterClientsIdGet200ResponseRelationships
    """ # noqa: E501
    label_printer: Optional[PrinterClientsIdGet200ResponseRelationshipsLabelPrinter] = None
    zpl_printer: Optional[PrinterClientsIdGet200ResponseRelationshipsLabelPrinter] = None
    document_printer: Optional[PrinterClientsIdGet200ResponseRelationshipsLabelPrinter] = None
    location: Optional[CarriersIdGet200ResponseRelationshipsSenderAddress] = None
    __properties: ClassVar[List[str]] = ["label_printer", "zpl_printer", "document_printer", "location"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.label_printer:
            _dict['label_printer'] = self.label_printer.to_dict()
        # override the default output from pydantic by calling `to_dict()` of zpl_printer
        if self.zpl_printer:
            _dict['zpl_printer'] = self.zpl_printer.to_dict()
        # override the default output from pydantic by calling `to_dict()` of document_printer
        if self.document_printer:
            _dict['document_printer'] = self.document_printer.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "label_printer": PrinterClientsIdGet200ResponseRelationshipsLabelPrinter.from_dict(obj.get("label_printer")) if obj.get("label_printer") is not None else None,
            "zpl_printer": PrinterClientsIdGet200ResponseRelationshipsLabelPrinter.from_dict(obj.get("zpl_printer")) if obj.get("zpl_printer") is not None else None,
            "document_printer": PrinterClientsIdGet200ResponseRelationshipsLabelPrinter.from_dict(obj.get("document_printer")) if obj.get("document_printer") is not None else None,
            "location": CarriersIdGet200ResponseRelationshipsSenderAddress.from_dict(obj.get("location")) if obj.get("location") is not None else None
        })
        return _obj
