...
class ShippingAddressesPostRequest(BaseModel):
    """
    ShippingAddressesPostRequest
    """ # noqa: E501
    data: Optional[ShippingAddressesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShippingAddressesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
