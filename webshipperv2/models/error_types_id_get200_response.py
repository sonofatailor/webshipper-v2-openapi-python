...
class ErrorTypesIdGet200Response(BaseModel):
    """
    ErrorTypesIdGet200Response
    """ # noqa: E501
    data: Optional[ErrorTypesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ErrorTypesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
