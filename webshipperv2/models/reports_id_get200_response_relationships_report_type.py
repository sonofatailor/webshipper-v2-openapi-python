...
class ReportsIdGet200ResponseRelationshipsReportType(BaseModel):
    """
    ReportsIdGet200ResponseRelationshipsReportType
    """ # noqa: E501
    data: Optional[ReportsIdGet200ResponseRelationshipsReportTypeData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReportsIdGet200ResponseRelationshipsReportTypeData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
