...
class WebhookFailuresIdGet200ResponseRelationships(BaseModel):
    """
    WebhookFailuresIdGet200ResponseRelationships
    """ # noqa: E501
    webhook: Optional[WebhookFailuresIdGet200ResponseRelationshipsWebhook] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "webhook": WebhookFailuresIdGet200ResponseRelationshipsWebhook.from_dict(obj.get("webhook")) if obj.get("webhook") is not None else None
        })
        return _obj
