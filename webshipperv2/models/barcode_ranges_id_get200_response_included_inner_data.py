...
BARCODERANGESIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["Carriers"]

class BarcodeRangesIdGet200ResponseIncludedInnerData(BaseModel):
    """
    BarcodeRangesIdGet200ResponseIncludedInnerData
    """
    # data type: Carriers
    oneof_schema_1_validator: Optional[Carriers] = None
    actual_instance: Optional[Union[Carriers]] = None
    one_of_schemas: List[str] = Literal["Carriers"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = BarcodeRangesIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in BarcodeRangesIdGet200ResponseIncludedInnerData with oneOf schemas: Carriers. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in BarcodeRangesIdGet200ResponseIncludedInnerData with oneOf schemas: Carriers. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into BarcodeRangesIdGet200ResponseIncludedInnerData with oneOf schemas: Carriers. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into BarcodeRangesIdGet200ResponseIncludedInnerData with oneOf schemas: Carriers. Details: " + ", ".join(error_messages))
        else:
            return instance
