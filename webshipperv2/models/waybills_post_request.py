...
class WaybillsPostRequest(BaseModel):
    """
    WaybillsPostRequest
    """ # noqa: E501
    data: Optional[WaybillsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": WaybillsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
