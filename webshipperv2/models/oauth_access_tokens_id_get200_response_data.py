...
class OauthAccessTokensIdGet200ResponseData(BaseModel):
    """
    OauthAccessTokensIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[OauthAccessTokens] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('oauth_access_tokens'):
            raise ValueError("must be one of enum values ('oauth_access_tokens')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": OauthAccessTokens.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
