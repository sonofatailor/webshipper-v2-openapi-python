...
class OauthAccessTokensIdGet200Response(BaseModel):
    """
    OauthAccessTokensIdGet200Response
    """ # noqa: E501
    data: Optional[OauthAccessTokensIdGet200ResponseData] = None
    relationships: Optional[OauthAccessTokensIdGet200ResponseRelationships] = None
    included: Optional[List[OauthAccessTokensIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OauthAccessTokensIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": OauthAccessTokensIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [OauthAccessTokensIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
