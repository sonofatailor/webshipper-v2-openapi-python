...
class CarriersIdGet200ResponseRelationshipsCarrierType(BaseModel):
    """
    CarriersIdGet200ResponseRelationshipsCarrierType
    """ # noqa: E501
    data: Optional[CarriersIdGet200ResponseRelationshipsCarrierTypeData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarriersIdGet200ResponseRelationshipsCarrierTypeData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
