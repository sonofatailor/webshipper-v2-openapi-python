...
class PrinterRequeueJobs(BaseModel):
    """
    PrinterRequeueJobs
    """ # noqa: E501
    ...
    mark_as_complete: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["start_time", "end_time", "job_id", "mark_as_complete"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mark_as_complete": obj.get("mark_as_complete")
        })
        return _obj
