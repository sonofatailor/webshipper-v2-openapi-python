...
class RateQuotesPostRequest(BaseModel):
    """
    RateQuotesPostRequest
    """ # noqa: E501
    data: Optional[RateQuotesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": RateQuotesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
