...
class EndOfDayReports(BaseModel):
    """
    EndOfDayReports
    """ # noqa: E501
    var_base64: Optional[StrictStr] = Field(default=None, description="Base64 encoding of the PDF document. This must explicitly be included with fields[end_of_day_reports]='base64'", alias="base64")
    ...
    start_time: Optional[StrictStr] = Field(default=None, description="Datetime representing the start time for the report")
    end_time: Optional[StrictStr] = Field(default=None, description="Datetime representing the end time for the report")
    __properties: ClassVar[List[str]] = ["base64", "updated_at", "created_at", "start_time", "end_time"]
