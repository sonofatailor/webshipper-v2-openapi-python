...
class WebhookFailuresIdGet200ResponseData(BaseModel):
    """
    WebhookFailuresIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[WebhookFailures] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('webhook_failures'):
            raise ValueError("must be one of enum values ('webhook_failures')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": WebhookFailures.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
