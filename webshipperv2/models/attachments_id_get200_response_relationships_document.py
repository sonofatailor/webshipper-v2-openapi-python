...
class AttachmentsIdGet200ResponseRelationshipsDocument(BaseModel):
    """
    AttachmentsIdGet200ResponseRelationshipsDocument
    """ # noqa: E501
    data: Optional[AttachmentsIdGet200ResponseRelationshipsDocumentData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AttachmentsIdGet200ResponseRelationshipsDocumentData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
