...
class OrdersIdGet200ResponseRelationshipsShippingRate(BaseModel):
    """
    OrdersIdGet200ResponseRelationshipsShippingRate
    """ # noqa: E501
    data: Optional[OrdersIdGet200ResponseRelationshipsShippingRateData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrdersIdGet200ResponseRelationshipsShippingRateData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
