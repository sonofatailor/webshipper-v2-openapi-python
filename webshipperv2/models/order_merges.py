...
class OrderMerges(BaseModel):
    """
    OrderMerges
    """ # noqa: E501
    order_id: Optional[StrictBool] = Field(default=None, description="ID of order to merge order lines in to")
    orders: Optional[List[StrictStr]] = Field(default=None, description="Orders from which to merge order lines from. Orders as nested resources")
    __properties: ClassVar[List[str]] = ["order_id", "orders"]
