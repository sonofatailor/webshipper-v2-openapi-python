...
class Triggers(BaseModel):
    ...
    Triggers
    """ # noqa: E501
    expression: Optional[StrictStr] = Field(default=None, description="WEL expression for the trigger")
    expression_ast: Optional[StrictStr] = None
    model_type: Optional[StrictStr] = Field(default=None, description="Model for the trigger. E.g. Order")
    event: Optional[StrictStr] = Field(default=None, description="<code>created</code> or <code>updated</code>")
    timing: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["expression", "expression_ast", "model_type", "event", "timing"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "expression_ast": obj.get("expression_ast"),
