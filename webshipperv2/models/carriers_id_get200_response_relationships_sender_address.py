...
class CarriersIdGet200ResponseRelationshipsSenderAddress(BaseModel):
    """
    CarriersIdGet200ResponseRelationshipsSenderAddress
    """ # noqa: E501
    data: Optional[CarriersIdGet200ResponseRelationshipsSenderAddressData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarriersIdGet200ResponseRelationshipsSenderAddressData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
