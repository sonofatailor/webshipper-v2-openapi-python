...
class HotKeys(BaseModel):
    ...
    HotKeys
    """ # noqa: E501
    hot_key: Optional[StrictStr] = Field(default=None, description="Key combination of the hotkey")
    path: Optional[StrictStr] = Field(default=None, description="Path the hotkey is assigned to")
    favourite_page_id: Optional[StrictInt] = None
    user_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["hot_key", "path", "favourite_page_id", "user_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "hot_key": obj.get("hot_key"),
            "path": obj.get("path"),
            "favourite_page_id": obj.get("favourite_page_id"),
