...
class PrinterRequeueJobsPostRequest(BaseModel):
    """
    PrinterRequeueJobsPostRequest
    """ # noqa: E501
    data: Optional[PrinterRequeueJobsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrinterRequeueJobsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
