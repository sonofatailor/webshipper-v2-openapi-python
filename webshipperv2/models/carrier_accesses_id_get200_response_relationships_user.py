...
class CarrierAccessesIdGet200ResponseRelationshipsUser(BaseModel):
    """
    CarrierAccessesIdGet200ResponseRelationshipsUser
    """ # noqa: E501
    data: Optional[CarrierAccessesIdGet200ResponseRelationshipsUserData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarrierAccessesIdGet200ResponseRelationshipsUserData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
