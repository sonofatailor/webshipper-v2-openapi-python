...
class CsvRulesIdGet200ResponseRelationships(BaseModel):
    """
    CsvRulesIdGet200ResponseRelationships
    """ # noqa: E501
    mapping: Optional[CsvRulesIdGet200ResponseRelationshipsMapping] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "mapping": CsvRulesIdGet200ResponseRelationshipsMapping.from_dict(obj.get("mapping")) if obj.get("mapping") is not None else None
        })
        return _obj
