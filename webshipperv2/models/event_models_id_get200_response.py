...
class EventModelsIdGet200Response(BaseModel):
    """
    EventModelsIdGet200Response
    """ # noqa: E501
    data: Optional[EventModelsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EventModelsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
