...
class TrackingEventsIdGet200Response(BaseModel):
    """
    TrackingEventsIdGet200Response
    """ # noqa: E501
    data: Optional[TrackingEventsIdGet200ResponseData] = None
    relationships: Optional[TrackingEventsIdGet200ResponseRelationships] = None
    included: Optional[List[TrackingEventsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TrackingEventsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": TrackingEventsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [TrackingEventsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
