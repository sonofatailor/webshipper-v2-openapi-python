...
class StoresIdGet200Response(BaseModel):
    """
    StoresIdGet200Response
    """ # noqa: E501
    data: Optional[StoresIdGet200ResponseData] = None
    relationships: Optional[StoresIdGet200ResponseRelationships] = None
    included: Optional[List[StoresIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": StoresIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": StoresIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [StoresIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
