...
class OrderChannelAccessesPostRequest(BaseModel):
    """
    OrderChannelAccessesPostRequest
    """ # noqa: E501
    data: Optional[OrderChannelAccessesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderChannelAccessesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
