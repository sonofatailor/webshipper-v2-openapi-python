...
class ReturnsIdGet200ResponseRelationshipsShippingMethod(BaseModel):
    """
    ReturnsIdGet200ResponseRelationshipsShippingMethod
    """ # noqa: E501
    data: Optional[ReturnsIdGet200ResponseRelationshipsShippingMethodData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnsIdGet200ResponseRelationshipsShippingMethodData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
