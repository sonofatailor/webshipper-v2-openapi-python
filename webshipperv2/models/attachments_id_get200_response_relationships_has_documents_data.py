...
class AttachmentsIdGet200ResponseRelationshipsHasDocumentsData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('has_documents'):
            raise ValueError("must be one of enum values ('has_documents')")
        return value
