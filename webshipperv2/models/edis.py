...
class Edis(BaseModel):
    ...
    Edis
    """ # noqa: E501
    status: Optional[StrictInt] = Field(default=None, description="Must be one of 'pending', 'on_hold' or 'sent'")
    data: Optional[StrictStr] = Field(default=None, description="The file contents (as text)")
    encoding: Optional[StrictInt] = Field(default=None, description="Must be either 'utf8' or 'ascii'")
    ...
    carrier_code: Optional[StrictStr] = Field(default=None, description="Text-based code representing the carrier type.")
    __properties: ClassVar[List[str]] = ["status", "data", "encoding", "updated_at", "created_at", "carrier_code"]
