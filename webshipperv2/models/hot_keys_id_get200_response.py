...
class HotKeysIdGet200Response(BaseModel):
    """
    HotKeysIdGet200Response
    """ # noqa: E501
    data: Optional[HotKeysIdGet200ResponseData] = None
    relationships: Optional[HotKeysIdGet200ResponseRelationships] = None
    included: Optional[List[HotKeysIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": HotKeysIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": HotKeysIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [HotKeysIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
