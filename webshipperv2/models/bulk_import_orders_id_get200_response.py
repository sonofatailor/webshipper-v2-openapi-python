...
class BulkImportOrdersIdGet200Response(BaseModel):
    """
    BulkImportOrdersIdGet200Response
    """ # noqa: E501
    data: Optional[BulkImportOrdersIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BulkImportOrdersIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
