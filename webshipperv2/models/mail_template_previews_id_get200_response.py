...
class MailTemplatePreviewsIdGet200Response(BaseModel):
    """
    MailTemplatePreviewsIdGet200Response
    """ # noqa: E501
    data: Optional[MailTemplatePreviewsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": MailTemplatePreviewsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
