...
class CsvMappingsPostRequest(BaseModel):
    """
    CsvMappingsPostRequest
    """ # noqa: E501
    data: Optional[CsvMappingsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvMappingsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
