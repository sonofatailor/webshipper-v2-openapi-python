...
PRINTERSIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["PrinterClients"]

class PrintersIdGet200ResponseIncludedInnerData(BaseModel):
    """
    PrintersIdGet200ResponseIncludedInnerData
    """
    # data type: PrinterClients
    oneof_schema_1_validator: Optional[PrinterClients] = None
    actual_instance: Optional[Union[PrinterClients]] = None
    one_of_schemas: List[str] = Literal["PrinterClients"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PrintersIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PrintersIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in PrintersIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into PrintersIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PrintersIdGet200ResponseIncludedInnerData with oneOf schemas: PrinterClients. Details: " + ", ".join(error_messages))
        else:
            return instance
