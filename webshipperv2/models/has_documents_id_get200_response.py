...
class HasDocumentsIdGet200Response(BaseModel):
    """
    HasDocumentsIdGet200Response
    """ # noqa: E501
    data: Optional[HasDocumentsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": HasDocumentsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
