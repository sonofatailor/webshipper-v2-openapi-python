...
class AttachmentsIdGet200ResponseRelationshipsHasDocuments(BaseModel):
    """
    AttachmentsIdGet200ResponseRelationshipsHasDocuments
    """ # noqa: E501
    data: Optional[AttachmentsIdGet200ResponseRelationshipsHasDocumentsData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AttachmentsIdGet200ResponseRelationshipsHasDocumentsData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
