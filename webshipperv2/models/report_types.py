...
class ReportTypes(BaseModel):
    ...
    columns: Optional[List[StrictStr]] = Field(default=None, description="Array of objects with keys <code>header</code> and <code>content</code>")
    parameters: Optional[List[StrictStr]] = Field(default=None, description="Array of objects with keys <code>parameter_key</code> and <code>parameter_value</code>")
    resource: Optional[StrictStr] = None
    header_columns: Optional[List[StrictStr]] = Field(default=None, description="Array of objects with keys <code>header</code> and <code>content</code> that will be used to display the header content of the report")
    footer_content: Optional[StrictStr] = None
    conditions: Optional[List[StrictStr]] = Field(default=None, description="Array of objects describing how to load the resources. Contains keys <code>condition_key</code>, <code>condition_operator</code>, <code>condition_value</code>.")
    include_deleted: Optional[StrictBool] = Field(default=None, description="If true the report will included deleted records. Default: <code>false</code>")
    use_carrier_eod: Optional[StrictBool] = Field(default=None, description="When set to true it will attempt to fetch the end of day list directly from the carrier. When this option is enabled, only pdf reports are available.")
    ...
    default_format: Optional[StrictStr] = None
    mail_on_run: Optional[StrictBool] = None
    mail: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "columns", "parameters", "resource", "header_columns", "footer_content", "conditions", "include_deleted", "use_carrier_eod", "created_at", "updated_at", "schedule", "default_format", "mail_on_run", "mail"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "header_columns": obj.get("header_columns"),
            "footer_content": obj.get("footer_content"),
            "conditions": obj.get("conditions"),
            "include_deleted": obj.get("include_deleted"),
            "use_carrier_eod": obj.get("use_carrier_eod"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "schedule": obj.get("schedule"),
            "default_format": obj.get("default_format"),
            "mail_on_run": obj.get("mail_on_run"),
            "mail": obj.get("mail")
        })
        return _obj
