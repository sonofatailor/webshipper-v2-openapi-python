...
class MailTemplatePreviews(BaseModel):
    """
    MailTemplatePreviews
    """ # noqa: E501
    mail: Optional[StrictStr] = None
    mail_template: Optional[StrictStr] = None
    mail_locale: Optional[StrictStr] = None
    locale: Optional[StrictStr] = None
    shipment_id: Optional[StrictStr] = None
    return_id: Optional[StrictStr] = None
    order_id: Optional[StrictStr] = None
    brand_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["mail", "mail_template", "mail_locale", "locale", "shipment_id", "return_id", "order_id", "brand_id", "hook", "overrides", "lang", "defaults", "to", "whitelisted_languages"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "mail": obj.get("mail"),
            "mail_template": obj.get("mail_template"),
            "mail_locale": obj.get("mail_locale"),
            "locale": obj.get("locale"),
            "shipment_id": obj.get("shipment_id"),
            "return_id": obj.get("return_id"),
