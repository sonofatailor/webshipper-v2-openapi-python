...
class LocalAttrsIdGet200ResponseRelationshipsOrderChannelType(BaseModel):
    """
    LocalAttrsIdGet200ResponseRelationshipsOrderChannelType
    """ # noqa: E501
    data: Optional[LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
