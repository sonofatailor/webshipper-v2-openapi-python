...
class PrinterJobs(BaseModel):
    ...
    completed: Optional[StrictBool] = Field(default=None, description="This will return as <code>true</code> when the printer client has accepted the job.")
    error: Optional[StrictStr] = Field(default=None, description="Any error message that resulted.")
    var_base64: Optional[StrictStr] = Field(default=None, description="Base64 encoding if the associated printable, must the explicitly included in <em>fields</em> query parameter to be included", alias="base64")
    try_count: Optional[StrictInt] = None
    initiator: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "completed", "error", "base64", "try_count", "initiator"]
