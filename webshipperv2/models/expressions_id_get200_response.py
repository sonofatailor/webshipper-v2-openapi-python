...
class ExpressionsIdGet200Response(BaseModel):
    """
    ExpressionsIdGet200Response
    """ # noqa: E501
    data: Optional[ExpressionsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ExpressionsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
