...
class PrinterJobsPostRequest(BaseModel):
    """
    PrinterJobsPostRequest
    """ # noqa: E501
    data: Optional[PrinterJobsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrinterJobsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
