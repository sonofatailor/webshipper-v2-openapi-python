...
class BarcodeRangesIdGet200Response(BaseModel):
    """
    BarcodeRangesIdGet200Response
    """ # noqa: E501
    data: Optional[BarcodeRangesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BarcodeRangesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
