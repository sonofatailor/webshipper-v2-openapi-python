...
class CsvUploadsPost204ResponseData(BaseModel):
    """
    CsvUploadsPost204ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[CsvUploads] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('csv_uploads'):
            raise ValueError("must be one of enum values ('csv_uploads')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": CsvUploads.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
