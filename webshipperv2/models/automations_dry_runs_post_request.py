...
class AutomationsDryRunsPostRequest(BaseModel):
    """
    AutomationsDryRunsPostRequest
    """ # noqa: E501
    data: Optional[AutomationsDryRunsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AutomationsDryRunsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
