...
class MailTemplatesIdGet200ResponseRelationships(BaseModel):
    """
    MailTemplatesIdGet200ResponseRelationships
    """ # noqa: E501
    brand: Optional[MailTemplatesIdGet200ResponseRelationshipsBrand] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "brand": MailTemplatesIdGet200ResponseRelationshipsBrand.from_dict(obj.get("brand")) if obj.get("brand") is not None else None
        })
        return _obj
