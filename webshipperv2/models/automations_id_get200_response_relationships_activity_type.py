...
class AutomationsIdGet200ResponseRelationshipsActivityType(BaseModel):
    """
    AutomationsIdGet200ResponseRelationshipsActivityType
    """ # noqa: E501
    data: Optional[AutomationsIdGet200ResponseRelationshipsActivityTypeData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AutomationsIdGet200ResponseRelationshipsActivityTypeData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
