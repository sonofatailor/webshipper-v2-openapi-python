...
class RegionsGet200ResponseDataInner(BaseModel):
    """
    RegionsGet200ResponseDataInner
    """ # noqa: E501
    attributes: Optional[Regions] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "attributes": Regions.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
