...
class CustomsLinesIdGet200Response(BaseModel):
    """
    CustomsLinesIdGet200Response
    """ # noqa: E501
    data: Optional[CustomsLinesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CustomsLinesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
