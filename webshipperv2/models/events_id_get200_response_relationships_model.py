...
class EventsIdGet200ResponseRelationshipsModel(BaseModel):
    """
    EventsIdGet200ResponseRelationshipsModel
    """ # noqa: E501
    data: Optional[EventsIdGet200ResponseRelationshipsModelData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EventsIdGet200ResponseRelationshipsModelData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
