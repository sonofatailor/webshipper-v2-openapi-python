...
class WebhooksIdGet200Response(BaseModel):
    """
    WebhooksIdGet200Response
    """ # noqa: E501
    data: Optional[WebhooksIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": WebhooksIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
