...
class WebhookFailuresIdGet200ResponseRelationshipsWebhook(BaseModel):
    """
    WebhookFailuresIdGet200ResponseRelationshipsWebhook
    """ # noqa: E501
    data: Optional[WebhookFailuresIdGet200ResponseRelationshipsWebhookData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": WebhookFailuresIdGet200ResponseRelationshipsWebhookData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
