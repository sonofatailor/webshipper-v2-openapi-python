...
class RegionsIdGet200Response(BaseModel):
    """
    RegionsIdGet200Response
    """ # noqa: E501
    data: Optional[RegionsIdGet200ResponseData] = None
    relationships: Optional[RegionsIdGet200ResponseRelationships] = None
    included: Optional[List[RegionsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": RegionsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": RegionsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [RegionsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
