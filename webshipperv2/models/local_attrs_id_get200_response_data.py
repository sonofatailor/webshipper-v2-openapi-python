...
class LocalAttrsIdGet200ResponseData(BaseModel):
    """
    LocalAttrsIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[LocalAttrs] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('local_attrs'):
            raise ValueError("must be one of enum values ('local_attrs')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": LocalAttrs.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
