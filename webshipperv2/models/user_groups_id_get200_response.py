...
class UserGroupsIdGet200Response(BaseModel):
    """
    UserGroupsIdGet200Response
    """ # noqa: E501
    data: Optional[UserGroupsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UserGroupsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
