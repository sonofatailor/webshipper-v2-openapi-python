...
class WebhookFailuresPostRequest(BaseModel):
    """
    WebhookFailuresPostRequest
    """ # noqa: E501
    data: Optional[WebhookFailuresPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": WebhookFailuresPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
