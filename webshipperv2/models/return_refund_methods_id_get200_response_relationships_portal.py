...
class ReturnRefundMethodsIdGet200ResponseRelationshipsPortal(BaseModel):
    """
    ReturnRefundMethodsIdGet200ResponseRelationshipsPortal
    """ # noqa: E501
    data: Optional[ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
