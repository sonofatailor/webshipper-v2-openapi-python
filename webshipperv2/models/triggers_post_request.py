...
class TriggersPostRequest(BaseModel):
    """
    TriggersPostRequest
    """ # noqa: E501
    data: Optional[TriggersPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TriggersPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
