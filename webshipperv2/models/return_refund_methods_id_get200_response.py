...
class ReturnRefundMethodsIdGet200Response(BaseModel):
    """
    ReturnRefundMethodsIdGet200Response
    """ # noqa: E501
    data: Optional[ReturnRefundMethodsIdGet200ResponseData] = None
    relationships: Optional[ReturnRefundMethodsIdGet200ResponseRelationships] = None
    included: Optional[List[ReturnRefundMethodsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnRefundMethodsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ReturnRefundMethodsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ReturnRefundMethodsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
