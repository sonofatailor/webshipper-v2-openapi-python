...
class AdditionalAttributesPostRequest(BaseModel):
    """
    AdditionalAttributesPostRequest
    """ # noqa: E501
    data: Optional[AdditionalAttributesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AdditionalAttributesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
