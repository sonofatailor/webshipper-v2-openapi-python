...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ReportTypeApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ReportTypeApi(api_client)
    id = 56 # int | 
    report_types_id_patch_request = openapi_client.ReportTypesIdPatchRequest() # ReportTypesIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ReportTypeApi(api_client)
    report_types_post_request = openapi_client.ReportTypesPostRequest() # ReportTypesPostRequest | 
