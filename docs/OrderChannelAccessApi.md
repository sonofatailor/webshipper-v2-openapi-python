# openapi_client.OrderChannelAccessApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.OrderChannelAccessApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.OrderChannelAccessApi(api_client)
    id = 56 # int | 
    order_channel_accesses_id_patch_request = openapi_client.OrderChannelAccessesIdPatchRequest() # OrderChannelAccessesIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.OrderChannelAccessApi(api_client)
    order_channel_accesses_post_request = openapi_client.OrderChannelAccessesPostRequest() # OrderChannelAccessesPostRequest | 
