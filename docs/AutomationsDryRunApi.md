# openapi_client.AutomationsDryRunApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AutomationsDryRunApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AutomationsDryRunApi(api_client)
    id = 56 # int | 
    automations_dry_runs_id_patch_request = openapi_client.AutomationsDryRunsIdPatchRequest() # AutomationsDryRunsIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.AutomationsDryRunApi(api_client)
    automations_dry_runs_post_request = openapi_client.AutomationsDryRunsPostRequest() # AutomationsDryRunsPostRequest | 
