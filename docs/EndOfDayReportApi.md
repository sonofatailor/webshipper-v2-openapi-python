# openapi_client.EndOfDayReportApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.EndOfDayReportApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.EndOfDayReportApi(api_client)
    id = 56 # int | 
    end_of_day_reports_id_patch_request = openapi_client.EndOfDayReportsIdPatchRequest() # EndOfDayReportsIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.EndOfDayReportApi(api_client)
    end_of_day_reports_post_request = openapi_client.EndOfDayReportsPostRequest() # EndOfDayReportsPostRequest | 
