# openapi_client.ShippingMappingApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ShippingMappingApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ShippingMappingApi(api_client)
    id = 56 # int | 
    shipping_mappings_id_patch_request = openapi_client.ShippingMappingsIdPatchRequest() # ShippingMappingsIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ShippingMappingApi(api_client)
    shipping_mappings_post_request = openapi_client.ShippingMappingsPostRequest() # ShippingMappingsPostRequest | 
