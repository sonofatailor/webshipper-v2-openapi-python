...
json = "{}"
# create an instance of StoresIdGet200ResponseIncludedInnerData from a JSON string
stores_id_get200_response_included_inner_data_instance = StoresIdGet200ResponseIncludedInnerData.from_json(json)
# print the JSON string representation of the object
print StoresIdGet200ResponseIncludedInnerData.to_json()

# convert the object into a dict
stores_id_get200_response_included_inner_data_dict = stores_id_get200_response_included_inner_data_instance.to_dict()
# create an instance of StoresIdGet200ResponseIncludedInnerData from a dict
stores_id_get200_response_included_inner_data_form_dict = stores_id_get200_response_included_inner_data.from_dict(stores_id_get200_response_included_inner_data_dict)
```
