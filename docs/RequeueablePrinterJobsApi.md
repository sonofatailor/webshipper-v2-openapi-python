# openapi_client.RequeueablePrinterJobsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.RequeueablePrinterJobsApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.RequeueablePrinterJobsApi(api_client)
    id = 56 # int | 
    printer_requeue_jobs_id_patch_request = openapi_client.PrinterRequeueJobsIdPatchRequest() # PrinterRequeueJobsIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.RequeueablePrinterJobsApi(api_client)
    printer_requeue_jobs_post_request = openapi_client.PrinterRequeueJobsPostRequest() # PrinterRequeueJobsPostRequest | 
