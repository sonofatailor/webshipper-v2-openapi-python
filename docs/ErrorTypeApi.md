...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ErrorTypeApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ErrorTypeApi(api_client)
    id = 56 # int | 
    error_types_id_patch_request = openapi_client.ErrorTypesIdPatchRequest() # ErrorTypesIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ErrorTypeApi(api_client)
    error_types_post_request = openapi_client.ErrorTypesPostRequest() # ErrorTypesPostRequest | 
