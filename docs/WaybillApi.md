...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.WaybillApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.WaybillApi(api_client)
    id = 56 # int | 
    waybills_id_patch_request = openapi_client.WaybillsIdPatchRequest() # WaybillsIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.WaybillApi(api_client)
    waybills_post_request = openapi_client.WaybillsPostRequest() # WaybillsPostRequest | 
