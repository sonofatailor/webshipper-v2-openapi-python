# openapi_client.ReturnShippingMethodApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ReturnShippingMethodApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ReturnShippingMethodApi(api_client)
    id = 56 # int | 
    return_shipping_methods_id_patch_request = openapi_client.ReturnShippingMethodsIdPatchRequest() # ReturnShippingMethodsIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ReturnShippingMethodApi(api_client)
    return_shipping_methods_post_request = openapi_client.ReturnShippingMethodsPostRequest() # ReturnShippingMethodsPostRequest | 
