# openapi_client.ShippingRateExpressionApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ShippingRateExpressionApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ShippingRateExpressionApi(api_client)
    id = 56 # int | 
    expressions_id_patch_request = openapi_client.ExpressionsIdPatchRequest() # ExpressionsIdPatchRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ShippingRateExpressionApi(api_client)
    expressions_post_request = openapi_client.ExpressionsPostRequest() # ExpressionsPostRequest | 
