...
class TestReportsIdGet200ResponseRelationshipsReportType(unittest.TestCase):
    """ReportsIdGet200ResponseRelationshipsReportType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportsIdGet200ResponseRelationshipsReportType:
        """Test ReportsIdGet200ResponseRelationshipsReportType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportsIdGet200ResponseRelationshipsReportType`
        """
        model = ReportsIdGet200ResponseRelationshipsReportType()
        if include_optional:
            return ReportsIdGet200ResponseRelationshipsReportType(
    ...
    def testReportsIdGet200ResponseRelationshipsReportType(self):
        """Test ReportsIdGet200ResponseRelationshipsReportType"""
