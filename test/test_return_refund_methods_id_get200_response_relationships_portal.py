...
class TestReturnRefundMethodsIdGet200ResponseRelationshipsPortal(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsIdGet200ResponseRelationshipsPortal:
        """Test ReturnRefundMethodsIdGet200ResponseRelationshipsPortal
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsIdGet200ResponseRelationshipsPortal`
        """
    ...
    def testReturnRefundMethodsIdGet200ResponseRelationshipsPortal(self):
        """Test ReturnRefundMethodsIdGet200ResponseRelationshipsPortal"""
