...
class TestBulkPrinterJobsIdPatchRequest(unittest.TestCase):
    """BulkPrinterJobsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkPrinterJobsIdPatchRequest:
        """Test BulkPrinterJobsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPrinterJobsIdPatchRequest`
        """
        model = BulkPrinterJobsIdPatchRequest()
        if include_optional:
            return BulkPrinterJobsIdPatchRequest(
    ...
    def testBulkPrinterJobsIdPatchRequest(self):
        """Test BulkPrinterJobsIdPatchRequest"""
