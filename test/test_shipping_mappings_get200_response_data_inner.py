...
class TestShippingMappingsGet200ResponseDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingMappingsGet200ResponseDataInner:
        """Test ShippingMappingsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingMappingsGet200ResponseDataInner`
        """
    ...
    def testShippingMappingsGet200ResponseDataInner(self):
        """Test ShippingMappingsGet200ResponseDataInner"""
