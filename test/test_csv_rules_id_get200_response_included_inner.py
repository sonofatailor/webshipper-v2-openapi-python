...
class TestCsvRulesIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvRulesIdGet200ResponseIncludedInner:
        """Test CsvRulesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesIdGet200ResponseIncludedInner`
        """
        model = CsvRulesIdGet200ResponseIncludedInner()
        if include_optional:
            return CsvRulesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testCsvRulesIdGet200ResponseIncludedInner(self):
        """Test CsvRulesIdGet200ResponseIncludedInner"""
