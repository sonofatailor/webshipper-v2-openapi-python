...
class TestMailTemplatePreviewsPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MailTemplatePreviewsPostRequest:
        """Test MailTemplatePreviewsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatePreviewsPostRequest`
        """
    ...
    def testMailTemplatePreviewsPostRequest(self):
        """Test MailTemplatePreviewsPostRequest"""
