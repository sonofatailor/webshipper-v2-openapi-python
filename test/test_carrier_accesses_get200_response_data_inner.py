...
class TestCarrierAccessesGet200ResponseDataInner(unittest.TestCase):
    """CarrierAccessesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierAccessesGet200ResponseDataInner:
        """Test CarrierAccessesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierAccessesGet200ResponseDataInner`
        """
        model = CarrierAccessesGet200ResponseDataInner()
        if include_optional:
            return CarrierAccessesGet200ResponseDataInner(
    ...
    def testCarrierAccessesGet200ResponseDataInner(self):
        """Test CarrierAccessesGet200ResponseDataInner"""
