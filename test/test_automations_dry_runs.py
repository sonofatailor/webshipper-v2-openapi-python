...
class TestAutomationsDryRuns(unittest.TestCase):
    """AutomationsDryRuns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsDryRuns:
        """Test AutomationsDryRuns
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsDryRuns`
        """
        model = AutomationsDryRuns()
        if include_optional:
            return AutomationsDryRuns(
                dry_run = '',
                automation = '',
                shipment_id = '',
                order_id = '',
    ...
    def testAutomationsDryRuns(self):
        """Test AutomationsDryRuns"""
