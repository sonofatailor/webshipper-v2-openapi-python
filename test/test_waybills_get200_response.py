...
class TestWaybillsGet200Response(unittest.TestCase):
    """WaybillsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaybillsGet200Response:
        """Test WaybillsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaybillsGet200Response`
        """
        model = WaybillsGet200Response()
        if include_optional:
            return WaybillsGet200Response(
                data = [
                    openapi_client.models._waybills_get_200_response_data_inner._waybills_get_200_response_data_inner(
    ...
    def testWaybillsGet200Response(self):
        """Test WaybillsGet200Response"""
