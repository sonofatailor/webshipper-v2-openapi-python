...
class TestAutomationsDryRunApi(unittest.TestCase):
    """AutomationsDryRunApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AutomationsDryRunApi()

    def tearDown(self) -> None:
        pass

    def test_automations_dry_runs_get(self) -> None:
        """Test case for automations_dry_runs_get

        List all Automations Dry Runs
        """
        pass

    def test_automations_dry_runs_id_delete(self) -> None:
        """Test case for automations_dry_runs_id_delete

        Delete a Automations Dry Run
        """
        pass

    def test_automations_dry_runs_id_get(self) -> None:
        """Test case for automations_dry_runs_id_get

        Show a single Automations Dry Run
        """
        pass

    def test_automations_dry_runs_id_patch(self) -> None:
        """Test case for automations_dry_runs_id_patch

        Update a Automations Dry Run
        """
        pass

    def test_automations_dry_runs_post(self) -> None:
        """Test case for automations_dry_runs_post
