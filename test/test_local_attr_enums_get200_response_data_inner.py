...
class TestLocalAttrEnumsGet200ResponseDataInner(unittest.TestCase):
    """LocalAttrEnumsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsGet200ResponseDataInner:
        """Test LocalAttrEnumsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsGet200ResponseDataInner`
        """
        model = LocalAttrEnumsGet200ResponseDataInner()
        if include_optional:
            return LocalAttrEnumsGet200ResponseDataInner(
    ...
    def testLocalAttrEnumsGet200ResponseDataInner(self):
        """Test LocalAttrEnumsGet200ResponseDataInner"""
