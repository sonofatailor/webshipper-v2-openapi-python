...
class TestTriggersGet200ResponseDataInner(unittest.TestCase):
    """TriggersGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggersGet200ResponseDataInner:
        """Test TriggersGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggersGet200ResponseDataInner`
        """
        model = TriggersGet200ResponseDataInner()
        if include_optional:
            return TriggersGet200ResponseDataInner(
    ...
    def testTriggersGet200ResponseDataInner(self):
        """Test TriggersGet200ResponseDataInner"""
