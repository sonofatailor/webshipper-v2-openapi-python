...
class TestCsvMappingsGet200ResponseDataInner(unittest.TestCase):
    """CsvMappingsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvMappingsGet200ResponseDataInner:
        """Test CsvMappingsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvMappingsGet200ResponseDataInner`
        """
        model = CsvMappingsGet200ResponseDataInner()
        if include_optional:
            return CsvMappingsGet200ResponseDataInner(
    ...
    def testCsvMappingsGet200ResponseDataInner(self):
        """Test CsvMappingsGet200ResponseDataInner"""
