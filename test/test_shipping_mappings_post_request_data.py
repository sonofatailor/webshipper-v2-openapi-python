...
class TestShippingMappingsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingMappingsPostRequestData:
        """Test ShippingMappingsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingMappingsPostRequestData`
        """
        model = ShippingMappingsPostRequestData()
        if include_optional:
    ...
    def testShippingMappingsPostRequestData(self):
        """Test ShippingMappingsPostRequestData"""
