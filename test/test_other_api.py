...
class TestOtherApi(unittest.TestCase):
    ...
    def test_brands_id_delete(self) -> None:
        """Test case for brands_id_delete

        Delete a Other
        """
        pass

    def test_brands_id_get(self) -> None:
        """Test case for brands_id_get

        Show a single Other
        """
        pass

    def test_brands_id_patch(self) -> None:
        """Test case for brands_id_patch

        Update a Other
        """
        pass

    def test_brands_post(self) -> None:
        """Test case for brands_post

        Create a Other
        """
        pass

    def test_return_refund_methods_get(self) -> None:
        """Test case for return_refund_methods_get

        List all Others
        """
        pass

    def test_return_refund_methods_id_delete(self) -> None:
        """Test case for return_refund_methods_id_delete

        Delete a Other
        """
        pass

    def test_return_refund_methods_id_get(self) -> None:
        """Test case for return_refund_methods_id_get

        Show a single Other
        """
        pass

    def test_return_refund_methods_id_patch(self) -> None:
        """Test case for return_refund_methods_id_patch

        Update a Other
        """
        pass

    def test_return_refund_methods_post(self) -> None:
        """Test case for return_refund_methods_post
