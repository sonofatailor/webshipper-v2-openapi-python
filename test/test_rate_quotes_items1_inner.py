...
class TestRateQuotesItems1Inner(unittest.TestCase):
    """RateQuotesItems1Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RateQuotesItems1Inner:
        """Test RateQuotesItems1Inner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateQuotesItems1Inner`
        """
        model = RateQuotesItems1Inner()
        if include_optional:
            return RateQuotesItems1Inner(
                quantity = '',
                sku = '',
                description = ''
            )
    ...
    def testRateQuotesItems1Inner(self):
        """Test RateQuotesItems1Inner"""
