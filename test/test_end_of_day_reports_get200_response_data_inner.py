...
class TestEndOfDayReportsGet200ResponseDataInner(unittest.TestCase):
    """EndOfDayReportsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndOfDayReportsGet200ResponseDataInner:
        """Test EndOfDayReportsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndOfDayReportsGet200ResponseDataInner`
        """
        model = EndOfDayReportsGet200ResponseDataInner()
        if include_optional:
            return EndOfDayReportsGet200ResponseDataInner(
    ...
    def testEndOfDayReportsGet200ResponseDataInner(self):
        """Test EndOfDayReportsGet200ResponseDataInner"""
