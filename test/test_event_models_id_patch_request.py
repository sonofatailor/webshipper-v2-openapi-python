...
class TestEventModelsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EventModelsIdPatchRequest:
        """Test EventModelsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventModelsIdPatchRequest`
        """
    ...
    def testEventModelsIdPatchRequest(self):
        """Test EventModelsIdPatchRequest"""
