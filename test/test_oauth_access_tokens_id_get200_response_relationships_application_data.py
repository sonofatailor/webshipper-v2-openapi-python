...
class TestOauthAccessTokensIdGet200ResponseRelationshipsApplicationData(unittest.TestCase):
    """OauthAccessTokensIdGet200ResponseRelationshipsApplicationData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthAccessTokensIdGet200ResponseRelationshipsApplicationData:
        """Test OauthAccessTokensIdGet200ResponseRelationshipsApplicationData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthAccessTokensIdGet200ResponseRelationshipsApplicationData`
        """
        model = OauthAccessTokensIdGet200ResponseRelationshipsApplicationData()
        if include_optional:
            return OauthAccessTokensIdGet200ResponseRelationshipsApplicationData(
                id = '',
    ...
    def testOauthAccessTokensIdGet200ResponseRelationshipsApplicationData(self):
        """Test OauthAccessTokensIdGet200ResponseRelationshipsApplicationData"""
