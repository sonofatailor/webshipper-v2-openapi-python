...
class TestPrinterJobsPostRequestData(unittest.TestCase):
    """PrinterJobsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsPostRequestData:
        """Test PrinterJobsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsPostRequestData`
        """
        model = PrinterJobsPostRequestData()
        if include_optional:
            return PrinterJobsPostRequestData(
                type = 'printer_jobs',
    ...
    def testPrinterJobsPostRequestData(self):
        """Test PrinterJobsPostRequestData"""
