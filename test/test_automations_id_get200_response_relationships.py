...
class TestAutomationsIdGet200ResponseRelationships(unittest.TestCase):
    """AutomationsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsIdGet200ResponseRelationships:
        """Test AutomationsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsIdGet200ResponseRelationships`
        """
        model = AutomationsIdGet200ResponseRelationships()
        if include_optional:
            return AutomationsIdGet200ResponseRelationships(
    ...
    def testAutomationsIdGet200ResponseRelationships(self):
        """Test AutomationsIdGet200ResponseRelationships"""
