...
class TestAdditionalAttributesIdGet200ResponseIncludedInner(unittest.TestCase):
    """AdditionalAttributesIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdGet200ResponseIncludedInner:
        """Test AdditionalAttributesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdGet200ResponseIncludedInner`
        """
        model = AdditionalAttributesIdGet200ResponseIncludedInner()
        if include_optional:
            return AdditionalAttributesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testAdditionalAttributesIdGet200ResponseIncludedInner(self):
        """Test AdditionalAttributesIdGet200ResponseIncludedInner"""
