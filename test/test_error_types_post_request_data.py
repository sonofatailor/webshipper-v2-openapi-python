...
class TestErrorTypesPostRequestData(unittest.TestCase):
    """ErrorTypesPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorTypesPostRequestData:
        """Test ErrorTypesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorTypesPostRequestData`
        """
        model = ErrorTypesPostRequestData()
        if include_optional:
            return ErrorTypesPostRequestData(
                type = 'error_types',
    ...
    def testErrorTypesPostRequestData(self):
        """Test ErrorTypesPostRequestData"""
