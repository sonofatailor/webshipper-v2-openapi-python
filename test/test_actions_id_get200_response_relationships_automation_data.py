...
class TestActionsIdGet200ResponseRelationshipsAutomationData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsIdGet200ResponseRelationshipsAutomationData:
        """Test ActionsIdGet200ResponseRelationshipsAutomationData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsIdGet200ResponseRelationshipsAutomationData`
        """
        model = ActionsIdGet200ResponseRelationshipsAutomationData()
        if include_optional:
            return ActionsIdGet200ResponseRelationshipsAutomationData(
                id = '',
                type = 'automations'
            )
        else:
    ...
    def testActionsIdGet200ResponseRelationshipsAutomationData(self):
        """Test ActionsIdGet200ResponseRelationshipsAutomationData"""
