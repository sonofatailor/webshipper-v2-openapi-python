...
class TestBulkImportOrdersGet200ResponseDataInner(unittest.TestCase):
    """BulkImportOrdersGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkImportOrdersGet200ResponseDataInner:
        """Test BulkImportOrdersGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkImportOrdersGet200ResponseDataInner`
        """
        model = BulkImportOrdersGet200ResponseDataInner()
        if include_optional:
            return BulkImportOrdersGet200ResponseDataInner(
    ...
    def testBulkImportOrdersGet200ResponseDataInner(self):
        """Test BulkImportOrdersGet200ResponseDataInner"""
