...
class TestBrandsIdGet200ResponseData(unittest.TestCase):
    """BrandsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandsIdGet200ResponseData:
        """Test BrandsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandsIdGet200ResponseData`
        """
        model = BrandsIdGet200ResponseData()
        if include_optional:
            return BrandsIdGet200ResponseData(
                id = 56,
                type = 'brands',
    ...
    def testBrandsIdGet200ResponseData(self):
        """Test BrandsIdGet200ResponseData"""
