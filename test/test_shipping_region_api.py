...
class TestShippingRegionApi(unittest.TestCase):
    """ShippingRegionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ShippingRegionApi()
    ...
    def test_regions_id_delete(self) -> None:
    ...
    def test_regions_id_get(self) -> None:
    ...
    def test_regions_id_patch(self) -> None:
        """Test case for regions_id_patch

        Update a Shipping Region
        """
        pass

    def test_regions_post(self) -> None:
