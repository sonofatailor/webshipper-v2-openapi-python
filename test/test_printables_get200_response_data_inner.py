...
class TestPrintablesGet200ResponseDataInner(unittest.TestCase):
    """PrintablesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintablesGet200ResponseDataInner:
        """Test PrintablesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintablesGet200ResponseDataInner`
        """
        model = PrintablesGet200ResponseDataInner()
        if include_optional:
            return PrintablesGet200ResponseDataInner(
    ...
    def testPrintablesGet200ResponseDataInner(self):
        """Test PrintablesGet200ResponseDataInner"""
