...
class TestCarriersIdGet200ResponseRelationshipsCarrierType(unittest.TestCase):
    """CarriersIdGet200ResponseRelationshipsCarrierType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersIdGet200ResponseRelationshipsCarrierType:
        """Test CarriersIdGet200ResponseRelationshipsCarrierType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersIdGet200ResponseRelationshipsCarrierType`
        """
        model = CarriersIdGet200ResponseRelationshipsCarrierType()
        if include_optional:
            return CarriersIdGet200ResponseRelationshipsCarrierType(
    ...
    def testCarriersIdGet200ResponseRelationshipsCarrierType(self):
        """Test CarriersIdGet200ResponseRelationshipsCarrierType"""
