...
class TestCSVMappingApi(unittest.TestCase):
    """CSVMappingApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CSVMappingApi()

    def tearDown(self) -> None:
        pass

    def test_csv_mappings_get(self) -> None:
        """Test case for csv_mappings_get

        List all CSV Mappings
        """
        pass

    def test_csv_mappings_id_delete(self) -> None:
        """Test case for csv_mappings_id_delete

        Delete a CSV Mapping
        """
        pass

    def test_csv_mappings_id_get(self) -> None:
        """Test case for csv_mappings_id_get

        Show a single CSV Mapping
        """
        pass

    def test_csv_mappings_id_patch(self) -> None:
        """Test case for csv_mappings_id_patch

        Update a CSV Mapping
        """
        pass

    def test_csv_mappings_post(self) -> None:
        """Test case for csv_mappings_post
