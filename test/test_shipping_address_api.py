...
class TestShippingAddressApi(unittest.TestCase):
    """ShippingAddressApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ShippingAddressApi()

    def tearDown(self) -> None:
        pass

    def test_shipping_addresses_get(self) -> None:
        """Test case for shipping_addresses_get

        List all Shipping Addresss
        """
        pass

    def test_shipping_addresses_id_delete(self) -> None:
        """Test case for shipping_addresses_id_delete

        Delete a Shipping Address
        """
        pass

    def test_shipping_addresses_id_get(self) -> None:
        """Test case for shipping_addresses_id_get

        Show a single Shipping Address
        """
        pass

    def test_shipping_addresses_id_patch(self) -> None:
        """Test case for shipping_addresses_id_patch

        Update a Shipping Address
        """
        pass

    def test_shipping_addresses_post(self) -> None:
        """Test case for shipping_addresses_post
