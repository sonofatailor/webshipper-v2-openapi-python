...
class TestEventModelApi(unittest.TestCase):
    """EventModelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EventModelApi()

    def tearDown(self) -> None:
        pass

    def test_event_models_get(self) -> None:
        """Test case for event_models_get

        List all EventModels
        """
        pass

    def test_event_models_id_delete(self) -> None:
        """Test case for event_models_id_delete

        Delete a EventModel
        """
        pass

    def test_event_models_id_get(self) -> None:
        """Test case for event_models_id_get

        Show a single EventModel
        """
        pass

    def test_event_models_id_patch(self) -> None:
        """Test case for event_models_id_patch

        Update a EventModel
        """
        pass

    def test_event_models_post(self) -> None:
        """Test case for event_models_post
