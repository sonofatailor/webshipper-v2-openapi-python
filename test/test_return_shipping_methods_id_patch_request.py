...
class TestReturnShippingMethodsIdPatchRequest(unittest.TestCase):
    """ReturnShippingMethodsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsIdPatchRequest:
        """Test ReturnShippingMethodsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsIdPatchRequest`
        """
        model = ReturnShippingMethodsIdPatchRequest()
        if include_optional:
            return ReturnShippingMethodsIdPatchRequest(
    ...
    def testReturnShippingMethodsIdPatchRequest(self):
        """Test ReturnShippingMethodsIdPatchRequest"""
