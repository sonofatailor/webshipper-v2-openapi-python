...
class TestReturnPortalsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnPortalsIdPatchRequest:
        """Test ReturnPortalsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsIdPatchRequest`
        """
    ...
    def testReturnPortalsIdPatchRequest(self):
        """Test ReturnPortalsIdPatchRequest"""
