...
class TestEventsIdGet200ResponseIncludedInner(unittest.TestCase):
    """EventsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsIdGet200ResponseIncludedInner:
        """Test EventsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsIdGet200ResponseIncludedInner`
        """
        model = EventsIdGet200ResponseIncludedInner()
        if include_optional:
            return EventsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testEventsIdGet200ResponseIncludedInner(self):
        """Test EventsIdGet200ResponseIncludedInner"""
