...
class TestUsersPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsersPostRequestData:
        """Test UsersPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersPostRequestData`
        """
        model = UsersPostRequestData()
        if include_optional:
    ...
    def testUsersPostRequestData(self):
        """Test UsersPostRequestData"""
