...
class TestCsvRulesIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """CsvRulesIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvRulesIdGet200ResponseIncludedInnerData:
        """Test CsvRulesIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesIdGet200ResponseIncludedInnerData`
        """
        model = CsvRulesIdGet200ResponseIncludedInnerData()
        if include_optional:
            return CsvRulesIdGet200ResponseIncludedInnerData(
                separator = '',
                target_class = '',
                grouped_by = 56,
                grouped_path = '',
    ...
    def testCsvRulesIdGet200ResponseIncludedInnerData(self):
        """Test CsvRulesIdGet200ResponseIncludedInnerData"""
