...
class TestAdditionalAttributesIdGet200ResponseRelationshipsOrderLineData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData:
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData`
        """
        model = AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData()
        if include_optional:
            return AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData(
                id = '',
                type = 'order_lines'
            )
        else:
    ...
    def testAdditionalAttributesIdGet200ResponseRelationshipsOrderLineData(self):
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData"""
