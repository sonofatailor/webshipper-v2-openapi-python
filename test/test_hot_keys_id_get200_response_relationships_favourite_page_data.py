...
class TestHotKeysIdGet200ResponseRelationshipsFavouritePageData(unittest.TestCase):
    """HotKeysIdGet200ResponseRelationshipsFavouritePageData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotKeysIdGet200ResponseRelationshipsFavouritePageData:
        """Test HotKeysIdGet200ResponseRelationshipsFavouritePageData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysIdGet200ResponseRelationshipsFavouritePageData`
        """
        model = HotKeysIdGet200ResponseRelationshipsFavouritePageData()
        if include_optional:
            return HotKeysIdGet200ResponseRelationshipsFavouritePageData(
                id = '',
    ...
    def testHotKeysIdGet200ResponseRelationshipsFavouritePageData(self):
        """Test HotKeysIdGet200ResponseRelationshipsFavouritePageData"""
