...
class TestPrintablesIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrintablesIdPatchRequest:
        """Test PrintablesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintablesIdPatchRequest`
        """
    ...
    def testPrintablesIdPatchRequest(self):
        """Test PrintablesIdPatchRequest"""
