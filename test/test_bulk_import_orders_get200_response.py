...
class TestBulkImportOrdersGet200Response(unittest.TestCase):
    """BulkImportOrdersGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkImportOrdersGet200Response:
        """Test BulkImportOrdersGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkImportOrdersGet200Response`
        """
        model = BulkImportOrdersGet200Response()
        if include_optional:
            return BulkImportOrdersGet200Response(
                data = [
                    openapi_client.models._bulk_import_orders_get_200_response_data_inner._bulk_import_orders_get_200_response_data_inner(
    ...
    def testBulkImportOrdersGet200Response(self):
        """Test BulkImportOrdersGet200Response"""
