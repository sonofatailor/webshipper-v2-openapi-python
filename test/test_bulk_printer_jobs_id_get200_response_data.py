...
class TestBulkPrinterJobsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BulkPrinterJobsIdGet200ResponseData:
        """Test BulkPrinterJobsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPrinterJobsIdGet200ResponseData`
        """
        model = BulkPrinterJobsIdGet200ResponseData()
        if include_optional:
    ...
    def testBulkPrinterJobsIdGet200ResponseData(self):
        """Test BulkPrinterJobsIdGet200ResponseData"""
