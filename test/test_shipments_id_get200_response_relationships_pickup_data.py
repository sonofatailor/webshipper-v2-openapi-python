...
class TestShipmentsIdGet200ResponseRelationshipsPickupData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShipmentsIdGet200ResponseRelationshipsPickupData:
        """Test ShipmentsIdGet200ResponseRelationshipsPickupData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsIdGet200ResponseRelationshipsPickupData`
        """
        model = ShipmentsIdGet200ResponseRelationshipsPickupData()
        if include_optional:
            return ShipmentsIdGet200ResponseRelationshipsPickupData(
                id = '',
                type = 'pickups'
            )
        else:
    ...
    def testShipmentsIdGet200ResponseRelationshipsPickupData(self):
        """Test ShipmentsIdGet200ResponseRelationshipsPickupData"""
