...
class TestPrinterRequeueJobsGet200Response(unittest.TestCase):
    """PrinterRequeueJobsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterRequeueJobsGet200Response:
        """Test PrinterRequeueJobsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterRequeueJobsGet200Response`
        """
        model = PrinterRequeueJobsGet200Response()
        if include_optional:
            return PrinterRequeueJobsGet200Response(
                data = [
                    openapi_client.models._printer_requeue_jobs_get_200_response_data_inner._printer_requeue_jobs_get_200_response_data_inner(
    ...
    def testPrinterRequeueJobsGet200Response(self):
        """Test PrinterRequeueJobsGet200Response"""
