...
class TestDocumentsGet200Response(unittest.TestCase):
    """DocumentsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsGet200Response:
        """Test DocumentsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsGet200Response`
        """
        model = DocumentsGet200Response()
        if include_optional:
            return DocumentsGet200Response(
                data = [
                    openapi_client.models._documents_get_200_response_data_inner._documents_get_200_response_data_inner(
    ...
    def testDocumentsGet200Response(self):
        """Test DocumentsGet200Response"""
