...
class TestEdisIdGet200ResponseRelationshipsShipment(unittest.TestCase):
    """EdisIdGet200ResponseRelationshipsShipment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdisIdGet200ResponseRelationshipsShipment:
        """Test EdisIdGet200ResponseRelationshipsShipment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdisIdGet200ResponseRelationshipsShipment`
        """
        model = EdisIdGet200ResponseRelationshipsShipment()
        if include_optional:
            return EdisIdGet200ResponseRelationshipsShipment(
    ...
    def testEdisIdGet200ResponseRelationshipsShipment(self):
        """Test EdisIdGet200ResponseRelationshipsShipment"""
