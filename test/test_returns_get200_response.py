...
class TestReturnsGet200Response(unittest.TestCase):
    """ReturnsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnsGet200Response:
        """Test ReturnsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsGet200Response`
        """
        model = ReturnsGet200Response()
        if include_optional:
            return ReturnsGet200Response(
                data = [
                    openapi_client.models._returns_get_200_response_data_inner._returns_get_200_response_data_inner(
    ...
    def testReturnsGet200Response(self):
        """Test ReturnsGet200Response"""
