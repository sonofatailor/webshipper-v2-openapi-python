...
class TestBulkImportOrdersApi(unittest.TestCase):
    """BulkImportOrdersApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BulkImportOrdersApi()

    def tearDown(self) -> None:
        pass

    def test_bulk_import_orders_get(self) -> None:
        """Test case for bulk_import_orders_get

        List all Bulk import orderss
        """
        pass

    def test_bulk_import_orders_id_delete(self) -> None:
        """Test case for bulk_import_orders_id_delete

        Delete a Bulk import orders
        """
        pass

    def test_bulk_import_orders_id_get(self) -> None:
        """Test case for bulk_import_orders_id_get

        Show a single Bulk import orders
        """
        pass

    def test_bulk_import_orders_id_patch(self) -> None:
        """Test case for bulk_import_orders_id_patch

        Update a Bulk import orders
        """
        pass

    def test_bulk_import_orders_post(self) -> None:
        """Test case for bulk_import_orders_post
