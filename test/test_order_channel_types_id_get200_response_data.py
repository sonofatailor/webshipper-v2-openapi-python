...
class TestOrderChannelTypesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderChannelTypesIdGet200ResponseData:
        """Test OrderChannelTypesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelTypesIdGet200ResponseData`
        """
        model = OrderChannelTypesIdGet200ResponseData()
        if include_optional:
    ...
    def testOrderChannelTypesIdGet200ResponseData(self):
        """Test OrderChannelTypesIdGet200ResponseData"""
