...
class TestLocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData(unittest.TestCase):
    """LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData:
        """Test LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData`
        """
        model = LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData()
        if include_optional:
            return LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData(
                id = '',
                type = 'local_attrs'
            )
        else:
    ...
    def testLocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData(self):
        """Test LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData"""
