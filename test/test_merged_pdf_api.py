...
class TestMergedPDFApi(unittest.TestCase):
    """MergedPDFApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MergedPDFApi()

    def tearDown(self) -> None:
        pass

    def test_pdf_merges_id_get(self) -> None:
        """Test case for pdf_merges_id_get

        Show a single Merged PDF
        """
        pass

    def test_pdf_merges_post(self) -> None:
        """Test case for pdf_merges_post
