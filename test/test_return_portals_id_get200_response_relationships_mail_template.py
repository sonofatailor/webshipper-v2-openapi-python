...
class TestReturnPortalsIdGet200ResponseRelationshipsMailTemplate(unittest.TestCase):
    """ReturnPortalsIdGet200ResponseRelationshipsMailTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnPortalsIdGet200ResponseRelationshipsMailTemplate:
        """Test ReturnPortalsIdGet200ResponseRelationshipsMailTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsIdGet200ResponseRelationshipsMailTemplate`
        """
        model = ReturnPortalsIdGet200ResponseRelationshipsMailTemplate()
        if include_optional:
            return ReturnPortalsIdGet200ResponseRelationshipsMailTemplate(
    ...
    def testReturnPortalsIdGet200ResponseRelationshipsMailTemplate(self):
        """Test ReturnPortalsIdGet200ResponseRelationshipsMailTemplate"""
