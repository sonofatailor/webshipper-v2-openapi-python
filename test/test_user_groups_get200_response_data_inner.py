...
class TestUserGroupsGet200ResponseDataInner(unittest.TestCase):
    """UserGroupsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserGroupsGet200ResponseDataInner:
        """Test UserGroupsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserGroupsGet200ResponseDataInner`
        """
        model = UserGroupsGet200ResponseDataInner()
        if include_optional:
            return UserGroupsGet200ResponseDataInner(
    ...
    def testUserGroupsGet200ResponseDataInner(self):
        """Test UserGroupsGet200ResponseDataInner"""
