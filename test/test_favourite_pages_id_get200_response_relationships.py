...
class TestFavouritePagesIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FavouritePagesIdGet200ResponseRelationships:
        """Test FavouritePagesIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesIdGet200ResponseRelationships`
        """
    ...
    def testFavouritePagesIdGet200ResponseRelationships(self):
        """Test FavouritePagesIdGet200ResponseRelationships"""
