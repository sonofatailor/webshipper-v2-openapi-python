...
class TestExpressionsGet200Response(unittest.TestCase):
    """ExpressionsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpressionsGet200Response:
        """Test ExpressionsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpressionsGet200Response`
        """
        model = ExpressionsGet200Response()
        if include_optional:
            return ExpressionsGet200Response(
                data = [
                    openapi_client.models._expressions_get_200_response_data_inner._expressions_get_200_response_data_inner(
    ...
    def testExpressionsGet200Response(self):
        """Test ExpressionsGet200Response"""
