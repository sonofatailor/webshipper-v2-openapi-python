...
class TestEventsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EventsIdGet200ResponseData:
        """Test EventsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsIdGet200ResponseData`
        """
        model = EventsIdGet200ResponseData()
        if include_optional:
    ...
    def testEventsIdGet200ResponseData(self):
        """Test EventsIdGet200ResponseData"""
