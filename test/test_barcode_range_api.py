...
class TestBarcodeRangeApi(unittest.TestCase):
    """BarcodeRangeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BarcodeRangeApi()

    def tearDown(self) -> None:
        pass

    def test_barcode_ranges_get(self) -> None:
        """Test case for barcode_ranges_get

        List all Barcode Ranges
        """
        pass

    def test_barcode_ranges_id_delete(self) -> None:
        """Test case for barcode_ranges_id_delete

        Delete a Barcode Range
        """
        pass

    def test_barcode_ranges_id_get(self) -> None:
        """Test case for barcode_ranges_id_get

        Show a single Barcode Range
        """
        pass

    def test_barcode_ranges_id_patch(self) -> None:
        """Test case for barcode_ranges_id_patch

        Update a Barcode Range
        """
        pass

    def test_barcode_ranges_post(self) -> None:
        """Test case for barcode_ranges_post
