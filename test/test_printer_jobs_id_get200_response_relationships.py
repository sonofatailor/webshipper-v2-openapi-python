...
class TestPrinterJobsIdGet200ResponseRelationships(unittest.TestCase):
    """PrinterJobsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsIdGet200ResponseRelationships:
        """Test PrinterJobsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsIdGet200ResponseRelationships`
        """
        model = PrinterJobsIdGet200ResponseRelationships()
        if include_optional:
            return PrinterJobsIdGet200ResponseRelationships(
    ...
    def testPrinterJobsIdGet200ResponseRelationships(self):
        """Test PrinterJobsIdGet200ResponseRelationships"""
