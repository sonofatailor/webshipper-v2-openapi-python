...
class TestCustomsLinesGet200ResponseDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomsLinesGet200ResponseDataInner:
        """Test CustomsLinesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomsLinesGet200ResponseDataInner`
        """
    ...
    def testCustomsLinesGet200ResponseDataInner(self):
        """Test CustomsLinesGet200ResponseDataInner"""
