...
class TestShippingAddressesGet200ResponseDataInner(unittest.TestCase):
    """ShippingAddressesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingAddressesGet200ResponseDataInner:
        """Test ShippingAddressesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingAddressesGet200ResponseDataInner`
        """
        model = ShippingAddressesGet200ResponseDataInner()
        if include_optional:
            return ShippingAddressesGet200ResponseDataInner(
    ...
    def testShippingAddressesGet200ResponseDataInner(self):
        """Test ShippingAddressesGet200ResponseDataInner"""
