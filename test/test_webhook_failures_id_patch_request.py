...
class TestWebhookFailuresIdPatchRequest(unittest.TestCase):
    """WebhookFailuresIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresIdPatchRequest:
        """Test WebhookFailuresIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresIdPatchRequest`
        """
        model = WebhookFailuresIdPatchRequest()
        if include_optional:
            return WebhookFailuresIdPatchRequest(
    ...
    def testWebhookFailuresIdPatchRequest(self):
        """Test WebhookFailuresIdPatchRequest"""
