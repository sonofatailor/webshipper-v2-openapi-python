...
class TestCustomsLineApi(unittest.TestCase):
    """CustomsLineApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CustomsLineApi()

    def tearDown(self) -> None:
        pass

    def test_customs_lines_get(self) -> None:
        """Test case for customs_lines_get

        List all Customs Lines
        """
        pass

    def test_customs_lines_id_delete(self) -> None:
        """Test case for customs_lines_id_delete

        Delete a Customs Line
        """
        pass

    def test_customs_lines_id_get(self) -> None:
        """Test case for customs_lines_id_get

        Show a single Customs Line
        """
        pass

    def test_customs_lines_id_patch(self) -> None:
        """Test case for customs_lines_id_patch

        Update a Customs Line
        """
        pass

    def test_customs_lines_post(self) -> None:
        """Test case for customs_lines_post
