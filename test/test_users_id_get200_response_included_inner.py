...
class TestUsersIdGet200ResponseIncludedInner(unittest.TestCase):
    """UsersIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersIdGet200ResponseIncludedInner:
        """Test UsersIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersIdGet200ResponseIncludedInner`
        """
        model = UsersIdGet200ResponseIncludedInner()
        if include_optional:
            return UsersIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testUsersIdGet200ResponseIncludedInner(self):
        """Test UsersIdGet200ResponseIncludedInner"""
