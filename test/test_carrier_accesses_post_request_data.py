...
class TestCarrierAccessesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CarrierAccessesPostRequestData:
        """Test CarrierAccessesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierAccessesPostRequestData`
        """
        model = CarrierAccessesPostRequestData()
        if include_optional:
    ...
    def testCarrierAccessesPostRequestData(self):
        """Test CarrierAccessesPostRequestData"""
