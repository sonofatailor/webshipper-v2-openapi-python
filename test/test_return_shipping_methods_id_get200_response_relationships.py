...
class TestReturnShippingMethodsIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsIdGet200ResponseRelationships:
        """Test ReturnShippingMethodsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsIdGet200ResponseRelationships`
        """
    ...
    def testReturnShippingMethodsIdGet200ResponseRelationships(self):
        """Test ReturnShippingMethodsIdGet200ResponseRelationships"""
