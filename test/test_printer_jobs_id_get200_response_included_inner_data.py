...
class TestPrinterJobsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """PrinterJobsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsIdGet200ResponseIncludedInnerData:
        """Test PrinterJobsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsIdGet200ResponseIncludedInnerData`
        """
        model = PrinterJobsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return PrinterJobsIdGet200ResponseIncludedInnerData(
                uuid = '',
                approved = True,
                alias = '',
                is_online = True,
    ...
    def testPrinterJobsIdGet200ResponseIncludedInnerData(self):
        """Test PrinterJobsIdGet200ResponseIncludedInnerData"""
