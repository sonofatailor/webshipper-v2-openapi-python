...
class TestCSVMappingRuleApi(unittest.TestCase):
    """CSVMappingRuleApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CSVMappingRuleApi()

    def tearDown(self) -> None:
        pass

    def test_csv_rules_get(self) -> None:
        """Test case for csv_rules_get

        List all CSV Mapping Rules
        """
        pass

    def test_csv_rules_id_delete(self) -> None:
        """Test case for csv_rules_id_delete

        Delete a CSV Mapping Rule
        """
        pass

    def test_csv_rules_id_get(self) -> None:
        """Test case for csv_rules_id_get

        Show a single CSV Mapping Rule
        """
        pass

    def test_csv_rules_id_patch(self) -> None:
        """Test case for csv_rules_id_patch

        Update a CSV Mapping Rule
        """
        pass

    def test_csv_rules_post(self) -> None:
        """Test case for csv_rules_post
