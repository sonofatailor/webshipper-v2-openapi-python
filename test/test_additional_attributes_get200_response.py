...
class TestAdditionalAttributesGet200Response(unittest.TestCase):
    """AdditionalAttributesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesGet200Response:
        """Test AdditionalAttributesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesGet200Response`
        """
        model = AdditionalAttributesGet200Response()
        if include_optional:
            return AdditionalAttributesGet200Response(
                data = [
                    openapi_client.models._additional_attributes_get_200_response_data_inner._additional_attributes_get_200_response_data_inner(
    ...
    def testAdditionalAttributesGet200Response(self):
        """Test AdditionalAttributesGet200Response"""
