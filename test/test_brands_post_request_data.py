...
class TestBrandsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BrandsPostRequestData:
        """Test BrandsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandsPostRequestData`
        """
        model = BrandsPostRequestData()
        if include_optional:
    ...
    def testBrandsPostRequestData(self):
        """Test BrandsPostRequestData"""
