...
class TestAutomationsGet200Response(unittest.TestCase):
    """AutomationsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsGet200Response:
        """Test AutomationsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsGet200Response`
        """
        model = AutomationsGet200Response()
        if include_optional:
            return AutomationsGet200Response(
                data = [
                    openapi_client.models._automations_get_200_response_data_inner._automations_get_200_response_data_inner(
    ...
    def testAutomationsGet200Response(self):
        """Test AutomationsGet200Response"""
