...
class TestTriggersIdGet200ResponseData(unittest.TestCase):
    """TriggersIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggersIdGet200ResponseData:
        """Test TriggersIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggersIdGet200ResponseData`
        """
        model = TriggersIdGet200ResponseData()
        if include_optional:
            return TriggersIdGet200ResponseData(
                id = 56,
                type = 'triggers',
    ...
    def testTriggersIdGet200ResponseData(self):
        """Test TriggersIdGet200ResponseData"""
