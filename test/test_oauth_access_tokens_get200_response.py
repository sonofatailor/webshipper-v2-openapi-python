...
class TestOauthAccessTokensGet200Response(unittest.TestCase):
    """OauthAccessTokensGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthAccessTokensGet200Response:
        """Test OauthAccessTokensGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthAccessTokensGet200Response`
        """
        model = OauthAccessTokensGet200Response()
        if include_optional:
            return OauthAccessTokensGet200Response(
                data = [
                    openapi_client.models._oauth_access_tokens_get_200_response_data_inner._oauth_access_tokens_get_200_response_data_inner(
    ...
    def testOauthAccessTokensGet200Response(self):
        """Test OauthAccessTokensGet200Response"""
