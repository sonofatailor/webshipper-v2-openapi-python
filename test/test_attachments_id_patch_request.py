...
class TestAttachmentsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttachmentsIdPatchRequest:
        """Test AttachmentsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdPatchRequest`
        """
    ...
    def testAttachmentsIdPatchRequest(self):
        """Test AttachmentsIdPatchRequest"""
