...
class TestPrinterClientsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterClientsIdGet200ResponseData:
        """Test PrinterClientsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsIdGet200ResponseData`
        """
        model = PrinterClientsIdGet200ResponseData()
        if include_optional:
    ...
    def testPrinterClientsIdGet200ResponseData(self):
        """Test PrinterClientsIdGet200ResponseData"""
