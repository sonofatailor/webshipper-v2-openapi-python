...
class TestCustomsLinesIdPatchRequest(unittest.TestCase):
    """CustomsLinesIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomsLinesIdPatchRequest:
        """Test CustomsLinesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomsLinesIdPatchRequest`
        """
        model = CustomsLinesIdPatchRequest()
        if include_optional:
            return CustomsLinesIdPatchRequest(
    ...
    def testCustomsLinesIdPatchRequest(self):
        """Test CustomsLinesIdPatchRequest"""
