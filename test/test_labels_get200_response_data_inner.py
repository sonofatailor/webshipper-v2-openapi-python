...
class TestLabelsGet200ResponseDataInner(unittest.TestCase):
    """LabelsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelsGet200ResponseDataInner:
        """Test LabelsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelsGet200ResponseDataInner`
        """
        model = LabelsGet200ResponseDataInner()
        if include_optional:
            return LabelsGet200ResponseDataInner(
    ...
    def testLabelsGet200ResponseDataInner(self):
        """Test LabelsGet200ResponseDataInner"""
