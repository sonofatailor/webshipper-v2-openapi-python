...
class TestHotKeysIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HotKeysIdGet200ResponseIncludedInnerData:
        """Test HotKeysIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysIdGet200ResponseIncludedInnerData`
        """
        model = HotKeysIdGet200ResponseIncludedInnerData()
        if include_optional:
            return HotKeysIdGet200ResponseIncludedInnerData(
                path = '',
                name = '',
                user_id = 56,
                first_name = '',
    ...
    def testHotKeysIdGet200ResponseIncludedInnerData(self):
        """Test HotKeysIdGet200ResponseIncludedInnerData"""
