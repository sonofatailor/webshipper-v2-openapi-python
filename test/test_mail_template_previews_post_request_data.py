...
class TestMailTemplatePreviewsPostRequestData(unittest.TestCase):
    """MailTemplatePreviewsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatePreviewsPostRequestData:
        """Test MailTemplatePreviewsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatePreviewsPostRequestData`
        """
        model = MailTemplatePreviewsPostRequestData()
        if include_optional:
            return MailTemplatePreviewsPostRequestData(
    ...
    def testMailTemplatePreviewsPostRequestData(self):
        """Test MailTemplatePreviewsPostRequestData"""
