...
class TestCarrierTypesIdGet200Response(unittest.TestCase):
    """CarrierTypesIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierTypesIdGet200Response:
        """Test CarrierTypesIdGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierTypesIdGet200Response`
        """
        model = CarrierTypesIdGet200Response()
        if include_optional:
            return CarrierTypesIdGet200Response(
                data = openapi_client.models._carrier_types__id__get_200_response_data._carrier_types__id__get_200_response_data(
                    id = 56, 
                    type = 'carrier_types', 
                    attributes = openapi_client.models.carrier_types.carrier_types(
                        fulfillment_logo = '', 
                        list_logo = '', 
                        name = '', 
                        carrier_code = '', 
                        description = '', 
                        required_details = '', 
                        requires_dutiable = True, 
                        supports_zpl = True, 
                        supports_pickup = '', 
                        supports_tracking = '', 
                        supports_price_quoting = True, 
                        requires_approval = True, 
                        supports_documents = True, 
                        supports_shipment_updates = True, 
                        shipment_updates_limit_minutes = 56, 
                        barcode_mail = '', 
                        supports_price_pdf_upload = '', 
                        supports_deletion = '', 
                        barcode_customer_notification_mail_template_id = 56, 
                        colli_type_support = 56, 
                        beta = True, 
    ...
    def testCarrierTypesIdGet200Response(self):
        """Test CarrierTypesIdGet200Response"""
