...
class TestOrderChannelsPostRequest(unittest.TestCase):
    """OrderChannelsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelsPostRequest:
        """Test OrderChannelsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelsPostRequest`
        """
        model = OrderChannelsPostRequest()
        if include_optional:
            return OrderChannelsPostRequest(
                data = openapi_client.models._order_channels_post_request_data._order_channels_post_request_data(
                    type = 'order_channels', 
    ...
    def testOrderChannelsPostRequest(self):
        """Test OrderChannelsPostRequest"""
