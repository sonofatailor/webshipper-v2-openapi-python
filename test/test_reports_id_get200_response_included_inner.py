...
class TestReportsIdGet200ResponseIncludedInner(unittest.TestCase):
    """ReportsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportsIdGet200ResponseIncludedInner:
        """Test ReportsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportsIdGet200ResponseIncludedInner`
        """
        model = ReportsIdGet200ResponseIncludedInner()
        if include_optional:
            return ReportsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testReportsIdGet200ResponseIncludedInner(self):
        """Test ReportsIdGet200ResponseIncludedInner"""
