...
class TestWebhookFailuresGet200ResponseDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebhookFailuresGet200ResponseDataInner:
        """Test WebhookFailuresGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresGet200ResponseDataInner`
        """
    ...
    def testWebhookFailuresGet200ResponseDataInner(self):
        """Test WebhookFailuresGet200ResponseDataInner"""
