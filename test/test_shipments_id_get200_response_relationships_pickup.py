...
class TestShipmentsIdGet200ResponseRelationshipsPickup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShipmentsIdGet200ResponseRelationshipsPickup:
        """Test ShipmentsIdGet200ResponseRelationshipsPickup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsIdGet200ResponseRelationshipsPickup`
        """
    ...
    def testShipmentsIdGet200ResponseRelationshipsPickup(self):
        """Test ShipmentsIdGet200ResponseRelationshipsPickup"""
