...
class TestPickupApi(unittest.TestCase):
    ...
    def test_pickups_get(self) -> None:
        """Test case for pickups_get

        List all Pickups
        """
        pass

    def test_pickups_id_delete(self) -> None:
        """Test case for pickups_id_delete

        Delete a Pickup
        """
        pass

    def test_pickups_id_get(self) -> None:
        """Test case for pickups_id_get

        Show a single Pickup
        """
        pass

    def test_pickups_id_patch(self) -> None:
        """Test case for pickups_id_patch

        Update a Pickup
        """
        pass

    def test_pickups_post(self) -> None:
        """Test case for pickups_post
