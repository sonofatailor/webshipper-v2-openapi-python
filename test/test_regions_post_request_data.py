...
class TestRegionsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RegionsPostRequestData:
        """Test RegionsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionsPostRequestData`
        """
        model = RegionsPostRequestData()
        if include_optional:
    ...
    def testRegionsPostRequestData(self):
        """Test RegionsPostRequestData"""
