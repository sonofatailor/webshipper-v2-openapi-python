...
class TestSlipTemplatePreviewsIdPatchRequest(unittest.TestCase):
    """SlipTemplatePreviewsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlipTemplatePreviewsIdPatchRequest:
        """Test SlipTemplatePreviewsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatePreviewsIdPatchRequest`
        """
        model = SlipTemplatePreviewsIdPatchRequest()
        if include_optional:
            return SlipTemplatePreviewsIdPatchRequest(
    ...
    def testSlipTemplatePreviewsIdPatchRequest(self):
        """Test SlipTemplatePreviewsIdPatchRequest"""
