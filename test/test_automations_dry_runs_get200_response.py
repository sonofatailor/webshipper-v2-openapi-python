...
class TestAutomationsDryRunsGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutomationsDryRunsGet200Response:
        """Test AutomationsDryRunsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsDryRunsGet200Response`
        """
        model = AutomationsDryRunsGet200Response()
        if include_optional:
    ...
    def testAutomationsDryRunsGet200Response(self):
        """Test AutomationsDryRunsGet200Response"""
