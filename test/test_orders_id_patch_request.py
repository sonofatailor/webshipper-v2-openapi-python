...
class TestOrdersIdPatchRequest(unittest.TestCase):
    """OrdersIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdPatchRequest:
        """Test OrdersIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdPatchRequest`
        """
        model = OrdersIdPatchRequest()
        if include_optional:
            return OrdersIdPatchRequest(
    ...
    def testOrdersIdPatchRequest(self):
        """Test OrdersIdPatchRequest"""
