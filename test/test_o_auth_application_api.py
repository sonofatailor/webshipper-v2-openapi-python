...
class TestOAuthApplicationApi(unittest.TestCase):
    ...
    def test_oauth_applications_get(self) -> None:
        """Test case for oauth_applications_get

        List all OAuth Applications
        """
        pass

    def test_oauth_applications_id_get(self) -> None:
        """Test case for oauth_applications_id_get
