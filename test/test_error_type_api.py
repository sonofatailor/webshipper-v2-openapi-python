...
class TestErrorTypeApi(unittest.TestCase):
    """ErrorTypeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ErrorTypeApi()

    def tearDown(self) -> None:
        pass

    def test_error_types_get(self) -> None:
        """Test case for error_types_get

        List all Error Types
        """
        pass

    def test_error_types_id_delete(self) -> None:
        """Test case for error_types_id_delete

        Delete a Error Type
        """
        pass

    def test_error_types_id_get(self) -> None:
        """Test case for error_types_id_get

        Show a single Error Type
        """
        pass

    def test_error_types_id_patch(self) -> None:
        """Test case for error_types_id_patch

        Update a Error Type
        """
        pass

    def test_error_types_post(self) -> None:
        """Test case for error_types_post
