...
class TestReportsIdPatchRequest(unittest.TestCase):
    """ReportsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportsIdPatchRequest:
        """Test ReportsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportsIdPatchRequest`
        """
        model = ReportsIdPatchRequest()
        if include_optional:
            return ReportsIdPatchRequest(
    ...
    def testReportsIdPatchRequest(self):
        """Test ReportsIdPatchRequest"""
