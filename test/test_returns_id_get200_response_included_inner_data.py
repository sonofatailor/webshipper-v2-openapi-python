...
class TestReturnsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnsIdGet200ResponseIncludedInnerData:
        """Test ReturnsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsIdGet200ResponseIncludedInnerData`
        """
        model = ReturnsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return ReturnsIdGet200ResponseIncludedInnerData(
                order_channel_id = 56,
                status = 56,
                ext_ref = '',
                visible_ref = '',
    ...
    def testReturnsIdGet200ResponseIncludedInnerData(self):
        """Test ReturnsIdGet200ResponseIncludedInnerData"""
