...
class TestMailTemplatesIdGet200ResponseRelationshipsBrand(unittest.TestCase):
    """MailTemplatesIdGet200ResponseRelationshipsBrand unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatesIdGet200ResponseRelationshipsBrand:
        """Test MailTemplatesIdGet200ResponseRelationshipsBrand
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesIdGet200ResponseRelationshipsBrand`
        """
        model = MailTemplatesIdGet200ResponseRelationshipsBrand()
        if include_optional:
            return MailTemplatesIdGet200ResponseRelationshipsBrand(
    ...
    def testMailTemplatesIdGet200ResponseRelationshipsBrand(self):
        """Test MailTemplatesIdGet200ResponseRelationshipsBrand"""
