...
class TestAdditionalAttributesIdGet200ResponseRelationshipsOrderLine(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdGet200ResponseRelationshipsOrderLine:
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrderLine
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdGet200ResponseRelationshipsOrderLine`
        """
    ...
    def testAdditionalAttributesIdGet200ResponseRelationshipsOrderLine(self):
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrderLine"""
