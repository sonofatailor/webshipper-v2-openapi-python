...
class TestAutomationsPostRequestData(unittest.TestCase):
    """AutomationsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsPostRequestData:
        """Test AutomationsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsPostRequestData`
        """
        model = AutomationsPostRequestData()
        if include_optional:
            return AutomationsPostRequestData(
                type = 'automations',
    ...
    def testAutomationsPostRequestData(self):
        """Test AutomationsPostRequestData"""
