...
class TestShippingMappingsIdGet200ResponseData(unittest.TestCase):
    """ShippingMappingsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingMappingsIdGet200ResponseData:
        """Test ShippingMappingsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingMappingsIdGet200ResponseData`
        """
        model = ShippingMappingsIdGet200ResponseData()
        if include_optional:
            return ShippingMappingsIdGet200ResponseData(
                id = 56,
    ...
    def testShippingMappingsIdGet200ResponseData(self):
        """Test ShippingMappingsIdGet200ResponseData"""
