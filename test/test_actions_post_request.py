...
class TestActionsPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsPostRequest:
        """Test ActionsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsPostRequest`
        """
    ...
    def testActionsPostRequest(self):
        """Test ActionsPostRequest"""
