...
class TestOrderChannelsIdGet200ResponseRelationshipsSlipTemplateData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData:
        """Test OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData`
        """
        model = OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData()
        if include_optional:
            return OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData(
                id = '',
                type = 'slip_templates'
            )
        else:
    ...
    def testOrderChannelsIdGet200ResponseRelationshipsSlipTemplateData(self):
        """Test OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData"""
