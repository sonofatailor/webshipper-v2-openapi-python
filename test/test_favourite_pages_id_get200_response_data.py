...
class TestFavouritePagesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FavouritePagesIdGet200ResponseData:
        """Test FavouritePagesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesIdGet200ResponseData`
        """
        model = FavouritePagesIdGet200ResponseData()
        if include_optional:
    ...
    def testFavouritePagesIdGet200ResponseData(self):
        """Test FavouritePagesIdGet200ResponseData"""
