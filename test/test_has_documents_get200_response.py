...
class TestHasDocumentsGet200Response(unittest.TestCase):
    """HasDocumentsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HasDocumentsGet200Response:
        """Test HasDocumentsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasDocumentsGet200Response`
        """
        model = HasDocumentsGet200Response()
        if include_optional:
            return HasDocumentsGet200Response(
                data = [
                    openapi_client.models._has_documents_get_200_response_data_inner._has_documents_get_200_response_data_inner(
    ...
    def testHasDocumentsGet200Response(self):
        """Test HasDocumentsGet200Response"""
