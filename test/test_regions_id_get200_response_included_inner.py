...
class TestRegionsIdGet200ResponseIncludedInner(unittest.TestCase):
    """RegionsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegionsIdGet200ResponseIncludedInner:
        """Test RegionsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionsIdGet200ResponseIncludedInner`
        """
        model = RegionsIdGet200ResponseIncludedInner()
        if include_optional:
            return RegionsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testRegionsIdGet200ResponseIncludedInner(self):
        """Test RegionsIdGet200ResponseIncludedInner"""
