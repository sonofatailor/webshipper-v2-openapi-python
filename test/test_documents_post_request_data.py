...
class TestDocumentsPostRequestData(unittest.TestCase):
    """DocumentsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsPostRequestData:
        """Test DocumentsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsPostRequestData`
        """
        model = DocumentsPostRequestData()
        if include_optional:
            return DocumentsPostRequestData(
                type = 'documents',
    ...
    def testDocumentsPostRequestData(self):
        """Test DocumentsPostRequestData"""
