...
class TestShippingRatesIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """ShippingRatesIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingRatesIdGet200ResponseIncludedInnerData:
        """Test ShippingRatesIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingRatesIdGet200ResponseIncludedInnerData`
        """
        model = ShippingRatesIdGet200ResponseIncludedInnerData()
        if include_optional:
            return ShippingRatesIdGet200ResponseIncludedInnerData(
                alias = '',
                services = '',
                attrs = [
                    ''
    ...
    def testShippingRatesIdGet200ResponseIncludedInnerData(self):
        """Test ShippingRatesIdGet200ResponseIncludedInnerData"""
