...
class TestSlipTemplateApi(unittest.TestCase):
    """SlipTemplateApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SlipTemplateApi()

    def tearDown(self) -> None:
        pass

    def test_slip_templates_get(self) -> None:
        """Test case for slip_templates_get

        List all Slip Templates
        """
        pass

    def test_slip_templates_id_delete(self) -> None:
        """Test case for slip_templates_id_delete

        Delete a Slip Template
        """
        pass

    def test_slip_templates_id_get(self) -> None:
        """Test case for slip_templates_id_get

        Show a single Slip Template
        """
        pass

    def test_slip_templates_id_patch(self) -> None:
        """Test case for slip_templates_id_patch

        Update a Slip Template
        """
        pass

    def test_slip_templates_post(self) -> None:
        """Test case for slip_templates_post
