...
class TestSlipTemplatePreviewApi(unittest.TestCase):
    """SlipTemplatePreviewApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SlipTemplatePreviewApi()

    def tearDown(self) -> None:
        pass

    def test_slip_template_previews_get(self) -> None:
        """Test case for slip_template_previews_get

        List all Slip Template Previews
        """
        pass

    def test_slip_template_previews_id_delete(self) -> None:
        """Test case for slip_template_previews_id_delete

        Delete a Slip Template Preview
        """
        pass

    def test_slip_template_previews_id_get(self) -> None:
        """Test case for slip_template_previews_id_get

        Show a single Slip Template Preview
        """
        pass

    def test_slip_template_previews_id_patch(self) -> None:
        """Test case for slip_template_previews_id_patch

        Update a Slip Template Preview
        """
        pass

    def test_slip_template_previews_post(self) -> None:
        """Test case for slip_template_previews_post
