...
class TestTrackingEventsIdGet200ResponseRelationshipsPackage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackingEventsIdGet200ResponseRelationshipsPackage:
        """Test TrackingEventsIdGet200ResponseRelationshipsPackage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsIdGet200ResponseRelationshipsPackage`
        """
    ...
    def testTrackingEventsIdGet200ResponseRelationshipsPackage(self):
        """Test TrackingEventsIdGet200ResponseRelationshipsPackage"""
