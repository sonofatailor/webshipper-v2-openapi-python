...
class TestMailTemplatePreviewApi(unittest.TestCase):
    """MailTemplatePreviewApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MailTemplatePreviewApi()

    def tearDown(self) -> None:
        pass

    def test_mail_template_previews_get(self) -> None:
        """Test case for mail_template_previews_get

        List all Mail Template Previews
        """
        pass

    def test_mail_template_previews_id_delete(self) -> None:
        """Test case for mail_template_previews_id_delete

        Delete a Mail Template Preview
        """
        pass

    def test_mail_template_previews_id_get(self) -> None:
        """Test case for mail_template_previews_id_get

        Show a single Mail Template Preview
        """
        pass

    def test_mail_template_previews_id_patch(self) -> None:
        """Test case for mail_template_previews_id_patch

        Update a Mail Template Preview
        """
        pass

    def test_mail_template_previews_post(self) -> None:
        """Test case for mail_template_previews_post
