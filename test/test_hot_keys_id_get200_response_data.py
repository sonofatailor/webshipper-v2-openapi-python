...
class TestHotKeysIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HotKeysIdGet200ResponseData:
        """Test HotKeysIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysIdGet200ResponseData`
        """
        model = HotKeysIdGet200ResponseData()
        if include_optional:
    ...
    def testHotKeysIdGet200ResponseData(self):
        """Test HotKeysIdGet200ResponseData"""
