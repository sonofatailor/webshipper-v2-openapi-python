...
class TestOauthApplicationsGet200ResponseDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OauthApplicationsGet200ResponseDataInner:
        """Test OauthApplicationsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthApplicationsGet200ResponseDataInner`
        """
    ...
    def testOauthApplicationsGet200ResponseDataInner(self):
        """Test OauthApplicationsGet200ResponseDataInner"""
