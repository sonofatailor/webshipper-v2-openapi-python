...
class TestPrinterClientsIdGet200ResponseRelationshipsLabelPrinterData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData:
        """Test PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData`
        """
        model = PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData()
        if include_optional:
            return PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData(
                id = '',
                type = 'printers'
            )
        else:
    ...
    def testPrinterClientsIdGet200ResponseRelationshipsLabelPrinterData(self):
        """Test PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData"""
