...
class TestLocalAttrEnumsGet200Response(unittest.TestCase):
    """LocalAttrEnumsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsGet200Response:
        """Test LocalAttrEnumsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsGet200Response`
        """
        model = LocalAttrEnumsGet200Response()
        if include_optional:
            return LocalAttrEnumsGet200Response(
                data = [
                    openapi_client.models._local_attr_enums_get_200_response_data_inner._local_attr_enums_get_200_response_data_inner(
    ...
    def testLocalAttrEnumsGet200Response(self):
        """Test LocalAttrEnumsGet200Response"""
