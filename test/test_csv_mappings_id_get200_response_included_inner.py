...
class TestCsvMappingsIdGet200ResponseIncludedInner(unittest.TestCase):
    """CsvMappingsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvMappingsIdGet200ResponseIncludedInner:
        """Test CsvMappingsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvMappingsIdGet200ResponseIncludedInner`
        """
        model = CsvMappingsIdGet200ResponseIncludedInner()
        if include_optional:
            return CsvMappingsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testCsvMappingsIdGet200ResponseIncludedInner(self):
        """Test CsvMappingsIdGet200ResponseIncludedInner"""
