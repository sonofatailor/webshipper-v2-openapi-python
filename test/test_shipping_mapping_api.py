...
class TestShippingMappingApi(unittest.TestCase):
    """ShippingMappingApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ShippingMappingApi()

    def tearDown(self) -> None:
        pass

    def test_shipping_mappings_get(self) -> None:
        """Test case for shipping_mappings_get

        List all Shipping Mappings
        """
        pass

    def test_shipping_mappings_id_delete(self) -> None:
        """Test case for shipping_mappings_id_delete

        Delete a Shipping Mapping
        """
        pass

    def test_shipping_mappings_id_get(self) -> None:
        """Test case for shipping_mappings_id_get

        Show a single Shipping Mapping
        """
        pass

    def test_shipping_mappings_id_patch(self) -> None:
        """Test case for shipping_mappings_id_patch

        Update a Shipping Mapping
        """
        pass

    def test_shipping_mappings_post(self) -> None:
        """Test case for shipping_mappings_post
