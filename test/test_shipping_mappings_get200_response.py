...
class TestShippingMappingsGet200Response(unittest.TestCase):
    """ShippingMappingsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingMappingsGet200Response:
        """Test ShippingMappingsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingMappingsGet200Response`
        """
        model = ShippingMappingsGet200Response()
        if include_optional:
            return ShippingMappingsGet200Response(
                data = [
                    openapi_client.models._shipping_mappings_get_200_response_data_inner._shipping_mappings_get_200_response_data_inner(
    ...
    def testShippingMappingsGet200Response(self):
        """Test ShippingMappingsGet200Response"""
