...
class TestShipmentsIdGet200ResponseRelationshipsDocumentTemplateData(unittest.TestCase):
    """ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData:
        """Test ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData`
        """
        model = ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData()
        if include_optional:
            return ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData(
                id = '',
    ...
    def testShipmentsIdGet200ResponseRelationshipsDocumentTemplateData(self):
        """Test ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData"""
