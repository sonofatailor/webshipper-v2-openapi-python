...
class TestReportsIdGet200ResponseData(unittest.TestCase):
    """ReportsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportsIdGet200ResponseData:
        """Test ReportsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportsIdGet200ResponseData`
        """
        model = ReportsIdGet200ResponseData()
        if include_optional:
            return ReportsIdGet200ResponseData(
                id = 56,
                type = 'reports',
    ...
    def testReportsIdGet200ResponseData(self):
        """Test ReportsIdGet200ResponseData"""
