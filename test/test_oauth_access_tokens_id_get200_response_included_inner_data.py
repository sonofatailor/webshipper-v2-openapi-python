...
class TestOauthAccessTokensIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """OauthAccessTokensIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthAccessTokensIdGet200ResponseIncludedInnerData:
        """Test OauthAccessTokensIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthAccessTokensIdGet200ResponseIncludedInnerData`
        """
        model = OauthAccessTokensIdGet200ResponseIncludedInnerData()
        if include_optional:
            return OauthAccessTokensIdGet200ResponseIncludedInnerData(
                name = '',
                uid = '',
                scopes = '',
                redirect_uri = '',
    ...
    def testOauthAccessTokensIdGet200ResponseIncludedInnerData(self):
        """Test OauthAccessTokensIdGet200ResponseIncludedInnerData"""
