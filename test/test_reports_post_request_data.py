...
class TestReportsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReportsPostRequestData:
        """Test ReportsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportsPostRequestData`
        """
        model = ReportsPostRequestData()
        if include_optional:
    ...
    def testReportsPostRequestData(self):
        """Test ReportsPostRequestData"""
