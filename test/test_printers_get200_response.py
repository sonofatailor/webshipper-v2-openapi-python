...
class TestPrintersGet200Response(unittest.TestCase):
    """PrintersGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintersGet200Response:
        """Test PrintersGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintersGet200Response`
        """
        model = PrintersGet200Response()
        if include_optional:
            return PrintersGet200Response(
                data = [
                    openapi_client.models._printers_get_200_response_data_inner._printers_get_200_response_data_inner(
    ...
    def testPrintersGet200Response(self):
        """Test PrintersGet200Response"""
