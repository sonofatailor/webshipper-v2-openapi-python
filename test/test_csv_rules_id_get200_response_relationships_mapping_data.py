...
class TestCsvRulesIdGet200ResponseRelationshipsMappingData(unittest.TestCase):
    """CsvRulesIdGet200ResponseRelationshipsMappingData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvRulesIdGet200ResponseRelationshipsMappingData:
        """Test CsvRulesIdGet200ResponseRelationshipsMappingData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesIdGet200ResponseRelationshipsMappingData`
        """
        model = CsvRulesIdGet200ResponseRelationshipsMappingData()
        if include_optional:
            return CsvRulesIdGet200ResponseRelationshipsMappingData(
                id = '',
                type = 'csv_mappings'
            )
        else:
    ...
    def testCsvRulesIdGet200ResponseRelationshipsMappingData(self):
        """Test CsvRulesIdGet200ResponseRelationshipsMappingData"""
