...
class TestUserGroupApi(unittest.TestCase):
    ...
    def test_user_groups_get(self) -> None:
    ...
    def test_user_groups_id_delete(self) -> None:
        """Test case for user_groups_id_delete

        Delete a User Group
        """
        pass

    def test_user_groups_id_get(self) -> None:
        """Test case for user_groups_id_get

        Show a single User Group
        """
        pass

    def test_user_groups_id_patch(self) -> None:
        """Test case for user_groups_id_patch

        Update a User Group
        """
        pass

    def test_user_groups_post(self) -> None:
