...
class TestRequeueablePrinterJobsApi(unittest.TestCase):
    """RequeueablePrinterJobsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RequeueablePrinterJobsApi()

    def tearDown(self) -> None:
        pass

    def test_printer_requeue_jobs_get(self) -> None:
        """Test case for printer_requeue_jobs_get

        List all Requeueable Printer Jobss
        """
        pass

    def test_printer_requeue_jobs_id_delete(self) -> None:
        """Test case for printer_requeue_jobs_id_delete

        Delete a Requeueable Printer Jobs
        """
        pass

    def test_printer_requeue_jobs_id_get(self) -> None:
        """Test case for printer_requeue_jobs_id_get

        Show a single Requeueable Printer Jobs
        """
        pass

    def test_printer_requeue_jobs_id_patch(self) -> None:
        """Test case for printer_requeue_jobs_id_patch

        Update a Requeueable Printer Jobs
        """
        pass

    def test_printer_requeue_jobs_post(self) -> None:
        """Test case for printer_requeue_jobs_post
