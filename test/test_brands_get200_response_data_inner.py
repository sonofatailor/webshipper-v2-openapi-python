...
class TestBrandsGet200ResponseDataInner(unittest.TestCase):
    """BrandsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandsGet200ResponseDataInner:
        """Test BrandsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandsGet200ResponseDataInner`
        """
        model = BrandsGet200ResponseDataInner()
        if include_optional:
            return BrandsGet200ResponseDataInner(
    ...
    def testBrandsGet200ResponseDataInner(self):
        """Test BrandsGet200ResponseDataInner"""
