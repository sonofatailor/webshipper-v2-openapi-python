...
class TestCarriersGet200ResponseDataInner(unittest.TestCase):
    """CarriersGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersGet200ResponseDataInner:
        """Test CarriersGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersGet200ResponseDataInner`
        """
        model = CarriersGet200ResponseDataInner()
        if include_optional:
            return CarriersGet200ResponseDataInner(
    ...
    def testCarriersGet200ResponseDataInner(self):
        """Test CarriersGet200ResponseDataInner"""
