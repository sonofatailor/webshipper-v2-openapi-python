...
class TestBulkImportOrdersPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BulkImportOrdersPostRequest:
        """Test BulkImportOrdersPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkImportOrdersPostRequest`
        """
    ...
    def testBulkImportOrdersPostRequest(self):
        """Test BulkImportOrdersPostRequest"""
