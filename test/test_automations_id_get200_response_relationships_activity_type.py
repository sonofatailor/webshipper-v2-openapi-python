...
class TestAutomationsIdGet200ResponseRelationshipsActivityType(unittest.TestCase):
    """AutomationsIdGet200ResponseRelationshipsActivityType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsIdGet200ResponseRelationshipsActivityType:
        """Test AutomationsIdGet200ResponseRelationshipsActivityType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsIdGet200ResponseRelationshipsActivityType`
        """
        model = AutomationsIdGet200ResponseRelationshipsActivityType()
        if include_optional:
            return AutomationsIdGet200ResponseRelationshipsActivityType(
    ...
    def testAutomationsIdGet200ResponseRelationshipsActivityType(self):
        """Test AutomationsIdGet200ResponseRelationshipsActivityType"""
