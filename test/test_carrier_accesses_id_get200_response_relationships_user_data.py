...
class TestCarrierAccessesIdGet200ResponseRelationshipsUserData(unittest.TestCase):
    """CarrierAccessesIdGet200ResponseRelationshipsUserData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierAccessesIdGet200ResponseRelationshipsUserData:
        """Test CarrierAccessesIdGet200ResponseRelationshipsUserData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierAccessesIdGet200ResponseRelationshipsUserData`
        """
        model = CarrierAccessesIdGet200ResponseRelationshipsUserData()
        if include_optional:
            return CarrierAccessesIdGet200ResponseRelationshipsUserData(
                id = '',
                type = 'users'
            )
        else:
    ...
    def testCarrierAccessesIdGet200ResponseRelationshipsUserData(self):
        """Test CarrierAccessesIdGet200ResponseRelationshipsUserData"""
