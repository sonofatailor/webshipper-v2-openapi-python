...
class TestEdisGet200ResponseDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EdisGet200ResponseDataInner:
        """Test EdisGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdisGet200ResponseDataInner`
        """
    ...
    def testEdisGet200ResponseDataInner(self):
        """Test EdisGet200ResponseDataInner"""
