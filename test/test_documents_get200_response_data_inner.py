...
class TestDocumentsGet200ResponseDataInner(unittest.TestCase):
    """DocumentsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsGet200ResponseDataInner:
        """Test DocumentsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsGet200ResponseDataInner`
        """
        model = DocumentsGet200ResponseDataInner()
        if include_optional:
            return DocumentsGet200ResponseDataInner(
    ...
    def testDocumentsGet200ResponseDataInner(self):
        """Test DocumentsGet200ResponseDataInner"""
