...
class TestPrintersIdGet200ResponseRelationships(unittest.TestCase):
    """PrintersIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintersIdGet200ResponseRelationships:
        """Test PrintersIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintersIdGet200ResponseRelationships`
        """
        model = PrintersIdGet200ResponseRelationships()
        if include_optional:
            return PrintersIdGet200ResponseRelationships(
    ...
    def testPrintersIdGet200ResponseRelationships(self):
        """Test PrintersIdGet200ResponseRelationships"""
