...
class TestPrintersIdGet200ResponseIncludedInner(unittest.TestCase):
    """PrintersIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintersIdGet200ResponseIncludedInner:
        """Test PrintersIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintersIdGet200ResponseIncludedInner`
        """
        model = PrintersIdGet200ResponseIncludedInner()
        if include_optional:
            return PrintersIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testPrintersIdGet200ResponseIncludedInner(self):
        """Test PrintersIdGet200ResponseIncludedInner"""
