...
class TestAttachmentsGet200ResponseDataInner(unittest.TestCase):
    """AttachmentsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsGet200ResponseDataInner:
        """Test AttachmentsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsGet200ResponseDataInner`
        """
        model = AttachmentsGet200ResponseDataInner()
        if include_optional:
            return AttachmentsGet200ResponseDataInner(
    ...
    def testAttachmentsGet200ResponseDataInner(self):
        """Test AttachmentsGet200ResponseDataInner"""
