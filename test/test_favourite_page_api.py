...
class TestFavouritePageApi(unittest.TestCase):
    """FavouritePageApi unit test stubs"""

    def setUp(self) -> None:
        self.api = FavouritePageApi()

    def tearDown(self) -> None:
        pass

    def test_favourite_pages_get(self) -> None:
        """Test case for favourite_pages_get

        List all Favourite Pages
        """
        pass

    def test_favourite_pages_id_delete(self) -> None:
        """Test case for favourite_pages_id_delete

        Delete a Favourite Page
        """
        pass

    def test_favourite_pages_id_get(self) -> None:
        """Test case for favourite_pages_id_get

        Show a single Favourite Page
        """
        pass

    def test_favourite_pages_id_patch(self) -> None:
        """Test case for favourite_pages_id_patch

        Update a Favourite Page
        """
        pass

    def test_favourite_pages_post(self) -> None:
        """Test case for favourite_pages_post
