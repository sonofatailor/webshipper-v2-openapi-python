...
class TestCsvRulesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvRulesIdGet200ResponseData:
        """Test CsvRulesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesIdGet200ResponseData`
        """
        model = CsvRulesIdGet200ResponseData()
        if include_optional:
    ...
    def testCsvRulesIdGet200ResponseData(self):
        """Test CsvRulesIdGet200ResponseData"""
