...
class TestMailTemplatesIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """MailTemplatesIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatesIdGet200ResponseIncludedInnerData:
        """Test MailTemplatesIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesIdGet200ResponseIncludedInnerData`
        """
        model = MailTemplatesIdGet200ResponseIncludedInnerData()
        if include_optional:
            return MailTemplatesIdGet200ResponseIncludedInnerData(
                documents = ''
            )
        else:
            return MailTemplatesIdGet200ResponseIncludedInnerData(
    ...
    def testMailTemplatesIdGet200ResponseIncludedInnerData(self):
        """Test MailTemplatesIdGet200ResponseIncludedInnerData"""
