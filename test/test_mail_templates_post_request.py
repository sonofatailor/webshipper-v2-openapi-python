...
class TestMailTemplatesPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MailTemplatesPostRequest:
        """Test MailTemplatesPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesPostRequest`
        """
    ...
    def testMailTemplatesPostRequest(self):
        """Test MailTemplatesPostRequest"""
