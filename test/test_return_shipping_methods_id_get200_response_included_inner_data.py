...
class TestReturnShippingMethodsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """ReturnShippingMethodsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsIdGet200ResponseIncludedInnerData:
        """Test ReturnShippingMethodsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsIdGet200ResponseIncludedInnerData`
        """
        model = ReturnShippingMethodsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return ReturnShippingMethodsIdGet200ResponseIncludedInnerData(
                name = '',
                custom_style = '',
                shipping_methods = '',
                translations = '',
    ...
    def testReturnShippingMethodsIdGet200ResponseIncludedInnerData(self):
        """Test ReturnShippingMethodsIdGet200ResponseIncludedInnerData"""
