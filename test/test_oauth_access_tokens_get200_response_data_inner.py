...
class TestOauthAccessTokensGet200ResponseDataInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OauthAccessTokensGet200ResponseDataInner:
        """Test OauthAccessTokensGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthAccessTokensGet200ResponseDataInner`
        """
    ...
    def testOauthAccessTokensGet200ResponseDataInner(self):
        """Test OauthAccessTokensGet200ResponseDataInner"""
