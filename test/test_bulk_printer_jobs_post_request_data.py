...
class TestBulkPrinterJobsPostRequestData(unittest.TestCase):
    """BulkPrinterJobsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkPrinterJobsPostRequestData:
        """Test BulkPrinterJobsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPrinterJobsPostRequestData`
        """
        model = BulkPrinterJobsPostRequestData()
        if include_optional:
            return BulkPrinterJobsPostRequestData(
    ...
    def testBulkPrinterJobsPostRequestData(self):
        """Test BulkPrinterJobsPostRequestData"""
