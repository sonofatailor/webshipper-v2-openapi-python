...
class TestAutomationApi(unittest.TestCase):
    ...
    def test_automations_id_delete(self) -> None:
        """Test case for automations_id_delete

        Delete a Automation
        """
        pass

    def test_automations_id_get(self) -> None:
        """Test case for automations_id_get

        Show a single Automation
        """
        pass

    def test_automations_id_patch(self) -> None:
        """Test case for automations_id_patch

        Update a Automation
        """
        pass

    def test_automations_post(self) -> None:
        """Test case for automations_post
