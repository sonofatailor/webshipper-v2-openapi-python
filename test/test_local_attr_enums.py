...
class TestLocalAttrEnums(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalAttrEnums:
        """Test LocalAttrEnums
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnums`
        """
        model = LocalAttrEnums()
        if include_optional:
            return LocalAttrEnums(
                enum_name = '',
                enum_value = ''
            )
        else:
