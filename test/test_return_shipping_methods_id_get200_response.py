...
class TestReturnShippingMethodsIdGet200Response(unittest.TestCase):
    """ReturnShippingMethodsIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsIdGet200Response:
        """Test ReturnShippingMethodsIdGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsIdGet200Response`
        """
        model = ReturnShippingMethodsIdGet200Response()
        if include_optional:
            return ReturnShippingMethodsIdGet200Response(
                data = openapi_client.models._return_shipping_methods__id__get_200_response_data._return_shipping_methods__id__get_200_response_data(
                    id = 56, 
                ...
                included = [
                    openapi_client.models._return_shipping_methods__id__get_200_response_included_inner._return_shipping_methods__id__get_200_response_included_inner(
                        type = 'orders', 
                        id = 56, 
                        data = null, )
                    ]
    ...
    def testReturnShippingMethodsIdGet200Response(self):
        """Test ReturnShippingMethodsIdGet200Response"""
