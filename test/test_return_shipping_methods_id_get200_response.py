    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsIdGet200Response:
        ...
        if include_optional:
            return ReturnShippingMethodsIdGet200Response(
                data = webshipperv2.models._return_shipping_methods__id__get_200_response_data._return_shipping_methods__id__get_200_response_data(
                    id = 56, 
                ...
                included = [
                    webshipperv2.models._return_shipping_methods__id__get_200_response_included_inner._return_shipping_methods__id__get_200_response_included_inner(
                        type = 'orders', 
                        id = 56, 
                        data = null, )
                    ]
