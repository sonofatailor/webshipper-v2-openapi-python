...
class TestStoresIdGet200ResponseData(unittest.TestCase):
    """StoresIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoresIdGet200ResponseData:
        """Test StoresIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresIdGet200ResponseData`
        """
        model = StoresIdGet200ResponseData()
        if include_optional:
            return StoresIdGet200ResponseData(
                id = 56,
                type = 'stores',
    ...
    def testStoresIdGet200ResponseData(self):
        """Test StoresIdGet200ResponseData"""
