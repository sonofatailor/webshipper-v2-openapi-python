...
class TestMailTemplatesIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MailTemplatesIdGet200ResponseRelationships:
        """Test MailTemplatesIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesIdGet200ResponseRelationships`
        """
    ...
    def testMailTemplatesIdGet200ResponseRelationships(self):
        """Test MailTemplatesIdGet200ResponseRelationships"""
