...
class TestCsvRulesIdGet200ResponseRelationshipsMapping(unittest.TestCase):
    """CsvRulesIdGet200ResponseRelationshipsMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvRulesIdGet200ResponseRelationshipsMapping:
        """Test CsvRulesIdGet200ResponseRelationshipsMapping
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesIdGet200ResponseRelationshipsMapping`
        """
        model = CsvRulesIdGet200ResponseRelationshipsMapping()
        if include_optional:
            return CsvRulesIdGet200ResponseRelationshipsMapping(
    ...
    def testCsvRulesIdGet200ResponseRelationshipsMapping(self):
        """Test CsvRulesIdGet200ResponseRelationshipsMapping"""
