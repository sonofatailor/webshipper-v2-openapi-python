...
class TestPackageApi(unittest.TestCase):
    ...
    def test_packages_get(self) -> None:
        """Test case for packages_get

        List all Packages
        """
        pass

    def test_packages_id_get(self) -> None:
        """Test case for packages_id_get

        Show a single Package
        """
        pass

    def test_packages_post(self) -> None:
