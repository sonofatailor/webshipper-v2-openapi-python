...
class TestCsvMappingsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvMappingsPostRequestData:
        """Test CsvMappingsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvMappingsPostRequestData`
        """
        model = CsvMappingsPostRequestData()
        if include_optional:
    ...
    def testCsvMappingsPostRequestData(self):
        """Test CsvMappingsPostRequestData"""
