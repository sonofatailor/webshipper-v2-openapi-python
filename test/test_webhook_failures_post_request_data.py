...
class TestWebhookFailuresPostRequestData(unittest.TestCase):
    """WebhookFailuresPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresPostRequestData:
        """Test WebhookFailuresPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresPostRequestData`
        """
        model = WebhookFailuresPostRequestData()
        if include_optional:
            return WebhookFailuresPostRequestData(
    ...
    def testWebhookFailuresPostRequestData(self):
        """Test WebhookFailuresPostRequestData"""
