...
class TestServiceQuotesPostRequestData(unittest.TestCase):
    """ServiceQuotesPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceQuotesPostRequestData:
        """Test ServiceQuotesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceQuotesPostRequestData`
        """
        model = ServiceQuotesPostRequestData()
        if include_optional:
            return ServiceQuotesPostRequestData(
                type = 'service_quotes',
    ...
    def testServiceQuotesPostRequestData(self):
        """Test ServiceQuotesPostRequestData"""
