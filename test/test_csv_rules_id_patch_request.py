...
class TestCsvRulesIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvRulesIdPatchRequest:
        """Test CsvRulesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesIdPatchRequest`
        """
    ...
    def testCsvRulesIdPatchRequest(self):
        """Test CsvRulesIdPatchRequest"""
