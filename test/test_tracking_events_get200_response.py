...
class TestTrackingEventsGet200Response(unittest.TestCase):
    """TrackingEventsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackingEventsGet200Response:
        """Test TrackingEventsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsGet200Response`
        """
        model = TrackingEventsGet200Response()
        if include_optional:
            return TrackingEventsGet200Response(
                data = [
                    openapi_client.models._tracking_events_get_200_response_data_inner._tracking_events_get_200_response_data_inner(
    ...
    def testTrackingEventsGet200Response(self):
        """Test TrackingEventsGet200Response"""
