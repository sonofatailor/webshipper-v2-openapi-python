...
class TestHotKeyApi(unittest.TestCase):
    ...
    def test_hot_keys_get(self) -> None:
        """Test case for hot_keys_get

        List all HotKeys
        """
        pass

    def test_hot_keys_id_delete(self) -> None:
        """Test case for hot_keys_id_delete

        Delete a HotKey
        """
        pass

    def test_hot_keys_id_get(self) -> None:
        """Test case for hot_keys_id_get

        Show a single HotKey
        """
        pass

    def test_hot_keys_id_patch(self) -> None:
        """Test case for hot_keys_id_patch

        Update a HotKey
        """
        pass

    def test_hot_keys_post(self) -> None:
        """Test case for hot_keys_post
