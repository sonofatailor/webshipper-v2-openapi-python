...
class TestEdisIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EdisIdGet200ResponseData:
        """Test EdisIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdisIdGet200ResponseData`
        """
        model = EdisIdGet200ResponseData()
        if include_optional:
    ...
    def testEdisIdGet200ResponseData(self):
        """Test EdisIdGet200ResponseData"""
