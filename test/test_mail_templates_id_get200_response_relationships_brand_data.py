...
class TestMailTemplatesIdGet200ResponseRelationshipsBrandData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MailTemplatesIdGet200ResponseRelationshipsBrandData:
        """Test MailTemplatesIdGet200ResponseRelationshipsBrandData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesIdGet200ResponseRelationshipsBrandData`
        """
        model = MailTemplatesIdGet200ResponseRelationshipsBrandData()
        if include_optional:
            return MailTemplatesIdGet200ResponseRelationshipsBrandData(
                id = '',
                type = 'brands'
            )
        else:
    ...
    def testMailTemplatesIdGet200ResponseRelationshipsBrandData(self):
        """Test MailTemplatesIdGet200ResponseRelationshipsBrandData"""
