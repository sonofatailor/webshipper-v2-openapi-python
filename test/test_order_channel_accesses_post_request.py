...
class TestOrderChannelAccessesPostRequest(unittest.TestCase):
    """OrderChannelAccessesPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesPostRequest:
        """Test OrderChannelAccessesPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesPostRequest`
        """
        model = OrderChannelAccessesPostRequest()
        if include_optional:
            return OrderChannelAccessesPostRequest(
                data = openapi_client.models._order_channel_accesses_post_request_data._order_channel_accesses_post_request_data(
    ...
    def testOrderChannelAccessesPostRequest(self):
        """Test OrderChannelAccessesPostRequest"""
