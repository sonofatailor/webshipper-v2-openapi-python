...
class TestUsersIdGet200ResponseRelationshipsUserGroupData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsersIdGet200ResponseRelationshipsUserGroupData:
        """Test UsersIdGet200ResponseRelationshipsUserGroupData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersIdGet200ResponseRelationshipsUserGroupData`
        """
        model = UsersIdGet200ResponseRelationshipsUserGroupData()
        if include_optional:
            return UsersIdGet200ResponseRelationshipsUserGroupData(
                id = '',
                type = 'user_groups'
            )
        else:
    ...
    def testUsersIdGet200ResponseRelationshipsUserGroupData(self):
        """Test UsersIdGet200ResponseRelationshipsUserGroupData"""
