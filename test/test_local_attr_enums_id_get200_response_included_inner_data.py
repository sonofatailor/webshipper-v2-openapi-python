...
class TestLocalAttrEnumsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """LocalAttrEnumsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsIdGet200ResponseIncludedInnerData:
        """Test LocalAttrEnumsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsIdGet200ResponseIncludedInnerData`
        """
        model = LocalAttrEnumsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return LocalAttrEnumsIdGet200ResponseIncludedInnerData(
                attr_name = '',
                attr_key = '',
                attr_type = '',
                is_required = True,
    ...
    def testLocalAttrEnumsIdGet200ResponseIncludedInnerData(self):
        """Test LocalAttrEnumsIdGet200ResponseIncludedInnerData"""
