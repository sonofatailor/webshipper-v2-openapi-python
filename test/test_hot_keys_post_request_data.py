...
class TestHotKeysPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HotKeysPostRequestData:
        """Test HotKeysPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysPostRequestData`
        """
        model = HotKeysPostRequestData()
        if include_optional:
    ...
    def testHotKeysPostRequestData(self):
        """Test HotKeysPostRequestData"""
