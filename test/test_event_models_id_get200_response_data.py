...
class TestEventModelsIdGet200ResponseData(unittest.TestCase):
    """EventModelsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventModelsIdGet200ResponseData:
        """Test EventModelsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventModelsIdGet200ResponseData`
        """
        model = EventModelsIdGet200ResponseData()
        if include_optional:
            return EventModelsIdGet200ResponseData(
                id = 56,
                type = 'event_models',
                attributes = None
            )
    ...
    def testEventModelsIdGet200ResponseData(self):
        """Test EventModelsIdGet200ResponseData"""
