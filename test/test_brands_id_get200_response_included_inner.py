...
class TestBrandsIdGet200ResponseIncludedInner(unittest.TestCase):
    """BrandsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrandsIdGet200ResponseIncludedInner:
        """Test BrandsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrandsIdGet200ResponseIncludedInner`
        """
        model = BrandsIdGet200ResponseIncludedInner()
        if include_optional:
            return BrandsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testBrandsIdGet200ResponseIncludedInner(self):
        """Test BrandsIdGet200ResponseIncludedInner"""
