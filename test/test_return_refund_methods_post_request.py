...
class TestReturnRefundMethodsPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsPostRequest:
        """Test ReturnRefundMethodsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsPostRequest`
        """
    ...
    def testReturnRefundMethodsPostRequest(self):
        """Test ReturnRefundMethodsPostRequest"""
