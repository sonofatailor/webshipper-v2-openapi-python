...
class TestPrinterClientApi(unittest.TestCase):
    """PrinterClientApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PrinterClientApi()

    def tearDown(self) -> None:
        pass

    def test_printer_clients_get(self) -> None:
        """Test case for printer_clients_get

        List all Printer Clients
        """
        pass

    def test_printer_clients_id_get(self) -> None:
        """Test case for printer_clients_id_get

        Show a single Printer Client
        """
        pass

    def test_printer_clients_id_patch(self) -> None:
        """Test case for printer_clients_id_patch
