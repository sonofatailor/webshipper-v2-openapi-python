...
class TestReturnRefundMethods(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethods:
        """Test ReturnRefundMethods
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethods`
        """
        model = ReturnRefundMethods()
        if include_optional:
            return ReturnRefundMethods(
                name = '',
                description = '',
                allowed_days = 56
            )
    ...
    def testReturnRefundMethods(self):
        """Test ReturnRefundMethods"""
