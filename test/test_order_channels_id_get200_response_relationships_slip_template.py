...
class TestOrderChannelsIdGet200ResponseRelationshipsSlipTemplate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderChannelsIdGet200ResponseRelationshipsSlipTemplate:
        """Test OrderChannelsIdGet200ResponseRelationshipsSlipTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelsIdGet200ResponseRelationshipsSlipTemplate`
        """
    ...
    def testOrderChannelsIdGet200ResponseRelationshipsSlipTemplate(self):
        """Test OrderChannelsIdGet200ResponseRelationshipsSlipTemplate"""
