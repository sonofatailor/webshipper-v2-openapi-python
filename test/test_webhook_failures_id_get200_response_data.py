...
class TestWebhookFailuresIdGet200ResponseData(unittest.TestCase):
    """WebhookFailuresIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresIdGet200ResponseData:
        """Test WebhookFailuresIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresIdGet200ResponseData`
        """
        model = WebhookFailuresIdGet200ResponseData()
        if include_optional:
            return WebhookFailuresIdGet200ResponseData(
                id = 56,
    ...
    def testWebhookFailuresIdGet200ResponseData(self):
        """Test WebhookFailuresIdGet200ResponseData"""
