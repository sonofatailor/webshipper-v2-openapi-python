...
class TestReturnRefundMethodsIdGet200ResponseRelationshipsPortalData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData:
        """Test ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData`
        """
        model = ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData()
        if include_optional:
            return ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData(
                id = '',
                type = 'return_portals'
            )
        else:
    ...
    def testReturnRefundMethodsIdGet200ResponseRelationshipsPortalData(self):
        """Test ReturnRefundMethodsIdGet200ResponseRelationshipsPortalData"""
