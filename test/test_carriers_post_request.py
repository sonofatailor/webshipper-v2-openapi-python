...
class TestCarriersPostRequest(unittest.TestCase):
    """CarriersPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersPostRequest:
        """Test CarriersPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersPostRequest`
        """
        model = CarriersPostRequest()
        if include_optional:
            return CarriersPostRequest(
                data = openapi_client.models._carriers_post_request_data._carriers_post_request_data(
                    type = 'carriers', 
    ...
    def testCarriersPostRequest(self):
        """Test CarriersPostRequest"""
