...
class TestHasDocumentsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HasDocumentsIdGet200ResponseData:
        """Test HasDocumentsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasDocumentsIdGet200ResponseData`
        """
        model = HasDocumentsIdGet200ResponseData()
        if include_optional:
            return HasDocumentsIdGet200ResponseData(
                id = 56,
                type = 'has_documents',
                attributes = None
            )
    ...
    def testHasDocumentsIdGet200ResponseData(self):
        """Test HasDocumentsIdGet200ResponseData"""
