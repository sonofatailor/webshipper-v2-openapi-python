...
class TestExpressionsIdGet200ResponseData(unittest.TestCase):
    """ExpressionsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpressionsIdGet200ResponseData:
        """Test ExpressionsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpressionsIdGet200ResponseData`
        """
        model = ExpressionsIdGet200ResponseData()
        if include_optional:
            return ExpressionsIdGet200ResponseData(
                id = 56,
                type = 'expressions',
    ...
    def testExpressionsIdGet200ResponseData(self):
        """Test ExpressionsIdGet200ResponseData"""
