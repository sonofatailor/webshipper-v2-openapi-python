...
class TestRateQuotesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RateQuotesPostRequestData:
        """Test RateQuotesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateQuotesPostRequestData`
        """
        model = RateQuotesPostRequestData()
        if include_optional:
    ...
    def testRateQuotesPostRequestData(self):
        """Test RateQuotesPostRequestData"""
