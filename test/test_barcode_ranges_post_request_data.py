...
class TestBarcodeRangesPostRequestData(unittest.TestCase):
    """BarcodeRangesPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BarcodeRangesPostRequestData:
        """Test BarcodeRangesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesPostRequestData`
        """
        model = BarcodeRangesPostRequestData()
        if include_optional:
            return BarcodeRangesPostRequestData(
                type = 'barcode_ranges',
    ...
    def testBarcodeRangesPostRequestData(self):
        """Test BarcodeRangesPostRequestData"""
