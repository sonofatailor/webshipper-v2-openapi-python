...
class TestUsersIdGet200ResponseRelationshipsUserGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsersIdGet200ResponseRelationshipsUserGroup:
        """Test UsersIdGet200ResponseRelationshipsUserGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersIdGet200ResponseRelationshipsUserGroup`
        """
    ...
    def testUsersIdGet200ResponseRelationshipsUserGroup(self):
        """Test UsersIdGet200ResponseRelationshipsUserGroup"""
