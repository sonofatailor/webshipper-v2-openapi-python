...
class TestHotKeysGet200Response(unittest.TestCase):
    """HotKeysGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotKeysGet200Response:
        """Test HotKeysGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysGet200Response`
        """
        model = HotKeysGet200Response()
        if include_optional:
            return HotKeysGet200Response(
                data = [
                    openapi_client.models._hot_keys_get_200_response_data_inner._hot_keys_get_200_response_data_inner(
    ...
    def testHotKeysGet200Response(self):
        """Test HotKeysGet200Response"""
