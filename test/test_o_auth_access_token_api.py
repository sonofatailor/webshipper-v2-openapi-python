...
class TestOAuthAccessTokenApi(unittest.TestCase):
    """OAuthAccessTokenApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OAuthAccessTokenApi()

    def tearDown(self) -> None:
        pass

    def test_oauth_access_tokens_get(self) -> None:
        """Test case for oauth_access_tokens_get

        List all OAuth Access Tokens
        """
        pass

    def test_oauth_access_tokens_id_get(self) -> None:
        """Test case for oauth_access_tokens_id_get
