...
class TestShippingMappings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingMappings:
        """Test ShippingMappings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingMappings`
        """
        model = ShippingMappings()
        if include_optional:
            return ShippingMappings(
                shipping_code = '',
                shipping_name = '',
                shipping_rate_id = 56,
                order_channel_id = 56,
