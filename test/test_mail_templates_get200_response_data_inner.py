...
class TestMailTemplatesGet200ResponseDataInner(unittest.TestCase):
    """MailTemplatesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatesGet200ResponseDataInner:
        """Test MailTemplatesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesGet200ResponseDataInner`
        """
        model = MailTemplatesGet200ResponseDataInner()
        if include_optional:
            return MailTemplatesGet200ResponseDataInner(
    ...
    def testMailTemplatesGet200ResponseDataInner(self):
        """Test MailTemplatesGet200ResponseDataInner"""
