...
class TestCarrierTypeApi(unittest.TestCase):
    """CarrierTypeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CarrierTypeApi()

    def tearDown(self) -> None:
        pass

    def test_carrier_types_get(self) -> None:
        """Test case for carrier_types_get

        List all Carrier Types
        """
        pass

    def test_carrier_types_id_get(self) -> None:
        """Test case for carrier_types_id_get
