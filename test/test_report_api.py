...
class TestReportApi(unittest.TestCase):
    ...
    def test_reports_id_delete(self) -> None:
        """Test case for reports_id_delete

        Delete a Report
        """
        pass

    def test_reports_id_get(self) -> None:
        """Test case for reports_id_get

        Show a single Report
        """
        pass

    def test_reports_id_patch(self) -> None:
        """Test case for reports_id_patch
