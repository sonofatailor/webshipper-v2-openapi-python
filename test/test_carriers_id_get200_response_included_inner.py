...
class TestCarriersIdGet200ResponseIncludedInner(unittest.TestCase):
    """CarriersIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersIdGet200ResponseIncludedInner:
        """Test CarriersIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersIdGet200ResponseIncludedInner`
        """
        model = CarriersIdGet200ResponseIncludedInner()
        if include_optional:
            return CarriersIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testCarriersIdGet200ResponseIncludedInner(self):
        """Test CarriersIdGet200ResponseIncludedInner"""
