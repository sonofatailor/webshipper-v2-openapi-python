...
class TestLocalAttrsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalAttrsIdGet200ResponseData:
        """Test LocalAttrsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsIdGet200ResponseData`
        """
        model = LocalAttrsIdGet200ResponseData()
        if include_optional:
    ...
    def testLocalAttrsIdGet200ResponseData(self):
        """Test LocalAttrsIdGet200ResponseData"""
