...
class TestMailTemplatesPostRequestData(unittest.TestCase):
    """MailTemplatesPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatesPostRequestData:
        """Test MailTemplatesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesPostRequestData`
        """
        model = MailTemplatesPostRequestData()
        if include_optional:
            return MailTemplatesPostRequestData(
                type = 'mail_templates',
    ...
    def testMailTemplatesPostRequestData(self):
        """Test MailTemplatesPostRequestData"""
