...
class TestOrdersIdGet200ResponseRelationshipsErrorTypeData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseRelationshipsErrorTypeData:
        """Test OrdersIdGet200ResponseRelationshipsErrorTypeData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseRelationshipsErrorTypeData`
        """
        model = OrdersIdGet200ResponseRelationshipsErrorTypeData()
        if include_optional:
            return OrdersIdGet200ResponseRelationshipsErrorTypeData(
                id = '',
                type = 'error_types'
            )
        else:
    ...
    def testOrdersIdGet200ResponseRelationshipsErrorTypeData(self):
        """Test OrdersIdGet200ResponseRelationshipsErrorTypeData"""
