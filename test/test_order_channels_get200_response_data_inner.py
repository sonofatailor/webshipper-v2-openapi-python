...
class TestOrderChannelsGet200ResponseDataInner(unittest.TestCase):
    """OrderChannelsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelsGet200ResponseDataInner:
        """Test OrderChannelsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelsGet200ResponseDataInner`
        """
        model = OrderChannelsGet200ResponseDataInner()
        if include_optional:
            return OrderChannelsGet200ResponseDataInner(
    ...
    def testOrderChannelsGet200ResponseDataInner(self):
        """Test OrderChannelsGet200ResponseDataInner"""
