...
class TestBarcodeRangesIdGet200ResponseRelationshipsCarrierData(unittest.TestCase):
    """BarcodeRangesIdGet200ResponseRelationshipsCarrierData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BarcodeRangesIdGet200ResponseRelationshipsCarrierData:
        """Test BarcodeRangesIdGet200ResponseRelationshipsCarrierData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesIdGet200ResponseRelationshipsCarrierData`
        """
        model = BarcodeRangesIdGet200ResponseRelationshipsCarrierData()
        if include_optional:
            return BarcodeRangesIdGet200ResponseRelationshipsCarrierData(
                id = '',
                type = 'carriers'
            )
        else:
    ...
    def testBarcodeRangesIdGet200ResponseRelationshipsCarrierData(self):
        """Test BarcodeRangesIdGet200ResponseRelationshipsCarrierData"""
