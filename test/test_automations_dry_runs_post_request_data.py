...
class TestAutomationsDryRunsPostRequestData(unittest.TestCase):
    """AutomationsDryRunsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsDryRunsPostRequestData:
        """Test AutomationsDryRunsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsDryRunsPostRequestData`
        """
        model = AutomationsDryRunsPostRequestData()
        if include_optional:
            return AutomationsDryRunsPostRequestData(
    ...
    def testAutomationsDryRunsPostRequestData(self):
        """Test AutomationsDryRunsPostRequestData"""
