...
class TestRegionsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RegionsIdGet200ResponseData:
        """Test RegionsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionsIdGet200ResponseData`
        """
        model = RegionsIdGet200ResponseData()
        if include_optional:
    ...
    def testRegionsIdGet200ResponseData(self):
        """Test RegionsIdGet200ResponseData"""
