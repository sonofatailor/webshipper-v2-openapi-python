...
class TestPickupsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PickupsPostRequestData:
        """Test PickupsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsPostRequestData`
        """
        model = PickupsPostRequestData()
        if include_optional:
    ...
    def testPickupsPostRequestData(self):
        """Test PickupsPostRequestData"""
