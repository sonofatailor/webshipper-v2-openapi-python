...
class TestPrinterClientsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterClientsIdGet200ResponseIncludedInnerData:
        """Test PrinterClientsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsIdGet200ResponseIncludedInnerData`
        """
        model = PrinterClientsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return PrinterClientsIdGet200ResponseIncludedInnerData(
                name = '',
                active = True,
                last_connected = '',
                paper_width = 1.337,
    ...
    def testPrinterClientsIdGet200ResponseIncludedInnerData(self):
        """Test PrinterClientsIdGet200ResponseIncludedInnerData"""
