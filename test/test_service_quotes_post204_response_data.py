...
class TestServiceQuotesPost204ResponseData(unittest.TestCase):
    """ServiceQuotesPost204ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceQuotesPost204ResponseData:
        """Test ServiceQuotesPost204ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceQuotesPost204ResponseData`
        """
        model = ServiceQuotesPost204ResponseData()
        if include_optional:
            return ServiceQuotesPost204ResponseData(
                id = 56,
                type = 'service_quotes',
    ...
    def testServiceQuotesPost204ResponseData(self):
        """Test ServiceQuotesPost204ResponseData"""
