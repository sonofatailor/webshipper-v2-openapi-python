...
class TestMailTemplatesApi(unittest.TestCase):
    ...
    def test_mail_templates_get(self) -> None:
        """Test case for mail_templates_get

        List all Mail Templatess
        """
        pass

    def test_mail_templates_id_delete(self) -> None:
        """Test case for mail_templates_id_delete

        Delete a Mail Templates
        """
        pass

    def test_mail_templates_id_get(self) -> None:
        """Test case for mail_templates_id_get

        Show a single Mail Templates
        """
        pass

    def test_mail_templates_id_patch(self) -> None:
        """Test case for mail_templates_id_patch

        Update a Mail Templates
        """
        pass

    def test_mail_templates_post(self) -> None:
        """Test case for mail_templates_post
