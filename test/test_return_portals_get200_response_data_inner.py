...
class TestReturnPortalsGet200ResponseDataInner(unittest.TestCase):
    """ReturnPortalsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnPortalsGet200ResponseDataInner:
        """Test ReturnPortalsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsGet200ResponseDataInner`
        """
        model = ReturnPortalsGet200ResponseDataInner()
        if include_optional:
            return ReturnPortalsGet200ResponseDataInner(
    ...
    def testReturnPortalsGet200ResponseDataInner(self):
        """Test ReturnPortalsGet200ResponseDataInner"""
