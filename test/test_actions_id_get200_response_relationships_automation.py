...
class TestActionsIdGet200ResponseRelationshipsAutomation(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsIdGet200ResponseRelationshipsAutomation:
        """Test ActionsIdGet200ResponseRelationshipsAutomation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsIdGet200ResponseRelationshipsAutomation`
        """
    ...
    def testActionsIdGet200ResponseRelationshipsAutomation(self):
        """Test ActionsIdGet200ResponseRelationshipsAutomation"""
