...
class TestMailTemplatePreviewsGet200Response(unittest.TestCase):
    """MailTemplatePreviewsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatePreviewsGet200Response:
        """Test MailTemplatePreviewsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatePreviewsGet200Response`
        """
        model = MailTemplatePreviewsGet200Response()
        if include_optional:
            return MailTemplatePreviewsGet200Response(
                data = [
                    openapi_client.models._mail_template_previews_get_200_response_data_inner._mail_template_previews_get_200_response_data_inner(
    ...
    def testMailTemplatePreviewsGet200Response(self):
        """Test MailTemplatePreviewsGet200Response"""
