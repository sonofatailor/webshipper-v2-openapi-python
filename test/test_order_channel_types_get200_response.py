...
class TestOrderChannelTypesGet200Response(unittest.TestCase):
    """OrderChannelTypesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelTypesGet200Response:
        """Test OrderChannelTypesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelTypesGet200Response`
        """
        model = OrderChannelTypesGet200Response()
        if include_optional:
            return OrderChannelTypesGet200Response(
                data = [
                    openapi_client.models._order_channel_types_get_200_response_data_inner._order_channel_types_get_200_response_data_inner(
    ...
    def testOrderChannelTypesGet200Response(self):
        """Test OrderChannelTypesGet200Response"""
