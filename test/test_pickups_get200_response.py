...
class TestPickupsGet200Response(unittest.TestCase):
    """PickupsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PickupsGet200Response:
        """Test PickupsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsGet200Response`
        """
        model = PickupsGet200Response()
        if include_optional:
            return PickupsGet200Response(
                data = [
                    openapi_client.models._pickups_get_200_response_data_inner._pickups_get_200_response_data_inner(
    ...
    def testPickupsGet200Response(self):
        """Test PickupsGet200Response"""
