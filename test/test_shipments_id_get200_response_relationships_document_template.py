...
class TestShipmentsIdGet200ResponseRelationshipsDocumentTemplate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShipmentsIdGet200ResponseRelationshipsDocumentTemplate:
        """Test ShipmentsIdGet200ResponseRelationshipsDocumentTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsIdGet200ResponseRelationshipsDocumentTemplate`
        """
    ...
    def testShipmentsIdGet200ResponseRelationshipsDocumentTemplate(self):
        """Test ShipmentsIdGet200ResponseRelationshipsDocumentTemplate"""
