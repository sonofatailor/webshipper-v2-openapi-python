...
class TestStoresPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StoresPostRequestData:
        """Test StoresPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresPostRequestData`
        """
        model = StoresPostRequestData()
        if include_optional:
    ...
    def testStoresPostRequestData(self):
        """Test StoresPostRequestData"""
