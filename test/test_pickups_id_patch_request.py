...
class TestPickupsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PickupsIdPatchRequest:
        """Test PickupsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsIdPatchRequest`
        """
    ...
    def testPickupsIdPatchRequest(self):
        """Test PickupsIdPatchRequest"""
