...
class TestReturnShippingMethodsIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsIdGet200ResponseIncludedInner:
        """Test ReturnShippingMethodsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsIdGet200ResponseIncludedInner`
        """
        model = ReturnShippingMethodsIdGet200ResponseIncludedInner()
        if include_optional:
            return ReturnShippingMethodsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testReturnShippingMethodsIdGet200ResponseIncludedInner(self):
        """Test ReturnShippingMethodsIdGet200ResponseIncludedInner"""
