...
class TestReturnsIdGet200ResponseRelationshipsShippingMethodData(unittest.TestCase):
    """ReturnsIdGet200ResponseRelationshipsShippingMethodData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnsIdGet200ResponseRelationshipsShippingMethodData:
        """Test ReturnsIdGet200ResponseRelationshipsShippingMethodData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsIdGet200ResponseRelationshipsShippingMethodData`
        """
        model = ReturnsIdGet200ResponseRelationshipsShippingMethodData()
        if include_optional:
            return ReturnsIdGet200ResponseRelationshipsShippingMethodData(
                id = '',
    ...
    def testReturnsIdGet200ResponseRelationshipsShippingMethodData(self):
        """Test ReturnsIdGet200ResponseRelationshipsShippingMethodData"""
