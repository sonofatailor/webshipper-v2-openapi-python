...
class TestEndOfDayReportsGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EndOfDayReportsGet200Response:
        """Test EndOfDayReportsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndOfDayReportsGet200Response`
        """
        model = EndOfDayReportsGet200Response()
        if include_optional:
    ...
    def testEndOfDayReportsGet200Response(self):
        """Test EndOfDayReportsGet200Response"""
