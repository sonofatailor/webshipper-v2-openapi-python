...
class TestLocalAttrsGet200Response(unittest.TestCase):
    """LocalAttrsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrsGet200Response:
        """Test LocalAttrsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsGet200Response`
        """
        model = LocalAttrsGet200Response()
        if include_optional:
            return LocalAttrsGet200Response(
                data = [
                    openapi_client.models._local_attrs_get_200_response_data_inner._local_attrs_get_200_response_data_inner(
    ...
    def testLocalAttrsGet200Response(self):
        """Test LocalAttrsGet200Response"""
