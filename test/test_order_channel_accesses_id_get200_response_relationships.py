...
class TestOrderChannelAccessesIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesIdGet200ResponseRelationships:
        """Test OrderChannelAccessesIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesIdGet200ResponseRelationships`
        """
    ...
    def testOrderChannelAccessesIdGet200ResponseRelationships(self):
        """Test OrderChannelAccessesIdGet200ResponseRelationships"""
