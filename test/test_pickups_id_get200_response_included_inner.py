...
class TestPickupsIdGet200ResponseIncludedInner(unittest.TestCase):
    """PickupsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PickupsIdGet200ResponseIncludedInner:
        """Test PickupsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsIdGet200ResponseIncludedInner`
        """
        model = PickupsIdGet200ResponseIncludedInner()
        if include_optional:
            return PickupsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testPickupsIdGet200ResponseIncludedInner(self):
        """Test PickupsIdGet200ResponseIncludedInner"""
