...
class TestErrorTypesGet200Response(unittest.TestCase):
    """ErrorTypesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorTypesGet200Response:
        """Test ErrorTypesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorTypesGet200Response`
        """
        model = ErrorTypesGet200Response()
        if include_optional:
            return ErrorTypesGet200Response(
                data = [
                    openapi_client.models._error_types_get_200_response_data_inner._error_types_get_200_response_data_inner(
    ...
    def testErrorTypesGet200Response(self):
        """Test ErrorTypesGet200Response"""
