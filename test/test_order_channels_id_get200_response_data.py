...
class TestOrderChannelsIdGet200ResponseData(unittest.TestCase):
    """OrderChannelsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelsIdGet200ResponseData:
        """Test OrderChannelsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelsIdGet200ResponseData`
        """
        model = OrderChannelsIdGet200ResponseData()
        if include_optional:
            return OrderChannelsIdGet200ResponseData(
                id = 56,
                type = 'order_channels',
    ...
    def testOrderChannelsIdGet200ResponseData(self):
        """Test OrderChannelsIdGet200ResponseData"""
