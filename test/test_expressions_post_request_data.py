...
class TestExpressionsPostRequestData(unittest.TestCase):
    """ExpressionsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpressionsPostRequestData:
        """Test ExpressionsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpressionsPostRequestData`
        """
        model = ExpressionsPostRequestData()
        if include_optional:
            return ExpressionsPostRequestData(
                type = 'expressions',
    ...
    def testExpressionsPostRequestData(self):
        """Test ExpressionsPostRequestData"""
