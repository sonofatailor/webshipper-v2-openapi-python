...
class TestUserGroupsGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserGroupsGet200Response:
        """Test UserGroupsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserGroupsGet200Response`
        """
        model = UserGroupsGet200Response()
        if include_optional:
    ...
    def testUserGroupsGet200Response(self):
        """Test UserGroupsGet200Response"""
