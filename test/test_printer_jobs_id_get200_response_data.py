...
class TestPrinterJobsIdGet200ResponseData(unittest.TestCase):
    """PrinterJobsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsIdGet200ResponseData:
        """Test PrinterJobsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsIdGet200ResponseData`
        """
        model = PrinterJobsIdGet200ResponseData()
        if include_optional:
            return PrinterJobsIdGet200ResponseData(
                id = 56,
                type = 'printer_jobs',
    ...
    def testPrinterJobsIdGet200ResponseData(self):
        """Test PrinterJobsIdGet200ResponseData"""
