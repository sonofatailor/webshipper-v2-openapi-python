...
class TestOauthApplicationsIdGet200ResponseData(unittest.TestCase):
    """OauthApplicationsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthApplicationsIdGet200ResponseData:
        """Test OauthApplicationsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthApplicationsIdGet200ResponseData`
        """
        model = OauthApplicationsIdGet200ResponseData()
        if include_optional:
            return OauthApplicationsIdGet200ResponseData(
                id = 56,
    ...
    def testOauthApplicationsIdGet200ResponseData(self):
        """Test OauthApplicationsIdGet200ResponseData"""
