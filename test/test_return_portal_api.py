...
class TestReturnPortalApi(unittest.TestCase):
    """ReturnPortalApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ReturnPortalApi()

    def tearDown(self) -> None:
        pass

    def test_return_portals_get(self) -> None:
        """Test case for return_portals_get

        List all Return Portals
        """
        pass

    def test_return_portals_id_delete(self) -> None:
        """Test case for return_portals_id_delete

        Delete a Return Portal
        """
        pass

    def test_return_portals_id_get(self) -> None:
        """Test case for return_portals_id_get

        Show a single Return Portal
        """
        pass

    def test_return_portals_id_patch(self) -> None:
        """Test case for return_portals_id_patch

        Update a Return Portal
        """
        pass

    def test_return_portals_post(self) -> None:
        """Test case for return_portals_post
