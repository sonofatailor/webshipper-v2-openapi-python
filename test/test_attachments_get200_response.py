...
class TestAttachmentsGet200Response(unittest.TestCase):
    """AttachmentsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsGet200Response:
        """Test AttachmentsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsGet200Response`
        """
        model = AttachmentsGet200Response()
        if include_optional:
            return AttachmentsGet200Response(
                data = [
                    openapi_client.models._attachments_get_200_response_data_inner._attachments_get_200_response_data_inner(
    ...
    def testAttachmentsGet200Response(self):
        """Test AttachmentsGet200Response"""
