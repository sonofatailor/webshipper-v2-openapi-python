...
class TestOauthAccessTokensIdGet200ResponseIncludedInner(unittest.TestCase):
    """OauthAccessTokensIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthAccessTokensIdGet200ResponseIncludedInner:
        """Test OauthAccessTokensIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthAccessTokensIdGet200ResponseIncludedInner`
        """
        model = OauthAccessTokensIdGet200ResponseIncludedInner()
        if include_optional:
            return OauthAccessTokensIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testOauthAccessTokensIdGet200ResponseIncludedInner(self):
        """Test OauthAccessTokensIdGet200ResponseIncludedInner"""
