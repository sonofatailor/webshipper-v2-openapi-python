...
class TestShippingRateApi(unittest.TestCase):
    """ShippingRateApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ShippingRateApi()

    def tearDown(self) -> None:
        pass

    def test_shipping_rates_get(self) -> None:
        """Test case for shipping_rates_get

        List all Shipping Rates
        """
        pass

    def test_shipping_rates_id_delete(self) -> None:
        """Test case for shipping_rates_id_delete

        Delete a Shipping Rate
        """
        pass

    def test_shipping_rates_id_get(self) -> None:
        """Test case for shipping_rates_id_get

        Show a single Shipping Rate
        """
        pass

    def test_shipping_rates_id_patch(self) -> None:
        """Test case for shipping_rates_id_patch

        Update a Shipping Rate
        """
        pass

    def test_shipping_rates_post(self) -> None:
        """Test case for shipping_rates_post
