...
class TestOrdersIdGet200ResponseIncludedInner(unittest.TestCase):
    """OrdersIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseIncludedInner:
        """Test OrdersIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseIncludedInner`
        """
        model = OrdersIdGet200ResponseIncludedInner()
        if include_optional:
            return OrdersIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testOrdersIdGet200ResponseIncludedInner(self):
        """Test OrdersIdGet200ResponseIncludedInner"""
