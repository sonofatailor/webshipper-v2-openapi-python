...
class TestSlipTemplatePreviewsGet200ResponseDataInner(unittest.TestCase):
    """SlipTemplatePreviewsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlipTemplatePreviewsGet200ResponseDataInner:
        """Test SlipTemplatePreviewsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatePreviewsGet200ResponseDataInner`
        """
        model = SlipTemplatePreviewsGet200ResponseDataInner()
        if include_optional:
            return SlipTemplatePreviewsGet200ResponseDataInner(
    ...
    def testSlipTemplatePreviewsGet200ResponseDataInner(self):
        """Test SlipTemplatePreviewsGet200ResponseDataInner"""
