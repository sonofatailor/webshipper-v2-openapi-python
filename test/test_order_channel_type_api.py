...
class TestOrderChannelTypeApi(unittest.TestCase):
    """OrderChannelTypeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OrderChannelTypeApi()

    def tearDown(self) -> None:
        pass

    def test_order_channel_types_get(self) -> None:
        """Test case for order_channel_types_get

        List all Order Channel Types
        """
        pass

    def test_order_channel_types_id_get(self) -> None:
        """Test case for order_channel_types_id_get
