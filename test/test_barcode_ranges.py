...
class TestBarcodeRanges(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BarcodeRanges:
        """Test BarcodeRanges
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRanges`
        """
        model = BarcodeRanges()
        if include_optional:
            return BarcodeRanges(
                barcode_type = '',
                serial_from = 56,
                serial_to = 56,
                current_serial = 56,
