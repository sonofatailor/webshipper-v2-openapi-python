...
class TestTagsGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TagsGet200Response:
        """Test TagsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagsGet200Response`
        """
        model = TagsGet200Response()
        if include_optional:
    ...
    def testTagsGet200Response(self):
        """Test TagsGet200Response"""
