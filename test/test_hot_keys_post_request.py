...
class TestHotKeysPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HotKeysPostRequest:
        """Test HotKeysPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysPostRequest`
        """
    ...
    def testHotKeysPostRequest(self):
        """Test HotKeysPostRequest"""
