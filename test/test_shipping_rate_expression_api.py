...
class TestShippingRateExpressionApi(unittest.TestCase):
    """ShippingRateExpressionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ShippingRateExpressionApi()

    def tearDown(self) -> None:
        pass

    def test_expressions_get(self) -> None:
    ...
    def test_expressions_id_delete(self) -> None:
        """Test case for expressions_id_delete

        Delete a Shipping Rate Expression
        """
        pass

    def test_expressions_id_get(self) -> None:
        """Test case for expressions_id_get

        Show a single Shipping Rate Expression
        """
        pass

    def test_expressions_id_patch(self) -> None:
        """Test case for expressions_id_patch

        Update a Shipping Rate Expression
        """
        pass

    def test_expressions_post(self) -> None:
