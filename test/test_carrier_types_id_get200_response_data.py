...
class TestCarrierTypesIdGet200ResponseData(unittest.TestCase):
    """CarrierTypesIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierTypesIdGet200ResponseData:
        """Test CarrierTypesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierTypesIdGet200ResponseData`
        """
        model = CarrierTypesIdGet200ResponseData()
        if include_optional:
            return CarrierTypesIdGet200ResponseData(
                id = 56,
                type = 'carrier_types',
    ...
    def testCarrierTypesIdGet200ResponseData(self):
        """Test CarrierTypesIdGet200ResponseData"""
