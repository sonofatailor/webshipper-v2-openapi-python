...
class TestReportTypesGet200ResponseDataInner(unittest.TestCase):
    """ReportTypesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportTypesGet200ResponseDataInner:
        """Test ReportTypesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportTypesGet200ResponseDataInner`
        """
        model = ReportTypesGet200ResponseDataInner()
        if include_optional:
            return ReportTypesGet200ResponseDataInner(
    ...
    def testReportTypesGet200ResponseDataInner(self):
        """Test ReportTypesGet200ResponseDataInner"""
