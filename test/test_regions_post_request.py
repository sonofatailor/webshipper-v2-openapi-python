...
class TestRegionsPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RegionsPostRequest:
        """Test RegionsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionsPostRequest`
        """
    ...
    def testRegionsPostRequest(self):
        """Test RegionsPostRequest"""
