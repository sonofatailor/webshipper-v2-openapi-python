...
class TestOrderMergesPost204ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderMergesPost204ResponseData:
        """Test OrderMergesPost204ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderMergesPost204ResponseData`
        """
        model = OrderMergesPost204ResponseData()
        if include_optional:
    ...
    def testOrderMergesPost204ResponseData(self):
        """Test OrderMergesPost204ResponseData"""
