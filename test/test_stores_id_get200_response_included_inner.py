...
class TestStoresIdGet200ResponseIncludedInner(unittest.TestCase):
    """StoresIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoresIdGet200ResponseIncludedInner:
        """Test StoresIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresIdGet200ResponseIncludedInner`
        """
        model = StoresIdGet200ResponseIncludedInner()
        if include_optional:
            return StoresIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testStoresIdGet200ResponseIncludedInner(self):
        """Test StoresIdGet200ResponseIncludedInner"""
