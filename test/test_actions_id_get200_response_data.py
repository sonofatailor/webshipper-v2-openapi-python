...
class TestActionsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsIdGet200ResponseData:
        """Test ActionsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsIdGet200ResponseData`
        """
        model = ActionsIdGet200ResponseData()
        if include_optional:
    ...
    def testActionsIdGet200ResponseData(self):
        """Test ActionsIdGet200ResponseData"""
