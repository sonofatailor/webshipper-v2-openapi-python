...
class TestTriggersPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TriggersPostRequestData:
        """Test TriggersPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggersPostRequestData`
        """
        model = TriggersPostRequestData()
        if include_optional:
    ...
    def testTriggersPostRequestData(self):
        """Test TriggersPostRequestData"""
