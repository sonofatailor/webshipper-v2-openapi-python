...
class TestOauthAccessTokensIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OauthAccessTokensIdGet200ResponseData:
        """Test OauthAccessTokensIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthAccessTokensIdGet200ResponseData`
        """
        model = OauthAccessTokensIdGet200ResponseData()
        if include_optional:
    ...
    def testOauthAccessTokensIdGet200ResponseData(self):
        """Test OauthAccessTokensIdGet200ResponseData"""
