...
class TestOrdersIdGet200ResponseRelationshipsPrinterClientData(unittest.TestCase):
    """OrdersIdGet200ResponseRelationshipsPrinterClientData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseRelationshipsPrinterClientData:
        """Test OrdersIdGet200ResponseRelationshipsPrinterClientData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseRelationshipsPrinterClientData`
        """
        model = OrdersIdGet200ResponseRelationshipsPrinterClientData()
        if include_optional:
            return OrdersIdGet200ResponseRelationshipsPrinterClientData(
                id = '',
    ...
    def testOrdersIdGet200ResponseRelationshipsPrinterClientData(self):
        """Test OrdersIdGet200ResponseRelationshipsPrinterClientData"""
