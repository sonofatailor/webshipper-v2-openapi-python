...
class TestReturnRefundMethodsPostRequestData(unittest.TestCase):
    """ReturnRefundMethodsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsPostRequestData:
        """Test ReturnRefundMethodsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsPostRequestData`
        """
        model = ReturnRefundMethodsPostRequestData()
        if include_optional:
            return ReturnRefundMethodsPostRequestData(
    ...
    def testReturnRefundMethodsPostRequestData(self):
        """Test ReturnRefundMethodsPostRequestData"""
