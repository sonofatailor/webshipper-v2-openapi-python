...
class TestWebhookFailuresGet200Response(unittest.TestCase):
    """WebhookFailuresGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresGet200Response:
        """Test WebhookFailuresGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresGet200Response`
        """
        model = WebhookFailuresGet200Response()
        if include_optional:
            return WebhookFailuresGet200Response(
                data = [
                    openapi_client.models._webhook_failures_get_200_response_data_inner._webhook_failures_get_200_response_data_inner(
    ...
    def testWebhookFailuresGet200Response(self):
        """Test WebhookFailuresGet200Response"""
