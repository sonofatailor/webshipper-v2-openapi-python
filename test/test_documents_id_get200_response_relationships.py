...
class TestDocumentsIdGet200ResponseRelationships(unittest.TestCase):
    """DocumentsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsIdGet200ResponseRelationships:
        """Test DocumentsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsIdGet200ResponseRelationships`
        """
        model = DocumentsIdGet200ResponseRelationships()
        if include_optional:
            return DocumentsIdGet200ResponseRelationships(
    ...
    def testDocumentsIdGet200ResponseRelationships(self):
        """Test DocumentsIdGet200ResponseRelationships"""
