...
class TestOauthAccessTokensIdGet200ResponseRelationshipsApplication(unittest.TestCase):
    """OauthAccessTokensIdGet200ResponseRelationshipsApplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthAccessTokensIdGet200ResponseRelationshipsApplication:
        """Test OauthAccessTokensIdGet200ResponseRelationshipsApplication
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthAccessTokensIdGet200ResponseRelationshipsApplication`
        """
        model = OauthAccessTokensIdGet200ResponseRelationshipsApplication()
        if include_optional:
            return OauthAccessTokensIdGet200ResponseRelationshipsApplication(
    ...
    def testOauthAccessTokensIdGet200ResponseRelationshipsApplication(self):
        """Test OauthAccessTokensIdGet200ResponseRelationshipsApplication"""
