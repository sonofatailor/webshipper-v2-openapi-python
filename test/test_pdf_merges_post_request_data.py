...
class TestPdfMergesPostRequestData(unittest.TestCase):
    """PdfMergesPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PdfMergesPostRequestData:
        """Test PdfMergesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PdfMergesPostRequestData`
        """
        model = PdfMergesPostRequestData()
        if include_optional:
            return PdfMergesPostRequestData(
                type = 'pdf_merges',
    ...
    def testPdfMergesPostRequestData(self):
        """Test PdfMergesPostRequestData"""
