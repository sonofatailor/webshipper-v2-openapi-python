...
class TestOrdersPostRequestData(unittest.TestCase):
    """OrdersPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersPostRequestData:
        """Test OrdersPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersPostRequestData`
        """
        model = OrdersPostRequestData()
        if include_optional:
            return OrdersPostRequestData(
                type = 'orders',
    ...
    def testOrdersPostRequestData(self):
        """Test OrdersPostRequestData"""
