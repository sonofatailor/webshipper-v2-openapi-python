...
class TestAttachmentsIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseRelationships:
        """Test AttachmentsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseRelationships`
        """
    ...
    def testAttachmentsIdGet200ResponseRelationships(self):
        """Test AttachmentsIdGet200ResponseRelationships"""
