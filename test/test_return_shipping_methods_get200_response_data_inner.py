...
class TestReturnShippingMethodsGet200ResponseDataInner(unittest.TestCase):
    """ReturnShippingMethodsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsGet200ResponseDataInner:
        """Test ReturnShippingMethodsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsGet200ResponseDataInner`
        """
        model = ReturnShippingMethodsGet200ResponseDataInner()
        if include_optional:
            return ReturnShippingMethodsGet200ResponseDataInner(
    ...
    def testReturnShippingMethodsGet200ResponseDataInner(self):
        """Test ReturnShippingMethodsGet200ResponseDataInner"""
