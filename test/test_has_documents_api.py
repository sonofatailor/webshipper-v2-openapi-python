...
class TestHasDocumentsApi(unittest.TestCase):
    """HasDocumentsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HasDocumentsApi()

    def tearDown(self) -> None:
        pass

    def test_has_documents_get(self) -> None:
        """Test case for has_documents_get

        List all Has Documentss
        """
        pass

    def test_has_documents_id_delete(self) -> None:
        """Test case for has_documents_id_delete

        Delete a Has Documents
        """
        pass

    def test_has_documents_id_get(self) -> None:
        """Test case for has_documents_id_get

        Show a single Has Documents
        """
        pass

    def test_has_documents_id_patch(self) -> None:
        """Test case for has_documents_id_patch

        Update a Has Documents
        """
        pass

    def test_has_documents_post(self) -> None:
        """Test case for has_documents_post
