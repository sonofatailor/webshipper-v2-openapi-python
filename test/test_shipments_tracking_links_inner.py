...
class TestShipmentsTrackingLinksInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShipmentsTrackingLinksInner:
        """Test ShipmentsTrackingLinksInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsTrackingLinksInner`
        """
        model = ShipmentsTrackingLinksInner()
        if include_optional:
            return ShipmentsTrackingLinksInner(
                url = '',
                number = '',
    ...
    def testShipmentsTrackingLinksInner(self):
        """Test ShipmentsTrackingLinksInner"""
