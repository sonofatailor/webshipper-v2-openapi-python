...
class TestCarrierAccesses(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CarrierAccesses:
        """Test CarrierAccesses
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierAccesses`
        """
        model = CarrierAccesses()
        if include_optional:
            return CarrierAccesses(
                created_at = '',
                updated_at = ''
            )
        else:
