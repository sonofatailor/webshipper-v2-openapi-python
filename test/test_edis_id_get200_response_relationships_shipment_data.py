...
class TestEdisIdGet200ResponseRelationshipsShipmentData(unittest.TestCase):
    """EdisIdGet200ResponseRelationshipsShipmentData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdisIdGet200ResponseRelationshipsShipmentData:
        """Test EdisIdGet200ResponseRelationshipsShipmentData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdisIdGet200ResponseRelationshipsShipmentData`
        """
        model = EdisIdGet200ResponseRelationshipsShipmentData()
        if include_optional:
            return EdisIdGet200ResponseRelationshipsShipmentData(
                id = '',
                type = 'shipments'
            )
        else:
    ...
    def testEdisIdGet200ResponseRelationshipsShipmentData(self):
        """Test EdisIdGet200ResponseRelationshipsShipmentData"""
