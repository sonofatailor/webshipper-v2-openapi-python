...
class TestAttachmentsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """AttachmentsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseIncludedInnerData:
        """Test AttachmentsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseIncludedInnerData`
        """
        model = AttachmentsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return AttachmentsIdGet200ResponseIncludedInnerData(
                shipment_id = 56,
                document_size = '',
                document_format = '',
                var_base64 = '',
    ...
    def testAttachmentsIdGet200ResponseIncludedInnerData(self):
        """Test AttachmentsIdGet200ResponseIncludedInnerData"""
