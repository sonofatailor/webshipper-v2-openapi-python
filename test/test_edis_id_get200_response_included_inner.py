...
class TestEdisIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EdisIdGet200ResponseIncludedInner:
        """Test EdisIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdisIdGet200ResponseIncludedInner`
        """
        model = EdisIdGet200ResponseIncludedInner()
        if include_optional:
            return EdisIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testEdisIdGet200ResponseIncludedInner(self):
        """Test EdisIdGet200ResponseIncludedInner"""
