...
class TestPrintablesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrintablesPostRequestData:
        """Test PrintablesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintablesPostRequestData`
        """
        model = PrintablesPostRequestData()
        if include_optional:
    ...
    def testPrintablesPostRequestData(self):
        """Test PrintablesPostRequestData"""
