...
class TestLocalAttrsIdGet200ResponseRelationshipsOrderChannelType(unittest.TestCase):
    """LocalAttrsIdGet200ResponseRelationshipsOrderChannelType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrsIdGet200ResponseRelationshipsOrderChannelType:
        """Test LocalAttrsIdGet200ResponseRelationshipsOrderChannelType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsIdGet200ResponseRelationshipsOrderChannelType`
        """
        model = LocalAttrsIdGet200ResponseRelationshipsOrderChannelType()
        if include_optional:
            return LocalAttrsIdGet200ResponseRelationshipsOrderChannelType(
    ...
    def testLocalAttrsIdGet200ResponseRelationshipsOrderChannelType(self):
        """Test LocalAttrsIdGet200ResponseRelationshipsOrderChannelType"""
