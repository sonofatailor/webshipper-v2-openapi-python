...
class TestReturnsIdGet200ResponseRelationshipsRefundMethod(unittest.TestCase):
    """ReturnsIdGet200ResponseRelationshipsRefundMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnsIdGet200ResponseRelationshipsRefundMethod:
        """Test ReturnsIdGet200ResponseRelationshipsRefundMethod
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsIdGet200ResponseRelationshipsRefundMethod`
        """
        model = ReturnsIdGet200ResponseRelationshipsRefundMethod()
        if include_optional:
            return ReturnsIdGet200ResponseRelationshipsRefundMethod(
    ...
    def testReturnsIdGet200ResponseRelationshipsRefundMethod(self):
        """Test ReturnsIdGet200ResponseRelationshipsRefundMethod"""
