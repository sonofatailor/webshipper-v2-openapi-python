...
class TestCsvRulesGet200ResponseDataInner(unittest.TestCase):
    """CsvRulesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvRulesGet200ResponseDataInner:
        """Test CsvRulesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesGet200ResponseDataInner`
        """
        model = CsvRulesGet200ResponseDataInner()
        if include_optional:
            return CsvRulesGet200ResponseDataInner(
    ...
    def testCsvRulesGet200ResponseDataInner(self):
        """Test CsvRulesGet200ResponseDataInner"""
