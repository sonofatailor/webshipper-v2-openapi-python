...
class TestShippingAddresses(unittest.TestCase):
    """ShippingAddresses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingAddresses:
        """Test ShippingAddresses
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingAddresses`
        """
    ...
    def testShippingAddresses(self):
        """Test ShippingAddresses"""
