...
class TestTrackingEventsIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackingEventsIdGet200ResponseRelationships:
        """Test TrackingEventsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsIdGet200ResponseRelationships`
        """
    ...
    def testTrackingEventsIdGet200ResponseRelationships(self):
        """Test TrackingEventsIdGet200ResponseRelationships"""
