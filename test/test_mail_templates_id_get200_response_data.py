...
class TestMailTemplatesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MailTemplatesIdGet200ResponseData:
        """Test MailTemplatesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesIdGet200ResponseData`
        """
        model = MailTemplatesIdGet200ResponseData()
        if include_optional:
    ...
    def testMailTemplatesIdGet200ResponseData(self):
        """Test MailTemplatesIdGet200ResponseData"""
