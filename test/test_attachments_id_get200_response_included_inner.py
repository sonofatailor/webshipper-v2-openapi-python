...
class TestAttachmentsIdGet200ResponseIncludedInner(unittest.TestCase):
    """AttachmentsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseIncludedInner:
        """Test AttachmentsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseIncludedInner`
        """
        model = AttachmentsIdGet200ResponseIncludedInner()
        if include_optional:
            return AttachmentsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testAttachmentsIdGet200ResponseIncludedInner(self):
        """Test AttachmentsIdGet200ResponseIncludedInner"""
