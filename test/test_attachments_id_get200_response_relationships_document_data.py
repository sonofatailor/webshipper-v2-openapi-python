...
class TestAttachmentsIdGet200ResponseRelationshipsDocumentData(unittest.TestCase):
    """AttachmentsIdGet200ResponseRelationshipsDocumentData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseRelationshipsDocumentData:
        """Test AttachmentsIdGet200ResponseRelationshipsDocumentData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseRelationshipsDocumentData`
        """
        model = AttachmentsIdGet200ResponseRelationshipsDocumentData()
        if include_optional:
            return AttachmentsIdGet200ResponseRelationshipsDocumentData(
                id = '',
                type = 'documents'
            )
        else:
    ...
    def testAttachmentsIdGet200ResponseRelationshipsDocumentData(self):
        """Test AttachmentsIdGet200ResponseRelationshipsDocumentData"""
