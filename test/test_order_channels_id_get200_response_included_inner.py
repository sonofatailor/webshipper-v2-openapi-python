...
class TestOrderChannelsIdGet200ResponseIncludedInner(unittest.TestCase):
    """OrderChannelsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelsIdGet200ResponseIncludedInner:
        """Test OrderChannelsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelsIdGet200ResponseIncludedInner`
        """
        model = OrderChannelsIdGet200ResponseIncludedInner()
        if include_optional:
            return OrderChannelsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testOrderChannelsIdGet200ResponseIncludedInner(self):
        """Test OrderChannelsIdGet200ResponseIncludedInner"""
