...
class TestTrackingEventsIdGet200ResponseIncludedInner(unittest.TestCase):
    """TrackingEventsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackingEventsIdGet200ResponseIncludedInner:
        """Test TrackingEventsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsIdGet200ResponseIncludedInner`
        """
        model = TrackingEventsIdGet200ResponseIncludedInner()
        if include_optional:
            return TrackingEventsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testTrackingEventsIdGet200ResponseIncludedInner(self):
        """Test TrackingEventsIdGet200ResponseIncludedInner"""
