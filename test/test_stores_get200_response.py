...
class TestStoresGet200Response(unittest.TestCase):
    """StoresGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoresGet200Response:
        """Test StoresGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresGet200Response`
        """
        model = StoresGet200Response()
        if include_optional:
            return StoresGet200Response(
                data = [
                    openapi_client.models._stores_get_200_response_data_inner._stores_get_200_response_data_inner(
    ...
    def testStoresGet200Response(self):
        """Test StoresGet200Response"""
