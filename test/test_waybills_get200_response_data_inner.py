...
class TestWaybillsGet200ResponseDataInner(unittest.TestCase):
    """WaybillsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaybillsGet200ResponseDataInner:
        """Test WaybillsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaybillsGet200ResponseDataInner`
        """
        model = WaybillsGet200ResponseDataInner()
        if include_optional:
            return WaybillsGet200ResponseDataInner(
    ...
    def testWaybillsGet200ResponseDataInner(self):
        """Test WaybillsGet200ResponseDataInner"""
