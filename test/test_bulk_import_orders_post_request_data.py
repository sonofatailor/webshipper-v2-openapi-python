...
class TestBulkImportOrdersPostRequestData(unittest.TestCase):
    """BulkImportOrdersPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkImportOrdersPostRequestData:
        """Test BulkImportOrdersPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkImportOrdersPostRequestData`
        """
        model = BulkImportOrdersPostRequestData()
        if include_optional:
            return BulkImportOrdersPostRequestData(
    ...
    def testBulkImportOrdersPostRequestData(self):
        """Test BulkImportOrdersPostRequestData"""
