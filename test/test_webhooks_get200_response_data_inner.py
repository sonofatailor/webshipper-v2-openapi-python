...
class TestWebhooksGet200ResponseDataInner(unittest.TestCase):
    """WebhooksGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksGet200ResponseDataInner:
        """Test WebhooksGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksGet200ResponseDataInner`
        """
        model = WebhooksGet200ResponseDataInner()
        if include_optional:
            return WebhooksGet200ResponseDataInner(
    ...
    def testWebhooksGet200ResponseDataInner(self):
        """Test WebhooksGet200ResponseDataInner"""
