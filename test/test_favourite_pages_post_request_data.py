...
class TestFavouritePagesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FavouritePagesPostRequestData:
        """Test FavouritePagesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesPostRequestData`
        """
        model = FavouritePagesPostRequestData()
        if include_optional:
    ...
    def testFavouritePagesPostRequestData(self):
        """Test FavouritePagesPostRequestData"""
