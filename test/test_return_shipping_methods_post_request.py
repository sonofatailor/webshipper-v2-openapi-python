...
class TestReturnShippingMethodsPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsPostRequest:
        """Test ReturnShippingMethodsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsPostRequest`
        """
    ...
    def testReturnShippingMethodsPostRequest(self):
        """Test ReturnShippingMethodsPostRequest"""
