...
class TestShippingAddressesIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingAddressesIdPatchRequest:
        """Test ShippingAddressesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingAddressesIdPatchRequest`
        """
    ...
    def testShippingAddressesIdPatchRequest(self):
        """Test ShippingAddressesIdPatchRequest"""
