...
class TestOrderChannelAccessesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesPostRequestData:
        """Test OrderChannelAccessesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesPostRequestData`
        """
        model = OrderChannelAccessesPostRequestData()
        if include_optional:
    ...
    def testOrderChannelAccessesPostRequestData(self):
        """Test OrderChannelAccessesPostRequestData"""
