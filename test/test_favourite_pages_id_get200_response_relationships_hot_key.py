...
class TestFavouritePagesIdGet200ResponseRelationshipsHotKey(unittest.TestCase):
    """FavouritePagesIdGet200ResponseRelationshipsHotKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FavouritePagesIdGet200ResponseRelationshipsHotKey:
        """Test FavouritePagesIdGet200ResponseRelationshipsHotKey
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesIdGet200ResponseRelationshipsHotKey`
        """
        model = FavouritePagesIdGet200ResponseRelationshipsHotKey()
        if include_optional:
            return FavouritePagesIdGet200ResponseRelationshipsHotKey(
    ...
    def testFavouritePagesIdGet200ResponseRelationshipsHotKey(self):
        """Test FavouritePagesIdGet200ResponseRelationshipsHotKey"""
