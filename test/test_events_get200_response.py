...
class TestEventsGet200Response(unittest.TestCase):
    """EventsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsGet200Response:
        """Test EventsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsGet200Response`
        """
        model = EventsGet200Response()
        if include_optional:
            return EventsGet200Response(
                data = [
                    openapi_client.models._events_get_200_response_data_inner._events_get_200_response_data_inner(
    ...
    def testEventsGet200Response(self):
        """Test EventsGet200Response"""
