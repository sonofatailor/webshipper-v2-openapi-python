...
class TestOrderChannelTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderChannelTypes:
        """Test OrderChannelTypes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelTypes`
        """
        model = OrderChannelTypes()
        if include_optional:
            return OrderChannelTypes(
                name = '',
                support_url = '',
                public_global_attrs = '',
                list_logo = '',
    ...
    def testOrderChannelTypes(self):
        """Test OrderChannelTypes"""
