...
class TestOrderChannelAccessesIdGet200ResponseData(unittest.TestCase):
    """OrderChannelAccessesIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesIdGet200ResponseData:
        """Test OrderChannelAccessesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesIdGet200ResponseData`
        """
        model = OrderChannelAccessesIdGet200ResponseData()
        if include_optional:
            return OrderChannelAccessesIdGet200ResponseData(
                id = 56,
    ...
    def testOrderChannelAccessesIdGet200ResponseData(self):
        """Test OrderChannelAccessesIdGet200ResponseData"""
