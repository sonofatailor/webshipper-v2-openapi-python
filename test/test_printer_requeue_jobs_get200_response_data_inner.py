...
class TestPrinterRequeueJobsGet200ResponseDataInner(unittest.TestCase):
    """PrinterRequeueJobsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterRequeueJobsGet200ResponseDataInner:
        """Test PrinterRequeueJobsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterRequeueJobsGet200ResponseDataInner`
        """
        model = PrinterRequeueJobsGet200ResponseDataInner()
        if include_optional:
            return PrinterRequeueJobsGet200ResponseDataInner(
    ...
    def testPrinterRequeueJobsGet200ResponseDataInner(self):
        """Test PrinterRequeueJobsGet200ResponseDataInner"""
