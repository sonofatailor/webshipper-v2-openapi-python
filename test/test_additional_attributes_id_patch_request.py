...
class TestAdditionalAttributesIdPatchRequest(unittest.TestCase):
    """AdditionalAttributesIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdPatchRequest:
        """Test AdditionalAttributesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdPatchRequest`
        """
        model = AdditionalAttributesIdPatchRequest()
        if include_optional:
            return AdditionalAttributesIdPatchRequest(
    ...
    def testAdditionalAttributesIdPatchRequest(self):
        """Test AdditionalAttributesIdPatchRequest"""
