...
class TestAutomationsIdGet200ResponseIncludedInner(unittest.TestCase):
    """AutomationsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsIdGet200ResponseIncludedInner:
        """Test AutomationsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsIdGet200ResponseIncludedInner`
        """
        model = AutomationsIdGet200ResponseIncludedInner()
        if include_optional:
            return AutomationsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testAutomationsIdGet200ResponseIncludedInner(self):
        """Test AutomationsIdGet200ResponseIncludedInner"""
