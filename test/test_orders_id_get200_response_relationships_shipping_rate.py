...
class TestOrdersIdGet200ResponseRelationshipsShippingRate(unittest.TestCase):
    """OrdersIdGet200ResponseRelationshipsShippingRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseRelationshipsShippingRate:
        """Test OrdersIdGet200ResponseRelationshipsShippingRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseRelationshipsShippingRate`
        """
        model = OrdersIdGet200ResponseRelationshipsShippingRate()
        if include_optional:
            return OrdersIdGet200ResponseRelationshipsShippingRate(
    ...
    def testOrdersIdGet200ResponseRelationshipsShippingRate(self):
        """Test OrdersIdGet200ResponseRelationshipsShippingRate"""
