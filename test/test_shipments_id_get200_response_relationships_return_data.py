...
class TestShipmentsIdGet200ResponseRelationshipsReturnData(unittest.TestCase):
    """ShipmentsIdGet200ResponseRelationshipsReturnData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentsIdGet200ResponseRelationshipsReturnData:
        """Test ShipmentsIdGet200ResponseRelationshipsReturnData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsIdGet200ResponseRelationshipsReturnData`
        """
        model = ShipmentsIdGet200ResponseRelationshipsReturnData()
        if include_optional:
            return ShipmentsIdGet200ResponseRelationshipsReturnData(
                id = '',
                type = 'returns'
            )
        else:
    ...
    def testShipmentsIdGet200ResponseRelationshipsReturnData(self):
        """Test ShipmentsIdGet200ResponseRelationshipsReturnData"""
