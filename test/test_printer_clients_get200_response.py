...
class TestPrinterClientsGet200Response(unittest.TestCase):
    """PrinterClientsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterClientsGet200Response:
        """Test PrinterClientsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsGet200Response`
        """
        model = PrinterClientsGet200Response()
        if include_optional:
            return PrinterClientsGet200Response(
                data = [
                    openapi_client.models._printer_clients_get_200_response_data_inner._printer_clients_get_200_response_data_inner(
    ...
    def testPrinterClientsGet200Response(self):
        """Test PrinterClientsGet200Response"""
