...
class TestReturnsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnsPostRequestData:
        """Test ReturnsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsPostRequestData`
        """
        model = ReturnsPostRequestData()
        if include_optional:
    ...
    def testReturnsPostRequestData(self):
        """Test ReturnsPostRequestData"""
