...
class TestActionsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsIdGet200ResponseIncludedInnerData:
        """Test ActionsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsIdGet200ResponseIncludedInnerData`
        """
    ...
    def testActionsIdGet200ResponseIncludedInnerData(self):
        """Test ActionsIdGet200ResponseIncludedInnerData"""
