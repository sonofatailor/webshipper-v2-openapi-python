...
class TestEventsPostRequestData(unittest.TestCase):
    """EventsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsPostRequestData:
        """Test EventsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsPostRequestData`
        """
        model = EventsPostRequestData()
        if include_optional:
            return EventsPostRequestData(
                type = 'events',
    ...
    def testEventsPostRequestData(self):
        """Test EventsPostRequestData"""
