...
class TestPrinterClientsGet200ResponseDataInner(unittest.TestCase):
    """PrinterClientsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterClientsGet200ResponseDataInner:
        """Test PrinterClientsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsGet200ResponseDataInner`
        """
        model = PrinterClientsGet200ResponseDataInner()
        if include_optional:
            return PrinterClientsGet200ResponseDataInner(
    ...
    def testPrinterClientsGet200ResponseDataInner(self):
        """Test PrinterClientsGet200ResponseDataInner"""
