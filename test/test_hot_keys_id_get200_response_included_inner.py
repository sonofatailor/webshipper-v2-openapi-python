...
class TestHotKeysIdGet200ResponseIncludedInner(unittest.TestCase):
    """HotKeysIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotKeysIdGet200ResponseIncludedInner:
        """Test HotKeysIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysIdGet200ResponseIncludedInner`
        """
        model = HotKeysIdGet200ResponseIncludedInner()
        if include_optional:
            return HotKeysIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testHotKeysIdGet200ResponseIncludedInner(self):
        """Test HotKeysIdGet200ResponseIncludedInner"""
