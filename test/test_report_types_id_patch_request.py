...
class TestReportTypesIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReportTypesIdPatchRequest:
        """Test ReportTypesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportTypesIdPatchRequest`
        """
    ...
    def testReportTypesIdPatchRequest(self):
        """Test ReportTypesIdPatchRequest"""
