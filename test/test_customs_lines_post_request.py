...
class TestCustomsLinesPostRequest(unittest.TestCase):
    """CustomsLinesPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomsLinesPostRequest:
        """Test CustomsLinesPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomsLinesPostRequest`
        """
        model = CustomsLinesPostRequest()
        if include_optional:
            return CustomsLinesPostRequest(
                data = openapi_client.models._customs_lines_post_request_data._customs_lines_post_request_data(
                    type = 'customs_lines', 
    ...
    def testCustomsLinesPostRequest(self):
        """Test CustomsLinesPostRequest"""
