...
class TestReturnRefundMethodsGet200Response(unittest.TestCase):
    """ReturnRefundMethodsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsGet200Response:
        """Test ReturnRefundMethodsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsGet200Response`
        """
        model = ReturnRefundMethodsGet200Response()
        if include_optional:
            return ReturnRefundMethodsGet200Response(
                data = [
                    openapi_client.models._return_refund_methods_get_200_response_data_inner._return_refund_methods_get_200_response_data_inner(
    ...
    def testReturnRefundMethodsGet200Response(self):
        """Test ReturnRefundMethodsGet200Response"""
