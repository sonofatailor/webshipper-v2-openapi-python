...
class TestWebhookFailuresIdGet200ResponseRelationships(unittest.TestCase):
    """WebhookFailuresIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresIdGet200ResponseRelationships:
        """Test WebhookFailuresIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresIdGet200ResponseRelationships`
        """
        model = WebhookFailuresIdGet200ResponseRelationships()
        if include_optional:
            return WebhookFailuresIdGet200ResponseRelationships(
    ...
    def testWebhookFailuresIdGet200ResponseRelationships(self):
        """Test WebhookFailuresIdGet200ResponseRelationships"""
