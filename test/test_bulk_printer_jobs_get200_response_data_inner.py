...
class TestBulkPrinterJobsGet200ResponseDataInner(unittest.TestCase):
    """BulkPrinterJobsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkPrinterJobsGet200ResponseDataInner:
        """Test BulkPrinterJobsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPrinterJobsGet200ResponseDataInner`
        """
        model = BulkPrinterJobsGet200ResponseDataInner()
        if include_optional:
            return BulkPrinterJobsGet200ResponseDataInner(
    ...
    def testBulkPrinterJobsGet200ResponseDataInner(self):
        """Test BulkPrinterJobsGet200ResponseDataInner"""
