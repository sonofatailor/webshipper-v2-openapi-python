...
class TestDocumentsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentsIdGet200ResponseData:
        """Test DocumentsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsIdGet200ResponseData`
        """
        model = DocumentsIdGet200ResponseData()
        if include_optional:
    ...
    def testDocumentsIdGet200ResponseData(self):
        """Test DocumentsIdGet200ResponseData"""
