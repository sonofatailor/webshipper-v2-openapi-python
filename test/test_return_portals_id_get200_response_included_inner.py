...
class TestReturnPortalsIdGet200ResponseIncludedInner(unittest.TestCase):
    """ReturnPortalsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnPortalsIdGet200ResponseIncludedInner:
        """Test ReturnPortalsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsIdGet200ResponseIncludedInner`
        """
        model = ReturnPortalsIdGet200ResponseIncludedInner()
        if include_optional:
            return ReturnPortalsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testReturnPortalsIdGet200ResponseIncludedInner(self):
        """Test ReturnPortalsIdGet200ResponseIncludedInner"""
