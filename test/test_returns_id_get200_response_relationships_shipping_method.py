...
class TestReturnsIdGet200ResponseRelationshipsShippingMethod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnsIdGet200ResponseRelationshipsShippingMethod:
        """Test ReturnsIdGet200ResponseRelationshipsShippingMethod
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsIdGet200ResponseRelationshipsShippingMethod`
        """
    ...
    def testReturnsIdGet200ResponseRelationshipsShippingMethod(self):
        """Test ReturnsIdGet200ResponseRelationshipsShippingMethod"""
