...
class TestErrorTypesGet200ResponseDataInner(unittest.TestCase):
    """ErrorTypesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorTypesGet200ResponseDataInner:
        """Test ErrorTypesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorTypesGet200ResponseDataInner`
        """
        model = ErrorTypesGet200ResponseDataInner()
        if include_optional:
            return ErrorTypesGet200ResponseDataInner(
    ...
    def testErrorTypesGet200ResponseDataInner(self):
        """Test ErrorTypesGet200ResponseDataInner"""
