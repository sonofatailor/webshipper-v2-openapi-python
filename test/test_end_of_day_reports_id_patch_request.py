...
class TestEndOfDayReportsIdPatchRequest(unittest.TestCase):
    """EndOfDayReportsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndOfDayReportsIdPatchRequest:
        """Test EndOfDayReportsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndOfDayReportsIdPatchRequest`
        """
        model = EndOfDayReportsIdPatchRequest()
        if include_optional:
            return EndOfDayReportsIdPatchRequest(
    ...
    def testEndOfDayReportsIdPatchRequest(self):
        """Test EndOfDayReportsIdPatchRequest"""
