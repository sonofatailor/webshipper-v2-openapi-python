...
class TestAdditionalAttributesIdGet200ResponseRelationshipsOrderData(unittest.TestCase):
    """AdditionalAttributesIdGet200ResponseRelationshipsOrderData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdGet200ResponseRelationshipsOrderData:
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrderData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdGet200ResponseRelationshipsOrderData`
        """
        model = AdditionalAttributesIdGet200ResponseRelationshipsOrderData()
        if include_optional:
            return AdditionalAttributesIdGet200ResponseRelationshipsOrderData(
                id = '',
                type = 'orders'
            )
        else:
    ...
    def testAdditionalAttributesIdGet200ResponseRelationshipsOrderData(self):
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrderData"""
