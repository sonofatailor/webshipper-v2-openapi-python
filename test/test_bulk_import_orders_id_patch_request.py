...
class TestBulkImportOrdersIdPatchRequest(unittest.TestCase):
    """BulkImportOrdersIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkImportOrdersIdPatchRequest:
        """Test BulkImportOrdersIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkImportOrdersIdPatchRequest`
        """
        model = BulkImportOrdersIdPatchRequest()
        if include_optional:
            return BulkImportOrdersIdPatchRequest(
    ...
    def testBulkImportOrdersIdPatchRequest(self):
        """Test BulkImportOrdersIdPatchRequest"""
