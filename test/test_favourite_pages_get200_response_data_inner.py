...
class TestFavouritePagesGet200ResponseDataInner(unittest.TestCase):
    """FavouritePagesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FavouritePagesGet200ResponseDataInner:
        """Test FavouritePagesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesGet200ResponseDataInner`
        """
        model = FavouritePagesGet200ResponseDataInner()
        if include_optional:
            return FavouritePagesGet200ResponseDataInner(
    ...
    def testFavouritePagesGet200ResponseDataInner(self):
        """Test FavouritePagesGet200ResponseDataInner"""
