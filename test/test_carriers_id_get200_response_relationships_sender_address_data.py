...
class TestCarriersIdGet200ResponseRelationshipsSenderAddressData(unittest.TestCase):
    """CarriersIdGet200ResponseRelationshipsSenderAddressData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersIdGet200ResponseRelationshipsSenderAddressData:
        """Test CarriersIdGet200ResponseRelationshipsSenderAddressData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersIdGet200ResponseRelationshipsSenderAddressData`
        """
        model = CarriersIdGet200ResponseRelationshipsSenderAddressData()
        if include_optional:
            return CarriersIdGet200ResponseRelationshipsSenderAddressData(
                id = '',
    ...
    def testCarriersIdGet200ResponseRelationshipsSenderAddressData(self):
        """Test CarriersIdGet200ResponseRelationshipsSenderAddressData"""
