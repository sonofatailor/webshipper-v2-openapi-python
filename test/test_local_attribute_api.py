...
class TestLocalAttributeApi(unittest.TestCase):
    """LocalAttributeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LocalAttributeApi()

    def tearDown(self) -> None:
        pass

    def test_local_attrs_get(self) -> None:
        """Test case for local_attrs_get

        List all Local Attributes
        """
        pass

    def test_local_attrs_id_get(self) -> None:
        """Test case for local_attrs_id_get
