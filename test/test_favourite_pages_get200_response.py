...
class TestFavouritePagesGet200Response(unittest.TestCase):
    """FavouritePagesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FavouritePagesGet200Response:
        """Test FavouritePagesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesGet200Response`
        """
        model = FavouritePagesGet200Response()
        if include_optional:
            return FavouritePagesGet200Response(
                data = [
                    openapi_client.models._favourite_pages_get_200_response_data_inner._favourite_pages_get_200_response_data_inner(
    ...
    def testFavouritePagesGet200Response(self):
        """Test FavouritePagesGet200Response"""
