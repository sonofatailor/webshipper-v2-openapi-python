...
class TestWaybillApi(unittest.TestCase):
    """WaybillApi unit test stubs"""
    ...
    def test_waybills_get(self) -> None:
        """Test case for waybills_get

        List all Waybills
        """
        pass

    def test_waybills_id_delete(self) -> None:
        """Test case for waybills_id_delete

        Delete a Waybill
        """
        pass

    def test_waybills_id_get(self) -> None:
        """Test case for waybills_id_get

        Show a single Waybill
        """
        pass

    def test_waybills_id_patch(self) -> None:
        """Test case for waybills_id_patch

        Update a Waybill
        """
        pass

    def test_waybills_post(self) -> None:
        """Test case for waybills_post
