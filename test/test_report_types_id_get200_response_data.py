...
class TestReportTypesIdGet200ResponseData(unittest.TestCase):
    """ReportTypesIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportTypesIdGet200ResponseData:
        """Test ReportTypesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportTypesIdGet200ResponseData`
        """
        model = ReportTypesIdGet200ResponseData()
        if include_optional:
            return ReportTypesIdGet200ResponseData(
                id = 56,
                type = 'report_types',
    ...
    def testReportTypesIdGet200ResponseData(self):
        """Test ReportTypesIdGet200ResponseData"""
