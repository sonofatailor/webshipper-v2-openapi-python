...
class TestWaybillsIdPatchRequest(unittest.TestCase):
    """WaybillsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaybillsIdPatchRequest:
        """Test WaybillsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaybillsIdPatchRequest`
        """
        model = WaybillsIdPatchRequest()
        if include_optional:
            return WaybillsIdPatchRequest(
    ...
    def testWaybillsIdPatchRequest(self):
        """Test WaybillsIdPatchRequest"""
