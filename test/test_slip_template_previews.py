...
class TestSlipTemplatePreviews(unittest.TestCase):
    """SlipTemplatePreviews unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlipTemplatePreviews:
        """Test SlipTemplatePreviews
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatePreviews`
        """
        model = SlipTemplatePreviews()
        if include_optional:
            return SlipTemplatePreviews(
                slip_template = '',
                order_visible_ref = '',
                var_base64 = '',
                example_id = ''
    ...
    def testSlipTemplatePreviews(self):
        """Test SlipTemplatePreviews"""
