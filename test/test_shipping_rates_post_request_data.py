...
class TestShippingRatesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingRatesPostRequestData:
        """Test ShippingRatesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingRatesPostRequestData`
        """
        model = ShippingRatesPostRequestData()
        if include_optional:
    ...
    def testShippingRatesPostRequestData(self):
        """Test ShippingRatesPostRequestData"""
