...
class TestSlipTemplatePreviewsGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SlipTemplatePreviewsGet200Response:
        """Test SlipTemplatePreviewsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatePreviewsGet200Response`
        """
        model = SlipTemplatePreviewsGet200Response()
        if include_optional:
    ...
    def testSlipTemplatePreviewsGet200Response(self):
        """Test SlipTemplatePreviewsGet200Response"""
