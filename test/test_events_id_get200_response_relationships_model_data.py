...
class TestEventsIdGet200ResponseRelationshipsModelData(unittest.TestCase):
    """EventsIdGet200ResponseRelationshipsModelData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsIdGet200ResponseRelationshipsModelData:
        """Test EventsIdGet200ResponseRelationshipsModelData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsIdGet200ResponseRelationshipsModelData`
        """
        model = EventsIdGet200ResponseRelationshipsModelData()
        if include_optional:
            return EventsIdGet200ResponseRelationshipsModelData(
                id = '',
                type = 'event_models'
            )
        else:
    ...
    def testEventsIdGet200ResponseRelationshipsModelData(self):
        """Test EventsIdGet200ResponseRelationshipsModelData"""
