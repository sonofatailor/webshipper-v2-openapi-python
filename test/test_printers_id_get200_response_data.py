...
class TestPrintersIdGet200ResponseData(unittest.TestCase):
    """PrintersIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintersIdGet200ResponseData:
        """Test PrintersIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintersIdGet200ResponseData`
        """
        model = PrintersIdGet200ResponseData()
        if include_optional:
            return PrintersIdGet200ResponseData(
                id = 56,
                type = 'printers',
    ...
    def testPrintersIdGet200ResponseData(self):
        """Test PrintersIdGet200ResponseData"""
