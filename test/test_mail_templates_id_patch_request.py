...
class TestMailTemplatesIdPatchRequest(unittest.TestCase):
    """MailTemplatesIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatesIdPatchRequest:
        """Test MailTemplatesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesIdPatchRequest`
        """
        model = MailTemplatesIdPatchRequest()
        if include_optional:
            return MailTemplatesIdPatchRequest(
    ...
    def testMailTemplatesIdPatchRequest(self):
        """Test MailTemplatesIdPatchRequest"""
