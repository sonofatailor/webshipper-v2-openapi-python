...
class TestLocalAttrsGet200ResponseDataInner(unittest.TestCase):
    """LocalAttrsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrsGet200ResponseDataInner:
        """Test LocalAttrsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsGet200ResponseDataInner`
        """
        model = LocalAttrsGet200ResponseDataInner()
        if include_optional:
            return LocalAttrsGet200ResponseDataInner(
    ...
    def testLocalAttrsGet200ResponseDataInner(self):
        """Test LocalAttrsGet200ResponseDataInner"""
