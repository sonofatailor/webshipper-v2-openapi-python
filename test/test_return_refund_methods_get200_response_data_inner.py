...
class TestReturnRefundMethodsGet200ResponseDataInner(unittest.TestCase):
    """ReturnRefundMethodsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsGet200ResponseDataInner:
        """Test ReturnRefundMethodsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsGet200ResponseDataInner`
        """
        model = ReturnRefundMethodsGet200ResponseDataInner()
        if include_optional:
            return ReturnRefundMethodsGet200ResponseDataInner(
    ...
    def testReturnRefundMethodsGet200ResponseDataInner(self):
        """Test ReturnRefundMethodsGet200ResponseDataInner"""
