...
class TestEndOfDayReportsPostRequestData(unittest.TestCase):
    """EndOfDayReportsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndOfDayReportsPostRequestData:
        """Test EndOfDayReportsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndOfDayReportsPostRequestData`
        """
        model = EndOfDayReportsPostRequestData()
        if include_optional:
            return EndOfDayReportsPostRequestData(
    ...
    def testEndOfDayReportsPostRequestData(self):
        """Test EndOfDayReportsPostRequestData"""
