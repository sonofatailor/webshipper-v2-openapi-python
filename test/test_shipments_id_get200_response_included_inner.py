...
class TestShipmentsIdGet200ResponseIncludedInner(unittest.TestCase):
    """ShipmentsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentsIdGet200ResponseIncludedInner:
        """Test ShipmentsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsIdGet200ResponseIncludedInner`
        """
        model = ShipmentsIdGet200ResponseIncludedInner()
        if include_optional:
            return ShipmentsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testShipmentsIdGet200ResponseIncludedInner(self):
        """Test ShipmentsIdGet200ResponseIncludedInner"""
