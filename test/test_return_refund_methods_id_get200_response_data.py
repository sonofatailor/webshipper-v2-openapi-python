...
class TestReturnRefundMethodsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsIdGet200ResponseData:
        """Test ReturnRefundMethodsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsIdGet200ResponseData`
        """
        model = ReturnRefundMethodsIdGet200ResponseData()
        if include_optional:
    ...
    def testReturnRefundMethodsIdGet200ResponseData(self):
        """Test ReturnRefundMethodsIdGet200ResponseData"""
