...
class TestHasDocumentsPostRequestData(unittest.TestCase):
    """HasDocumentsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HasDocumentsPostRequestData:
        """Test HasDocumentsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasDocumentsPostRequestData`
        """
        model = HasDocumentsPostRequestData()
        if include_optional:
            return HasDocumentsPostRequestData(
                type = 'has_documents',
    ...
    def testHasDocumentsPostRequestData(self):
        """Test HasDocumentsPostRequestData"""
