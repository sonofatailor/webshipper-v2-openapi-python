...
class TestReturnsIdGet200ResponseRelationshipsRefundMethodData(unittest.TestCase):
    """ReturnsIdGet200ResponseRelationshipsRefundMethodData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnsIdGet200ResponseRelationshipsRefundMethodData:
        """Test ReturnsIdGet200ResponseRelationshipsRefundMethodData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsIdGet200ResponseRelationshipsRefundMethodData`
        """
        model = ReturnsIdGet200ResponseRelationshipsRefundMethodData()
        if include_optional:
            return ReturnsIdGet200ResponseRelationshipsRefundMethodData(
                id = '',
    ...
    def testReturnsIdGet200ResponseRelationshipsRefundMethodData(self):
        """Test ReturnsIdGet200ResponseRelationshipsRefundMethodData"""
