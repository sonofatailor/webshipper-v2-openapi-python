...
class TestReturnRefundMethodsIdGet200ResponseRelationships(unittest.TestCase):
    """ReturnRefundMethodsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsIdGet200ResponseRelationships:
        """Test ReturnRefundMethodsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsIdGet200ResponseRelationships`
        """
        model = ReturnRefundMethodsIdGet200ResponseRelationships()
        if include_optional:
            return ReturnRefundMethodsIdGet200ResponseRelationships(
    ...
    def testReturnRefundMethodsIdGet200ResponseRelationships(self):
        """Test ReturnRefundMethodsIdGet200ResponseRelationships"""
