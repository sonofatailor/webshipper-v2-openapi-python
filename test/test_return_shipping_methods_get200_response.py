...
class TestReturnShippingMethodsGet200Response(unittest.TestCase):
    """ReturnShippingMethodsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsGet200Response:
        """Test ReturnShippingMethodsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsGet200Response`
        """
        model = ReturnShippingMethodsGet200Response()
        if include_optional:
            return ReturnShippingMethodsGet200Response(
                data = [
                    openapi_client.models._return_shipping_methods_get_200_response_data_inner._return_shipping_methods_get_200_response_data_inner(
    ...
    def testReturnShippingMethodsGet200Response(self):
        """Test ReturnShippingMethodsGet200Response"""
