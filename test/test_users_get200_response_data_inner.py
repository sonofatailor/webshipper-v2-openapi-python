...
class TestUsersGet200ResponseDataInner(unittest.TestCase):
    """UsersGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersGet200ResponseDataInner:
        """Test UsersGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersGet200ResponseDataInner`
        """
        model = UsersGet200ResponseDataInner()
        if include_optional:
            return UsersGet200ResponseDataInner(
    ...
    def testUsersGet200ResponseDataInner(self):
        """Test UsersGet200ResponseDataInner"""
