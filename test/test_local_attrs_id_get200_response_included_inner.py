...
class TestLocalAttrsIdGet200ResponseIncludedInner(unittest.TestCase):
    """LocalAttrsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrsIdGet200ResponseIncludedInner:
        """Test LocalAttrsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsIdGet200ResponseIncludedInner`
        """
        model = LocalAttrsIdGet200ResponseIncludedInner()
        if include_optional:
            return LocalAttrsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testLocalAttrsIdGet200ResponseIncludedInner(self):
        """Test LocalAttrsIdGet200ResponseIncludedInner"""
