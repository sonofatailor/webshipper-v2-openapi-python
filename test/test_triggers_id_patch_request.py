...
class TestTriggersIdPatchRequest(unittest.TestCase):
    """TriggersIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggersIdPatchRequest:
        """Test TriggersIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggersIdPatchRequest`
        """
        model = TriggersIdPatchRequest()
        if include_optional:
            return TriggersIdPatchRequest(
    ...
    def testTriggersIdPatchRequest(self):
        """Test TriggersIdPatchRequest"""
