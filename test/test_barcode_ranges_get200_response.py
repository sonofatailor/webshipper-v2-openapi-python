...
class TestBarcodeRangesGet200Response(unittest.TestCase):
    """BarcodeRangesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BarcodeRangesGet200Response:
        """Test BarcodeRangesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesGet200Response`
        """
        model = BarcodeRangesGet200Response()
        if include_optional:
            return BarcodeRangesGet200Response(
                data = [
                    openapi_client.models._barcode_ranges_get_200_response_data_inner._barcode_ranges_get_200_response_data_inner(
    ...
    def testBarcodeRangesGet200Response(self):
        """Test BarcodeRangesGet200Response"""
