...
class TestOrderMergesPostRequestData(unittest.TestCase):
    """OrderMergesPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderMergesPostRequestData:
        """Test OrderMergesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderMergesPostRequestData`
        """
        model = OrderMergesPostRequestData()
        if include_optional:
            return OrderMergesPostRequestData(
                type = 'order_merges',
    ...
    def testOrderMergesPostRequestData(self):
        """Test OrderMergesPostRequestData"""
