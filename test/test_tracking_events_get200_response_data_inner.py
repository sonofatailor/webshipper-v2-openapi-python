...
class TestTrackingEventsGet200ResponseDataInner(unittest.TestCase):
    """TrackingEventsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackingEventsGet200ResponseDataInner:
        """Test TrackingEventsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsGet200ResponseDataInner`
        """
        model = TrackingEventsGet200ResponseDataInner()
        if include_optional:
            return TrackingEventsGet200ResponseDataInner(
    ...
    def testTrackingEventsGet200ResponseDataInner(self):
        """Test TrackingEventsGet200ResponseDataInner"""
