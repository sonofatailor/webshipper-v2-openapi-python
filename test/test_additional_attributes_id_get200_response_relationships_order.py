...
class TestAdditionalAttributesIdGet200ResponseRelationshipsOrder(unittest.TestCase):
    """AdditionalAttributesIdGet200ResponseRelationshipsOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdGet200ResponseRelationshipsOrder:
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrder
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdGet200ResponseRelationshipsOrder`
        """
        model = AdditionalAttributesIdGet200ResponseRelationshipsOrder()
        if include_optional:
            return AdditionalAttributesIdGet200ResponseRelationshipsOrder(
    ...
    def testAdditionalAttributesIdGet200ResponseRelationshipsOrder(self):
        """Test AdditionalAttributesIdGet200ResponseRelationshipsOrder"""
