...
class TestWaybillsIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WaybillsIdGet200ResponseIncludedInner:
        """Test WaybillsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaybillsIdGet200ResponseIncludedInner`
        """
        model = WaybillsIdGet200ResponseIncludedInner()
        if include_optional:
            return WaybillsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testWaybillsIdGet200ResponseIncludedInner(self):
        """Test WaybillsIdGet200ResponseIncludedInner"""
