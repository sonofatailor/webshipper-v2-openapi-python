...
class TestPrinterJobsIdPatchRequest(unittest.TestCase):
    """PrinterJobsIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsIdPatchRequest:
        """Test PrinterJobsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsIdPatchRequest`
        """
        model = PrinterJobsIdPatchRequest()
        if include_optional:
            return PrinterJobsIdPatchRequest(
    ...
    def testPrinterJobsIdPatchRequest(self):
        """Test PrinterJobsIdPatchRequest"""
