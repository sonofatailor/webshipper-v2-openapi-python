...
class TestPrinterJobsIdGet200ResponseIncludedInner(unittest.TestCase):
    """PrinterJobsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsIdGet200ResponseIncludedInner:
        """Test PrinterJobsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsIdGet200ResponseIncludedInner`
        """
        model = PrinterJobsIdGet200ResponseIncludedInner()
        if include_optional:
            return PrinterJobsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testPrinterJobsIdGet200ResponseIncludedInner(self):
        """Test PrinterJobsIdGet200ResponseIncludedInner"""
