...
class TestAdditionalAttributeApi(unittest.TestCase):
    """AdditionalAttributeApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AdditionalAttributeApi()

    def tearDown(self) -> None:
        pass

    def test_additional_attributes_get(self) -> None:
        """Test case for additional_attributes_get

        List all Additional Attributes
        """
        pass

    def test_additional_attributes_id_delete(self) -> None:
        """Test case for additional_attributes_id_delete

        Delete a Additional Attribute
        """
        pass

    def test_additional_attributes_id_get(self) -> None:
        """Test case for additional_attributes_id_get

        Show a single Additional Attribute
        """
        pass

    def test_additional_attributes_id_patch(self) -> None:
        """Test case for additional_attributes_id_patch

        Update a Additional Attribute
        """
        pass

    def test_additional_attributes_post(self) -> None:
        """Test case for additional_attributes_post
