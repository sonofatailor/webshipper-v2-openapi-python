...
class TestTrackingEventsIdGet200ResponseRelationshipsPackageData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackingEventsIdGet200ResponseRelationshipsPackageData:
        """Test TrackingEventsIdGet200ResponseRelationshipsPackageData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsIdGet200ResponseRelationshipsPackageData`
        """
        model = TrackingEventsIdGet200ResponseRelationshipsPackageData()
        if include_optional:
            return TrackingEventsIdGet200ResponseRelationshipsPackageData(
                id = '',
                type = 'packages'
            )
        else:
    ...
    def testTrackingEventsIdGet200ResponseRelationshipsPackageData(self):
        """Test TrackingEventsIdGet200ResponseRelationshipsPackageData"""
