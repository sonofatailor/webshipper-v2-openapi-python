...
class TestMailTemplatesIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MailTemplatesIdGet200ResponseIncludedInner:
        """Test MailTemplatesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesIdGet200ResponseIncludedInner`
        """
        model = MailTemplatesIdGet200ResponseIncludedInner()
        if include_optional:
            return MailTemplatesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testMailTemplatesIdGet200ResponseIncludedInner(self):
        """Test MailTemplatesIdGet200ResponseIncludedInner"""
