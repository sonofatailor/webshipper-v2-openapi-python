...
class TestPackagesGet200ResponseDataInner(unittest.TestCase):
    """PackagesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PackagesGet200ResponseDataInner:
        """Test PackagesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackagesGet200ResponseDataInner`
        """
        model = PackagesGet200ResponseDataInner()
        if include_optional:
            return PackagesGet200ResponseDataInner(
    ...
    def testPackagesGet200ResponseDataInner(self):
        """Test PackagesGet200ResponseDataInner"""
