...
class TestPrinterClientsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterClientsIdPatchRequest:
        """Test PrinterClientsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsIdPatchRequest`
        """
    ...
    def testPrinterClientsIdPatchRequest(self):
        """Test PrinterClientsIdPatchRequest"""
