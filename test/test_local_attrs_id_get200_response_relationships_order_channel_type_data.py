...
class TestLocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData:
        """Test LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData`
        """
        model = LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData()
        if include_optional:
            return LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData(
                id = '',
    ...
    def testLocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData(self):
        """Test LocalAttrsIdGet200ResponseRelationshipsOrderChannelTypeData"""
