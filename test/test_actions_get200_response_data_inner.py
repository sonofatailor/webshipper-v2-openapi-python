...
class TestActionsGet200ResponseDataInner(unittest.TestCase):
    """ActionsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionsGet200ResponseDataInner:
        """Test ActionsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsGet200ResponseDataInner`
        """
        model = ActionsGet200ResponseDataInner()
        if include_optional:
            return ActionsGet200ResponseDataInner(
    ...
    def testActionsGet200ResponseDataInner(self):
        """Test ActionsGet200ResponseDataInner"""
