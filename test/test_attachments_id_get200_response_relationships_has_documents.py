...
class TestAttachmentsIdGet200ResponseRelationshipsHasDocuments(unittest.TestCase):
    """AttachmentsIdGet200ResponseRelationshipsHasDocuments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseRelationshipsHasDocuments:
        """Test AttachmentsIdGet200ResponseRelationshipsHasDocuments
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseRelationshipsHasDocuments`
        """
        model = AttachmentsIdGet200ResponseRelationshipsHasDocuments()
        if include_optional:
            return AttachmentsIdGet200ResponseRelationshipsHasDocuments(
    ...
    def testAttachmentsIdGet200ResponseRelationshipsHasDocuments(self):
        """Test AttachmentsIdGet200ResponseRelationshipsHasDocuments"""
