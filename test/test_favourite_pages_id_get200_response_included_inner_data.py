...
class TestFavouritePagesIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """FavouritePagesIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FavouritePagesIdGet200ResponseIncludedInnerData:
        """Test FavouritePagesIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesIdGet200ResponseIncludedInnerData`
        """
        model = FavouritePagesIdGet200ResponseIncludedInnerData()
        if include_optional:
            return FavouritePagesIdGet200ResponseIncludedInnerData(
                first_name = '',
                last_name = '',
                email = '',
                password = 56,
    ...
    def testFavouritePagesIdGet200ResponseIncludedInnerData(self):
        """Test FavouritePagesIdGet200ResponseIncludedInnerData"""
