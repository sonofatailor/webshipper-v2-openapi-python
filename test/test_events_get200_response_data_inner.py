...
class TestEventsGet200ResponseDataInner(unittest.TestCase):
    """EventsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsGet200ResponseDataInner:
        """Test EventsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsGet200ResponseDataInner`
        """
        model = EventsGet200ResponseDataInner()
        if include_optional:
            return EventsGet200ResponseDataInner(
    ...
    def testEventsGet200ResponseDataInner(self):
        """Test EventsGet200ResponseDataInner"""
