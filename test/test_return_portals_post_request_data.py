...
class TestReturnPortalsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnPortalsPostRequestData:
        """Test ReturnPortalsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsPostRequestData`
        """
        model = ReturnPortalsPostRequestData()
        if include_optional:
    ...
    def testReturnPortalsPostRequestData(self):
        """Test ReturnPortalsPostRequestData"""
