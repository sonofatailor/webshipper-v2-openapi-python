...
class TestCarrierAccessesIdGet200ResponseIncludedInner(unittest.TestCase):
    """CarrierAccessesIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierAccessesIdGet200ResponseIncludedInner:
        """Test CarrierAccessesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierAccessesIdGet200ResponseIncludedInner`
        """
        model = CarrierAccessesIdGet200ResponseIncludedInner()
        if include_optional:
            return CarrierAccessesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testCarrierAccessesIdGet200ResponseIncludedInner(self):
        """Test CarrierAccessesIdGet200ResponseIncludedInner"""
