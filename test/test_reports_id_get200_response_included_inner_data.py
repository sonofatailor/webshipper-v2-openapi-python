...
class TestReportsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """ReportsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportsIdGet200ResponseIncludedInnerData:
        """Test ReportsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportsIdGet200ResponseIncludedInnerData`
        """
        model = ReportsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return ReportsIdGet200ResponseIncludedInnerData(
                name = '',
                columns = [
                    ''
                    ],
    ...
    def testReportsIdGet200ResponseIncludedInnerData(self):
        """Test ReportsIdGet200ResponseIncludedInnerData"""
