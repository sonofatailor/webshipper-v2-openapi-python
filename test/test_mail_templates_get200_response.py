...
class TestMailTemplatesGet200Response(unittest.TestCase):
    """MailTemplatesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatesGet200Response:
        """Test MailTemplatesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatesGet200Response`
        """
        model = MailTemplatesGet200Response()
        if include_optional:
            return MailTemplatesGet200Response(
                data = [
                    openapi_client.models._mail_templates_get_200_response_data_inner._mail_templates_get_200_response_data_inner(
    ...
    def testMailTemplatesGet200Response(self):
        """Test MailTemplatesGet200Response"""
