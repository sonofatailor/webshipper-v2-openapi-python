...
class TestAttachmentApi(unittest.TestCase):
    ...
    def test_attachments_get(self) -> None:
    ...
    def test_attachments_id_get(self) -> None:
    ...
    def test_attachments_id_patch(self) -> None:
        """Test case for attachments_id_patch

        Update a Attachment
        """
        pass

    def test_attachments_post(self) -> None:
