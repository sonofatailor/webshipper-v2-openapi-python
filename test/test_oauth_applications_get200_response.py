...
class TestOauthApplicationsGet200Response(unittest.TestCase):
    """OauthApplicationsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthApplicationsGet200Response:
        """Test OauthApplicationsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthApplicationsGet200Response`
        """
        model = OauthApplicationsGet200Response()
        if include_optional:
            return OauthApplicationsGet200Response(
                data = [
                    openapi_client.models._oauth_applications_get_200_response_data_inner._oauth_applications_get_200_response_data_inner(
    ...
    def testOauthApplicationsGet200Response(self):
        """Test OauthApplicationsGet200Response"""
