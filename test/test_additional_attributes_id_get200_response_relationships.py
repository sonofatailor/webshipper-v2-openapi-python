...
class TestAdditionalAttributesIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdGet200ResponseRelationships:
        """Test AdditionalAttributesIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdGet200ResponseRelationships`
        """
    ...
    def testAdditionalAttributesIdGet200ResponseRelationships(self):
        """Test AdditionalAttributesIdGet200ResponseRelationships"""
