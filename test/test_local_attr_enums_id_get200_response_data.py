...
class TestLocalAttrEnumsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsIdGet200ResponseData:
        """Test LocalAttrEnumsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsIdGet200ResponseData`
        """
        model = LocalAttrEnumsIdGet200ResponseData()
        if include_optional:
    ...
    def testLocalAttrEnumsIdGet200ResponseData(self):
        """Test LocalAttrEnumsIdGet200ResponseData"""
