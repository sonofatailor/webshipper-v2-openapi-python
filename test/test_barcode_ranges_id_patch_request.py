...
class TestBarcodeRangesIdPatchRequest(unittest.TestCase):
    """BarcodeRangesIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BarcodeRangesIdPatchRequest:
        """Test BarcodeRangesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesIdPatchRequest`
        """
        model = BarcodeRangesIdPatchRequest()
        if include_optional:
            return BarcodeRangesIdPatchRequest(
    ...
    def testBarcodeRangesIdPatchRequest(self):
        """Test BarcodeRangesIdPatchRequest"""
