...
class TestPrinterJobsPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterJobsPostRequest:
        """Test PrinterJobsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsPostRequest`
        """
    ...
    def testPrinterJobsPostRequest(self):
        """Test PrinterJobsPostRequest"""
