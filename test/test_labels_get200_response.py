...
class TestLabelsGet200Response(unittest.TestCase):
    """LabelsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LabelsGet200Response:
        """Test LabelsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelsGet200Response`
        """
        model = LabelsGet200Response()
        if include_optional:
            return LabelsGet200Response(
                data = [
                    openapi_client.models._labels_get_200_response_data_inner._labels_get_200_response_data_inner(
    ...
    def testLabelsGet200Response(self):
        """Test LabelsGet200Response"""
