...
class TestReturnPortalsIdGet200ResponseRelationshipsMailTemplateData(unittest.TestCase):
    """ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData:
        """Test ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData`
        """
        model = ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData()
        if include_optional:
            return ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData(
                id = '',
                type = 'mail_templates'
            )
        else:
    ...
    def testReturnPortalsIdGet200ResponseRelationshipsMailTemplateData(self):
        """Test ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData"""
