...
class TestBarcodeRangesIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BarcodeRangesIdGet200ResponseRelationships:
        """Test BarcodeRangesIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesIdGet200ResponseRelationships`
        """
    ...
    def testBarcodeRangesIdGet200ResponseRelationships(self):
        """Test BarcodeRangesIdGet200ResponseRelationships"""
