...
class TestEventModelsGet200Response(unittest.TestCase):
    """EventModelsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventModelsGet200Response:
        """Test EventModelsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventModelsGet200Response`
        """
        model = EventModelsGet200Response()
        if include_optional:
            return EventModelsGet200Response(
                data = [
                    openapi_client.models._event_models_get_200_response_data_inner._event_models_get_200_response_data_inner(
    ...
    def testEventModelsGet200Response(self):
        """Test EventModelsGet200Response"""
