...
class TestCustomsLinesIdGet200ResponseData(unittest.TestCase):
    """CustomsLinesIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomsLinesIdGet200ResponseData:
        """Test CustomsLinesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomsLinesIdGet200ResponseData`
        """
        model = CustomsLinesIdGet200ResponseData()
        if include_optional:
            return CustomsLinesIdGet200ResponseData(
                id = 56,
                type = 'customs_lines',
    ...
    def testCustomsLinesIdGet200ResponseData(self):
        """Test CustomsLinesIdGet200ResponseData"""
