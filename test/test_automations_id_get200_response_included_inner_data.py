...
class TestAutomationsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """AutomationsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsIdGet200ResponseIncludedInnerData:
        """Test AutomationsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsIdGet200ResponseIncludedInnerData`
        """
        model = AutomationsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return AutomationsIdGet200ResponseIncludedInnerData(
            )
        else:
            return AutomationsIdGet200ResponseIncludedInnerData(
        )
    ...
    def testAutomationsIdGet200ResponseIncludedInnerData(self):
        """Test AutomationsIdGet200ResponseIncludedInnerData"""
