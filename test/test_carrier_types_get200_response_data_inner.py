...
class TestCarrierTypesGet200ResponseDataInner(unittest.TestCase):
    """CarrierTypesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierTypesGet200ResponseDataInner:
        """Test CarrierTypesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierTypesGet200ResponseDataInner`
        """
        model = CarrierTypesGet200ResponseDataInner()
        if include_optional:
            return CarrierTypesGet200ResponseDataInner(
    ...
    def testCarrierTypesGet200ResponseDataInner(self):
        """Test CarrierTypesGet200ResponseDataInner"""
