...
class TestReturnPortalsIdGet200ResponseRelationships(unittest.TestCase):
    """ReturnPortalsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnPortalsIdGet200ResponseRelationships:
        """Test ReturnPortalsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsIdGet200ResponseRelationships`
        """
        model = ReturnPortalsIdGet200ResponseRelationships()
        if include_optional:
            return ReturnPortalsIdGet200ResponseRelationships(
    ...
    def testReturnPortalsIdGet200ResponseRelationships(self):
        """Test ReturnPortalsIdGet200ResponseRelationships"""
