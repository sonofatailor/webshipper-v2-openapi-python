...
class TestCsvUploadsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvUploadsPostRequestData:
        """Test CsvUploadsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvUploadsPostRequestData`
        """
        model = CsvUploadsPostRequestData()
        if include_optional:
    ...
    def testCsvUploadsPostRequestData(self):
        """Test CsvUploadsPostRequestData"""
