...
class TestOrderChannelAccessesIdGet200ResponseIncludedInner(unittest.TestCase):
    """OrderChannelAccessesIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesIdGet200ResponseIncludedInner:
        """Test OrderChannelAccessesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesIdGet200ResponseIncludedInner`
        """
        model = OrderChannelAccessesIdGet200ResponseIncludedInner()
        if include_optional:
            return OrderChannelAccessesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testOrderChannelAccessesIdGet200ResponseIncludedInner(self):
        """Test OrderChannelAccessesIdGet200ResponseIncludedInner"""
