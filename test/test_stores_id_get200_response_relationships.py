...
class TestStoresIdGet200ResponseRelationships(unittest.TestCase):
    """StoresIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoresIdGet200ResponseRelationships:
        """Test StoresIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresIdGet200ResponseRelationships`
        """
        model = StoresIdGet200ResponseRelationships()
        if include_optional:
            return StoresIdGet200ResponseRelationships(
    ...
    def testStoresIdGet200ResponseRelationships(self):
        """Test StoresIdGet200ResponseRelationships"""
