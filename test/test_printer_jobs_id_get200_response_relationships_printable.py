...
class TestPrinterJobsIdGet200ResponseRelationshipsPrintable(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterJobsIdGet200ResponseRelationshipsPrintable:
        """Test PrinterJobsIdGet200ResponseRelationshipsPrintable
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsIdGet200ResponseRelationshipsPrintable`
        """
    ...
    def testPrinterJobsIdGet200ResponseRelationshipsPrintable(self):
        """Test PrinterJobsIdGet200ResponseRelationshipsPrintable"""
