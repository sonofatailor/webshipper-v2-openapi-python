...
class TestEventModelsPostRequestData(unittest.TestCase):
    """EventModelsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventModelsPostRequestData:
        """Test EventModelsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventModelsPostRequestData`
        """
        model = EventModelsPostRequestData()
        if include_optional:
            return EventModelsPostRequestData(
                type = 'event_models',
    ...
    def testEventModelsPostRequestData(self):
        """Test EventModelsPostRequestData"""
