...
class TestPrintablesGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrintablesGet200Response:
        """Test PrintablesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintablesGet200Response`
        """
        model = PrintablesGet200Response()
        if include_optional:
    ...
    def testPrintablesGet200Response(self):
        """Test PrintablesGet200Response"""
