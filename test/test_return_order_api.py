...
class TestReturnOrderApi(unittest.TestCase):
    ...
    def test_returns_get(self) -> None:
        """Test case for returns_get

        List all Return Orders
        """
        pass

    def test_returns_id_delete(self) -> None:
        """Test case for returns_id_delete

        Delete a Return Order
        """
        pass

    def test_returns_id_get(self) -> None:
        """Test case for returns_id_get

        Show a single Return Order
        """
        pass

    def test_returns_id_patch(self) -> None:
        """Test case for returns_id_patch
