...
class TestAutomationsGet200ResponseDataInner(unittest.TestCase):
    """AutomationsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsGet200ResponseDataInner:
        """Test AutomationsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsGet200ResponseDataInner`
        """
        model = AutomationsGet200ResponseDataInner()
        if include_optional:
            return AutomationsGet200ResponseDataInner(
    ...
    def testAutomationsGet200ResponseDataInner(self):
        """Test AutomationsGet200ResponseDataInner"""
