...
class TestMailTemplatePreviewsIdGet200ResponseData(unittest.TestCase):
    """MailTemplatePreviewsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatePreviewsIdGet200ResponseData:
        """Test MailTemplatePreviewsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatePreviewsIdGet200ResponseData`
        """
        model = MailTemplatePreviewsIdGet200ResponseData()
        if include_optional:
            return MailTemplatePreviewsIdGet200ResponseData(
                id = 56,
    ...
    def testMailTemplatePreviewsIdGet200ResponseData(self):
        """Test MailTemplatePreviewsIdGet200ResponseData"""
