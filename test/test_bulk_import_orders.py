...
class TestBulkImportOrders(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BulkImportOrders:
        """Test BulkImportOrders
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkImportOrders`
        """
        model = BulkImportOrders()
        if include_optional:
            return BulkImportOrders(
                ids = '',
                order_channel_id = '',
                var_async = '',
                reimport = '',
