...
class TestCustomsLinesGet200Response(unittest.TestCase):
    """CustomsLinesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomsLinesGet200Response:
        """Test CustomsLinesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomsLinesGet200Response`
        """
        model = CustomsLinesGet200Response()
        if include_optional:
            return CustomsLinesGet200Response(
                data = [
                    openapi_client.models._customs_lines_get_200_response_data_inner._customs_lines_get_200_response_data_inner(
    ...
    def testCustomsLinesGet200Response(self):
        """Test CustomsLinesGet200Response"""
