...
class TestCarrierAccessesIdGet200ResponseRelationshipsUser(unittest.TestCase):
    """CarrierAccessesIdGet200ResponseRelationshipsUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierAccessesIdGet200ResponseRelationshipsUser:
        """Test CarrierAccessesIdGet200ResponseRelationshipsUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierAccessesIdGet200ResponseRelationshipsUser`
        """
        model = CarrierAccessesIdGet200ResponseRelationshipsUser()
        if include_optional:
            return CarrierAccessesIdGet200ResponseRelationshipsUser(
    ...
    def testCarrierAccessesIdGet200ResponseRelationshipsUser(self):
        """Test CarrierAccessesIdGet200ResponseRelationshipsUser"""
