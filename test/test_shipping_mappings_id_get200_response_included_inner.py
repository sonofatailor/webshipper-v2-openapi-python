...
class TestShippingMappingsIdGet200ResponseIncludedInner(unittest.TestCase):
    """ShippingMappingsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingMappingsIdGet200ResponseIncludedInner:
        """Test ShippingMappingsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingMappingsIdGet200ResponseIncludedInner`
        """
        model = ShippingMappingsIdGet200ResponseIncludedInner()
        if include_optional:
            return ShippingMappingsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testShippingMappingsIdGet200ResponseIncludedInner(self):
        """Test ShippingMappingsIdGet200ResponseIncludedInner"""
