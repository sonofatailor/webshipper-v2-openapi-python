...
class TestLocalAttrsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """LocalAttrsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrsIdGet200ResponseIncludedInnerData:
        """Test LocalAttrsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsIdGet200ResponseIncludedInnerData`
        """
        model = LocalAttrsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return LocalAttrsIdGet200ResponseIncludedInnerData(
                name = '',
                support_url = '',
                public_global_attrs = '',
                list_logo = '',
    ...
    def testLocalAttrsIdGet200ResponseIncludedInnerData(self):
        """Test LocalAttrsIdGet200ResponseIncludedInnerData"""
