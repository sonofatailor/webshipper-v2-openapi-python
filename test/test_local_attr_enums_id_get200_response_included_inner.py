...
class TestLocalAttrEnumsIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsIdGet200ResponseIncludedInner:
        """Test LocalAttrEnumsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsIdGet200ResponseIncludedInner`
        """
        model = LocalAttrEnumsIdGet200ResponseIncludedInner()
        if include_optional:
            return LocalAttrEnumsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testLocalAttrEnumsIdGet200ResponseIncludedInner(self):
        """Test LocalAttrEnumsIdGet200ResponseIncludedInner"""
