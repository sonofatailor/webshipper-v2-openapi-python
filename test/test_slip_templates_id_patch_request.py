...
class TestSlipTemplatesIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SlipTemplatesIdPatchRequest:
        """Test SlipTemplatesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatesIdPatchRequest`
        """
    ...
    def testSlipTemplatesIdPatchRequest(self):
        """Test SlipTemplatesIdPatchRequest"""
