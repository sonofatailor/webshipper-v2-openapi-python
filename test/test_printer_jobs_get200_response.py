...
class TestPrinterJobsGet200Response(unittest.TestCase):
    """PrinterJobsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsGet200Response:
        """Test PrinterJobsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsGet200Response`
        """
        model = PrinterJobsGet200Response()
        if include_optional:
            return PrinterJobsGet200Response(
                data = [
                    openapi_client.models._printer_jobs_get_200_response_data_inner._printer_jobs_get_200_response_data_inner(
    ...
    def testPrinterJobsGet200Response(self):
        """Test PrinterJobsGet200Response"""
