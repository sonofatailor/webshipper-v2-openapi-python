...
class TestBulkPrinterJobsGet200Response(unittest.TestCase):
    """BulkPrinterJobsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkPrinterJobsGet200Response:
        """Test BulkPrinterJobsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPrinterJobsGet200Response`
        """
        model = BulkPrinterJobsGet200Response()
        if include_optional:
            return BulkPrinterJobsGet200Response(
                data = [
                    openapi_client.models._bulk_printer_jobs_get_200_response_data_inner._bulk_printer_jobs_get_200_response_data_inner(
    ...
    def testBulkPrinterJobsGet200Response(self):
        """Test BulkPrinterJobsGet200Response"""
