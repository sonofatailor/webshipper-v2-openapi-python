    ...
    def make_instance(self, include_optional) -> OrdersIdGet200Response:
        ...
        if include_optional:
            return OrdersIdGet200Response(
                data = webshipperv2.models._orders__id__get_200_response_data._orders__id__get_200_response_data(
                    id = 56, 
                    type = 'orders', 
                ...
                included = [
                    webshipperv2.models._orders__id__get_200_response_included_inner._orders__id__get_200_response_included_inner(
                        type = 'orders', 
                        id = 56, 
                        data = null, )
                    ]
