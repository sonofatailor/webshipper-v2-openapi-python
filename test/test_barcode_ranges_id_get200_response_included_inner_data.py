...
class TestBarcodeRangesIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """BarcodeRangesIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BarcodeRangesIdGet200ResponseIncludedInnerData:
        """Test BarcodeRangesIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesIdGet200ResponseIncludedInnerData`
        """
        model = BarcodeRangesIdGet200ResponseIncludedInnerData()
        if include_optional:
            return BarcodeRangesIdGet200ResponseIncludedInnerData(
                alias = '',
                services = '',
                attrs = '',
                prefer_zpl = True,
    ...
    def testBarcodeRangesIdGet200ResponseIncludedInnerData(self):
        """Test BarcodeRangesIdGet200ResponseIncludedInnerData"""
