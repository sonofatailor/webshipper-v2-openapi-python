...
class TestTagsGet200ResponseDataInner(unittest.TestCase):
    """TagsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagsGet200ResponseDataInner:
        """Test TagsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagsGet200ResponseDataInner`
        """
        model = TagsGet200ResponseDataInner()
        if include_optional:
            return TagsGet200ResponseDataInner(
    ...
    def testTagsGet200ResponseDataInner(self):
        """Test TagsGet200ResponseDataInner"""
