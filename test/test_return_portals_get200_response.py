...
class TestReturnPortalsGet200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnPortalsGet200Response:
        """Test ReturnPortalsGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsGet200Response`
        """
        model = ReturnPortalsGet200Response()
        if include_optional:
    ...
    def testReturnPortalsGet200Response(self):
        """Test ReturnPortalsGet200Response"""
