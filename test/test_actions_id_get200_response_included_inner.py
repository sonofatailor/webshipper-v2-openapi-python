...
class TestActionsIdGet200ResponseIncludedInner(unittest.TestCase):
    """ActionsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionsIdGet200ResponseIncludedInner:
        """Test ActionsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsIdGet200ResponseIncludedInner`
        """
        model = ActionsIdGet200ResponseIncludedInner()
        if include_optional:
            return ActionsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testActionsIdGet200ResponseIncludedInner(self):
        """Test ActionsIdGet200ResponseIncludedInner"""
