...
class TestLocalAttrsIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalAttrsIdGet200ResponseRelationships:
        """Test LocalAttrsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrsIdGet200ResponseRelationships`
        """
    ...
    def testLocalAttrsIdGet200ResponseRelationships(self):
        """Test LocalAttrsIdGet200ResponseRelationships"""
