...
class TestHotKeysIdGet200ResponseRelationshipsFavouritePage(unittest.TestCase):
    """HotKeysIdGet200ResponseRelationshipsFavouritePage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotKeysIdGet200ResponseRelationshipsFavouritePage:
        """Test HotKeysIdGet200ResponseRelationshipsFavouritePage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysIdGet200ResponseRelationshipsFavouritePage`
        """
        model = HotKeysIdGet200ResponseRelationshipsFavouritePage()
        if include_optional:
            return HotKeysIdGet200ResponseRelationshipsFavouritePage(
    ...
    def testHotKeysIdGet200ResponseRelationshipsFavouritePage(self):
        """Test HotKeysIdGet200ResponseRelationshipsFavouritePage"""
