...
class TestCarriersIdGet200ResponseRelationshipsCarrierTypeData(unittest.TestCase):
    """CarriersIdGet200ResponseRelationshipsCarrierTypeData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersIdGet200ResponseRelationshipsCarrierTypeData:
        """Test CarriersIdGet200ResponseRelationshipsCarrierTypeData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersIdGet200ResponseRelationshipsCarrierTypeData`
        """
        model = CarriersIdGet200ResponseRelationshipsCarrierTypeData()
        if include_optional:
            return CarriersIdGet200ResponseRelationshipsCarrierTypeData(
                id = '',
                type = 'carrier_types'
            )
        else:
    ...
    def testCarriersIdGet200ResponseRelationshipsCarrierTypeData(self):
        """Test CarriersIdGet200ResponseRelationshipsCarrierTypeData"""
