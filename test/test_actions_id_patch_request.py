...
class TestActionsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsIdPatchRequest:
        """Test ActionsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsIdPatchRequest`
        """
    ...
    def testActionsIdPatchRequest(self):
        """Test ActionsIdPatchRequest"""
