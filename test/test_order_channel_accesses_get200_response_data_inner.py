...
class TestOrderChannelAccessesGet200ResponseDataInner(unittest.TestCase):
    """OrderChannelAccessesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesGet200ResponseDataInner:
        """Test OrderChannelAccessesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesGet200ResponseDataInner`
        """
        model = OrderChannelAccessesGet200ResponseDataInner()
        if include_optional:
            return OrderChannelAccessesGet200ResponseDataInner(
    ...
    def testOrderChannelAccessesGet200ResponseDataInner(self):
        """Test OrderChannelAccessesGet200ResponseDataInner"""
