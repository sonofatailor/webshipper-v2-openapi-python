...
class TestStoresIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StoresIdGet200ResponseIncludedInnerData:
        """Test StoresIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresIdGet200ResponseIncludedInnerData`
        """
        model = StoresIdGet200ResponseIncludedInnerData()
        if include_optional:
            return StoresIdGet200ResponseIncludedInnerData(
                att_contact = '',
                company_name = '',
                address_1 = '',
                address_2 = '',
    ...
    def testStoresIdGet200ResponseIncludedInnerData(self):
        """Test StoresIdGet200ResponseIncludedInnerData"""
