...
class TestActionsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionsPostRequestData:
        """Test ActionsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsPostRequestData`
        """
        model = ActionsPostRequestData()
        if include_optional:
    ...
    def testActionsPostRequestData(self):
        """Test ActionsPostRequestData"""
