...
class TestDropPointLocators(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DropPointLocators:
        """Test DropPointLocators
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DropPointLocators`
        """
        model = DropPointLocators()
        if include_optional:
            return DropPointLocators(
                carrier_id = 56,
                service_code = '',
                shipping_rate_id = '',
                drop_point_id = '',
    ...
    def testDropPointLocators(self):
        """Test DropPointLocators"""
