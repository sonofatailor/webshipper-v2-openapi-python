...
class TestBulkPrinterJobs(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BulkPrinterJobs:
        """Test BulkPrinterJobs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPrinterJobs`
        """
        model = BulkPrinterJobs()
        if include_optional:
            return BulkPrinterJobs(
                ids = '',
                model_type = '',
                printer_client_id = ''
            )
