...
class TestHasDocumentsGet200ResponseDataInner(unittest.TestCase):
    """HasDocumentsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HasDocumentsGet200ResponseDataInner:
        """Test HasDocumentsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasDocumentsGet200ResponseDataInner`
        """
        model = HasDocumentsGet200ResponseDataInner()
        if include_optional:
            return HasDocumentsGet200ResponseDataInner(
    ...
    def testHasDocumentsGet200ResponseDataInner(self):
        """Test HasDocumentsGet200ResponseDataInner"""
