...
class TestCsvMappingsIdGet200ResponseRelationshipsOrderChannelData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvMappingsIdGet200ResponseRelationshipsOrderChannelData:
        """Test CsvMappingsIdGet200ResponseRelationshipsOrderChannelData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvMappingsIdGet200ResponseRelationshipsOrderChannelData`
        """
        model = CsvMappingsIdGet200ResponseRelationshipsOrderChannelData()
        if include_optional:
            return CsvMappingsIdGet200ResponseRelationshipsOrderChannelData(
                id = '',
                type = 'order_channels'
            )
        else:
    ...
    def testCsvMappingsIdGet200ResponseRelationshipsOrderChannelData(self):
        """Test CsvMappingsIdGet200ResponseRelationshipsOrderChannelData"""
