...
class TestAutomationsIdGet200ResponseData(unittest.TestCase):
    """AutomationsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsIdGet200ResponseData:
        """Test AutomationsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsIdGet200ResponseData`
        """
        model = AutomationsIdGet200ResponseData()
        if include_optional:
            return AutomationsIdGet200ResponseData(
                id = 56,
                type = 'automations',
    ...
    def testAutomationsIdGet200ResponseData(self):
        """Test AutomationsIdGet200ResponseData"""
