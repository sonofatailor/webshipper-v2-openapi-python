...
class TestCustomsLinesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomsLinesPostRequestData:
        """Test CustomsLinesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomsLinesPostRequestData`
        """
        model = CustomsLinesPostRequestData()
        if include_optional:
    ...
    def testCustomsLinesPostRequestData(self):
        """Test CustomsLinesPostRequestData"""
