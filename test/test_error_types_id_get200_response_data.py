...
class TestErrorTypesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ErrorTypesIdGet200ResponseData:
        """Test ErrorTypesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorTypesIdGet200ResponseData`
        """
        model = ErrorTypesIdGet200ResponseData()
        if include_optional:
    ...
    def testErrorTypesIdGet200ResponseData(self):
        """Test ErrorTypesIdGet200ResponseData"""
