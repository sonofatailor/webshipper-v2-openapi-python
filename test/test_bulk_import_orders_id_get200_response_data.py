...
class TestBulkImportOrdersIdGet200ResponseData(unittest.TestCase):
    """BulkImportOrdersIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkImportOrdersIdGet200ResponseData:
        """Test BulkImportOrdersIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkImportOrdersIdGet200ResponseData`
        """
        model = BulkImportOrdersIdGet200ResponseData()
        if include_optional:
            return BulkImportOrdersIdGet200ResponseData(
                id = 56,
    ...
    def testBulkImportOrdersIdGet200ResponseData(self):
        """Test BulkImportOrdersIdGet200ResponseData"""
