...
class TestOrdersIdGet200ResponseRelationshipsShippingRateData(unittest.TestCase):
    """OrdersIdGet200ResponseRelationshipsShippingRateData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseRelationshipsShippingRateData:
        """Test OrdersIdGet200ResponseRelationshipsShippingRateData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseRelationshipsShippingRateData`
        """
        model = OrdersIdGet200ResponseRelationshipsShippingRateData()
        if include_optional:
            return OrdersIdGet200ResponseRelationshipsShippingRateData(
                id = '',
                type = 'shipping_rates'
            )
        else:
    ...
    def testOrdersIdGet200ResponseRelationshipsShippingRateData(self):
        """Test OrdersIdGet200ResponseRelationshipsShippingRateData"""
