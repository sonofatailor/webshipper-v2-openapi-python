...
class TestCarrierApi(unittest.TestCase):
    ...
    def test_carriers_get(self) -> None:
        """Test case for carriers_get

        List all Carriers
        """
        pass

    def test_carriers_id_delete(self) -> None:
        """Test case for carriers_id_delete

        Delete a Carrier
        """
        pass

    def test_carriers_id_get(self) -> None:
        """Test case for carriers_id_get

        Show a single Carrier
        """
        pass

    def test_carriers_id_patch(self) -> None:
        """Test case for carriers_id_patch

        Update a Carrier
        """
        pass

    def test_carriers_post(self) -> None:
        """Test case for carriers_post
