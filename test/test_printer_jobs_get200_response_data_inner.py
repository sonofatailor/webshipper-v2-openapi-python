...
class TestPrinterJobsGet200ResponseDataInner(unittest.TestCase):
    """PrinterJobsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsGet200ResponseDataInner:
        """Test PrinterJobsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsGet200ResponseDataInner`
        """
        model = PrinterJobsGet200ResponseDataInner()
        if include_optional:
            return PrinterJobsGet200ResponseDataInner(
    ...
    def testPrinterJobsGet200ResponseDataInner(self):
        """Test PrinterJobsGet200ResponseDataInner"""
