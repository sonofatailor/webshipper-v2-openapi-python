...
class TestAutomationsIdGet200ResponseRelationshipsActivityTypeData(unittest.TestCase):
    """AutomationsIdGet200ResponseRelationshipsActivityTypeData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomationsIdGet200ResponseRelationshipsActivityTypeData:
        """Test AutomationsIdGet200ResponseRelationshipsActivityTypeData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsIdGet200ResponseRelationshipsActivityTypeData`
        """
        model = AutomationsIdGet200ResponseRelationshipsActivityTypeData()
        if include_optional:
            return AutomationsIdGet200ResponseRelationshipsActivityTypeData(
                id = '',
                type = 'activity_types'
            )
        else:
    ...
    def testAutomationsIdGet200ResponseRelationshipsActivityTypeData(self):
        """Test AutomationsIdGet200ResponseRelationshipsActivityTypeData"""
