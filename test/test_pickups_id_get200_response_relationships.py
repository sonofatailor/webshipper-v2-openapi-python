...
class TestPickupsIdGet200ResponseRelationships(unittest.TestCase):
    """PickupsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PickupsIdGet200ResponseRelationships:
        """Test PickupsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsIdGet200ResponseRelationships`
        """
        model = PickupsIdGet200ResponseRelationships()
        if include_optional:
            return PickupsIdGet200ResponseRelationships(
    ...
    def testPickupsIdGet200ResponseRelationships(self):
        """Test PickupsIdGet200ResponseRelationships"""
