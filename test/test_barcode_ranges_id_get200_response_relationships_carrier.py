...
class TestBarcodeRangesIdGet200ResponseRelationshipsCarrier(unittest.TestCase):
    """BarcodeRangesIdGet200ResponseRelationshipsCarrier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BarcodeRangesIdGet200ResponseRelationshipsCarrier:
        """Test BarcodeRangesIdGet200ResponseRelationshipsCarrier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesIdGet200ResponseRelationshipsCarrier`
        """
        model = BarcodeRangesIdGet200ResponseRelationshipsCarrier()
        if include_optional:
            return BarcodeRangesIdGet200ResponseRelationshipsCarrier(
    ...
    def testBarcodeRangesIdGet200ResponseRelationshipsCarrier(self):
        """Test BarcodeRangesIdGet200ResponseRelationshipsCarrier"""
