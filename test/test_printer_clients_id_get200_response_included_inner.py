...
class TestPrinterClientsIdGet200ResponseIncludedInner(unittest.TestCase):
    """PrinterClientsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterClientsIdGet200ResponseIncludedInner:
        """Test PrinterClientsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsIdGet200ResponseIncludedInner`
        """
        model = PrinterClientsIdGet200ResponseIncludedInner()
        if include_optional:
            return PrinterClientsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testPrinterClientsIdGet200ResponseIncludedInner(self):
        """Test PrinterClientsIdGet200ResponseIncludedInner"""
