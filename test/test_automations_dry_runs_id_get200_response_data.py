...
class TestAutomationsDryRunsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutomationsDryRunsIdGet200ResponseData:
        """Test AutomationsDryRunsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomationsDryRunsIdGet200ResponseData`
        """
        model = AutomationsDryRunsIdGet200ResponseData()
        if include_optional:
    ...
    def testAutomationsDryRunsIdGet200ResponseData(self):
        """Test AutomationsDryRunsIdGet200ResponseData"""
