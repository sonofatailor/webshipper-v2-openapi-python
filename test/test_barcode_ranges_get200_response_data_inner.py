...
class TestBarcodeRangesGet200ResponseDataInner(unittest.TestCase):
    """BarcodeRangesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BarcodeRangesGet200ResponseDataInner:
        """Test BarcodeRangesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesGet200ResponseDataInner`
        """
        model = BarcodeRangesGet200ResponseDataInner()
        if include_optional:
            return BarcodeRangesGet200ResponseDataInner(
    ...
    def testBarcodeRangesGet200ResponseDataInner(self):
        """Test BarcodeRangesGet200ResponseDataInner"""
