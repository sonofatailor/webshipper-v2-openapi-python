...
class TestCarriersPostRequestData(unittest.TestCase):
    """CarriersPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersPostRequestData:
        """Test CarriersPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersPostRequestData`
        """
        model = CarriersPostRequestData()
        if include_optional:
            return CarriersPostRequestData(
                type = 'carriers',
    ...
    def testCarriersPostRequestData(self):
        """Test CarriersPostRequestData"""
