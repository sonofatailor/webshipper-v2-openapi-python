...
class TestOrderChannelAccessesIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """OrderChannelAccessesIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesIdGet200ResponseIncludedInnerData:
        """Test OrderChannelAccessesIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesIdGet200ResponseIncludedInnerData`
        """
        model = OrderChannelAccessesIdGet200ResponseIncludedInnerData()
        if include_optional:
            return OrderChannelAccessesIdGet200ResponseIncludedInnerData(
                channel_label = '',
                attrs = [
                    ''
                    ],
    ...
    def testOrderChannelAccessesIdGet200ResponseIncludedInnerData(self):
        """Test OrderChannelAccessesIdGet200ResponseIncludedInnerData"""
