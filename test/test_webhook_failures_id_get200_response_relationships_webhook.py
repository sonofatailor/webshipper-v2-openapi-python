...
class TestWebhookFailuresIdGet200ResponseRelationshipsWebhook(unittest.TestCase):
    """WebhookFailuresIdGet200ResponseRelationshipsWebhook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresIdGet200ResponseRelationshipsWebhook:
        """Test WebhookFailuresIdGet200ResponseRelationshipsWebhook
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresIdGet200ResponseRelationshipsWebhook`
        """
        model = WebhookFailuresIdGet200ResponseRelationshipsWebhook()
        if include_optional:
            return WebhookFailuresIdGet200ResponseRelationshipsWebhook(
    ...
    def testWebhookFailuresIdGet200ResponseRelationshipsWebhook(self):
        """Test WebhookFailuresIdGet200ResponseRelationshipsWebhook"""
