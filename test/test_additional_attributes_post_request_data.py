...
class TestAdditionalAttributesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesPostRequestData:
        """Test AdditionalAttributesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesPostRequestData`
        """
        model = AdditionalAttributesPostRequestData()
        if include_optional:
    ...
    def testAdditionalAttributesPostRequestData(self):
        """Test AdditionalAttributesPostRequestData"""
