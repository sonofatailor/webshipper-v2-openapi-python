...
class TestExpressionsPostRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExpressionsPostRequest:
        """Test ExpressionsPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpressionsPostRequest`
        """
    ...
    def testExpressionsPostRequest(self):
        """Test ExpressionsPostRequest"""
