...
class TestOrdersIdGet200ResponseRelationshipsPrinterClient(unittest.TestCase):
    """OrdersIdGet200ResponseRelationshipsPrinterClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseRelationshipsPrinterClient:
        """Test OrdersIdGet200ResponseRelationshipsPrinterClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseRelationshipsPrinterClient`
        """
        model = OrdersIdGet200ResponseRelationshipsPrinterClient()
        if include_optional:
            return OrdersIdGet200ResponseRelationshipsPrinterClient(
    ...
    def testOrdersIdGet200ResponseRelationshipsPrinterClient(self):
        """Test OrdersIdGet200ResponseRelationshipsPrinterClient"""
