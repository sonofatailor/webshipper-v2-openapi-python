...
class TestDocumentsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """DocumentsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsIdGet200ResponseIncludedInnerData:
        """Test DocumentsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsIdGet200ResponseIncludedInnerData`
        """
        model = DocumentsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return DocumentsIdGet200ResponseIncludedInnerData(
            )
        else:
            return DocumentsIdGet200ResponseIncludedInnerData(
        )
    ...
    def testDocumentsIdGet200ResponseIncludedInnerData(self):
        """Test DocumentsIdGet200ResponseIncludedInnerData"""
