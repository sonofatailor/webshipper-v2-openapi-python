...
class TestAttachmentsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttachmentsPostRequestData:
        """Test AttachmentsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsPostRequestData`
        """
        model = AttachmentsPostRequestData()
        if include_optional:
    ...
    def testAttachmentsPostRequestData(self):
        """Test AttachmentsPostRequestData"""
