...
class TestAttachmentsIdGet200ResponseData(unittest.TestCase):
    """AttachmentsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseData:
        """Test AttachmentsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseData`
        """
        model = AttachmentsIdGet200ResponseData()
        if include_optional:
            return AttachmentsIdGet200ResponseData(
                id = 56,
                type = 'attachments',
    ...
    def testAttachmentsIdGet200ResponseData(self):
        """Test AttachmentsIdGet200ResponseData"""
