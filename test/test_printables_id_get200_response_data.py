...
class TestPrintablesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrintablesIdGet200ResponseData:
        """Test PrintablesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintablesIdGet200ResponseData`
        """
        model = PrintablesIdGet200ResponseData()
        if include_optional:
            return PrintablesIdGet200ResponseData(
                id = 56,
                type = 'printables',
                attributes = None
            )
    ...
    def testPrintablesIdGet200ResponseData(self):
        """Test PrintablesIdGet200ResponseData"""
