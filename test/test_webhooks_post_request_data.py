...
class TestWebhooksPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebhooksPostRequestData:
        """Test WebhooksPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksPostRequestData`
        """
        model = WebhooksPostRequestData()
        if include_optional:
    ...
    def testWebhooksPostRequestData(self):
        """Test WebhooksPostRequestData"""
