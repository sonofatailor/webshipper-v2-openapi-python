...
class TestWebhookFailures(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebhookFailures:
        """Test WebhookFailures
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailures`
        """
        model = WebhookFailures()
        if include_optional:
