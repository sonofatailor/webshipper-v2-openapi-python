...
class TestOrderChannelApi(unittest.TestCase):
    """OrderChannelApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OrderChannelApi()

    def tearDown(self) -> None:
        pass

    def test_order_channels_get(self) -> None:
        """Test case for order_channels_get

        List all Order Channels
        """
        pass

    def test_order_channels_id_delete(self) -> None:
        """Test case for order_channels_id_delete

        Delete a Order Channel
        """
        pass

    def test_order_channels_id_get(self) -> None:
        """Test case for order_channels_id_get

        Show a single Order Channel
        """
        pass

    def test_order_channels_id_patch(self) -> None:
        """Test case for order_channels_id_patch

        Update a Order Channel
        """
        pass

    def test_order_channels_post(self) -> None:
        """Test case for order_channels_post
