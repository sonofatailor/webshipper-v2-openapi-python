...
class TestShippingRatesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingRatesIdGet200ResponseData:
        """Test ShippingRatesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingRatesIdGet200ResponseData`
        """
        model = ShippingRatesIdGet200ResponseData()
        if include_optional:
    ...
    def testShippingRatesIdGet200ResponseData(self):
        """Test ShippingRatesIdGet200ResponseData"""
