...
class TestMailTemplatePreviewsGet200ResponseDataInner(unittest.TestCase):
    """MailTemplatePreviewsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatePreviewsGet200ResponseDataInner:
        """Test MailTemplatePreviewsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatePreviewsGet200ResponseDataInner`
        """
        model = MailTemplatePreviewsGet200ResponseDataInner()
        if include_optional:
            return MailTemplatePreviewsGet200ResponseDataInner(
    ...
    def testMailTemplatePreviewsGet200ResponseDataInner(self):
        """Test MailTemplatePreviewsGet200ResponseDataInner"""
