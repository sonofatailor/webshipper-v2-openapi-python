...
class TestSlipTemplatePreviewsPostRequestData(unittest.TestCase):
    """SlipTemplatePreviewsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlipTemplatePreviewsPostRequestData:
        """Test SlipTemplatePreviewsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatePreviewsPostRequestData`
        """
        model = SlipTemplatePreviewsPostRequestData()
        if include_optional:
            return SlipTemplatePreviewsPostRequestData(
    ...
    def testSlipTemplatePreviewsPostRequestData(self):
        """Test SlipTemplatePreviewsPostRequestData"""
