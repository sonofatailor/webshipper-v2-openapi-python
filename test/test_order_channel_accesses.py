...
class TestOrderChannelAccesses(unittest.TestCase):
    """OrderChannelAccesses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelAccesses:
        """Test OrderChannelAccesses
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccesses`
        """
        model = OrderChannelAccesses()
        if include_optional:
            return OrderChannelAccesses(
                created_at = '',
                updated_at = ''
            )
        else:
    ...
    def testOrderChannelAccesses(self):
        """Test OrderChannelAccesses"""
