...
class TestRegionsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """RegionsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegionsIdGet200ResponseIncludedInnerData:
        """Test RegionsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionsIdGet200ResponseIncludedInnerData`
        """
        model = RegionsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return RegionsIdGet200ResponseIncludedInnerData(
                carrier_id = 56,
                order_channel_id = 56,
                name = '',
    ...
    def testRegionsIdGet200ResponseIncludedInnerData(self):
        """Test RegionsIdGet200ResponseIncludedInnerData"""
