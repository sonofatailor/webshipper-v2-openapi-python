...
class TestPackagesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PackagesIdGet200ResponseData:
        """Test PackagesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackagesIdGet200ResponseData`
        """
        model = PackagesIdGet200ResponseData()
        if include_optional:
    ...
    def testPackagesIdGet200ResponseData(self):
        """Test PackagesIdGet200ResponseData"""
