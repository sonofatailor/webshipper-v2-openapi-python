...
class TestFavouritePagesIdGet200ResponseRelationshipsHotKeyData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FavouritePagesIdGet200ResponseRelationshipsHotKeyData:
        """Test FavouritePagesIdGet200ResponseRelationshipsHotKeyData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesIdGet200ResponseRelationshipsHotKeyData`
        """
        model = FavouritePagesIdGet200ResponseRelationshipsHotKeyData()
        if include_optional:
            return FavouritePagesIdGet200ResponseRelationshipsHotKeyData(
                id = '',
                type = 'hot_keys'
            )
        else:
    ...
    def testFavouritePagesIdGet200ResponseRelationshipsHotKeyData(self):
        """Test FavouritePagesIdGet200ResponseRelationshipsHotKeyData"""
