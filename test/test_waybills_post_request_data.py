...
class TestWaybillsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WaybillsPostRequestData:
        """Test WaybillsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaybillsPostRequestData`
        """
        model = WaybillsPostRequestData()
        if include_optional:
    ...
    def testWaybillsPostRequestData(self):
        """Test WaybillsPostRequestData"""
