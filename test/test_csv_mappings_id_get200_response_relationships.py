...
class TestCsvMappingsIdGet200ResponseRelationships(unittest.TestCase):
    """CsvMappingsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvMappingsIdGet200ResponseRelationships:
        """Test CsvMappingsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvMappingsIdGet200ResponseRelationships`
        """
        model = CsvMappingsIdGet200ResponseRelationships()
        if include_optional:
            return CsvMappingsIdGet200ResponseRelationships(
    ...
    def testCsvMappingsIdGet200ResponseRelationships(self):
        """Test CsvMappingsIdGet200ResponseRelationships"""
