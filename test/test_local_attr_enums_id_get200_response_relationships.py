...
class TestLocalAttrEnumsIdGet200ResponseRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsIdGet200ResponseRelationships:
        """Test LocalAttrEnumsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsIdGet200ResponseRelationships`
        """
    ...
    def testLocalAttrEnumsIdGet200ResponseRelationships(self):
        """Test LocalAttrEnumsIdGet200ResponseRelationships"""
