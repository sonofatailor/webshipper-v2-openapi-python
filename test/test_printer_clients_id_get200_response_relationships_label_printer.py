...
class TestPrinterClientsIdGet200ResponseRelationshipsLabelPrinter(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterClientsIdGet200ResponseRelationshipsLabelPrinter:
        """Test PrinterClientsIdGet200ResponseRelationshipsLabelPrinter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterClientsIdGet200ResponseRelationshipsLabelPrinter`
        """
    ...
    def testPrinterClientsIdGet200ResponseRelationshipsLabelPrinter(self):
        """Test PrinterClientsIdGet200ResponseRelationshipsLabelPrinter"""
