...
class TestWebhookFailuresIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """WebhookFailuresIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresIdGet200ResponseIncludedInnerData:
        """Test WebhookFailuresIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresIdGet200ResponseIncludedInnerData`
        """
        model = WebhookFailuresIdGet200ResponseIncludedInnerData()
        if include_optional:
            return WebhookFailuresIdGet200ResponseIncludedInnerData(
                url = '',
                topic = '',
                enabled = True,
                secret = '',
    ...
    def testWebhookFailuresIdGet200ResponseIncludedInnerData(self):
        """Test WebhookFailuresIdGet200ResponseIncludedInnerData"""
