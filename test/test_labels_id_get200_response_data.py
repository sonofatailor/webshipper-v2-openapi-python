...
class TestLabelsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LabelsIdGet200ResponseData:
        """Test LabelsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelsIdGet200ResponseData`
        """
        model = LabelsIdGet200ResponseData()
        if include_optional:
    ...
    def testLabelsIdGet200ResponseData(self):
        """Test LabelsIdGet200ResponseData"""
