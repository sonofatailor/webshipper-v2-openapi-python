...
class TestWaybillsIdGet200ResponseData(unittest.TestCase):
    """WaybillsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaybillsIdGet200ResponseData:
        """Test WaybillsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaybillsIdGet200ResponseData`
        """
        model = WaybillsIdGet200ResponseData()
        if include_optional:
            return WaybillsIdGet200ResponseData(
                id = 56,
                type = 'waybills',
    ...
    def testWaybillsIdGet200ResponseData(self):
        """Test WaybillsIdGet200ResponseData"""
