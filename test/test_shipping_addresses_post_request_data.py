...
class TestShippingAddressesPostRequestData(unittest.TestCase):
    """ShippingAddressesPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingAddressesPostRequestData:
        """Test ShippingAddressesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingAddressesPostRequestData`
        """
        model = ShippingAddressesPostRequestData()
        if include_optional:
            return ShippingAddressesPostRequestData(
    ...
    def testShippingAddressesPostRequestData(self):
        """Test ShippingAddressesPostRequestData"""
