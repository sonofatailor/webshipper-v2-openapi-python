...
class TestFavouritePagesPostRequest(unittest.TestCase):
    """FavouritePagesPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FavouritePagesPostRequest:
        """Test FavouritePagesPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesPostRequest`
        """
        model = FavouritePagesPostRequest()
        if include_optional:
            return FavouritePagesPostRequest(
                data = openapi_client.models._favourite_pages_post_request_data._favourite_pages_post_request_data(
    ...
    def testFavouritePagesPostRequest(self):
        """Test FavouritePagesPostRequest"""
