...
class TestReturnShippingMethods(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethods:
        """Test ReturnShippingMethods
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethods`
        """
        model = ReturnShippingMethods()
        if include_optional:
    ...
    def testReturnShippingMethods(self):
        """Test ReturnShippingMethods"""
