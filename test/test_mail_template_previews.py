...
class TestMailTemplatePreviews(unittest.TestCase):
    """MailTemplatePreviews unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatePreviews:
        """Test MailTemplatePreviews
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatePreviews`
        """
        model = MailTemplatePreviews()
        if include_optional:
            return MailTemplatePreviews(
                mail = '',
                mail_template = '',
                mail_locale = '',
                locale = '',
    ...
    def testMailTemplatePreviews(self):
        """Test MailTemplatePreviews"""
