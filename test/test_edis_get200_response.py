...
class TestEdisGet200Response(unittest.TestCase):
    """EdisGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EdisGet200Response:
        """Test EdisGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EdisGet200Response`
        """
        model = EdisGet200Response()
        if include_optional:
            return EdisGet200Response(
                data = [
                    openapi_client.models._edis_get_200_response_data_inner._edis_get_200_response_data_inner(
    ...
    def testEdisGet200Response(self):
        """Test EdisGet200Response"""
