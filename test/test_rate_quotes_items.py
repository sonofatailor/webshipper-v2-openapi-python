...
class TestRateQuotesItems(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RateQuotesItems:
        """Test RateQuotesItems
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RateQuotesItems`
        """
        model = RateQuotesItems()
        if include_optional:
            return RateQuotesItems(
                price = ''
            )
        else:
            return RateQuotesItems(
