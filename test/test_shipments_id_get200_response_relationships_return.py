...
class TestShipmentsIdGet200ResponseRelationshipsReturn(unittest.TestCase):
    """ShipmentsIdGet200ResponseRelationshipsReturn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentsIdGet200ResponseRelationshipsReturn:
        """Test ShipmentsIdGet200ResponseRelationshipsReturn
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsIdGet200ResponseRelationshipsReturn`
        """
        model = ShipmentsIdGet200ResponseRelationshipsReturn()
        if include_optional:
            return ShipmentsIdGet200ResponseRelationshipsReturn(
    ...
    def testShipmentsIdGet200ResponseRelationshipsReturn(self):
        """Test ShipmentsIdGet200ResponseRelationshipsReturn"""
