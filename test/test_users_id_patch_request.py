...
class TestUsersIdPatchRequest(unittest.TestCase):
    """UsersIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersIdPatchRequest:
        """Test UsersIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersIdPatchRequest`
        """
        model = UsersIdPatchRequest()
        if include_optional:
            return UsersIdPatchRequest(
    ...
    def testUsersIdPatchRequest(self):
        """Test UsersIdPatchRequest"""
