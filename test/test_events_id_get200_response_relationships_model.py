...
class TestEventsIdGet200ResponseRelationshipsModel(unittest.TestCase):
    """EventsIdGet200ResponseRelationshipsModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsIdGet200ResponseRelationshipsModel:
        """Test EventsIdGet200ResponseRelationshipsModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsIdGet200ResponseRelationshipsModel`
        """
        model = EventsIdGet200ResponseRelationshipsModel()
        if include_optional:
            return EventsIdGet200ResponseRelationshipsModel(
    ...
    def testEventsIdGet200ResponseRelationshipsModel(self):
        """Test EventsIdGet200ResponseRelationshipsModel"""
