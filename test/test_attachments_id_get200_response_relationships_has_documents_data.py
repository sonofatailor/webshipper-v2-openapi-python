...
class TestAttachmentsIdGet200ResponseRelationshipsHasDocumentsData(unittest.TestCase):
    """AttachmentsIdGet200ResponseRelationshipsHasDocumentsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseRelationshipsHasDocumentsData:
        """Test AttachmentsIdGet200ResponseRelationshipsHasDocumentsData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseRelationshipsHasDocumentsData`
        """
        model = AttachmentsIdGet200ResponseRelationshipsHasDocumentsData()
        if include_optional:
            return AttachmentsIdGet200ResponseRelationshipsHasDocumentsData(
                id = '',
                type = 'has_documents'
            )
        else:
    ...
    def testAttachmentsIdGet200ResponseRelationshipsHasDocumentsData(self):
        """Test AttachmentsIdGet200ResponseRelationshipsHasDocumentsData"""
