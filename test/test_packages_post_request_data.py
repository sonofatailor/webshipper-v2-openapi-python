...
class TestPackagesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PackagesPostRequestData:
        """Test PackagesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PackagesPostRequestData`
        """
        model = PackagesPostRequestData()
        if include_optional:
    ...
    def testPackagesPostRequestData(self):
        """Test PackagesPostRequestData"""
