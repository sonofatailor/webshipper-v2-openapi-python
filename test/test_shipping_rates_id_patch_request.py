...
class TestShippingRatesIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingRatesIdPatchRequest:
        """Test ShippingRatesIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingRatesIdPatchRequest`
        """
    ...
    def testShippingRatesIdPatchRequest(self):
        """Test ShippingRatesIdPatchRequest"""
