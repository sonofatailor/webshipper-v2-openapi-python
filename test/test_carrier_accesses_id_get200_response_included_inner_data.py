...
class TestCarrierAccessesIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CarrierAccessesIdGet200ResponseIncludedInnerData:
        """Test CarrierAccessesIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierAccessesIdGet200ResponseIncludedInnerData`
        """
        model = CarrierAccessesIdGet200ResponseIncludedInnerData()
        if include_optional:
            return CarrierAccessesIdGet200ResponseIncludedInnerData(
                alias = '',
                services = '',
                attrs = '',
                prefer_zpl = True,
    ...
    def testCarrierAccessesIdGet200ResponseIncludedInnerData(self):
        """Test CarrierAccessesIdGet200ResponseIncludedInnerData"""
