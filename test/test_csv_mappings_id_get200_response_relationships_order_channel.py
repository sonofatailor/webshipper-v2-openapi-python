...
class TestCsvMappingsIdGet200ResponseRelationshipsOrderChannel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvMappingsIdGet200ResponseRelationshipsOrderChannel:
        """Test CsvMappingsIdGet200ResponseRelationshipsOrderChannel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvMappingsIdGet200ResponseRelationshipsOrderChannel`
        """
    ...
    def testCsvMappingsIdGet200ResponseRelationshipsOrderChannel(self):
        """Test CsvMappingsIdGet200ResponseRelationshipsOrderChannel"""
