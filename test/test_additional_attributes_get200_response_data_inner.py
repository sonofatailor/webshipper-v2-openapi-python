...
class TestAdditionalAttributesGet200ResponseDataInner(unittest.TestCase):
    """AdditionalAttributesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesGet200ResponseDataInner:
        """Test AdditionalAttributesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesGet200ResponseDataInner`
        """
        model = AdditionalAttributesGet200ResponseDataInner()
        if include_optional:
            return AdditionalAttributesGet200ResponseDataInner(
    ...
    def testAdditionalAttributesGet200ResponseDataInner(self):
        """Test AdditionalAttributesGet200ResponseDataInner"""
