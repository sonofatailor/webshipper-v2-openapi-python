...
class TestBarcodeRangesIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BarcodeRangesIdGet200ResponseIncludedInner:
        """Test BarcodeRangesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BarcodeRangesIdGet200ResponseIncludedInner`
        """
        model = BarcodeRangesIdGet200ResponseIncludedInner()
        if include_optional:
            return BarcodeRangesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testBarcodeRangesIdGet200ResponseIncludedInner(self):
        """Test BarcodeRangesIdGet200ResponseIncludedInner"""
