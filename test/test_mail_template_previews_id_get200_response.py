...
class TestMailTemplatePreviewsIdGet200Response(unittest.TestCase):
    """MailTemplatePreviewsIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MailTemplatePreviewsIdGet200Response:
        """Test MailTemplatePreviewsIdGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailTemplatePreviewsIdGet200Response`
        """
        model = MailTemplatePreviewsIdGet200Response()
        if include_optional:
            return MailTemplatePreviewsIdGet200Response(
    ...
    def testMailTemplatePreviewsIdGet200Response(self):
        """Test MailTemplatePreviewsIdGet200Response"""
