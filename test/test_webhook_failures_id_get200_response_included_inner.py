...
class TestWebhookFailuresIdGet200ResponseIncludedInner(unittest.TestCase):
    """WebhookFailuresIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookFailuresIdGet200ResponseIncludedInner:
        """Test WebhookFailuresIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresIdGet200ResponseIncludedInner`
        """
        model = WebhookFailuresIdGet200ResponseIncludedInner()
        if include_optional:
            return WebhookFailuresIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testWebhookFailuresIdGet200ResponseIncludedInner(self):
        """Test WebhookFailuresIdGet200ResponseIncludedInner"""
