...
class TestReturnRefundMethodsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """ReturnRefundMethodsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsIdGet200ResponseIncludedInnerData:
        """Test ReturnRefundMethodsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsIdGet200ResponseIncludedInnerData`
        """
        model = ReturnRefundMethodsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return ReturnRefundMethodsIdGet200ResponseIncludedInnerData(
                name = '',
                custom_style = '',
                shipping_methods = '',
                translations = '',
    ...
    def testReturnRefundMethodsIdGet200ResponseIncludedInnerData(self):
        """Test ReturnRefundMethodsIdGet200ResponseIncludedInnerData"""
