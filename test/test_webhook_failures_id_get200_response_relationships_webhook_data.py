...
class TestWebhookFailuresIdGet200ResponseRelationshipsWebhookData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebhookFailuresIdGet200ResponseRelationshipsWebhookData:
        """Test WebhookFailuresIdGet200ResponseRelationshipsWebhookData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookFailuresIdGet200ResponseRelationshipsWebhookData`
        """
        model = WebhookFailuresIdGet200ResponseRelationshipsWebhookData()
        if include_optional:
            return WebhookFailuresIdGet200ResponseRelationshipsWebhookData(
                id = '',
                type = 'webhooks'
            )
        else:
    ...
    def testWebhookFailuresIdGet200ResponseRelationshipsWebhookData(self):
        """Test WebhookFailuresIdGet200ResponseRelationshipsWebhookData"""
