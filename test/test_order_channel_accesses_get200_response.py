...
class TestOrderChannelAccessesGet200Response(unittest.TestCase):
    """OrderChannelAccessesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelAccessesGet200Response:
        """Test OrderChannelAccessesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelAccessesGet200Response`
        """
        model = OrderChannelAccessesGet200Response()
        if include_optional:
            return OrderChannelAccessesGet200Response(
                data = [
                    openapi_client.models._order_channel_accesses_get_200_response_data_inner._order_channel_accesses_get_200_response_data_inner(
    ...
    def testOrderChannelAccessesGet200Response(self):
        """Test OrderChannelAccessesGet200Response"""
