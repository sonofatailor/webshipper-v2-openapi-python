...
class TestHasDocumentsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HasDocumentsIdPatchRequest:
        """Test HasDocumentsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasDocumentsIdPatchRequest`
        """
    ...
    def testHasDocumentsIdPatchRequest(self):
        """Test HasDocumentsIdPatchRequest"""
