...
class TestShipmentApi(unittest.TestCase):
    ...
    def test_shipments_get(self) -> None:
        """Test case for shipments_get

        List all Shipments
        """
        pass

    def test_shipments_id_get(self) -> None:
        """Test case for shipments_id_get

        Show a single Shipment
        """
        pass

    def test_shipments_post(self) -> None:
        """Test case for shipments_post
