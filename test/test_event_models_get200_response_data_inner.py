...
class TestEventModelsGet200ResponseDataInner(unittest.TestCase):
    """EventModelsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventModelsGet200ResponseDataInner:
        """Test EventModelsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventModelsGet200ResponseDataInner`
        """
        model = EventModelsGet200ResponseDataInner()
        if include_optional:
            return EventModelsGet200ResponseDataInner(
    ...
    def testEventModelsGet200ResponseDataInner(self):
        """Test EventModelsGet200ResponseDataInner"""
