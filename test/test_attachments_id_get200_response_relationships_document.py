...
class TestAttachmentsIdGet200ResponseRelationshipsDocument(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AttachmentsIdGet200ResponseRelationshipsDocument:
        """Test AttachmentsIdGet200ResponseRelationshipsDocument
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsIdGet200ResponseRelationshipsDocument`
        """
    ...
    def testAttachmentsIdGet200ResponseRelationshipsDocument(self):
        """Test AttachmentsIdGet200ResponseRelationshipsDocument"""
