...
class TestTrackingEventsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackingEventsIdGet200ResponseIncludedInnerData:
        """Test TrackingEventsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsIdGet200ResponseIncludedInnerData`
        """
        model = TrackingEventsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return TrackingEventsIdGet200ResponseIncludedInnerData(
                weight = 1.337,
                weight_unit = 'g',
                dimensions = '',
                service_attributes = [
    ...
    def testTrackingEventsIdGet200ResponseIncludedInnerData(self):
        """Test TrackingEventsIdGet200ResponseIncludedInnerData"""
