...
class TestShippingRatesIdGet200ResponseIncludedInner(unittest.TestCase):
    """ShippingRatesIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingRatesIdGet200ResponseIncludedInner:
        """Test ShippingRatesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingRatesIdGet200ResponseIncludedInner`
        """
        model = ShippingRatesIdGet200ResponseIncludedInner()
        if include_optional:
            return ShippingRatesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testShippingRatesIdGet200ResponseIncludedInner(self):
        """Test ShippingRatesIdGet200ResponseIncludedInner"""
