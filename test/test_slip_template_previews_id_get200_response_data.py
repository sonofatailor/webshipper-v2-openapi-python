...
class TestSlipTemplatePreviewsIdGet200ResponseData(unittest.TestCase):
    """SlipTemplatePreviewsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlipTemplatePreviewsIdGet200ResponseData:
        """Test SlipTemplatePreviewsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatePreviewsIdGet200ResponseData`
        """
        model = SlipTemplatePreviewsIdGet200ResponseData()
        if include_optional:
            return SlipTemplatePreviewsIdGet200ResponseData(
                id = 56,
    ...
    def testSlipTemplatePreviewsIdGet200ResponseData(self):
        """Test SlipTemplatePreviewsIdGet200ResponseData"""
