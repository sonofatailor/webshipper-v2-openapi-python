...
class TestReportTypesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReportTypesPostRequestData:
        """Test ReportTypesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportTypesPostRequestData`
        """
        model = ReportTypesPostRequestData()
        if include_optional:
    ...
    def testReportTypesPostRequestData(self):
        """Test ReportTypesPostRequestData"""
