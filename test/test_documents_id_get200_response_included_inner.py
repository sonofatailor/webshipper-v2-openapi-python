...
class TestDocumentsIdGet200ResponseIncludedInner(unittest.TestCase):
    """DocumentsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsIdGet200ResponseIncludedInner:
        """Test DocumentsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsIdGet200ResponseIncludedInner`
        """
        model = DocumentsIdGet200ResponseIncludedInner()
        if include_optional:
            return DocumentsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testDocumentsIdGet200ResponseIncludedInner(self):
        """Test DocumentsIdGet200ResponseIncludedInner"""
