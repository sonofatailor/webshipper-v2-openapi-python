...
class TestPrintersIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """PrintersIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrintersIdGet200ResponseIncludedInnerData:
        """Test PrintersIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrintersIdGet200ResponseIncludedInnerData`
        """
        model = PrintersIdGet200ResponseIncludedInnerData()
        if include_optional:
            return PrintersIdGet200ResponseIncludedInnerData(
                uuid = '',
                approved = True,
                alias = '',
                is_online = True,
    ...
    def testPrintersIdGet200ResponseIncludedInnerData(self):
        """Test PrintersIdGet200ResponseIncludedInnerData"""
