...
class TestSlipTemplatesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SlipTemplatesPostRequestData:
        """Test SlipTemplatesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatesPostRequestData`
        """
        model = SlipTemplatesPostRequestData()
        if include_optional:
    ...
    def testSlipTemplatesPostRequestData(self):
        """Test SlipTemplatesPostRequestData"""
