...
class TestOrdersIdGet200ResponseRelationshipsErrorType(unittest.TestCase):
    """OrdersIdGet200ResponseRelationshipsErrorType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseRelationshipsErrorType:
        """Test OrdersIdGet200ResponseRelationshipsErrorType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseRelationshipsErrorType`
        """
        model = OrdersIdGet200ResponseRelationshipsErrorType()
        if include_optional:
            return OrdersIdGet200ResponseRelationshipsErrorType(
    ...
    def testOrdersIdGet200ResponseRelationshipsErrorType(self):
        """Test OrdersIdGet200ResponseRelationshipsErrorType"""
