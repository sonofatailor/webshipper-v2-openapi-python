...
class TestEndOfDayReportsIdGet200ResponseData(unittest.TestCase):
    """EndOfDayReportsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndOfDayReportsIdGet200ResponseData:
        """Test EndOfDayReportsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndOfDayReportsIdGet200ResponseData`
        """
        model = EndOfDayReportsIdGet200ResponseData()
        if include_optional:
            return EndOfDayReportsIdGet200ResponseData(
                id = 56,
    ...
    def testEndOfDayReportsIdGet200ResponseData(self):
        """Test EndOfDayReportsIdGet200ResponseData"""
