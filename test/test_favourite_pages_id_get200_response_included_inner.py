...
class TestFavouritePagesIdGet200ResponseIncludedInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FavouritePagesIdGet200ResponseIncludedInner:
        """Test FavouritePagesIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FavouritePagesIdGet200ResponseIncludedInner`
        """
        model = FavouritePagesIdGet200ResponseIncludedInner()
        if include_optional:
            return FavouritePagesIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testFavouritePagesIdGet200ResponseIncludedInner(self):
        """Test FavouritePagesIdGet200ResponseIncludedInner"""
