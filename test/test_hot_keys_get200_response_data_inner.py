...
class TestHotKeysGet200ResponseDataInner(unittest.TestCase):
    """HotKeysGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotKeysGet200ResponseDataInner:
        """Test HotKeysGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysGet200ResponseDataInner`
        """
        model = HotKeysGet200ResponseDataInner()
        if include_optional:
            return HotKeysGet200ResponseDataInner(
    ...
    def testHotKeysGet200ResponseDataInner(self):
        """Test HotKeysGet200ResponseDataInner"""
