...
class TestPrinterRequeueJobs(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterRequeueJobs:
        """Test PrinterRequeueJobs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterRequeueJobs`
        """
        model = PrinterRequeueJobs()
        if include_optional:
            return PrinterRequeueJobs(
                start_time = '',
                end_time = '',
                job_id = '',
                mark_as_complete = ''
    ...
    def testPrinterRequeueJobs(self):
        """Test PrinterRequeueJobs"""
