...
class TestReturnRefundMethodsIdGet200ResponseIncludedInner(unittest.TestCase):
    """ReturnRefundMethodsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnRefundMethodsIdGet200ResponseIncludedInner:
        """Test ReturnRefundMethodsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnRefundMethodsIdGet200ResponseIncludedInner`
        """
        model = ReturnRefundMethodsIdGet200ResponseIncludedInner()
        if include_optional:
            return ReturnRefundMethodsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testReturnRefundMethodsIdGet200ResponseIncludedInner(self):
        """Test ReturnRefundMethodsIdGet200ResponseIncludedInner"""
