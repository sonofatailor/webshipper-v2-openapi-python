...
class TestCsvMappingsIdGet200ResponseData(unittest.TestCase):
    """CsvMappingsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvMappingsIdGet200ResponseData:
        """Test CsvMappingsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvMappingsIdGet200ResponseData`
        """
        model = CsvMappingsIdGet200ResponseData()
        if include_optional:
            return CsvMappingsIdGet200ResponseData(
                id = 56,
                type = 'csv_mappings',
    ...
    def testCsvMappingsIdGet200ResponseData(self):
        """Test CsvMappingsIdGet200ResponseData"""
