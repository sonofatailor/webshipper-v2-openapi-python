...
class TestRegionsGet200ResponseDataInner(unittest.TestCase):
    """RegionsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegionsGet200ResponseDataInner:
        """Test RegionsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionsGet200ResponseDataInner`
        """
        model = RegionsGet200ResponseDataInner()
        if include_optional:
            return RegionsGet200ResponseDataInner(
    ...
    def testRegionsGet200ResponseDataInner(self):
        """Test RegionsGet200ResponseDataInner"""
