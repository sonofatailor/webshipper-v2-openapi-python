...
class TestReturnShippingMethodsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsPostRequestData:
        """Test ReturnShippingMethodsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsPostRequestData`
        """
        model = ReturnShippingMethodsPostRequestData()
        if include_optional:
    ...
    def testReturnShippingMethodsPostRequestData(self):
        """Test ReturnShippingMethodsPostRequestData"""
