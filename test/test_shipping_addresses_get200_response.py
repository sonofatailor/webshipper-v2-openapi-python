...
class TestShippingAddressesGet200Response(unittest.TestCase):
    """ShippingAddressesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShippingAddressesGet200Response:
        """Test ShippingAddressesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingAddressesGet200Response`
        """
        model = ShippingAddressesGet200Response()
        if include_optional:
            return ShippingAddressesGet200Response(
                data = [
                    openapi_client.models._shipping_addresses_get_200_response_data_inner._shipping_addresses_get_200_response_data_inner(
    ...
    def testShippingAddressesGet200Response(self):
        """Test ShippingAddressesGet200Response"""
