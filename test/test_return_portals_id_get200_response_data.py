...
class TestReturnPortalsIdGet200ResponseData(unittest.TestCase):
    """ReturnPortalsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnPortalsIdGet200ResponseData:
        """Test ReturnPortalsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnPortalsIdGet200ResponseData`
        """
        model = ReturnPortalsIdGet200ResponseData()
        if include_optional:
            return ReturnPortalsIdGet200ResponseData(
                id = 56,
                type = 'return_portals',
    ...
    def testReturnPortalsIdGet200ResponseData(self):
        """Test ReturnPortalsIdGet200ResponseData"""
