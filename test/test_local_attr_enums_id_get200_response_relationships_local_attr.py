...
class TestLocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr(unittest.TestCase):
    """LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr:
        """Test LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr`
        """
        model = LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr()
        if include_optional:
            return LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr(
    ...
    def testLocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr(self):
        """Test LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr"""
