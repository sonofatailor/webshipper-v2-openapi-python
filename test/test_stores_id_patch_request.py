...
class TestStoresIdPatchRequest(unittest.TestCase):
    """StoresIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoresIdPatchRequest:
        """Test StoresIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresIdPatchRequest`
        """
        model = StoresIdPatchRequest()
        if include_optional:
            return StoresIdPatchRequest(
    ...
    def testStoresIdPatchRequest(self):
        """Test StoresIdPatchRequest"""
