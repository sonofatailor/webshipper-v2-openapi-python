...
class TestPrinterJobsIdGet200ResponseRelationshipsPrintableData(unittest.TestCase):
    """PrinterJobsIdGet200ResponseRelationshipsPrintableData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterJobsIdGet200ResponseRelationshipsPrintableData:
        """Test PrinterJobsIdGet200ResponseRelationshipsPrintableData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterJobsIdGet200ResponseRelationshipsPrintableData`
        """
        model = PrinterJobsIdGet200ResponseRelationshipsPrintableData()
        if include_optional:
            return PrinterJobsIdGet200ResponseRelationshipsPrintableData(
                id = '',
                type = 'printables'
            )
        else:
    ...
    def testPrinterJobsIdGet200ResponseRelationshipsPrintableData(self):
        """Test PrinterJobsIdGet200ResponseRelationshipsPrintableData"""
