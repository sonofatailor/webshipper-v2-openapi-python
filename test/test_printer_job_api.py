...
class TestPrinterJobApi(unittest.TestCase):
    """PrinterJobApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PrinterJobApi()

    def tearDown(self) -> None:
        pass

    def test_printer_jobs_get(self) -> None:
        """Test case for printer_jobs_get

        List all Printer Jobs
        """
        pass

    def test_printer_jobs_id_delete(self) -> None:
        """Test case for printer_jobs_id_delete

        Delete a Printer Job
        """
        pass

    def test_printer_jobs_id_get(self) -> None:
        """Test case for printer_jobs_id_get

        Show a single Printer Job
        """
        pass

    def test_printer_jobs_id_patch(self) -> None:
        """Test case for printer_jobs_id_patch

        Update a Printer Job
        """
        pass

    def test_printer_jobs_post(self) -> None:
        """Test case for printer_jobs_post
