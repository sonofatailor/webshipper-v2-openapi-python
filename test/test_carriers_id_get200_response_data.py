...
class TestCarriersIdGet200ResponseData(unittest.TestCase):
    """CarriersIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarriersIdGet200ResponseData:
        """Test CarriersIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarriersIdGet200ResponseData`
        """
        model = CarriersIdGet200ResponseData()
        if include_optional:
            return CarriersIdGet200ResponseData(
                id = 56,
                type = 'carriers',
    ...
    def testCarriersIdGet200ResponseData(self):
        """Test CarriersIdGet200ResponseData"""
