...
class TestUserGroupsIdGet200ResponseData(unittest.TestCase):
    """UserGroupsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserGroupsIdGet200ResponseData:
        """Test UserGroupsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserGroupsIdGet200ResponseData`
        """
        model = UserGroupsIdGet200ResponseData()
        if include_optional:
            return UserGroupsIdGet200ResponseData(
                id = 56,
                type = 'user_groups',
    ...
    def testUserGroupsIdGet200ResponseData(self):
        """Test UserGroupsIdGet200ResponseData"""
