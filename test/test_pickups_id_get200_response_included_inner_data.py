...
class TestPickupsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """PickupsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PickupsIdGet200ResponseIncludedInnerData:
        """Test PickupsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsIdGet200ResponseIncludedInnerData`
        """
        model = PickupsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return PickupsIdGet200ResponseIncludedInnerData(
                alias = '',
                services = '',
                attrs = '',
                prefer_zpl = True,
    ...
    def testPickupsIdGet200ResponseIncludedInnerData(self):
        """Test PickupsIdGet200ResponseIncludedInnerData"""
