...
class TestEndOfDayReports(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EndOfDayReports:
        """Test EndOfDayReports
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndOfDayReports`
        """
        model = EndOfDayReports()
        if include_optional:
            return EndOfDayReports(
                var_base64 = '',
                updated_at = '',
                created_at = '',
                start_time = '',
