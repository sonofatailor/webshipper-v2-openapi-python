...
class TestDropPointLocatorsPostRequestData(unittest.TestCase):
    """DropPointLocatorsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DropPointLocatorsPostRequestData:
        """Test DropPointLocatorsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DropPointLocatorsPostRequestData`
        """
        model = DropPointLocatorsPostRequestData()
        if include_optional:
            return DropPointLocatorsPostRequestData(
    ...
    def testDropPointLocatorsPostRequestData(self):
        """Test DropPointLocatorsPostRequestData"""
