...
class TestPickupsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PickupsIdGet200ResponseData:
        """Test PickupsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsIdGet200ResponseData`
        """
        model = PickupsIdGet200ResponseData()
        if include_optional:
    ...
    def testPickupsIdGet200ResponseData(self):
        """Test PickupsIdGet200ResponseData"""
