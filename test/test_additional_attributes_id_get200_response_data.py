...
class TestAdditionalAttributesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdditionalAttributesIdGet200ResponseData:
        """Test AdditionalAttributesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalAttributesIdGet200ResponseData`
        """
        model = AdditionalAttributesIdGet200ResponseData()
        if include_optional:
    ...
    def testAdditionalAttributesIdGet200ResponseData(self):
        """Test AdditionalAttributesIdGet200ResponseData"""
