...
class TestPrinterRequeueJobsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrinterRequeueJobsPostRequestData:
        """Test PrinterRequeueJobsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterRequeueJobsPostRequestData`
        """
        model = PrinterRequeueJobsPostRequestData()
        if include_optional:
    ...
    def testPrinterRequeueJobsPostRequestData(self):
        """Test PrinterRequeueJobsPostRequestData"""
