...
class TestEventsIdGet200ResponseRelationships(unittest.TestCase):
    """EventsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsIdGet200ResponseRelationships:
        """Test EventsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsIdGet200ResponseRelationships`
        """
        model = EventsIdGet200ResponseRelationships()
        if include_optional:
            return EventsIdGet200ResponseRelationships(
    ...
    def testEventsIdGet200ResponseRelationships(self):
        """Test EventsIdGet200ResponseRelationships"""
