...
class TestShippingMappingsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ShippingMappingsIdGet200ResponseIncludedInnerData:
        """Test ShippingMappingsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShippingMappingsIdGet200ResponseIncludedInnerData`
        """
        model = ShippingMappingsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return ShippingMappingsIdGet200ResponseIncludedInnerData(
                carrier_id = 56,
                order_channel_id = 56,
                name = '',
    ...
    def testShippingMappingsIdGet200ResponseIncludedInnerData(self):
        """Test ShippingMappingsIdGet200ResponseIncludedInnerData"""
