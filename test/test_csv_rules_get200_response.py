...
class TestCsvRulesGet200Response(unittest.TestCase):
    """CsvRulesGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CsvRulesGet200Response:
        """Test CsvRulesGet200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesGet200Response`
        """
        model = CsvRulesGet200Response()
        if include_optional:
            return CsvRulesGet200Response(
                data = [
                    openapi_client.models._csv_rules_get_200_response_data_inner._csv_rules_get_200_response_data_inner(
    ...
    def testCsvRulesGet200Response(self):
        """Test CsvRulesGet200Response"""
