...
class TestCsvRulesPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvRulesPostRequestData:
        """Test CsvRulesPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvRulesPostRequestData`
        """
        model = CsvRulesPostRequestData()
        if include_optional:
    ...
    def testCsvRulesPostRequestData(self):
        """Test CsvRulesPostRequestData"""
