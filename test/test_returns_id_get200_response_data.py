...
class TestReturnsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReturnsIdGet200ResponseData:
        """Test ReturnsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsIdGet200ResponseData`
        """
        model = ReturnsIdGet200ResponseData()
        if include_optional:
    ...
    def testReturnsIdGet200ResponseData(self):
        """Test ReturnsIdGet200ResponseData"""
