...
class TestCsvUploadsPost204ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CsvUploadsPost204ResponseData:
        """Test CsvUploadsPost204ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsvUploadsPost204ResponseData`
        """
        model = CsvUploadsPost204ResponseData()
        if include_optional:
    ...
    def testCsvUploadsPost204ResponseData(self):
        """Test CsvUploadsPost204ResponseData"""
