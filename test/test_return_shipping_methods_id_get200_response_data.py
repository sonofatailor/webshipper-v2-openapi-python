...
class TestReturnShippingMethodsIdGet200ResponseData(unittest.TestCase):
    """ReturnShippingMethodsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnShippingMethodsIdGet200ResponseData:
        """Test ReturnShippingMethodsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnShippingMethodsIdGet200ResponseData`
        """
        model = ReturnShippingMethodsIdGet200ResponseData()
        if include_optional:
            return ReturnShippingMethodsIdGet200ResponseData(
                id = 56,
    ...
    def testReturnShippingMethodsIdGet200ResponseData(self):
        """Test ReturnShippingMethodsIdGet200ResponseData"""
