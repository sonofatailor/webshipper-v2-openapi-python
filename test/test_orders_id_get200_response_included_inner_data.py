...
class TestOrdersIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """OrdersIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrdersIdGet200ResponseIncludedInnerData:
        """Test OrdersIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrdersIdGet200ResponseIncludedInnerData`
        """
        model = OrdersIdGet200ResponseIncludedInnerData()
        if include_optional:
            return OrdersIdGet200ResponseIncludedInnerData(
                channel_label = '',
                attrs = [
                    ''
                    ],
    ...
    def testOrdersIdGet200ResponseIncludedInnerData(self):
        """Test OrdersIdGet200ResponseIncludedInnerData"""
