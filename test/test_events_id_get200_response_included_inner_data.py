...
class TestEventsIdGet200ResponseIncludedInnerData(unittest.TestCase):
    """EventsIdGet200ResponseIncludedInnerData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsIdGet200ResponseIncludedInnerData:
        """Test EventsIdGet200ResponseIncludedInnerData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsIdGet200ResponseIncludedInnerData`
        """
        model = EventsIdGet200ResponseIncludedInnerData()
        if include_optional:
            return EventsIdGet200ResponseIncludedInnerData(
            )
        else:
            return EventsIdGet200ResponseIncludedInnerData(
        )
    ...
    def testEventsIdGet200ResponseIncludedInnerData(self):
        """Test EventsIdGet200ResponseIncludedInnerData"""
