...
class TestDocumentsIdPatchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentsIdPatchRequest:
        """Test DocumentsIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsIdPatchRequest`
        """
    ...
    def testDocumentsIdPatchRequest(self):
        """Test DocumentsIdPatchRequest"""
