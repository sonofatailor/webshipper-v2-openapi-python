...
class TestActionsIdGet200ResponseRelationships(unittest.TestCase):
    """ActionsIdGet200ResponseRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionsIdGet200ResponseRelationships:
        """Test ActionsIdGet200ResponseRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionsIdGet200ResponseRelationships`
        """
        model = ActionsIdGet200ResponseRelationships()
        if include_optional:
            return ActionsIdGet200ResponseRelationships(
    ...
    def testActionsIdGet200ResponseRelationships(self):
        """Test ActionsIdGet200ResponseRelationships"""
