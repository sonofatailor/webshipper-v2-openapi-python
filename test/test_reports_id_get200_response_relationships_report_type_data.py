...
class TestReportsIdGet200ResponseRelationshipsReportTypeData(unittest.TestCase):
    """ReportsIdGet200ResponseRelationshipsReportTypeData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportsIdGet200ResponseRelationshipsReportTypeData:
        """Test ReportsIdGet200ResponseRelationshipsReportTypeData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportsIdGet200ResponseRelationshipsReportTypeData`
        """
        model = ReportsIdGet200ResponseRelationshipsReportTypeData()
        if include_optional:
            return ReportsIdGet200ResponseRelationshipsReportTypeData(
                id = '',
                type = 'report_types'
            )
        else:
    ...
    def testReportsIdGet200ResponseRelationshipsReportTypeData(self):
        """Test ReportsIdGet200ResponseRelationshipsReportTypeData"""
