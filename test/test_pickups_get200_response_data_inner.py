...
class TestPickupsGet200ResponseDataInner(unittest.TestCase):
    """PickupsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PickupsGet200ResponseDataInner:
        """Test PickupsGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupsGet200ResponseDataInner`
        """
        model = PickupsGet200ResponseDataInner()
        if include_optional:
            return PickupsGet200ResponseDataInner(
    ...
    def testPickupsGet200ResponseDataInner(self):
        """Test PickupsGet200ResponseDataInner"""
