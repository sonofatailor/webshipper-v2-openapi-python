...
class TestTrackingEventApi(unittest.TestCase):
    """TrackingEventApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TrackingEventApi()

    def tearDown(self) -> None:
        pass

    def test_tracking_events_get(self) -> None:
        """Test case for tracking_events_get

        List all Tracking Events
        """
        pass

    def test_tracking_events_id_get(self) -> None:
        """Test case for tracking_events_id_get
