...
class TestUsersIdGet200ResponseData(unittest.TestCase):
    """UsersIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersIdGet200ResponseData:
        """Test UsersIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersIdGet200ResponseData`
        """
        model = UsersIdGet200ResponseData()
        if include_optional:
            return UsersIdGet200ResponseData(
                id = 56,
                type = 'users',
    ...
    def testUsersIdGet200ResponseData(self):
        """Test UsersIdGet200ResponseData"""
