...
class TestReturnsIdGet200ResponseIncludedInner(unittest.TestCase):
    """ReturnsIdGet200ResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReturnsIdGet200ResponseIncludedInner:
        """Test ReturnsIdGet200ResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReturnsIdGet200ResponseIncludedInner`
        """
        model = ReturnsIdGet200ResponseIncludedInner()
        if include_optional:
            return ReturnsIdGet200ResponseIncludedInner(
                type = 'orders',
                id = 56,
                data = None
            )
    ...
    def testReturnsIdGet200ResponseIncludedInner(self):
        """Test ReturnsIdGet200ResponseIncludedInner"""
