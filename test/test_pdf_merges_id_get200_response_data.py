...
class TestPdfMergesIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PdfMergesIdGet200ResponseData:
        """Test PdfMergesIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PdfMergesIdGet200ResponseData`
        """
        model = PdfMergesIdGet200ResponseData()
        if include_optional:
    ...
    def testPdfMergesIdGet200ResponseData(self):
        """Test PdfMergesIdGet200ResponseData"""
