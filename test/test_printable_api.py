...
class TestPrintableApi(unittest.TestCase):
    """PrintableApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PrintableApi()

    def tearDown(self) -> None:
        pass

    def test_printables_get(self) -> None:
        """Test case for printables_get

        List all Printables
        """
        pass

    def test_printables_id_delete(self) -> None:
        """Test case for printables_id_delete

        Delete a Printable
        """
        pass

    def test_printables_id_get(self) -> None:
        """Test case for printables_id_get

        Show a single Printable
        """
        pass

    def test_printables_id_patch(self) -> None:
        """Test case for printables_id_patch

        Update a Printable
        """
        pass

    def test_printables_post(self) -> None:
        """Test case for printables_post
