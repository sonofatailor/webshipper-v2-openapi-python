...
class TestTrackingEventsIdGet200ResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrackingEventsIdGet200ResponseData:
        """Test TrackingEventsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventsIdGet200ResponseData`
        """
        model = TrackingEventsIdGet200ResponseData()
        if include_optional:
    ...
    def testTrackingEventsIdGet200ResponseData(self):
        """Test TrackingEventsIdGet200ResponseData"""
