...
class TestStoresGet200ResponseDataInner(unittest.TestCase):
    """StoresGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoresGet200ResponseDataInner:
        """Test StoresGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoresGet200ResponseDataInner`
        """
        model = StoresGet200ResponseDataInner()
        if include_optional:
            return StoresGet200ResponseDataInner(
    ...
    def testStoresGet200ResponseDataInner(self):
        """Test StoresGet200ResponseDataInner"""
