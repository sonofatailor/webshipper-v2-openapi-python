...
class TestPrinterRequeueJobsIdGet200ResponseData(unittest.TestCase):
    """PrinterRequeueJobsIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrinterRequeueJobsIdGet200ResponseData:
        """Test PrinterRequeueJobsIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrinterRequeueJobsIdGet200ResponseData`
        """
        model = PrinterRequeueJobsIdGet200ResponseData()
        if include_optional:
            return PrinterRequeueJobsIdGet200ResponseData(
                id = 56,
    ...
    def testPrinterRequeueJobsIdGet200ResponseData(self):
        """Test PrinterRequeueJobsIdGet200ResponseData"""
