...
class TestUserGroupsPostRequestData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserGroupsPostRequestData:
        """Test UserGroupsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserGroupsPostRequestData`
        """
        model = UserGroupsPostRequestData()
        if include_optional:
    ...
    def testUserGroupsPostRequestData(self):
        """Test UserGroupsPostRequestData"""
