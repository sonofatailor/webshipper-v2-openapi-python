...
class TestWebhooksIdGet200ResponseData(unittest.TestCase):
    """WebhooksIdGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhooksIdGet200ResponseData:
        """Test WebhooksIdGet200ResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhooksIdGet200ResponseData`
        """
        model = WebhooksIdGet200ResponseData()
        if include_optional:
            return WebhooksIdGet200ResponseData(
                id = 56,
                type = 'webhooks',
    ...
    def testWebhooksIdGet200ResponseData(self):
        """Test WebhooksIdGet200ResponseData"""
