...
class TestSlipTemplatesGet200ResponseDataInner(unittest.TestCase):
    """SlipTemplatesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SlipTemplatesGet200ResponseDataInner:
        """Test SlipTemplatesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SlipTemplatesGet200ResponseDataInner`
        """
        model = SlipTemplatesGet200ResponseDataInner()
        if include_optional:
            return SlipTemplatesGet200ResponseDataInner(
    ...
    def testSlipTemplatesGet200ResponseDataInner(self):
        """Test SlipTemplatesGet200ResponseDataInner"""
