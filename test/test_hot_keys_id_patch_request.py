...
class TestHotKeysIdPatchRequest(unittest.TestCase):
    """HotKeysIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotKeysIdPatchRequest:
        """Test HotKeysIdPatchRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotKeysIdPatchRequest`
        """
        model = HotKeysIdPatchRequest()
        if include_optional:
            return HotKeysIdPatchRequest(
    ...
    def testHotKeysIdPatchRequest(self):
        """Test HotKeysIdPatchRequest"""
