...
class TestShipmentsPostRequestData(unittest.TestCase):
    """ShipmentsPostRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShipmentsPostRequestData:
        """Test ShipmentsPostRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShipmentsPostRequestData`
        """
        model = ShipmentsPostRequestData()
        if include_optional:
            return ShipmentsPostRequestData(
                type = 'shipments',
    ...
    def testShipmentsPostRequestData(self):
        """Test ShipmentsPostRequestData"""
