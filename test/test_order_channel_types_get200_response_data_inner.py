...
class TestOrderChannelTypesGet200ResponseDataInner(unittest.TestCase):
    """OrderChannelTypesGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderChannelTypesGet200ResponseDataInner:
        """Test OrderChannelTypesGet200ResponseDataInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderChannelTypesGet200ResponseDataInner`
        """
        model = OrderChannelTypesGet200ResponseDataInner()
        if include_optional:
            return OrderChannelTypesGet200ResponseDataInner(
    ...
    def testOrderChannelTypesGet200ResponseDataInner(self):
        """Test OrderChannelTypesGet200ResponseDataInner"""
