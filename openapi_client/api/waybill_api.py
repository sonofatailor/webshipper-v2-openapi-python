...
class WaybillApi:
    ...
    def waybills_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WaybillsGet200Response]:
        """List all Waybills
    ...
    def waybills_id_delete(
        ...
        _param = self._waybills_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def waybills_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WaybillsIdGet200Response]:
        """Delete a Waybill
    ...
    @validate_call
    def waybills_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _waybills_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def waybills_id_get(
        ...
        _param = self._waybills_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def waybills_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def waybills_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _waybills_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def waybills_id_patch(
        self,
        id: StrictInt,
        waybills_id_patch_request: WaybillsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param waybills_id_patch_request: (required)
        :type waybills_id_patch_request: WaybillsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._waybills_id_patch_serialize(
            id=id,
            waybills_id_patch_request=waybills_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def waybills_id_patch_with_http_info(
        self,
        id: StrictInt,
        waybills_id_patch_request: WaybillsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def waybills_id_patch_without_preload_content(
        self,
        id: StrictInt,
        waybills_id_patch_request: WaybillsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _waybills_id_patch_serialize(
        self,
        id,
        waybills_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if waybills_id_patch_request is not None:
            _body_params = waybills_id_patch_request
    ...
    def waybills_post(
        self,
        waybills_post_request: WaybillsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param waybills_post_request: (required)
        :type waybills_post_request: WaybillsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._waybills_post_serialize(
            waybills_post_request=waybills_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _waybills_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if waybills_post_request is not None:
            _body_params = waybills_post_request
