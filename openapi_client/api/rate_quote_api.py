...
class RateQuoteApi:
    ...
    @validate_call
    def rate_quotes_post(
        self,
        rate_quotes_post_request: RateQuotesPostRequest,
        ...
        :param rate_quotes_post_request: (required)
        :type rate_quotes_post_request: RateQuotesPostRequest
        ...
        _param = self._rate_quotes_post_serialize(
            rate_quotes_post_request=rate_quotes_post_request,
    ...
    @validate_call
    def rate_quotes_post_with_http_info(
        self,
        rate_quotes_post_request: RateQuotesPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RateQuotesPost204Response]:
        """Create a Rate Quote
    ...
    @validate_call
    def rate_quotes_post_without_preload_content(
        self,
        rate_quotes_post_request: RateQuotesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _rate_quotes_post_serialize(
        self,
        rate_quotes_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if rate_quotes_post_request is not None:
            _body_params = rate_quotes_post_request
