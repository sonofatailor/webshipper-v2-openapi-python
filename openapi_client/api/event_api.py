...
class EventApi:
    ...
    def events_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventsGet200Response]:
        """List all Events
    ...
    def events_id_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventsIdGet200Response]:
        """Delete a Event
    ...
    def events_id_patch(
        self,
        id: StrictInt,
        events_id_patch_request: EventsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param events_id_patch_request: (required)
        :type events_id_patch_request: EventsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._events_id_patch_serialize(
            id=id,
            events_id_patch_request=events_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _events_id_patch_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if events_id_patch_request is not None:
            _body_params = events_id_patch_request
    ...
    def events_post(
        self,
        events_post_request: EventsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param events_post_request: (required)
        :type events_post_request: EventsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._events_post_serialize(
            events_post_request=events_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _events_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if events_post_request is not None:
            _body_params = events_post_request
