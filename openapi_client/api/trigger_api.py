...
class TriggerApi:
    ...
    def triggers_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TriggersGet200Response]:
        """List all Triggers
    ...
    def triggers_id_delete(
        ...
        _param = self._triggers_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def triggers_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TriggersIdGet200Response]:
        """Delete a Trigger
    ...
    @validate_call
    def triggers_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _triggers_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def triggers_id_get(
        ...
        _param = self._triggers_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def triggers_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def triggers_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _triggers_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def triggers_id_patch(
        self,
        id: StrictInt,
        triggers_id_patch_request: TriggersIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param triggers_id_patch_request: (required)
        :type triggers_id_patch_request: TriggersIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._triggers_id_patch_serialize(
            id=id,
            triggers_id_patch_request=triggers_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def triggers_id_patch_with_http_info(
        self,
        id: StrictInt,
        triggers_id_patch_request: TriggersIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def triggers_id_patch_without_preload_content(
        self,
        id: StrictInt,
        triggers_id_patch_request: TriggersIdPatchRequest,
        _request_timeout: Union[
    ...
    def _triggers_id_patch_serialize(
        self,
        id,
        triggers_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if triggers_id_patch_request is not None:
            _body_params = triggers_id_patch_request
    ...
    def triggers_post(
        self,
        triggers_post_request: TriggersPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param triggers_post_request: (required)
        :type triggers_post_request: TriggersPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._triggers_post_serialize(
            triggers_post_request=triggers_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def triggers_post_with_http_info(
        self,
        triggers_post_request: TriggersPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def triggers_post_without_preload_content(
        self,
        triggers_post_request: TriggersPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _triggers_post_serialize(
        self,
        triggers_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if triggers_post_request is not None:
            _body_params = triggers_post_request
