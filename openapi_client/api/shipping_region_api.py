...
class ShippingRegionApi:
    ...
    def regions_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RegionsGet200Response]:
        """List all Shipping Regions
    ...
    def regions_id_delete(
        ...
        _param = self._regions_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def regions_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RegionsIdGet200Response]:
        """Delete a Shipping Region
    ...
    @validate_call
    def regions_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _regions_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def regions_id_get(
        ...
        _param = self._regions_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def regions_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def regions_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def regions_id_patch(
        self,
        id: StrictInt,
        regions_id_patch_request: RegionsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param regions_id_patch_request: (required)
        :type regions_id_patch_request: RegionsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._regions_id_patch_serialize(
            id=id,
            regions_id_patch_request=regions_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def regions_id_patch_with_http_info(
        self,
        id: StrictInt,
        regions_id_patch_request: RegionsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def regions_id_patch_without_preload_content(
        self,
        id: StrictInt,
        regions_id_patch_request: RegionsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _regions_id_patch_serialize(
        self,
        id,
        regions_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if regions_id_patch_request is not None:
            _body_params = regions_id_patch_request
    ...
    def regions_post(
        self,
        regions_post_request: RegionsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param regions_post_request: (required)
        :type regions_post_request: RegionsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._regions_post_serialize(
            regions_post_request=regions_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def regions_post_with_http_info(
        self,
        regions_post_request: RegionsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def regions_post_without_preload_content(
        self,
        regions_post_request: RegionsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _regions_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if regions_post_request is not None:
            _body_params = regions_post_request
