...
class CarrierAccessApi:
    ...
    def carrier_accesses_get(
        ...
        _param = self._carrier_accesses_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CarrierAccessesGet200Response"
    ...
    @validate_call
    def carrier_accesses_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CarrierAccessesGet200Response]:
        """List all Carrier Accesss
    ...
    @validate_call
    def carrier_accesses_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _carrier_accesses_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/carrier_accesses',
    ...
    @validate_call
    def carrier_accesses_id_delete(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._carrier_accesses_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CarrierAccessesIdGet200Response"
    ...
    @validate_call
    def carrier_accesses_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CarrierAccessesIdGet200Response]:
        """Delete a Carrier Access
    ...
    @validate_call
    def carrier_accesses_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _carrier_accesses_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/carrier_accesses/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def carrier_accesses_id_get(
        ...
        _param = self._carrier_accesses_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def carrier_accesses_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def carrier_accesses_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _carrier_accesses_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def carrier_accesses_post(
        self,
        carrier_accesses_post_request: CarrierAccessesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param carrier_accesses_post_request: (required)
        :type carrier_accesses_post_request: CarrierAccessesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._carrier_accesses_post_serialize(
            carrier_accesses_post_request=carrier_accesses_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "CarrierAccessesIdGet200Response"
    ...
    @validate_call
    def carrier_accesses_post_with_http_info(
        self,
        carrier_accesses_post_request: CarrierAccessesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def carrier_accesses_post_without_preload_content(
        self,
        carrier_accesses_post_request: CarrierAccessesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _carrier_accesses_post_serialize(
        self,
        carrier_accesses_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if carrier_accesses_post_request is not None:
            _body_params = carrier_accesses_post_request
