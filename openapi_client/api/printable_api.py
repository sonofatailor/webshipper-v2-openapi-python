...
class PrintableApi:
    ...
    def printables_get(
        ...
        _param = self._printables_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def printables_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrintablesGet200Response]:
        """List all Printables
    ...
    @validate_call
    def printables_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def printables_id_delete(
        ...
        _param = self._printables_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PrintablesIdGet200Response"
    ...
    @validate_call
    def printables_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrintablesIdGet200Response]:
        """Delete a Printable
    ...
    @validate_call
    def printables_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _printables_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def printables_id_get(
        ...
        _param = self._printables_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def printables_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def printables_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _printables_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def printables_id_patch(
        self,
        id: StrictInt,
        printables_id_patch_request: PrintablesIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param printables_id_patch_request: (required)
        :type printables_id_patch_request: PrintablesIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._printables_id_patch_serialize(
            id=id,
            printables_id_patch_request=printables_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def printables_id_patch_with_http_info(
        self,
        id: StrictInt,
        printables_id_patch_request: PrintablesIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def printables_id_patch_without_preload_content(
        self,
        id: StrictInt,
        printables_id_patch_request: PrintablesIdPatchRequest,
        _request_timeout: Union[
    ...
    def _printables_id_patch_serialize(
        self,
        id,
        printables_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if printables_id_patch_request is not None:
            _body_params = printables_id_patch_request
    ...
    def printables_post(
        self,
        printables_post_request: PrintablesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param printables_post_request: (required)
        :type printables_post_request: PrintablesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._printables_post_serialize(
            printables_post_request=printables_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "PrintablesIdGet200Response"
    ...
    @validate_call
    def printables_post_with_http_info(
        self,
        printables_post_request: PrintablesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def printables_post_without_preload_content(
        self,
        printables_post_request: PrintablesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _printables_post_serialize(
        self,
        printables_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if printables_post_request is not None:
            _body_params = printables_post_request
