...
class ReturnOrderApi:
    ...
    def returns_get(
        ...
        filter_secret: Annotated[Optional[StrictStr], Field(description="Filter by secret")] = None,
        ...
        filter_portal_id: Annotated[Optional[StrictStr], Field(description="Filter by portal_id")] = None,
        filter_free_text: Annotated[Optional[StrictStr], Field(description="Filter by free_text")] = None,
        filter_return_causes: Annotated[Optional[StrictStr], Field(description="Filter by return_causes")] = None,
        ...
        :type filter_id: str
        :param filter_secret: Filter by secret
        :type filter_secret: str
        ...
        :param filter_portal_id: Filter by portal_id
        :type filter_portal_id: str
        :param filter_free_text: Filter by free_text
        :type filter_free_text: str
        :param filter_return_causes: Filter by return_causes
        :type filter_return_causes: str
    ...
    @validate_call
    def returns_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_secret: Annotated[Optional[StrictStr], Field(description="Filter by secret")] = None,
        filter_activity_type: Annotated[Optional[StrictStr], Field(description="Filter by activity_type")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReturnsGet200Response]:
        """List all Return Orders
    ...
    @validate_call
    def returns_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        filter_secret: Annotated[Optional[StrictStr], Field(description="Filter by secret")] = None,
        filter_activity_type: Annotated[Optional[StrictStr], Field(description="Filter by activity_type")] = None,
    ...
    def _returns_get_serialize(
        ...
        if filter_secret is not None:
            
            _query_params.append(('filter[secret]', filter_secret))
        ...
        if filter_portal_id is not None:
            
            _query_params.append(('filter[portal_id]', filter_portal_id))
            
        if filter_free_text is not None:
            
            _query_params.append(('filter[free_text]', filter_free_text))
            
        if filter_return_causes is not None:
            
            _query_params.append(('filter[return_causes]', filter_return_causes))
    ...
    def returns_id_delete(
        ...
        _param = self._returns_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def returns_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReturnsIdGet200Response]:
        """Delete a Return Order
    ...
    @validate_call
    def returns_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _returns_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def returns_id_get(
        ...
        _param = self._returns_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def returns_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def returns_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def returns_id_patch(
        self,
        id: StrictInt,
        returns_id_patch_request: ReturnsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param returns_id_patch_request: (required)
        :type returns_id_patch_request: ReturnsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._returns_id_patch_serialize(
            id=id,
            returns_id_patch_request=returns_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def returns_id_patch_with_http_info(
        self,
        id: StrictInt,
        returns_id_patch_request: ReturnsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def returns_id_patch_without_preload_content(
        self,
        id: StrictInt,
        returns_id_patch_request: ReturnsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _returns_id_patch_serialize(
        self,
        id,
        returns_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if returns_id_patch_request is not None:
            _body_params = returns_id_patch_request
    ...
    def returns_post(
        self,
        returns_post_request: ReturnsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param returns_post_request: (required)
        :type returns_post_request: ReturnsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._returns_post_serialize(
            returns_post_request=returns_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def returns_post_with_http_info(
        self,
        returns_post_request: ReturnsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def returns_post_without_preload_content(
        self,
        returns_post_request: ReturnsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _returns_post_serialize(
        self,
        returns_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if returns_post_request is not None:
            _body_params = returns_post_request
