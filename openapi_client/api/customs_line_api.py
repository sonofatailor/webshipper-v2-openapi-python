...
class CustomsLineApi:
    ...
    def customs_lines_get(
        ...
        _param = self._customs_lines_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CustomsLinesGet200Response"
    ...
    @validate_call
    def customs_lines_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomsLinesGet200Response]:
        """List all Customs Lines
    ...
    @validate_call
    def customs_lines_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _customs_lines_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def customs_lines_id_delete(
        ...
        _param = self._customs_lines_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CustomsLinesIdGet200Response"
    ...
    @validate_call
    def customs_lines_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomsLinesIdGet200Response]:
        """Delete a Customs Line
    ...
    @validate_call
    def customs_lines_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _customs_lines_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/customs_lines/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def customs_lines_id_get(
        ...
        _param = self._customs_lines_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def customs_lines_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def customs_lines_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _customs_lines_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def customs_lines_id_patch(
        self,
        id: StrictInt,
        customs_lines_id_patch_request: CustomsLinesIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param customs_lines_id_patch_request: (required)
        :type customs_lines_id_patch_request: CustomsLinesIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._customs_lines_id_patch_serialize(
            id=id,
            customs_lines_id_patch_request=customs_lines_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def customs_lines_id_patch_with_http_info(
        self,
        id: StrictInt,
        customs_lines_id_patch_request: CustomsLinesIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def customs_lines_id_patch_without_preload_content(
        self,
        id: StrictInt,
        customs_lines_id_patch_request: CustomsLinesIdPatchRequest,
        _request_timeout: Union[
    ...
    def _customs_lines_id_patch_serialize(
        self,
        id,
        customs_lines_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if customs_lines_id_patch_request is not None:
            _body_params = customs_lines_id_patch_request
    ...
    @validate_call
    def customs_lines_post(
        self,
        customs_lines_post_request: CustomsLinesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param customs_lines_post_request: (required)
        :type customs_lines_post_request: CustomsLinesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._customs_lines_post_serialize(
            customs_lines_post_request=customs_lines_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "CustomsLinesIdGet200Response"
    ...
    @validate_call
    def customs_lines_post_with_http_info(
        self,
        customs_lines_post_request: CustomsLinesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def customs_lines_post_without_preload_content(
        self,
        customs_lines_post_request: CustomsLinesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _customs_lines_post_serialize(
        self,
        customs_lines_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if customs_lines_post_request is not None:
            _body_params = customs_lines_post_request
