...
class WebhookApi:
    ...
    def webhooks_id_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhooksIdGet200Response]:
        """Delete a Webhook
    ...
    def webhooks_id_patch(
        self,
        id: StrictInt,
        webhooks_id_patch_request: WebhooksIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param webhooks_id_patch_request: (required)
        :type webhooks_id_patch_request: WebhooksIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._webhooks_id_patch_serialize(
            id=id,
            webhooks_id_patch_request=webhooks_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _webhooks_id_patch_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if webhooks_id_patch_request is not None:
            _body_params = webhooks_id_patch_request
    ...
    def webhooks_post(
        self,
        webhooks_post_request: WebhooksPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param webhooks_post_request: (required)
        :type webhooks_post_request: WebhooksPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._webhooks_post_serialize(
            webhooks_post_request=webhooks_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _webhooks_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if webhooks_post_request is not None:
            _body_params = webhooks_post_request
