...
class MergedOrderApi:
    ...
    @validate_call
    def order_merges_post(
        self,
        order_merges_post_request: OrderMergesPostRequest,
        ...
        :param order_merges_post_request: (required)
        :type order_merges_post_request: OrderMergesPostRequest
        ...
        _param = self._order_merges_post_serialize(
            order_merges_post_request=order_merges_post_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "OrderMergesPost204Response"
    ...
    @validate_call
    def order_merges_post_with_http_info(
        self,
        order_merges_post_request: OrderMergesPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrderMergesPost204Response]:
        """Create a Merged Order
    ...
    @validate_call
    def order_merges_post_without_preload_content(
        self,
        order_merges_post_request: OrderMergesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _order_merges_post_serialize(
        self,
        order_merges_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if order_merges_post_request is not None:
            _body_params = order_merges_post_request
