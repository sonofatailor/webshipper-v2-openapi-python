...
class PackageApi:
    ...
    def packages_get(
        ...
        _param = self._packages_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def packages_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PackagesGet200Response]:
        """List all Packages
    ...
    @validate_call
    def packages_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def packages_id_get(
        ...
        _param = self._packages_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def packages_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PackagesIdGet200Response]:
        """Show a single Package
    ...
    @validate_call
    def packages_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _packages_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def packages_post(
        self,
        packages_post_request: PackagesPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param packages_post_request: (required)
        :type packages_post_request: PackagesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._packages_post_serialize(
            packages_post_request=packages_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def packages_post_with_http_info(
        self,
        packages_post_request: PackagesPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def packages_post_without_preload_content(
        self,
        packages_post_request: PackagesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _packages_post_serialize(
        self,
        packages_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if packages_post_request is not None:
            _body_params = packages_post_request
