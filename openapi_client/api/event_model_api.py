...
class EventModelApi:
    ...
    def event_models_get(
        ...
        _param = self._event_models_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def event_models_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventModelsGet200Response]:
        """List all EventModels
    ...
    @validate_call
    def event_models_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _event_models_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def event_models_id_delete(
        ...
        _param = self._event_models_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EventModelsIdGet200Response"
    ...
    @validate_call
    def event_models_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventModelsIdGet200Response]:
        """Delete a EventModel
    ...
    @validate_call
    def event_models_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _event_models_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def event_models_id_get(
        ...
        _param = self._event_models_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def event_models_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def event_models_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _event_models_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def event_models_id_patch(
        self,
        id: StrictInt,
        event_models_id_patch_request: EventModelsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param event_models_id_patch_request: (required)
        :type event_models_id_patch_request: EventModelsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._event_models_id_patch_serialize(
            id=id,
            event_models_id_patch_request=event_models_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def event_models_id_patch_with_http_info(
        self,
        id: StrictInt,
        event_models_id_patch_request: EventModelsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def event_models_id_patch_without_preload_content(
        self,
        id: StrictInt,
        event_models_id_patch_request: EventModelsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _event_models_id_patch_serialize(
        self,
        id,
        event_models_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if event_models_id_patch_request is not None:
            _body_params = event_models_id_patch_request
    ...
    @validate_call
    def event_models_post(
        self,
        event_models_post_request: EventModelsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param event_models_post_request: (required)
        :type event_models_post_request: EventModelsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._event_models_post_serialize(
            event_models_post_request=event_models_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "EventModelsIdGet200Response"
    ...
    @validate_call
    def event_models_post_with_http_info(
        self,
        event_models_post_request: EventModelsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def event_models_post_without_preload_content(
        self,
        event_models_post_request: EventModelsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _event_models_post_serialize(
        self,
        event_models_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if event_models_post_request is not None:
            _body_params = event_models_post_request
