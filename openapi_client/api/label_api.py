...
class LabelApi:
    ...
    def labels_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LabelsGet200Response]:
        """List all Labels
    ...
    def labels_id_get(
        ...
        _param = self._labels_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def labels_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LabelsIdGet200Response]:
        """Show a single Label
    ...
    @validate_call
    def labels_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
