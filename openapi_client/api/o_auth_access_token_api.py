...
class OAuthAccessTokenApi:
    ...
    def oauth_access_tokens_get(
        ...
        _param = self._oauth_access_tokens_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OauthAccessTokensGet200Response"
    ...
    @validate_call
    def oauth_access_tokens_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OauthAccessTokensGet200Response]:
        """List all OAuth Access Tokens
    ...
    @validate_call
    def oauth_access_tokens_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _oauth_access_tokens_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/oauth_access_tokens',
    ...
    @validate_call
    def oauth_access_tokens_id_get(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._oauth_access_tokens_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OauthAccessTokensIdGet200Response"
    ...
    @validate_call
    def oauth_access_tokens_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OauthAccessTokensIdGet200Response]:
        """Show a single OAuth Access Token
    ...
    @validate_call
    def oauth_access_tokens_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _oauth_access_tokens_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/oauth_access_tokens/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
