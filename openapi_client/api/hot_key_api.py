...
class HotKeyApi:
    ...
    def hot_keys_get(
        ...
        _param = self._hot_keys_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def hot_keys_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HotKeysGet200Response]:
        """List all HotKeys
    ...
    @validate_call
    def hot_keys_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def hot_keys_id_delete(
        ...
        _param = self._hot_keys_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def hot_keys_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HotKeysIdGet200Response]:
        """Delete a HotKey
    ...
    @validate_call
    def hot_keys_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _hot_keys_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def hot_keys_id_get(
        ...
        _param = self._hot_keys_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def hot_keys_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def hot_keys_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _hot_keys_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def hot_keys_id_patch(
        self,
        id: StrictInt,
        hot_keys_id_patch_request: HotKeysIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param hot_keys_id_patch_request: (required)
        :type hot_keys_id_patch_request: HotKeysIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._hot_keys_id_patch_serialize(
            id=id,
            hot_keys_id_patch_request=hot_keys_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def hot_keys_id_patch_with_http_info(
        self,
        id: StrictInt,
        hot_keys_id_patch_request: HotKeysIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def hot_keys_id_patch_without_preload_content(
        self,
        id: StrictInt,
        hot_keys_id_patch_request: HotKeysIdPatchRequest,
        _request_timeout: Union[
    ...
    def _hot_keys_id_patch_serialize(
        self,
        id,
        hot_keys_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if hot_keys_id_patch_request is not None:
            _body_params = hot_keys_id_patch_request
    ...
    def hot_keys_post(
        self,
        hot_keys_post_request: HotKeysPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param hot_keys_post_request: (required)
        :type hot_keys_post_request: HotKeysPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._hot_keys_post_serialize(
            hot_keys_post_request=hot_keys_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def hot_keys_post_with_http_info(
        self,
        hot_keys_post_request: HotKeysPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def hot_keys_post_without_preload_content(
        self,
        hot_keys_post_request: HotKeysPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _hot_keys_post_serialize(
        self,
        hot_keys_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if hot_keys_post_request is not None:
            _body_params = hot_keys_post_request
