...
class ServiceQuoteApi:
    ...
    @validate_call
    def service_quotes_post(
        self,
        service_quotes_post_request: ServiceQuotesPostRequest,
        ...
        :param service_quotes_post_request: (required)
        :type service_quotes_post_request: ServiceQuotesPostRequest
        ...
        _param = self._service_quotes_post_serialize(
            service_quotes_post_request=service_quotes_post_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "ServiceQuotesPost204Response"
    ...
    @validate_call
    def service_quotes_post_with_http_info(
        self,
        service_quotes_post_request: ServiceQuotesPostRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServiceQuotesPost204Response]:
        """Create a Service Quote
    ...
    @validate_call
    def service_quotes_post_without_preload_content(
        self,
        service_quotes_post_request: ServiceQuotesPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _service_quotes_post_serialize(
        self,
        service_quotes_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if service_quotes_post_request is not None:
            _body_params = service_quotes_post_request
