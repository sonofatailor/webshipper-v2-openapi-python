...
class CSVMappingApi:
    ...
    def csv_mappings_get(
        ...
        _param = self._csv_mappings_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def csv_mappings_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CsvMappingsGet200Response]:
        """List all CSV Mappings
    ...
    @validate_call
    def csv_mappings_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _csv_mappings_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def csv_mappings_id_delete(
        ...
        _param = self._csv_mappings_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CsvMappingsIdGet200Response"
    ...
    @validate_call
    def csv_mappings_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CsvMappingsIdGet200Response]:
        """Delete a CSV Mapping
    ...
    @validate_call
    def csv_mappings_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _csv_mappings_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def csv_mappings_id_get(
        ...
        _param = self._csv_mappings_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def csv_mappings_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def csv_mappings_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _csv_mappings_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def csv_mappings_id_patch(
        self,
        id: StrictInt,
        csv_mappings_id_patch_request: CsvMappingsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param csv_mappings_id_patch_request: (required)
        :type csv_mappings_id_patch_request: CsvMappingsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._csv_mappings_id_patch_serialize(
            id=id,
            csv_mappings_id_patch_request=csv_mappings_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def csv_mappings_id_patch_with_http_info(
        self,
        id: StrictInt,
        csv_mappings_id_patch_request: CsvMappingsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def csv_mappings_id_patch_without_preload_content(
        self,
        id: StrictInt,
        csv_mappings_id_patch_request: CsvMappingsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _csv_mappings_id_patch_serialize(
        self,
        id,
        csv_mappings_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if csv_mappings_id_patch_request is not None:
            _body_params = csv_mappings_id_patch_request
    ...
    @validate_call
    def csv_mappings_post(
        self,
        csv_mappings_post_request: CsvMappingsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param csv_mappings_post_request: (required)
        :type csv_mappings_post_request: CsvMappingsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._csv_mappings_post_serialize(
            csv_mappings_post_request=csv_mappings_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "CsvMappingsIdGet200Response"
    ...
    @validate_call
    def csv_mappings_post_with_http_info(
        self,
        csv_mappings_post_request: CsvMappingsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def csv_mappings_post_without_preload_content(
        self,
        csv_mappings_post_request: CsvMappingsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _csv_mappings_post_serialize(
        self,
        csv_mappings_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if csv_mappings_post_request is not None:
            _body_params = csv_mappings_post_request
