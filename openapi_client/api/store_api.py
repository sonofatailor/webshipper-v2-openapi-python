...
class StoreApi:
    ...
    def stores_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StoresGet200Response]:
        """List all Stores
    ...
    def stores_id_delete(
        ...
        _param = self._stores_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def stores_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StoresIdGet200Response]:
        """Delete a Store
    ...
    @validate_call
    def stores_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _stores_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def stores_id_get(
        ...
        _param = self._stores_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def stores_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def stores_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def stores_id_patch(
        self,
        id: StrictInt,
        stores_id_patch_request: StoresIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param stores_id_patch_request: (required)
        :type stores_id_patch_request: StoresIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._stores_id_patch_serialize(
            id=id,
            stores_id_patch_request=stores_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def stores_id_patch_with_http_info(
        self,
        id: StrictInt,
        stores_id_patch_request: StoresIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def stores_id_patch_without_preload_content(
        self,
        id: StrictInt,
        stores_id_patch_request: StoresIdPatchRequest,
        _request_timeout: Union[
    ...
    def _stores_id_patch_serialize(
        self,
        id,
        stores_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if stores_id_patch_request is not None:
            _body_params = stores_id_patch_request
    ...
    def stores_post(
        self,
        stores_post_request: StoresPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param stores_post_request: (required)
        :type stores_post_request: StoresPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._stores_post_serialize(
            stores_post_request=stores_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def stores_post_with_http_info(
        self,
        stores_post_request: StoresPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def stores_post_without_preload_content(
        self,
        stores_post_request: StoresPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _stores_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if stores_post_request is not None:
            _body_params = stores_post_request
