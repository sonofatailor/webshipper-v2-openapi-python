...
class DocumentApi:
    ...
    def documents_get(
        ...
        filter_is_special: Annotated[Optional[StrictStr], Field(description="Filter by is_special")] = None,
        ...
        :type filter_id: str
        :param filter_is_special: Filter by is_special
        :type filter_is_special: str
        ...
        _param = self._documents_get_serialize(
            filter_id=filter_id,
            filter_is_special=filter_is_special,
    ...
    def documents_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentsGet200Response]:
        """List all Documents
    ...
    def _documents_get_serialize(
        ...
        if filter_is_special is not None:
            
            _query_params.append(('filter[is_special]', filter_is_special))
    ...
    @validate_call
    def documents_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentsIdGet200Response]:
        """Delete a Document
    ...
    @validate_call
    def documents_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def documents_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def documents_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def documents_id_patch(
        self,
        id: StrictInt,
        documents_id_patch_request: DocumentsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param documents_id_patch_request: (required)
        :type documents_id_patch_request: DocumentsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._documents_id_patch_serialize(
            id=id,
            documents_id_patch_request=documents_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def documents_id_patch_with_http_info(
        self,
        id: StrictInt,
        documents_id_patch_request: DocumentsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def documents_id_patch_without_preload_content(
        self,
        id: StrictInt,
        documents_id_patch_request: DocumentsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _documents_id_patch_serialize(
        self,
        id,
        documents_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if documents_id_patch_request is not None:
            _body_params = documents_id_patch_request
    ...
    def documents_post(
        self,
        documents_post_request: DocumentsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param documents_post_request: (required)
        :type documents_post_request: DocumentsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._documents_post_serialize(
            documents_post_request=documents_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def documents_post_with_http_info(
        self,
        documents_post_request: DocumentsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def documents_post_without_preload_content(
        self,
        documents_post_request: DocumentsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _documents_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if documents_post_request is not None:
            _body_params = documents_post_request
