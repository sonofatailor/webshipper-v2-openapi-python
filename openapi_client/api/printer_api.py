...
class PrinterApi:
    ...
    def printers_get(
        ...
        _param = self._printers_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def printers_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrintersGet200Response]:
        """List all Printers
    ...
    @validate_call
    def printers_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def printers_id_get(
        ...
        _param = self._printers_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def printers_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrintersIdGet200Response]:
        """Show a single Printer
    ...
    @validate_call
    def printers_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _printers_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
