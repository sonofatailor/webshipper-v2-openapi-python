...
class WebhookFailureApi:
    ...
    def webhook_failures_get(
        ...
        _param = self._webhook_failures_get_serialize(
            filter_id=filter_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WebhookFailuresGet200Response"
    ...
    @validate_call
    def webhook_failures_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhookFailuresGet200Response]:
        """List all Webhook Failures
    ...
    @validate_call
    def webhook_failures_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _webhook_failures_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhook_failures',
    ...
    @validate_call
    def webhook_failures_id_delete(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._webhook_failures_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WebhookFailuresIdGet200Response"
    ...
    @validate_call
    def webhook_failures_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhookFailuresIdGet200Response]:
        """Delete a Webhook Failure
    ...
    @validate_call
    def webhook_failures_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _webhook_failures_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/webhook_failures/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def webhook_failures_id_get(
        ...
        _param = self._webhook_failures_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def webhook_failures_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def webhook_failures_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _webhook_failures_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def webhook_failures_id_patch(
        self,
        id: StrictInt,
        webhook_failures_id_patch_request: WebhookFailuresIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param webhook_failures_id_patch_request: (required)
        :type webhook_failures_id_patch_request: WebhookFailuresIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._webhook_failures_id_patch_serialize(
            id=id,
            webhook_failures_id_patch_request=webhook_failures_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def webhook_failures_id_patch_with_http_info(
        self,
        id: StrictInt,
        webhook_failures_id_patch_request: WebhookFailuresIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def webhook_failures_id_patch_without_preload_content(
        self,
        id: StrictInt,
        webhook_failures_id_patch_request: WebhookFailuresIdPatchRequest,
        _request_timeout: Union[
    ...
    def _webhook_failures_id_patch_serialize(
        self,
        id,
        webhook_failures_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if webhook_failures_id_patch_request is not None:
            _body_params = webhook_failures_id_patch_request
    ...
    @validate_call
    def webhook_failures_post(
        self,
        webhook_failures_post_request: WebhookFailuresPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param webhook_failures_post_request: (required)
        :type webhook_failures_post_request: WebhookFailuresPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._webhook_failures_post_serialize(
            webhook_failures_post_request=webhook_failures_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "WebhookFailuresIdGet200Response"
    ...
    @validate_call
    def webhook_failures_post_with_http_info(
        self,
        webhook_failures_post_request: WebhookFailuresPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def webhook_failures_post_without_preload_content(
        self,
        webhook_failures_post_request: WebhookFailuresPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _webhook_failures_post_serialize(
        self,
        webhook_failures_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if webhook_failures_post_request is not None:
            _body_params = webhook_failures_post_request
