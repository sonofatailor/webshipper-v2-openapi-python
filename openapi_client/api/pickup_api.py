...
class PickupApi:
    ...
    def pickups_get(
        ...
        _param = self._pickups_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def pickups_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PickupsGet200Response]:
        """List all Pickups
    ...
    @validate_call
    def pickups_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def pickups_id_delete(
        ...
        _param = self._pickups_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def pickups_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PickupsIdGet200Response]:
        """Delete a Pickup
    ...
    @validate_call
    def pickups_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _pickups_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def pickups_id_get(
        ...
        _param = self._pickups_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def pickups_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def pickups_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def pickups_id_patch(
        self,
        id: StrictInt,
        pickups_id_patch_request: PickupsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param pickups_id_patch_request: (required)
        :type pickups_id_patch_request: PickupsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._pickups_id_patch_serialize(
            id=id,
            pickups_id_patch_request=pickups_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def pickups_id_patch_with_http_info(
        self,
        id: StrictInt,
        pickups_id_patch_request: PickupsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def pickups_id_patch_without_preload_content(
        self,
        id: StrictInt,
        pickups_id_patch_request: PickupsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _pickups_id_patch_serialize(
        self,
        id,
        pickups_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if pickups_id_patch_request is not None:
            _body_params = pickups_id_patch_request
    ...
    def pickups_post(
        self,
        pickups_post_request: PickupsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pickups_post_request: (required)
        :type pickups_post_request: PickupsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._pickups_post_serialize(
            pickups_post_request=pickups_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def pickups_post_with_http_info(
        self,
        pickups_post_request: PickupsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def pickups_post_without_preload_content(
        self,
        pickups_post_request: PickupsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _pickups_post_serialize(
        self,
        pickups_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if pickups_post_request is not None:
            _body_params = pickups_post_request
