...
class ShippingRateExpressionApi:
    ...
    def expressions_get(
        ...
        _param = self._expressions_get_serialize(
            filter_id=filter_id,
    ...
    @validate_call
    def expressions_get_with_http_info(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressionsGet200Response]:
        """List all Shipping Rate Expressions
    ...
    @validate_call
    def expressions_get_without_preload_content(
        self,
        filter_id: Annotated[Optional[StrictStr], Field(description="Filter by id")] = None,
        _request_timeout: Union[
            None,
    ...
    def _expressions_get_serialize(
        self,
        filter_id,
        _request_auth,
        _content_type,
    ...
    def expressions_id_delete(
        ...
        _param = self._expressions_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressionsIdGet200Response"
    ...
    @validate_call
    def expressions_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressionsIdGet200Response]:
        """Delete a Shipping Rate Expression
    ...
    @validate_call
    def expressions_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _expressions_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def expressions_id_get(
        ...
        _param = self._expressions_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def expressions_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def expressions_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _expressions_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def expressions_id_patch(
        self,
        id: StrictInt,
        expressions_id_patch_request: ExpressionsIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: int
        :param expressions_id_patch_request: (required)
        :type expressions_id_patch_request: ExpressionsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._expressions_id_patch_serialize(
            id=id,
            expressions_id_patch_request=expressions_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def expressions_id_patch_with_http_info(
        self,
        id: StrictInt,
        expressions_id_patch_request: ExpressionsIdPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def expressions_id_patch_without_preload_content(
        self,
        id: StrictInt,
        expressions_id_patch_request: ExpressionsIdPatchRequest,
        _request_timeout: Union[
    ...
    def _expressions_id_patch_serialize(
        self,
        id,
        expressions_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if expressions_id_patch_request is not None:
            _body_params = expressions_id_patch_request
    ...
    @validate_call
    def expressions_post(
        self,
        expressions_post_request: ExpressionsPostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param expressions_post_request: (required)
        :type expressions_post_request: ExpressionsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._expressions_post_serialize(
            expressions_post_request=expressions_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '204': "ExpressionsIdGet200Response"
    ...
    @validate_call
    def expressions_post_with_http_info(
        self,
        expressions_post_request: ExpressionsPostRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def expressions_post_without_preload_content(
        self,
        expressions_post_request: ExpressionsPostRequest,
        _request_timeout: Union[
            None,
    ...
    def _expressions_post_serialize(
        self,
        expressions_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if expressions_post_request is not None:
            _body_params = expressions_post_request
