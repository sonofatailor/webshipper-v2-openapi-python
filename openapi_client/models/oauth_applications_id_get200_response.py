...
class OauthApplicationsIdGet200Response(BaseModel):
    """
    OauthApplicationsIdGet200Response
    """ # noqa: E501
    data: Optional[OauthApplicationsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OauthApplicationsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
