...
class OrderChannelsIdGet200Response(BaseModel):
    """
    OrderChannelsIdGet200Response
    """ # noqa: E501
    data: Optional[OrderChannelsIdGet200ResponseData] = None
    relationships: Optional[OrderChannelsIdGet200ResponseRelationships] = None
    included: Optional[List[OrderChannelsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderChannelsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": OrderChannelsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [OrderChannelsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
