...
class DropPointLocatorsPost204ResponseData(BaseModel):
    """
    DropPointLocatorsPost204ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[DropPointLocators] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('drop_point_locators'):
            raise ValueError("must be one of enum values ('drop_point_locators')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": DropPointLocators.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
