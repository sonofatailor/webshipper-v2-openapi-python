...
class OauthAccessTokensIdGet200ResponseRelationshipsApplication(BaseModel):
    """
    OauthAccessTokensIdGet200ResponseRelationshipsApplication
    """ # noqa: E501
    data: Optional[OauthAccessTokensIdGet200ResponseRelationshipsApplicationData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OauthAccessTokensIdGet200ResponseRelationshipsApplicationData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
