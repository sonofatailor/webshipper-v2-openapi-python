...
class ActionsGet200Response(BaseModel):
    """
    ActionsGet200Response
    """ # noqa: E501
    data: Optional[List[ActionsGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ActionsGet200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
