...
class AutomationsIdGet200Response(BaseModel):
    """
    AutomationsIdGet200Response
    """ # noqa: E501
    data: Optional[AutomationsIdGet200ResponseData] = None
    relationships: Optional[AutomationsIdGet200ResponseRelationships] = None
    included: Optional[List[AutomationsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AutomationsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": AutomationsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [AutomationsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
