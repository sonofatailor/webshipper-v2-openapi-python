...
class PrinterClientsIdGet200Response(BaseModel):
    """
    PrinterClientsIdGet200Response
    """ # noqa: E501
    data: Optional[PrinterClientsIdGet200ResponseData] = None
    relationships: Optional[PrinterClientsIdGet200ResponseRelationships] = None
    included: Optional[List[PrinterClientsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrinterClientsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": PrinterClientsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [PrinterClientsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
