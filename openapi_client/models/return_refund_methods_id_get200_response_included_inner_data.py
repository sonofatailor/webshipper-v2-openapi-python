...
RETURNREFUNDMETHODSIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["ReturnPortals"]

class ReturnRefundMethodsIdGet200ResponseIncludedInnerData(BaseModel):
    """
    ...
    actual_instance: Optional[Union[ReturnPortals]] = None
    one_of_schemas: List[str] = Literal["ReturnPortals"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ReturnRefundMethodsIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ReturnRefundMethodsIdGet200ResponseIncludedInnerData with oneOf schemas: ReturnPortals. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ReturnRefundMethodsIdGet200ResponseIncludedInnerData with oneOf schemas: ReturnPortals. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ReturnRefundMethodsIdGet200ResponseIncludedInnerData with oneOf schemas: ReturnPortals. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ReturnRefundMethodsIdGet200ResponseIncludedInnerData with oneOf schemas: ReturnPortals. Details: " + ", ".join(error_messages))
        else:
            return instance
