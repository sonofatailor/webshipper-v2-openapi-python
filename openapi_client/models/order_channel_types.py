...
class OrderChannelTypes(BaseModel):
    """
    OrderChannelTypes
    """ # noqa: E501
    name: Optional[StrictStr] = None
    support_url: Optional[StrictStr] = None
    public_global_attrs: Optional[StrictStr] = None
    list_logo: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    module_link: Optional[StrictStr] = None
    can_autofulfill: Optional[StrictBool] = None
    can_limit_drop_points: Optional[StrictBool] = None
    supports_rate_quoting: Optional[StrictBool] = None
    uses_scheduled_import: Optional[StrictBool] = None
    supports_time_interval_import: Optional[StrictBool] = None
    supports_statuses_import: Optional[StrictBool] = None
    supports_id_import: Optional[StrictBool] = None
    supports_vat_in_checkout: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "support_url", "public_global_attrs", "list_logo", "description", "module_link", "can_autofulfill", "can_limit_drop_points", "supports_rate_quoting", "uses_scheduled_import", "supports_time_interval_import", "supports_statuses_import", "supports_id_import", "supports_vat_in_checkout"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "public_global_attrs": obj.get("public_global_attrs"),
            "list_logo": obj.get("list_logo"),
            "description": obj.get("description"),
            "module_link": obj.get("module_link"),
            "can_autofulfill": obj.get("can_autofulfill"),
            "can_limit_drop_points": obj.get("can_limit_drop_points"),
            "supports_rate_quoting": obj.get("supports_rate_quoting"),
            "uses_scheduled_import": obj.get("uses_scheduled_import"),
            "supports_time_interval_import": obj.get("supports_time_interval_import"),
            "supports_statuses_import": obj.get("supports_statuses_import"),
            "supports_id_import": obj.get("supports_id_import"),
            "supports_vat_in_checkout": obj.get("supports_vat_in_checkout")
        })
        return _obj
