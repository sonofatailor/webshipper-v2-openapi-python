...
class ReturnPortalsIdGet200ResponseRelationshipsMailTemplate(BaseModel):
    """
    ReturnPortalsIdGet200ResponseRelationshipsMailTemplate
    """ # noqa: E501
    data: Optional[ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnPortalsIdGet200ResponseRelationshipsMailTemplateData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
