...
class WaybillsIdGet200Response(BaseModel):
    """
    WaybillsIdGet200Response
    """ # noqa: E501
    data: Optional[WaybillsIdGet200ResponseData] = None
    relationships: Optional[WaybillsIdGet200ResponseRelationships] = None
    included: Optional[List[WaybillsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": WaybillsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": WaybillsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [WaybillsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
