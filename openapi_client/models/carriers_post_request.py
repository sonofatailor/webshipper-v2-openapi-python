...
class CarriersPostRequest(BaseModel):
    """
    CarriersPostRequest
    """ # noqa: E501
    data: Optional[CarriersPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarriersPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
