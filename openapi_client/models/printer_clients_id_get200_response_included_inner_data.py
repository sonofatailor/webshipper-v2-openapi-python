...
PRINTERCLIENTSIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["Printers", "ShippingAddresses"]

class PrinterClientsIdGet200ResponseIncludedInnerData(BaseModel):
    """
    PrinterClientsIdGet200ResponseIncludedInnerData
    """
    # data type: Printers
    oneof_schema_1_validator: Optional[Printers] = None
    # data type: ShippingAddresses
    oneof_schema_2_validator: Optional[ShippingAddresses] = None
    actual_instance: Optional[Union[Printers, ShippingAddresses]] = None
    one_of_schemas: List[str] = Literal["Printers", "ShippingAddresses"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = PrinterClientsIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in PrinterClientsIdGet200ResponseIncludedInnerData with oneOf schemas: Printers, ShippingAddresses. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in PrinterClientsIdGet200ResponseIncludedInnerData with oneOf schemas: Printers, ShippingAddresses. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into PrinterClientsIdGet200ResponseIncludedInnerData with oneOf schemas: Printers, ShippingAddresses. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PrinterClientsIdGet200ResponseIncludedInnerData with oneOf schemas: Printers, ShippingAddresses. Details: " + ", ".join(error_messages))
        else:
            return instance
