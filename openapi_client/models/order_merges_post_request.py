...
class OrderMergesPostRequest(BaseModel):
    """
    OrderMergesPostRequest
    """ # noqa: E501
    data: Optional[OrderMergesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderMergesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
