...
class BarcodeRangesIdGet200ResponseRelationshipsCarrier(BaseModel):
    """
    BarcodeRangesIdGet200ResponseRelationshipsCarrier
    """ # noqa: E501
    data: Optional[BarcodeRangesIdGet200ResponseRelationshipsCarrierData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BarcodeRangesIdGet200ResponseRelationshipsCarrierData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
