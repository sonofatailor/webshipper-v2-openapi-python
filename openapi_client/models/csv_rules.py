...
class CsvRules(BaseModel):
    ...
    CsvRules
    """ # noqa: E501
    target_path: Optional[StrictStr] = Field(default=None, description="Path of the attribute to update")
    source_index: Optional[StrictInt] = Field(default=None, description="The index of the field in the CSV file to be mapped")
    default_value: Optional[StrictStr] = Field(default=None, description="Value to use if the value in the CSV file is empty or missing")
    input_conversions: Optional[Union[str, Any]] = Field(default=None, description="A key/value mapping for converting values before creating the object")
    __properties: ClassVar[List[str]] = ["target_path", "source_index", "default_value", "input_conversions"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "input_conversions": obj.get("input_conversions")
        })
        return _obj
