...
class ShippingRatesIdGet200ResponseData(BaseModel):
    """
    ShippingRatesIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[ShippingRates] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('shipping_rates'):
            raise ValueError("must be one of enum values ('shipping_rates')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ShippingRates.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
