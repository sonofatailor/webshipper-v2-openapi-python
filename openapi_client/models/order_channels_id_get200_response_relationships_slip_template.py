...
class OrderChannelsIdGet200ResponseRelationshipsSlipTemplate(BaseModel):
    """
    OrderChannelsIdGet200ResponseRelationshipsSlipTemplate
    """ # noqa: E501
    data: Optional[OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderChannelsIdGet200ResponseRelationshipsSlipTemplateData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
