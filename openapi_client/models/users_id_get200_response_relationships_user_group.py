...
class UsersIdGet200ResponseRelationshipsUserGroup(BaseModel):
    """
    UsersIdGet200ResponseRelationshipsUserGroup
    """ # noqa: E501
    data: Optional[UsersIdGet200ResponseRelationshipsUserGroupData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UsersIdGet200ResponseRelationshipsUserGroupData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
