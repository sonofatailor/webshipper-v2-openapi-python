...
EDISIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["Shipments"]

class EdisIdGet200ResponseIncludedInnerData(BaseModel):
    """
    EdisIdGet200ResponseIncludedInnerData
    """
    # data type: Shipments
    oneof_schema_1_validator: Optional[Shipments] = None
    actual_instance: Optional[Union[Shipments]] = None
    one_of_schemas: List[str] = Literal["Shipments"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = EdisIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in EdisIdGet200ResponseIncludedInnerData with oneOf schemas: Shipments. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in EdisIdGet200ResponseIncludedInnerData with oneOf schemas: Shipments. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into EdisIdGet200ResponseIncludedInnerData with oneOf schemas: Shipments. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into EdisIdGet200ResponseIncludedInnerData with oneOf schemas: Shipments. Details: " + ", ".join(error_messages))
        else:
            return instance
