...
class ReturnsPostRequest(BaseModel):
    """
    ReturnsPostRequest
    """ # noqa: E501
    data: Optional[ReturnsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
