...
class EndOfDayReportsIdGet200Response(BaseModel):
    """
    EndOfDayReportsIdGet200Response
    """ # noqa: E501
    data: Optional[EndOfDayReportsIdGet200ResponseData] = None
    relationships: Optional[BarcodeRangesIdGet200ResponseRelationships] = None
    included: Optional[List[BarcodeRangesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EndOfDayReportsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": BarcodeRangesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [BarcodeRangesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
