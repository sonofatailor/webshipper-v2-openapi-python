...
class HasDocumentsPostRequest(BaseModel):
    """
    HasDocumentsPostRequest
    """ # noqa: E501
    data: Optional[HasDocumentsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": HasDocumentsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
