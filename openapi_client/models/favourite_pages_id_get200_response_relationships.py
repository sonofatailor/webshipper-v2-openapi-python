...
class FavouritePagesIdGet200ResponseRelationships(BaseModel):
    """
    FavouritePagesIdGet200ResponseRelationships
    """ # noqa: E501
    user: Optional[CarrierAccessesIdGet200ResponseRelationshipsUser] = None
    hot_key: Optional[FavouritePagesIdGet200ResponseRelationshipsHotKey] = None
    __properties: ClassVar[List[str]] = ["user", "hot_key"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of hot_key
        if self.hot_key:
            _dict['hot_key'] = self.hot_key.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hot_key": FavouritePagesIdGet200ResponseRelationshipsHotKey.from_dict(obj.get("hot_key")) if obj.get("hot_key") is not None else None
        })
        return _obj
