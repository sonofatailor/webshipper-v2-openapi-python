...
class CarrierAccessesIdGet200ResponseData(BaseModel):
    """
    CarrierAccessesIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[CarrierAccesses] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('carrier_accesses'):
            raise ValueError("must be one of enum values ('carrier_accesses')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": CarrierAccesses.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
