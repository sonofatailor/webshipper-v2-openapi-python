...
class PrintablesIdGet200Response(BaseModel):
    """
    PrintablesIdGet200Response
    """ # noqa: E501
    data: Optional[PrintablesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrintablesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
