...
class EndOfDayReportsIdGet200ResponseData(BaseModel):
    """
    EndOfDayReportsIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[EndOfDayReports] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('end_of_day_reports'):
            raise ValueError("must be one of enum values ('end_of_day_reports')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": EndOfDayReports.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
