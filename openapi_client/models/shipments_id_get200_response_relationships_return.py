...
class ShipmentsIdGet200ResponseRelationshipsReturn(BaseModel):
    """
    ShipmentsIdGet200ResponseRelationshipsReturn
    """ # noqa: E501
    data: Optional[ShipmentsIdGet200ResponseRelationshipsReturnData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShipmentsIdGet200ResponseRelationshipsReturnData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
