...
class ReturnsIdGet200Response(BaseModel):
    """
    ReturnsIdGet200Response
    """ # noqa: E501
    data: Optional[ReturnsIdGet200ResponseData] = None
    relationships: Optional[ReturnsIdGet200ResponseRelationships] = None
    included: Optional[List[ReturnsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ReturnsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ReturnsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
