...
class Expressions(BaseModel):
    ...
    Expressions
    """ # noqa: E501
    expression: Optional[StrictStr] = Field(default=None, description="Is the actual WEL expression to be evaluated")
    vat_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="VAT rate in percentage which must be added to the price.")
    currency: Optional[StrictStr] = Field(default=None, description="Currency of the price")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cost price displayed to the end user")
    __properties: ClassVar[List[str]] = ["expression", "vat_percent", "currency", "price"]
