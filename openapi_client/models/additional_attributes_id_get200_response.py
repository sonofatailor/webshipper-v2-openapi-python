...
class AdditionalAttributesIdGet200Response(BaseModel):
    """
    AdditionalAttributesIdGet200Response
    """ # noqa: E501
    data: Optional[AdditionalAttributesIdGet200ResponseData] = None
    relationships: Optional[AdditionalAttributesIdGet200ResponseRelationships] = None
    included: Optional[List[AdditionalAttributesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AdditionalAttributesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": AdditionalAttributesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [AdditionalAttributesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
