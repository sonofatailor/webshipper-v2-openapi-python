...
class TagsGet200ResponseDataInner(BaseModel):
    """
    TagsGet200ResponseDataInner
    """ # noqa: E501
    attributes: Optional[Tags] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "attributes": Tags.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
