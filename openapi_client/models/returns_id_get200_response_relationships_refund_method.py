...
class ReturnsIdGet200ResponseRelationshipsRefundMethod(BaseModel):
    """
    ReturnsIdGet200ResponseRelationshipsRefundMethod
    """ # noqa: E501
    data: Optional[ReturnsIdGet200ResponseRelationshipsRefundMethodData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnsIdGet200ResponseRelationshipsRefundMethodData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
