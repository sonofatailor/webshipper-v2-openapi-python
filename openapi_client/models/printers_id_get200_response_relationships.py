...
class PrintersIdGet200ResponseRelationships(BaseModel):
    """
    PrintersIdGet200ResponseRelationships
    """ # noqa: E501
    client: Optional[OrdersIdGet200ResponseRelationshipsPrinterClient] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "client": OrdersIdGet200ResponseRelationshipsPrinterClient.from_dict(obj.get("client")) if obj.get("client") is not None else None
        })
        return _obj
