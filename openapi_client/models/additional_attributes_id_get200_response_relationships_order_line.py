...
class AdditionalAttributesIdGet200ResponseRelationshipsOrderLine(BaseModel):
    """
    AdditionalAttributesIdGet200ResponseRelationshipsOrderLine
    """ # noqa: E501
    data: Optional[AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
