...
class SlipTemplatesPostRequest(BaseModel):
    """
    SlipTemplatesPostRequest
    """ # noqa: E501
    data: Optional[SlipTemplatesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SlipTemplatesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
