...
class PickupsPostRequest(BaseModel):
    """
    PickupsPostRequest
    """ # noqa: E501
    data: Optional[PickupsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PickupsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
