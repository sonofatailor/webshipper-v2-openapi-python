...
class OrdersIdGet200ResponseRelationshipsErrorType(BaseModel):
    """
    OrdersIdGet200ResponseRelationshipsErrorType
    """ # noqa: E501
    data: Optional[OrdersIdGet200ResponseRelationshipsErrorTypeData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrdersIdGet200ResponseRelationshipsErrorTypeData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
