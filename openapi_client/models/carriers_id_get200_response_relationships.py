...
class CarriersIdGet200ResponseRelationships(BaseModel):
    """
    CarriersIdGet200ResponseRelationships
    """ # noqa: E501
    carrier_type: Optional[CarriersIdGet200ResponseRelationshipsCarrierType] = None
    ...
    __properties: ClassVar[List[str]] = ["carrier_type", "sender_address", "return_address"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of carrier_type
        if self.carrier_type:
            _dict['carrier_type'] = self.carrier_type.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "carrier_type": CarriersIdGet200ResponseRelationshipsCarrierType.from_dict(obj.get("carrier_type")) if obj.get("carrier_type") is not None else None,
