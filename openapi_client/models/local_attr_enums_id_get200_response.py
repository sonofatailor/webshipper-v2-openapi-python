...
class LocalAttrEnumsIdGet200Response(BaseModel):
    """
    LocalAttrEnumsIdGet200Response
    """ # noqa: E501
    data: Optional[LocalAttrEnumsIdGet200ResponseData] = None
    relationships: Optional[LocalAttrEnumsIdGet200ResponseRelationships] = None
    included: Optional[List[LocalAttrEnumsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": LocalAttrEnumsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": LocalAttrEnumsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [LocalAttrEnumsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
