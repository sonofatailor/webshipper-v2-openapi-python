...
class EventsIdGet200Response(BaseModel):
    """
    EventsIdGet200Response
    """ # noqa: E501
    data: Optional[EventsIdGet200ResponseData] = None
    relationships: Optional[EventsIdGet200ResponseRelationships] = None
    included: Optional[List[EventsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EventsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": EventsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [EventsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
