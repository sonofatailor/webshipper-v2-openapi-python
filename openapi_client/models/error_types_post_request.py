...
class ErrorTypesPostRequest(BaseModel):
    """
    ErrorTypesPostRequest
    """ # noqa: E501
    data: Optional[ErrorTypesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ErrorTypesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
