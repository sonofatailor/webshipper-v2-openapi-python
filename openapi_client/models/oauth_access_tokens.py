...
class OauthAccessTokens(BaseModel):
    ...
    OauthAccessTokens
    """ # noqa: E501
    scopes: Optional[StrictStr] = Field(default=None, description="The scopes to which access is granted by the access token.")
    created_at: Optional[StrictStr] = Field(default=None, description="The time when the resource was created")
    resource_owner_id: Optional[StrictInt] = Field(default=None, description="Id of the owner")
    expires_in: Optional[StrictInt] = Field(default=None, description="Epoch timestamp of the expiration date for the token")
    expired: Optional[StrictStr] = None
    token: Optional[StrictStr] = Field(default=None, description="The access token")
    revoked_at: Optional[StrictStr] = Field(default=None, description="Datetime of the time the token was revoked - if revoked")
    resource_owner: Optional[StrictStr] = None
    application_id: Optional[StrictInt] = None
    application: Optional[StrictStr] = Field(default=None, description="The application to which this tokens grants access")
    __properties: ClassVar[List[str]] = ["scopes", "created_at", "resource_owner_id", "expires_in", "expired", "token", "revoked_at", "resource_owner", "application_id", "application"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "resource_owner": obj.get("resource_owner"),
