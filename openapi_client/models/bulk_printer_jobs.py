...
class BulkPrinterJobs(BaseModel):
    """
    BulkPrinterJobs
    """ # noqa: E501
    ids: Optional[StrictStr] = None
    model_type: Optional[StrictStr] = None
    printer_client_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["ids", "model_type", "printer_client_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "printer_client_id": obj.get("printer_client_id")
        })
        return _obj
