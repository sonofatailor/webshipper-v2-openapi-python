...
class OrderChannelAccessesIdGet200Response(BaseModel):
    """
    OrderChannelAccessesIdGet200Response
    """ # noqa: E501
    data: Optional[OrderChannelAccessesIdGet200ResponseData] = None
    relationships: Optional[OrderChannelAccessesIdGet200ResponseRelationships] = None
    included: Optional[List[OrderChannelAccessesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderChannelAccessesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": OrderChannelAccessesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [OrderChannelAccessesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
