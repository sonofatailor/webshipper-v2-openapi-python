...
class SlipTemplatesIdGet200Response(BaseModel):
    """
    SlipTemplatesIdGet200Response
    """ # noqa: E501
    data: Optional[SlipTemplatesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SlipTemplatesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
