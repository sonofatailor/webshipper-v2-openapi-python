...
class ServiceQuotesPost204Response(BaseModel):
    """
    ServiceQuotesPost204Response
    """ # noqa: E501
    data: Optional[ServiceQuotesPost204ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ServiceQuotesPost204ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
