...
class PdfMergesIdGet200Response(BaseModel):
    """
    PdfMergesIdGet200Response
    """ # noqa: E501
    data: Optional[PdfMergesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PdfMergesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
