...
class ReportTypesIdGet200Response(BaseModel):
    """
    ReportTypesIdGet200Response
    """ # noqa: E501
    data: Optional[ReportTypesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReportTypesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
