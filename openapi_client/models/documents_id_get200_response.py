...
class DocumentsIdGet200Response(BaseModel):
    """
    DocumentsIdGet200Response
    """ # noqa: E501
    data: Optional[DocumentsIdGet200ResponseData] = None
    relationships: Optional[DocumentsIdGet200ResponseRelationships] = None
    included: Optional[List[DocumentsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": DocumentsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": DocumentsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [DocumentsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
