...
class UserGroups(BaseModel):
    ...
    scopes: Optional[List[StrictStr]] = Field(default=None, description="Array of scopes. Please see section 6 for more details regarding scopes.")
    ...
    __properties: ClassVar[List[str]] = ["name", "scopes", "locked", "updated_at", "created_at"]
