...
class DropPointLocatorsPostRequest(BaseModel):
    """
    DropPointLocatorsPostRequest
    """ # noqa: E501
    data: Optional[DropPointLocatorsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": DropPointLocatorsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
