...
class HotKeysIdGet200ResponseRelationships(BaseModel):
    """
    HotKeysIdGet200ResponseRelationships
    """ # noqa: E501
    favourite_page: Optional[HotKeysIdGet200ResponseRelationshipsFavouritePage] = None
    user: Optional[CarrierAccessesIdGet200ResponseRelationshipsUser] = None
    __properties: ClassVar[List[str]] = ["favourite_page", "user"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of favourite_page
        if self.favourite_page:
            _dict['favourite_page'] = self.favourite_page.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "favourite_page": HotKeysIdGet200ResponseRelationshipsFavouritePage.from_dict(obj.get("favourite_page")) if obj.get("favourite_page") is not None else None,
            "user": CarrierAccessesIdGet200ResponseRelationshipsUser.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
