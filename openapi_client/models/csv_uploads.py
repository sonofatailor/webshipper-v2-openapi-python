...
class CsvUploads(BaseModel):
    ...
    CsvUploads
    """ # noqa: E501
    imported: Optional[List[StrictStr]] = Field(default=None, description="A list of ids of the imported records")
    input: Optional[StrictStr] = Field(default=None, description="The raw CSV data")
    input_url: Optional[StrictStr] = None
    import_errors: Optional[List[StrictStr]] = Field(default=None, description="A list of error messages for items that could not be imported")
    var_async: Optional[StrictBool] = Field(default=None, description="If set to true, the import will be performed in background. Highly recommended for imports larger than 100 rows.", alias="async")
    make_exportable: Optional[StrictBool] = None
    created_at: Optional[StrictStr] = Field(default=None, description="The time when the resource was created")
    __properties: ClassVar[List[str]] = ["imported", "input", "input_url", "import_errors", "async", "make_exportable", "created_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "input": obj.get("input"),
            "input_url": obj.get("input_url"),
            "import_errors": obj.get("import_errors"),
            "async": obj.get("async"),
            "make_exportable": obj.get("make_exportable"),
