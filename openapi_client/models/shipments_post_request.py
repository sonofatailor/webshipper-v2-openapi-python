...
class ShipmentsPostRequest(BaseModel):
    """
    ShipmentsPostRequest
    """ # noqa: E501
    data: Optional[ShipmentsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShipmentsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
