...
class ServiceQuotesPost204ResponseData(BaseModel):
    """
    ServiceQuotesPost204ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[ServiceQuotes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('service_quotes'):
            raise ValueError("must be one of enum values ('service_quotes')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ServiceQuotes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
