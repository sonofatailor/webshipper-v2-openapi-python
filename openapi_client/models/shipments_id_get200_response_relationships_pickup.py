...
class ShipmentsIdGet200ResponseRelationshipsPickup(BaseModel):
    """
    ShipmentsIdGet200ResponseRelationshipsPickup
    """ # noqa: E501
    data: Optional[ShipmentsIdGet200ResponseRelationshipsPickupData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShipmentsIdGet200ResponseRelationshipsPickupData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
