...
class ReturnShippingMethodsIdGet200ResponseData(BaseModel):
    """
    ReturnShippingMethodsIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[ReturnShippingMethods] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('return_shipping_methods'):
            raise ValueError("must be one of enum values ('return_shipping_methods')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ReturnShippingMethods.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
