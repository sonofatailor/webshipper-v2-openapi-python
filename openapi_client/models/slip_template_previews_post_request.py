...
class SlipTemplatePreviewsPostRequest(BaseModel):
    """
    SlipTemplatePreviewsPostRequest
    """ # noqa: E501
    data: Optional[SlipTemplatePreviewsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SlipTemplatePreviewsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
