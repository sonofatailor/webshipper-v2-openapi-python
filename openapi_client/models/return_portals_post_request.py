...
class ReturnPortalsPostRequest(BaseModel):
    """
    ReturnPortalsPostRequest
    """ # noqa: E501
    data: Optional[ReturnPortalsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnPortalsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
