...
class PrintablesPostRequest(BaseModel):
    """
    PrintablesPostRequest
    """ # noqa: E501
    data: Optional[PrintablesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrintablesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
