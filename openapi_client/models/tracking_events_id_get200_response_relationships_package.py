...
class TrackingEventsIdGet200ResponseRelationshipsPackage(BaseModel):
    """
    TrackingEventsIdGet200ResponseRelationshipsPackage
    """ # noqa: E501
    data: Optional[TrackingEventsIdGet200ResponseRelationshipsPackageData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TrackingEventsIdGet200ResponseRelationshipsPackageData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
