...
class CarrierTypesIdGet200Response(BaseModel):
    """
    CarrierTypesIdGet200Response
    """ # noqa: E501
    data: Optional[CarrierTypesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarrierTypesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
