...
class OauthApplications(BaseModel):
    ...
    uid: Optional[StrictStr] = Field(default=None, description="Unique id")
    scopes: Optional[StrictStr] = Field(default=None, description="The scopes which the OAuth application will be granted.")
    redirect_uri: Optional[StrictStr] = Field(default=None, description="OAuth redirect URI")
    ...
    __properties: ClassVar[List[str]] = ["name", "uid", "scopes", "redirect_uri", "created_at", "updated_at"]
