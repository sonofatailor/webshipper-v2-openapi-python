...
class ReportsIdGet200Response(BaseModel):
    """
    ReportsIdGet200Response
    """ # noqa: E501
    data: Optional[ReportsIdGet200ResponseData] = None
    relationships: Optional[ReportsIdGet200ResponseRelationships] = None
    included: Optional[List[ReportsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReportsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ReportsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ReportsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
