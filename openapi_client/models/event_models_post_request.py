...
class EventModelsPostRequest(BaseModel):
    """
    EventModelsPostRequest
    """ # noqa: E501
    data: Optional[EventModelsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EventModelsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
