...
class ActionsIdGet200ResponseRelationships(BaseModel):
    """
    ActionsIdGet200ResponseRelationships
    """ # noqa: E501
    automation: Optional[ActionsIdGet200ResponseRelationshipsAutomation] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "automation": ActionsIdGet200ResponseRelationshipsAutomation.from_dict(obj.get("automation")) if obj.get("automation") is not None else None
        })
        return _obj
