...
class BarcodeRangesPostRequest(BaseModel):
    """
    BarcodeRangesPostRequest
    """ # noqa: E501
    data: Optional[BarcodeRangesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BarcodeRangesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
