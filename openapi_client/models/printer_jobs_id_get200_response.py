...
class PrinterJobsIdGet200Response(BaseModel):
    """
    PrinterJobsIdGet200Response
    """ # noqa: E501
    data: Optional[PrinterJobsIdGet200ResponseData] = None
    relationships: Optional[PrinterJobsIdGet200ResponseRelationships] = None
    included: Optional[List[PrinterJobsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrinterJobsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": PrinterJobsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [PrinterJobsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
