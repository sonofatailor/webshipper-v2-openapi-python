...
class PackagesGet200Response(BaseModel):
    """
    PackagesGet200Response
    """ # noqa: E501
    data: Optional[List[PackagesGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [PackagesGet200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
