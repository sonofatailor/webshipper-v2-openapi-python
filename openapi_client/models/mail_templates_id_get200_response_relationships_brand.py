...
class MailTemplatesIdGet200ResponseRelationshipsBrand(BaseModel):
    """
    MailTemplatesIdGet200ResponseRelationshipsBrand
    """ # noqa: E501
    data: Optional[MailTemplatesIdGet200ResponseRelationshipsBrandData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": MailTemplatesIdGet200ResponseRelationshipsBrandData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
