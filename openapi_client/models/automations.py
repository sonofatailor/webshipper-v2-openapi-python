...
class Automations(BaseModel):
    ...
    Automations
    """ # noqa: E501
    trigger: Optional[Union[str, Any]] = Field(default=None, description="Flattened resource of type Trigger")
    actions: Optional[List[StrictStr]] = Field(default=None, description="Array of flattened resources of type Action ")
    name: Optional[StrictStr] = None
    enabled: Optional[StrictBool] = None
    priority: Optional[StrictInt] = None
    automation_type: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["trigger", "actions", "name", "enabled", "priority", "automation_type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "automation_type": obj.get("automation_type")
        })
        return _obj
