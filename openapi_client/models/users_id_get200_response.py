...
class UsersIdGet200Response(BaseModel):
    """
    UsersIdGet200Response
    """ # noqa: E501
    data: Optional[UsersIdGet200ResponseData] = None
    relationships: Optional[UsersIdGet200ResponseRelationships] = None
    included: Optional[List[UsersIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UsersIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": UsersIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [UsersIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
