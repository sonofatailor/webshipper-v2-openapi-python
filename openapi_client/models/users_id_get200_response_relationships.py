...
class UsersIdGet200ResponseRelationships(BaseModel):
    """
    UsersIdGet200ResponseRelationships
    """ # noqa: E501
    user_group: Optional[UsersIdGet200ResponseRelationshipsUserGroup] = None
    printer_client: Optional[OrdersIdGet200ResponseRelationshipsPrinterClient] = None
    __properties: ClassVar[List[str]] = ["user_group", "printer_client"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user_group": UsersIdGet200ResponseRelationshipsUserGroup.from_dict(obj.get("user_group")) if obj.get("user_group") is not None else None,
