...
class BulkPrinterJobsPostRequest(BaseModel):
    """
    BulkPrinterJobsPostRequest
    """ # noqa: E501
    data: Optional[BulkPrinterJobsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BulkPrinterJobsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
