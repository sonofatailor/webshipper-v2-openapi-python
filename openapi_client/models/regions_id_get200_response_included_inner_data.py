...
REGIONSIDGET200RESPONSEINCLUDEDINNERDATA_ONE_OF_SCHEMAS = ["ShippingRates"]

class RegionsIdGet200ResponseIncludedInnerData(BaseModel):
    """
    RegionsIdGet200ResponseIncludedInnerData
    """
    # data type: ShippingRates
    oneof_schema_1_validator: Optional[ShippingRates] = None
    actual_instance: Optional[Union[ShippingRates]] = None
    one_of_schemas: List[str] = Literal["ShippingRates"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = RegionsIdGet200ResponseIncludedInnerData.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in RegionsIdGet200ResponseIncludedInnerData with oneOf schemas: ShippingRates. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in RegionsIdGet200ResponseIncludedInnerData with oneOf schemas: ShippingRates. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into RegionsIdGet200ResponseIncludedInnerData with oneOf schemas: ShippingRates. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into RegionsIdGet200ResponseIncludedInnerData with oneOf schemas: ShippingRates. Details: " + ", ".join(error_messages))
        else:
            return instance
