...
class OrderChannelTypesIdGet200Response(BaseModel):
    """
    OrderChannelTypesIdGet200Response
    """ # noqa: E501
    data: Optional[OrderChannelTypesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderChannelTypesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
