...
class ShipmentsIdGet200ResponseRelationshipsDocumentTemplate(BaseModel):
    """
    ShipmentsIdGet200ResponseRelationshipsDocumentTemplate
    """ # noqa: E501
    data: Optional[ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShipmentsIdGet200ResponseRelationshipsDocumentTemplateData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
