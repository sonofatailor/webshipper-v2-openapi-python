...
class ReturnPortalsIdGet200Response(BaseModel):
    """
    ReturnPortalsIdGet200Response
    """ # noqa: E501
    data: Optional[ReturnPortalsIdGet200ResponseData] = None
    relationships: Optional[ReturnPortalsIdGet200ResponseRelationships] = None
    included: Optional[List[ReturnPortalsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnPortalsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ReturnPortalsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ReturnPortalsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
