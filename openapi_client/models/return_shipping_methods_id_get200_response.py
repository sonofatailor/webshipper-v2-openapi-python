...
class ReturnShippingMethodsIdGet200Response(BaseModel):
    """
    ReturnShippingMethodsIdGet200Response
    """ # noqa: E501
    data: Optional[ReturnShippingMethodsIdGet200ResponseData] = None
    relationships: Optional[ReturnShippingMethodsIdGet200ResponseRelationships] = None
    included: Optional[List[ReturnShippingMethodsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnShippingMethodsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ReturnShippingMethodsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ReturnShippingMethodsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
