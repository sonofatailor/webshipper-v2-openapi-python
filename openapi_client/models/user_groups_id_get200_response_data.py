...
class UserGroupsIdGet200ResponseData(BaseModel):
    """
    UserGroupsIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[UserGroups] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('user_groups'):
            raise ValueError("must be one of enum values ('user_groups')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": UserGroups.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
