...
class ShippingMappings(BaseModel):
    """
    ShippingMappings
    """ # noqa: E501
    shipping_code: Optional[StrictStr] = Field(default=None, description="Shipping code is a unique identifier from the order channel that will be mapped to a shipping rate")
    shipping_name: Optional[StrictStr] = Field(default=None, description="Shipping name is a human readable identifier of the shipping method")
    shipping_rate_id: Optional[StrictInt] = Field(default=None, description="Shipping rate id is the id of the shipping rate which you want to map to.")
    order_channel_id: Optional[StrictInt] = Field(default=None, description="Order channel id of the order channel")
    ...
    __properties: ClassVar[List[str]] = ["shipping_code", "shipping_name", "shipping_rate_id", "order_channel_id", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipping_name": obj.get("shipping_name"),
