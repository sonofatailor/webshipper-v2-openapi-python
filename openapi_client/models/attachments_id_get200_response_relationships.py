...
class AttachmentsIdGet200ResponseRelationships(BaseModel):
    """
    AttachmentsIdGet200ResponseRelationships
    """ # noqa: E501
    document: Optional[AttachmentsIdGet200ResponseRelationshipsDocument] = None
    has_documents: Optional[AttachmentsIdGet200ResponseRelationshipsHasDocuments] = None
    __properties: ClassVar[List[str]] = ["document", "has_documents"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of has_documents
        if self.has_documents:
            _dict['has_documents'] = self.has_documents.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "document": AttachmentsIdGet200ResponseRelationshipsDocument.from_dict(obj.get("document")) if obj.get("document") is not None else None,
            "has_documents": AttachmentsIdGet200ResponseRelationshipsHasDocuments.from_dict(obj.get("has_documents")) if obj.get("has_documents") is not None else None
        })
        return _obj
