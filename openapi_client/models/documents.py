...
class Documents(BaseModel):
    ...
    Documents
    """ # noqa: E501
    shipment_id: Optional[StrictInt] = Field(default=None, description="Id of the shipment it belongs to")
    document_size: Optional[StrictStr] = Field(default=None, description="Enum for the paper size. valid values: <code>A4</code>")
    document_format: Optional[StrictStr] = Field(default=None, description="Enum for the document format. Valid values: <code>PDF</code>")
    var_base64: Optional[StrictStr] = Field(default=None, description="Base64 representation of the document. Only required when creating.", alias="base64")
    is_special: Optional[StrictBool] = Field(default=None, description="Used to indicate if this document is a special document, like static customs documents. Special documents will be displayed in Webshipper under Settings > Documents.")
    name: Optional[StrictStr] = Field(default=None, description="Used for special documents")
    description: Optional[StrictStr] = Field(default=None, description="Used for special documents")
    document_type: Optional[StrictInt] = Field(default=None, description="One of: 'shipping_document', 'other', 'customs_document', 'invoice', 'certificate', 'proforma', 'nafta_certificate', 'commercial', 'awb'. Documents returned from the carrier are always shipping_document. ")
    is_paperless: Optional[StrictBool] = Field(default=None, description="Used to indicate if a shipment is paperless")
    ...
    __properties: ClassVar[List[str]] = ["shipment_id", "document_size", "document_format", "base64", "is_special", "name", "description", "document_type", "is_paperless", "updated_at", "created_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "document_size": obj.get("document_size"),
            ...
            "is_paperless": obj.get("is_paperless"),
