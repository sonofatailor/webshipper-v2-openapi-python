...
class HotKeysPostRequest(BaseModel):
    """
    HotKeysPostRequest
    """ # noqa: E501
    data: Optional[HotKeysPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": HotKeysPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
