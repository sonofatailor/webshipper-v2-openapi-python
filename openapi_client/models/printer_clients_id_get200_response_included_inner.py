...
class PrinterClientsIdGet200ResponseIncludedInner(BaseModel):
    """
    PrinterClientsIdGet200ResponseIncludedInner
    """ # noqa: E501
    type: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    data: Optional[PrinterClientsIdGet200ResponseIncludedInnerData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "data": PrinterClientsIdGet200ResponseIncludedInnerData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
