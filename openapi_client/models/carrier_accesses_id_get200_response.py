...
class CarrierAccessesIdGet200Response(BaseModel):
    """
    CarrierAccessesIdGet200Response
    """ # noqa: E501
    data: Optional[CarrierAccessesIdGet200ResponseData] = None
    relationships: Optional[CarrierAccessesIdGet200ResponseRelationships] = None
    included: Optional[List[CarrierAccessesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarrierAccessesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": CarrierAccessesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [CarrierAccessesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
