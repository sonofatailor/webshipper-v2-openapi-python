...
class AdditionalAttributes(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Visible name of the attribute")
    attr_key: Optional[StrictStr] = Field(default=None, description="Key for the attribute")
    attr_value: Optional[StrictStr] = Field(default=None, description="Value of the attribute")
    ...
    __properties: ClassVar[List[str]] = ["name", "attr_key", "attr_value", "updated_at", "created_at"]
