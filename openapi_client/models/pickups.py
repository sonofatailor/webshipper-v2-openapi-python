...
class Pickups(BaseModel):
    ...
    Pickups
    """ # noqa: E501
    pickup_instruction: Optional[StrictStr] = Field(default=None, description="Instruction to the carrier.")
    pickup_location_close_time: Optional[StrictStr] = Field(default=None, description="When the pickup location is closing.")
    pickup_time: Optional[StrictStr] = Field(default=None, description="The time you want the carrier to arrive at the pickup address.")
    reference: Optional[StrictStr] = Field(default=None, description="The reference returned by the carrier.")
    status: Optional[StrictInt] = Field(default=None, description="Decides if the pickup is <code>requested</code> or <code>cancelled</code>. To cancel a pickup you must update the status to cancelled. ")
    ...
    shipping_address: Optional[StrictStr] = Field(default=None, description="The address where the shipments must be picked up.")
    carrier: Optional[StrictStr] = Field(default=None, description="The carrier that should pickup the shipments.")
    __properties: ClassVar[List[str]] = ["pickup_instruction", "pickup_location_close_time", "pickup_time", "reference", "status", "created_at", "updated_at", "shipping_address", "carrier"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "pickup_instruction": obj.get("pickup_instruction"),
            "pickup_location_close_time": obj.get("pickup_location_close_time"),
