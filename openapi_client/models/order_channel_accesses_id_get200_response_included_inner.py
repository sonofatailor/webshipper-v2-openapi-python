...
class OrderChannelAccessesIdGet200ResponseIncludedInner(BaseModel):
    """
    OrderChannelAccessesIdGet200ResponseIncludedInner
    """ # noqa: E501
    type: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    data: Optional[OrderChannelAccessesIdGet200ResponseIncludedInnerData] = None
    __properties: ClassVar[List[str]] = ["type", "id", "data"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('orders', 'shipments'):
            raise ValueError("must be one of enum values ('orders', 'shipments')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "data": OrderChannelAccessesIdGet200ResponseIncludedInnerData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
