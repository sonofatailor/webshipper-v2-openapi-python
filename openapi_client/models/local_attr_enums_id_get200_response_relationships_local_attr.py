...
class LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr(BaseModel):
    """
    LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr
    """ # noqa: E501
    data: Optional[LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttrData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
