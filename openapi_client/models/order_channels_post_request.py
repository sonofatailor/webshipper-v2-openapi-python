...
class OrderChannelsPostRequest(BaseModel):
    """
    OrderChannelsPostRequest
    """ # noqa: E501
    data: Optional[OrderChannelsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderChannelsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
