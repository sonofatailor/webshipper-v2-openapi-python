...
class AdditionalAttributesIdGet200ResponseRelationshipsOrder(BaseModel):
    """
    AdditionalAttributesIdGet200ResponseRelationshipsOrder
    """ # noqa: E501
    data: Optional[AdditionalAttributesIdGet200ResponseRelationshipsOrderData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AdditionalAttributesIdGet200ResponseRelationshipsOrderData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
