...
class LocalAttrEnumsIdGet200ResponseRelationships(BaseModel):
    """
    LocalAttrEnumsIdGet200ResponseRelationships
    """ # noqa: E501
    local_attr: Optional[LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr] = None
    __properties: ClassVar[List[str]] = ["local_attr"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of local_attr
        if self.local_attr:
            _dict['local_attr'] = self.local_attr.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "local_attr": LocalAttrEnumsIdGet200ResponseRelationshipsLocalAttr.from_dict(obj.get("local_attr")) if obj.get("local_attr") is not None else None
        })
        return _obj
