...
class PickupsIdGet200ResponseRelationships(BaseModel):
    """
    PickupsIdGet200ResponseRelationships
    """ # noqa: E501
    carrier: Optional[BarcodeRangesIdGet200ResponseRelationshipsCarrier] = None
    shipping_address: Optional[CarriersIdGet200ResponseRelationshipsSenderAddress] = None
    __properties: ClassVar[List[str]] = ["carrier", "shipping_address"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "shipping_address": CarriersIdGet200ResponseRelationshipsSenderAddress.from_dict(obj.get("shipping_address")) if obj.get("shipping_address") is not None else None
        })
        return _obj
