...
class OrderMergesPost204Response(BaseModel):
    """
    OrderMergesPost204Response
    """ # noqa: E501
    data: Optional[OrderMergesPost204ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrderMergesPost204ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
