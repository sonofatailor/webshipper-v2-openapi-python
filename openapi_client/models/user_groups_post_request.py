...
class UserGroupsPostRequest(BaseModel):
    """
    UserGroupsPostRequest
    """ # noqa: E501
    data: Optional[UserGroupsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UserGroupsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
