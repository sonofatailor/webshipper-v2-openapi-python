...
class SlipTemplatePreviewsIdGet200Response(BaseModel):
    """
    SlipTemplatePreviewsIdGet200Response
    """ # noqa: E501
    data: Optional[SlipTemplatePreviewsIdGet200ResponseData] = None
    relationships: Optional[Union[str, Any]] = None
    included: Optional[List[BrandsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SlipTemplatePreviewsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": obj.get("relationships"),
            "included": [BrandsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
