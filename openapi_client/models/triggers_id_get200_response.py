...
class TriggersIdGet200Response(BaseModel):
    """
    TriggersIdGet200Response
    """ # noqa: E501
    data: Optional[TriggersIdGet200ResponseData] = None
    relationships: Optional[ActionsIdGet200ResponseRelationships] = None
    included: Optional[List[ActionsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": TriggersIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ActionsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ActionsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
