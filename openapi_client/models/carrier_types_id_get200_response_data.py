...
class CarrierTypesIdGet200ResponseData(BaseModel):
    """
    CarrierTypesIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[CarrierTypes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('carrier_types'):
            raise ValueError("must be one of enum values ('carrier_types')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": CarrierTypes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
