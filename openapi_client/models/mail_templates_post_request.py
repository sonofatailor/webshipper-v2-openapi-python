...
class MailTemplatesPostRequest(BaseModel):
    """
    MailTemplatesPostRequest
    """ # noqa: E501
    data: Optional[MailTemplatesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": MailTemplatesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
