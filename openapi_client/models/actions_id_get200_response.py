...
class ActionsIdGet200Response(BaseModel):
    """
    ActionsIdGet200Response
    """ # noqa: E501
    data: Optional[ActionsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ActionsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
