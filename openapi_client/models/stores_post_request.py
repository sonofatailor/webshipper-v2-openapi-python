...
class StoresPostRequest(BaseModel):
    """
    StoresPostRequest
    """ # noqa: E501
    data: Optional[StoresPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": StoresPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
