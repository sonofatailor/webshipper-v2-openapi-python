...
class SlipTemplatePreviews(BaseModel):
    """
    SlipTemplatePreviews
    """ # noqa: E501
    slip_template: Optional[StrictStr] = None
    order_visible_ref: Optional[StrictStr] = None
    var_base64: Optional[StrictStr] = Field(default=None, alias="base64")
    example_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["slip_template", "order_visible_ref", "base64", "example_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "slip_template": obj.get("slip_template"),
            "order_visible_ref": obj.get("order_visible_ref"),
