...
class ShippingAddressesIdGet200ResponseData(BaseModel):
    """
    ShippingAddressesIdGet200ResponseData
    """ # noqa: E501
    id: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    attributes: Optional[ShippingAddresses] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('shipping_addresses'):
            raise ValueError("must be one of enum values ('shipping_addresses')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ShippingAddresses.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
