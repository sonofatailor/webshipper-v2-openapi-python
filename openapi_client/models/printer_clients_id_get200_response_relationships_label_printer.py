...
class PrinterClientsIdGet200ResponseRelationshipsLabelPrinter(BaseModel):
    """
    PrinterClientsIdGet200ResponseRelationshipsLabelPrinter
    """ # noqa: E501
    data: Optional[PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PrinterClientsIdGet200ResponseRelationshipsLabelPrinterData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
