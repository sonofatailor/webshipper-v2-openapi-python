...
class BrandsPostRequest(BaseModel):
    """
    BrandsPostRequest
    """ # noqa: E501
    data: Optional[BrandsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BrandsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
