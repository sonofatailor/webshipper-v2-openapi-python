...
class CarrierAccessesPostRequest(BaseModel):
    """
    CarrierAccessesPostRequest
    """ # noqa: E501
    data: Optional[CarrierAccessesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CarrierAccessesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
