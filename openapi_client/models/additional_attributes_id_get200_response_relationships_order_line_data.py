...
class AdditionalAttributesIdGet200ResponseRelationshipsOrderLineData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('order_lines'):
            raise ValueError("must be one of enum values ('order_lines')")
        return value
