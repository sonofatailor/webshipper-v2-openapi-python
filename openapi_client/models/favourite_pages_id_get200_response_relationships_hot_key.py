...
class FavouritePagesIdGet200ResponseRelationshipsHotKey(BaseModel):
    """
    FavouritePagesIdGet200ResponseRelationshipsHotKey
    """ # noqa: E501
    data: Optional[FavouritePagesIdGet200ResponseRelationshipsHotKeyData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": FavouritePagesIdGet200ResponseRelationshipsHotKeyData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
