...
class CsvRulesPostRequest(BaseModel):
    """
    CsvRulesPostRequest
    """ # noqa: E501
    data: Optional[CsvRulesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvRulesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
