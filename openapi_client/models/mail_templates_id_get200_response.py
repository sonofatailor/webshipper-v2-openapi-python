...
class MailTemplatesIdGet200Response(BaseModel):
    """
    MailTemplatesIdGet200Response
    """ # noqa: E501
    data: Optional[MailTemplatesIdGet200ResponseData] = None
    relationships: Optional[MailTemplatesIdGet200ResponseRelationships] = None
    included: Optional[List[MailTemplatesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": MailTemplatesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": MailTemplatesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [MailTemplatesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
