...
class PackagesPostRequest(BaseModel):
    """
    PackagesPostRequest
    """ # noqa: E501
    data: Optional[PackagesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PackagesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
