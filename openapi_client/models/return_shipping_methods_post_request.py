...
class ReturnShippingMethodsPostRequest(BaseModel):
    """
    ReturnShippingMethodsPostRequest
    """ # noqa: E501
    data: Optional[ReturnShippingMethodsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ReturnShippingMethodsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
