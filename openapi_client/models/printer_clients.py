...
class PrinterClients(BaseModel):
    """
    PrinterClients
    """ # noqa: E501
    uuid: Optional[StrictStr] = Field(default=None, description="Unique ID of the printer client")
    approved: Optional[StrictBool] = Field(default=None, description="DEPRECATED")
    alias: Optional[StrictStr] = Field(default=None, description="Defaults to the host name of the machine running the client ")
    is_online: Optional[StrictBool] = Field(default=None, description="Shows if the printer client is online")
    last_connected: Optional[StrictStr] = Field(default=None, description="Shows when the printer client was last connected")
    prevent_multiple_shipments: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["uuid", "approved", "alias", "is_online", "last_connected", "prevent_multiple_shipments"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "prevent_multiple_shipments": obj.get("prevent_multiple_shipments")
        })
        return _obj
