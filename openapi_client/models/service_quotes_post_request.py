...
class ServiceQuotesPostRequest(BaseModel):
    """
    ServiceQuotesPostRequest
    """ # noqa: E501
    data: Optional[ServiceQuotesPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ServiceQuotesPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
