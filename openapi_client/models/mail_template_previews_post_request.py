...
class MailTemplatePreviewsPostRequest(BaseModel):
    """
    MailTemplatePreviewsPostRequest
    """ # noqa: E501
    data: Optional[MailTemplatePreviewsPostRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": MailTemplatePreviewsPostRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
