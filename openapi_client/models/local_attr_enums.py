...
class LocalAttrEnums(BaseModel):
    """
    LocalAttrEnums
    """ # noqa: E501
    enum_name: Optional[StrictStr] = Field(default=None, description="Visible name for the enum")
    enum_value: Optional[StrictStr] = Field(default=None, description="Value for the enum")
    __properties: ClassVar[List[str]] = ["enum_name", "enum_value"]
