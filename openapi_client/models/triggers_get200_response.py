...
class TriggersGet200Response(BaseModel):
    """
    TriggersGet200Response
    """ # noqa: E501
    data: Optional[List[TriggersGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [TriggersGet200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
