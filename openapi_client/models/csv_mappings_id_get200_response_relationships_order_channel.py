...
class CsvMappingsIdGet200ResponseRelationshipsOrderChannel(BaseModel):
    """
    CsvMappingsIdGet200ResponseRelationshipsOrderChannel
    """ # noqa: E501
    data: Optional[CsvMappingsIdGet200ResponseRelationshipsOrderChannelData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CsvMappingsIdGet200ResponseRelationshipsOrderChannelData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
