...
class PickupsIdGet200Response(BaseModel):
    """
    PickupsIdGet200Response
    """ # noqa: E501
    data: Optional[PickupsIdGet200ResponseData] = None
    relationships: Optional[PickupsIdGet200ResponseRelationships] = None
    included: Optional[List[PickupsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": PickupsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": PickupsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [PickupsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
