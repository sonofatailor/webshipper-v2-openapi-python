...
class ShippingRatesIdGet200Response(BaseModel):
    """
    ShippingRatesIdGet200Response
    """ # noqa: E501
    data: Optional[ShippingRatesIdGet200ResponseData] = None
    relationships: Optional[ShippingRatesIdGet200ResponseRelationships] = None
    included: Optional[List[ShippingRatesIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ShippingRatesIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": ShippingRatesIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [ShippingRatesIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
