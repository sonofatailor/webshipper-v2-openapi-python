...
class FavouritePages(BaseModel):
    """
    FavouritePages
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default=None, description="Path of the favourite page")
    name: Optional[StrictStr] = Field(default=None, description="Name of the favourite page")
    user_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["path", "name", "user_id"]
