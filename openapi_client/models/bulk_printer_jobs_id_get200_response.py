...
class BulkPrinterJobsIdGet200Response(BaseModel):
    """
    BulkPrinterJobsIdGet200Response
    """ # noqa: E501
    data: Optional[BulkPrinterJobsIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": BulkPrinterJobsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
