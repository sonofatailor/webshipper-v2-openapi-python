...
class LocalAttrsIdGet200Response(BaseModel):
    """
    LocalAttrsIdGet200Response
    """ # noqa: E501
    data: Optional[LocalAttrsIdGet200ResponseData] = None
    relationships: Optional[LocalAttrsIdGet200ResponseRelationships] = None
    included: Optional[List[LocalAttrsIdGet200ResponseIncludedInner]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": LocalAttrsIdGet200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "relationships": LocalAttrsIdGet200ResponseRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
            "included": [LocalAttrsIdGet200ResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
